...
extern "C" OMR_Agent* omr_agent_create(OMR_VM* vm, char const* arg) { return OMR_Agent::createAgent(vm, arg); }

extern "C" void omr_agent_destroy(OMR_Agent* agent) { OMR_Agent::destroyAgent(agent); }

extern "C" omr_error_t omr_agent_openLibrary(OMR_Agent* agent) { return agent->openLibrary(); }

extern "C" omr_error_t omr_agent_callOnLoad(OMR_Agent* agent) { return agent->callOnLoad(); }

extern "C" omr_error_t omr_agent_callOnUnload(OMR_Agent* agent) { return agent->callOnUnload(); }
...
omr_error_t OMR_Agent::callOnPreFork(void) { return _agentCallbacks.onPreFork(); }

omr_error_t OMR_Agent::callOnPostForkParent(void) { return _agentCallbacks.onPostForkParent(); }

omr_error_t OMR_Agent::callOnPostForkChild(void) { return _agentCallbacks.onPostForkChild(); }
