...
#if !defined(OMRAPP_OBJECTDESCRIPTION_H_)
#define OMRAPP_OBJECTDESCRIPTION_H_
...
typedef OMRApp::Object* languageobjectptr_t;
typedef OMRApp::Object* omrobjectptr_t;
...
#endif /* OMRAPP_OBJECTDESCRIPTION_H_ */
