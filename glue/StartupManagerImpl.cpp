...
MM_ConfigurationLanguageInterface* MM_StartupManagerImpl::createConfigurationLanguageInterface(MM_EnvironmentBase* env)
{
...
char* MM_StartupManagerImpl::getOptions(void) { return getenv("OMR_GC_OPTIONS"); }
