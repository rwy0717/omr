...
__asm(" IARV64 PLISTVER=MAX,MF=(L,LGETSTOR)"
      : "DS"(lgetstor));
...
__asm(" IARV64 PLISTVER=MAX,MF=(L,NGETSTOR)"
      : "DS"(ngetstor));
...
__asm(" IARV64 PLISTVER=MAX,MF=(L,OGETSTOR)"
      : "DS"(ogetstor));
...
__asm(" IARV64 PLISTVER=MAX,MF=(L,MGETSTOR)"
      : "DS"(mgetstor));
...
__asm(" IARV64 PLISTVER=MAX,MF=(L,RGETSTOR)"
      : "DS"(rgetstor));
...
__asm(" IARV64 PLISTVER=MAX,MF=(L,PGETSTOR)"
      : "DS"(pgetstor));
...
int omrfree_memory_above_bar(void* address, const char* ttkn)
{
    ...
    __asm(" IARV64 REQUEST=DETACH,COND=YES,MEMOBJSTART=(%2),TTOKEN=(%3),RETCODE=%0,MF=(E,(%1))" ::"m"(iarv64_rc), "r"(&wgetstor), "r"(&xmemobjstart), "r"(ttkn));
    return iarv64_rc;
}
...
__asm(" IARV64 PLISTVER=MAX,MF=(L,QGETSTOR)"
      : "DS"(qgetstor));
