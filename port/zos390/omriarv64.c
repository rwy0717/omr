 ...
 */
void *
omrallocate_1M_fixed_pages(int *numMBSegments, int *userExtendedPrivateAreaMemoryType, const char *ttkn)
{
	long segments;
	long origin;
 ...
 */
void *
omrallocate_1M_pageable_pages_above_bar(int *numMBSegments, int *userExtendedPrivateAreaMemoryType, const char *ttkn)
{
	long segments;
	long origin;
	long useMemoryType = *userExtendedPrivateAreaMemoryType;
 ...
 */
void *
omrallocate_2G_pages(int *num2GBUnits, int *userExtendedPrivateAreaMemoryType, const char *ttkn)
{
	long units;
	long origin;
	long useMemoryType = *userExtendedPrivateAreaMemoryType;
        ...
        int *numMBSegments, int *userExtendedPrivateAreaMemoryType, const char *ttkn)
{
	...
	switch (useMemoryType) {
	case ZOS64_VMEM_ABOVE_BAR_GENERAL: break;
	case ZOS64_VMEM_2_TO_32G:
		__asm(" IARV64 REQUEST=GETSTOR,COND=YES,SADMP=NO,USE2GTO32G=YES,"
