...
int64_t omrtime_nano_time(struct OMRPortLibrary* portLibrary) { return (int64_t)__getNanos(); }
 ...
 */
uint64_t omrtime_hires_clock(struct OMRPortLibrary* portLibrary) { return (int64_t)__getNanos(); }
/**
