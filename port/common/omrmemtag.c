 ...
 */
void* omrmem_allocate_portLibrary(uintptr_t byteAmount) { return omrmem_allocate_portLibrary_basic(byteAmount); }
 ...
 * @note Must be implemented for all platforms.
 */
void omrmem_deallocate_portLibrary(void* memoryPointer) { omrmem_deallocate_portLibrary_basic(memoryPointer); }
