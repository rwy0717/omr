 ...
 */
int32_t omrfile_attr(struct OMRPortLibrary* portLibrary, const char* path) { return -1; }
...
int32_t omrfile_chmod(struct OMRPortLibrary* portLibrary, const char* path, int32_t mode) { return -1; }
 ...
 */
void omrfile_findclose(struct OMRPortLibrary* portLibrary, uintptr_t findhandle) { return; }
 ...
 * @internal @todo return negative portable return code on failure.
 */
int32_t omrfile_findnext(struct OMRPortLibrary* portLibrary, uintptr_t findhandle, char* resultbuf) { return -1; }
 ...
 *
 */
int64_t omrfile_lastmod(struct OMRPortLibrary* portLibrary, const char* path) { return -1; }
/**
 ...
 * @internal @todo return negative portable return code on failure.
 */
int32_t omrfile_mkdir(struct OMRPortLibrary* portLibrary, const char* path) { return -1; }
 ...
 * @internal @todo return negative portable return code on failure.
 */
int32_t omrfile_move(struct OMRPortLibrary* portLibrary, const char* pathExist, const char* pathNew) { return -1; }
 ...
 * @internal @todo return negative portable return code on failure.
 */
int32_t omrfile_sync(struct OMRPortLibrary* portLibrary, intptr_t fd) { return -1; }
 ...
 * @internal @todo return negative portable return code on failure.
 */
int32_t omrfile_unlink(struct OMRPortLibrary* portLibrary, const char* path) { return -1; }
 ...
 * @internal @todo return negative portable return code on failure..
 */
int32_t omrfile_unlinkdir(struct OMRPortLibrary* portLibrary, const char* path) { return -1; }
 ...
 *
 */
int32_t omrfile_fstat(struct OMRPortLibrary* portLibrary, intptr_t fd, struct J9FileStat* buf) { return -1; }
