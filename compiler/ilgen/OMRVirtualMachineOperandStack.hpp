...
public:
	 ...
	 * @param growsUp to configure virtual machine stack growth direction, set to true if virtual machine stack
	 * grows towards larger addresses, false otherwise
	...
	/**
	 * @brief emit operands to store current operand stack values into same variables as used in another operand
	 * stack
	 ...
	 * @param b builder object to use for any operations used to implement the drop (e.g. to update the top of
	 * stack)
