...
TR_IlGenerator *
CompileIlGenRequest::getIlGenerator(TR::ResolvedMethodSymbol *methodSymbol, TR_FrontEnd *fe, TR::Compilation *comp,
...
TR_IlGenerator *
InliningIlGenRequest::getIlGenerator(TR::ResolvedMethodSymbol *methodSymbol, TR_FrontEnd *fe, TR::Compilation *comp,
        TR::SymbolReferenceTable *symRefTab)
{
...
TR_IlGenerator *
PartialInliningIlGenRequest::getIlGenerator(TR::ResolvedMethodSymbol *methodSymbol, TR_FrontEnd *fe,
