...
public:
	 ...
	 * @param arrayBase previously allocated and initialized VirtualMachineRegister representing the base of the
	 * array
	 */
	...
	/**
	 * @brief emit operands to store current operand array values into same variables as used in another operand
	 * array
