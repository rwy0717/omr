...
TR::Node* OMR::IlInjector::aconst(uintptrj_t value) { return TR::Node::aconst(value); }
...
TR::Node* OMR::IlInjector::staticAddress(void* address) { return TR::Node::aconst((uintptrj_t)address); }
