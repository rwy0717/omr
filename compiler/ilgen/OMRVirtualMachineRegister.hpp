...
protected:
	 ...
	 */
	VirtualMachineRegister(const char *const localName) : TR::VirtualMachineState(), _localName(localName) {}
...
public:
	 ...
	 * @param amount the TR::IlValue that should be added to the simulated value, after multiplication by
