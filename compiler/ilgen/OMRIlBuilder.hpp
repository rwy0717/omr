...
public:
	...
	public:
		 ...
		 */
		JBCase(int32_t v, TR::IlBuilder *b, int32_t f) : _value(v), _builder(b), _fallsThrough(f), _client(NULL)
		{}
	 ...
	 * @param numArgs the number of actual arguments for the method
	 * @param ... arguments to pass to the function, provided as TR::IlValue pointers, with the first argument
	 * providing the function address
	 * @returns the TR::IlValue corresponding to the called function's return value or NULL if return type is None
	 */
	...
	virtual void ForLoop(bool countsUp, const char *indVar, TR::IlBuilder **body, TR::IlBuilder **breakBuilder,
	        TR::IlBuilder **continueBuilder, TR::IlValue *initial, TR::IlValue *iterateWhile,
	 ...
	 * @param caseBuilder pointer to pointer to IlBuilder for the case (automatically allocated if pointed-to
	 * pointer is null).
