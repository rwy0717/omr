...
public:
	IlGenRequest(TR::IlGeneratorMethodDetails &methodDetails) : OMR::IlGenRequestConnector(methodDetails) {}
...
public:
	CompileIlGenRequest(TR::IlGeneratorMethodDetails &methodDetails) : IlGenRequest(methodDetails) {}
