...
uint8_t* TR_FrontEnd::allocateCodeMemory(
    TR::Compilation*, uint32_t warmCodeSize, uint32_t coldCodeSize, uint8_t** coldCode, bool isMethodHeaderNeeded)
{
    notImplemented("allocateCodeMemory");
    return 0;
}

void TR_FrontEnd::resizeCodeMemory(TR::Compilation*, uint8_t*, uint32_t numBytes)
{
...
void TR_FrontEnd::releaseCodeMemory(void*, uint8_t) { notImplemented("releaseCodeMemory"); }
...
bool TR_FrontEnd::isMethodEnterTracingEnabled(TR_OpaqueMethodBlock* method) { return false; }

bool TR_FrontEnd::isMethodExitTracingEnabled(TR_OpaqueMethodBlock* method) { return false; }
...
uintptrj_t TR_FrontEnd::getClassDepthAndFlagsValue(TR_OpaqueClassBlock* classPointer)
{
...
TR_OpaqueMethodBlock* TR_FrontEnd::getMethodFromName(
    char* className, char* methodName, char* signature, TR_OpaqueMethodBlock* callingMethod)
{
...
intptrj_t TR_FrontEnd::indexedTrampolineLookup(int32_t helperIndex, void* callSite)
{
