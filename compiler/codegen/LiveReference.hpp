...
public:
	...
	TR_LiveReference(TR_Memory *m) : _referenceNode(NULL), _numberOfParents(0), _parents(m), _needSpillTemp(false)
	{}

	TR_LiveReference(TR::Node *rn, TR::Node *parent, TR_Memory *m)
	        : _referenceNode(rn), _numberOfParents(0), _parents(m), _needSpillTemp(false)
	{
