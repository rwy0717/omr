...
public:
	...
	TR_LiveRegisterInfo(TR::Compilation *compilation) : _compilation(compilation) {}
...
public:
	...
	TR_LiveRegisters(TR::Compilation *comp) : _compilation(comp), _head(NULL), _pool(NULL), _numLiveRegisters(0) {}
