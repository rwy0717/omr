...
public:
    ...
    virtual TR_OpaqueMethodBlock* getMethodFromName(
        char* className, char* methodName, char* signature, TR_OpaqueMethodBlock* callingMethod = 0);
    ...
    virtual intptrj_t indexedTrampolineLookup(
        int32_t helperIndex, void* callSite); // No TR::Compilation parameter so this can be called from runtime code
