...
{
	TR_ASSERT(_callNode,
	        "preEvaluatePersistentHelperArguments can only be called for TR_OutOfLineCodeSection which are helper "
	        "calls");
...
TR::Node *
TR_OutOfLineCodeSection::createOutOfLineCallNode(TR::Node *callNode, TR::ILOpCodes callOp)
{
	int32_t i;
