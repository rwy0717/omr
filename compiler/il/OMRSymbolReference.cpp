 ...
 */
void
OMR::SymbolReference::init(TR::SymbolReferenceTable *symRefTab, uint32_t refNumber, TR::Symbol *sym, intptrj_t offset,
        mcount_t owningMethodIndex, int32_t cpIndex, int32_t unresolvedIndex, bool checkNoNamedShadow)
{
