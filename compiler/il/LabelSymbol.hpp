...
protected:
	...
	LabelSymbol(TR::CodeGenerator *codeGen) : OMR::LabelSymbolConnector(codeGen) {}

	LabelSymbol(TR::CodeGenerator *codeGen, TR::Block *labb) : OMR::LabelSymbolConnector(codeGen, labb) {}
