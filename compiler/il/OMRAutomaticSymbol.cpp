...
OMR::AutomaticSymbol::AutomaticSymbol(TR::DataType d) : TR::RegisterMappedSymbol(d)
{
	self()->init();
}

OMR::AutomaticSymbol::AutomaticSymbol(TR::DataType d, uint32_t s) : TR::RegisterMappedSymbol(d, s)
{
	self()->init();
}

OMR::AutomaticSymbol::AutomaticSymbol(TR::DataType d, uint32_t s, const char *name) : TR::RegisterMappedSymbol(d, s)
{
	self()->init();
	_name = name;
}
...
template <typename AllocatorType>
TR::AutomaticSymbol *
OMR::AutomaticSymbol::create(AllocatorType t, TR::DataType d, uint32_t s, const char *n)
{
...
template <typename AllocatorType>
TR::AutomaticSymbol *
OMR::AutomaticSymbol::createLocalObject(AllocatorType m, int32_t arrayType, TR::DataType d, uint32_t s, TR_FrontEnd *fe)
{
...
template <typename AllocatorType>
TR::AutomaticSymbol *
OMR::AutomaticSymbol::createLocalObject(AllocatorType m, TR::ILOpCodes kind, TR::SymbolReference *classSymRef,
...
template <typename AllocatorType>
TR::AutomaticSymbol *
OMR::AutomaticSymbol::createInternalPointer(AllocatorType m, TR::AutomaticSymbol *pinningArrayPointer)
{
...
template <typename AllocatorType>
TR::AutomaticSymbol *
OMR::AutomaticSymbol::createInternalPointer(AllocatorType m, TR::DataType d, TR::AutomaticSymbol *pinningArrayPointer)
{
...
template <typename AllocatorType>
TR::AutomaticSymbol *
OMR::AutomaticSymbol::createInternalPointer(AllocatorType m, TR::DataType d, uint32_t s, TR_FrontEnd *fe)
{
	TR::AutomaticSymbol *sym = new (m) TR::AutomaticSymbol(d, s);
	sym->setInternalPointer();
