...
bool OMR::Symbol::isAutoAddressTaken() { return self()->isAuto() && _flags.testAny(AutoAddressTaken); }
...
bool OMR::Symbol::isPythonConstantShadowSymbol() { return self()->isShadow() && _flags.testAny(PythonConstant); }
...
bool OMR::Symbol::isPythonNameShadowSymbol() { return self()->isShadow() && _flags.testAny(PythonName); }
...
bool OMR::Symbol::isGlobalLabel() { return self()->isLabel() && _flags.testValue(LabelKindMask, IsGlobalLabel); }
