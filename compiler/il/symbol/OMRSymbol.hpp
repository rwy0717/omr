...
public:
    ...
    enum {
        ...
        SetUpDLPFlags = 0xF0000000, ///< Used by TR::StaticSymbol::SetupDLPFlags(), == ConstString |
                                    ///< AddressIsCPIndexOfStatic | RecognizedStatic
        ...
        PythonLocalVariable = 0x10000000, // Python local variable shadow  TODO: If we ever move this somewhere else,
                                          // can we move UnsafeShadow from flags2 to here?
