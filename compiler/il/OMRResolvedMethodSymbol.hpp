...
public:
	...
	bool genIL(TR_FrontEnd *fe, TR::Compilation *comp, TR::SymbolReferenceTable *symRefTab,
	...
	void insertStoresForDeadStackSlotsBeforeInducingOSR(TR::Compilation *comp, int32_t inlinedSiteIndex,
	        TR_ByteCodeInfo &byteCodeInfo, TR::TreeTop *induceOSRTree);
	void insertStoresForDeadStackSlots(TR::Compilation *comp, TR_ByteCodeInfo &byteCodeInfo,
	        TR::TreeTop *insertTree, bool keepStashedArgsLive = true);
	bool sharesStackSlots(TR::Compilation *comp);
	void resetLiveLocalIndices();

	bool genPartialIL(TR_FrontEnd *, TR::Compilation *, TR::SymbolReferenceTable *,
	        bool forceClassLookahead = false, TR_InlineBlocks *blocksToInline = 0);
...
public:
	 ...
	 */
	template <typename AllocatorType>
	static TR::ResolvedMethodSymbol *createJittedMethodSymbol(
	        AllocatorType m, TR_ResolvedMethod *, TR::Compilation *);
