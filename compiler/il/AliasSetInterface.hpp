...
template <>
inline TR_BitVector* TR_NodeAliasSetInterface<mayUseAliasSet>::getTRAliases_impl(
    bool isDirectCall, bool includeGCSafePoint)
{
    TR::Compilation* comp = TR::comp();
...
template <>
inline TR_BitVector* TR_NodeAliasSetInterface<mayKillAliasSet>::getTRAliases_impl(
    bool isDirectCall, bool includeGCSafePoint)
{
    TR::Compilation* comp = TR::comp();
    TR_BitVector* bv = NULL;
    ...
    if (_node->getOpCode().hasSymbolReference()
        && (_node->getOpCode().isLikeDef()
               || _node->mightHaveVolatileSymbolReference())) // we want the old behavior in these cases
    {
...
struct TR_NodeUseAliasSetInterface : public TR_NodeAliasSetInterface<mayUseAliasSet> {
    TR_NodeUseAliasSetInterface(TR::Node* node, bool isDirectCall = false, bool includeGCSafePoint = false)
...
struct TR_NodeKillAliasSetInterface : public TR_NodeAliasSetInterface<mayKillAliasSet> {
    TR_NodeKillAliasSetInterface(TR::Node* node, bool isDirectCall = false, bool includeGCSafePoint = false)
