...
template <uint32_t _aliasSetType> inline void TR_SymAliasSetInterface<_aliasSetType>::setAlias_impl(TR::SymbolReference* symRef2, bool value, bool isDirectCall, bool includeGCSafePoint)
{
    TR::Compilation* comp = TR::comp();
    if (symRef2 == NULL)
        return;
...
template <uint32_t _aliasSetType> inline void TR_SymAliasSetInterface<_aliasSetType>::removeSymRef1KillsSymRef2Asymmetrically(TR::SymbolReference* symRef1, TR::SymbolReference* symRef2, bool includeGCSafePoint)
{
...
template <uint32_t _aliasSetType> inline void TR_SymAliasSetInterface<_aliasSetType>::addSymRef1KillsSymRef2Asymmetrically(TR::SymbolReference* symRef1, TR::SymbolReference* symRef2, bool includeGCSafePoint)
{
    TR::Compilation* comp = TR::comp();
    TR_BitVector* symRef1_killedAliases = symRef1->getUseDefAliases(includeGCSafePoint).getTRAliases();
...
template <uint32_t _aliasSetType> inline void TR_SymAliasSetInterface<_aliasSetType>::setSymRef1KillsSymRef2Asymmetrically(TR::SymbolReference* symRef1, TR::SymbolReference* symRef2, bool includeGCSafePoint, bool value)
{
    TR::Compilation* comp = TR::comp();
...
template <> inline TR_BitVector* TR_SymAliasSetInterface<useDefAliasSet>::getTRAliases_impl(bool isDirectCall, bool includeGCSafePoint)
{
    return _symbolReference->getUseDefAliasesBV(isDirectCall, includeGCSafePoint);
}

template <> inline TR_BitVector* TR_SymAliasSetInterface<UseOnlyAliasSet>::getTRAliases_impl(bool isDirectCall, bool includeGCSafePoint)
{
...
template <> inline TR_BitVector* TR_NodeAliasSetInterface<mayUseAliasSet>::getTRAliases_impl(bool isDirectCall, bool includeGCSafePoint)
{
    TR::Compilation* comp = TR::comp();
...
template <> inline TR_BitVector* TR_NodeAliasSetInterface<mayKillAliasSet>::getTRAliases_impl(bool isDirectCall, bool includeGCSafePoint)
{
    TR::Compilation* comp = TR::comp();
    TR_BitVector* bv = NULL;
...
struct TR_NodeUseAliasSetInterface : public TR_NodeAliasSetInterface<mayUseAliasSet> {
    TR_NodeUseAliasSetInterface(TR::Node* node,
        bool isDirectCall = false,
        bool includeGCSafePoint = false)
        : TR_NodeAliasSetInterface<mayUseAliasSet>(node, isDirectCall, includeGCSafePoint)
    {}
};
...
struct TR_NodeKillAliasSetInterface : public TR_NodeAliasSetInterface<mayKillAliasSet> {
    TR_NodeKillAliasSetInterface(TR::Node* node,
        bool isDirectCall = false,
        bool includeGCSafePoint = false)
        : TR_NodeAliasSetInterface<mayKillAliasSet>(node, isDirectCall, includeGCSafePoint)
    {}
};
