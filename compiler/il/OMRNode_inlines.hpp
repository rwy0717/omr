...
bool OMR::Node::isSingleRefUnevaluated() { return self()->isSingleRef() && !self()->getRegister(); }
...
uint16_t OMR::Node::setUseDefIndex(uint16_t udi) { return (_unionA._useDefIndex = udi); }
