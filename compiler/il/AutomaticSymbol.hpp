...
protected:
	...
	AutomaticSymbol(TR::DataType d, uint32_t s) : OMR::AutomaticSymbolConnector(d, s) {}

	AutomaticSymbol(TR::DataType d, uint32_t s, const char *name) : OMR::AutomaticSymbolConnector(d, s, name) {}
