...
bool OMR::Node::nodeMightKillCondCode()
{
    ...
    if (((opcode.isLoad() || opcode.isStore() || opcode.isLoadReg() || opcode.isStoreDirectOrReg()
            ...
            && (self()->getSize() == 4 || self()->getSize() == 8 || self()->getSize() == 2
                   || (self()->getSize() == 1 && TR::Compiler->target.cpu.getS390SupportsZ9())
                   || self()->getSize() == 0)))
        return false;
...
bool OMR::Node::hasPinningArrayPointer() { return self()->getOpCode().hasPinningArrayPointer(); }
...
const char* OMR::Node::printIsNonZero() { return self()->isNonZero() ? "X!=0 " : ""; }
...
const char* OMR::Node::printPointsToNull() { return self()->chkPointsToNull() ? "*X==null " : ""; }
...
const char* OMR::Node::printPointsToNonNull() { return self()->chkPointsToNonNull() ? "nodePointsToNonNull " : ""; }
...
const char* OMR::Node::printIsHPREligible() { return self()->getIsHPREligible() ? "canBeAssignedToHPR " : ""; }
    ...
    case TR::idiv:
        if (firstChild->getIsHPREligible()) {
            if (secondChild->isPowerOfTwo()
                || (secondChild->getOpCodeValue() == TR::iconst && ((secondChild->getInt() % 2) == 0))) {
...
const char* OMR::Node::printIsProfilingCode() { return self()->isProfilingCode() ? "profilingCode " : ""; }
...
const char* OMR::Node::printIsNonNegative() { return self()->isNonNegative() ? "X>=0 " : ""; }
...
const char* OMR::Node::printIsNonPositive() { return self()->isNonPositive() ? "X<=0 " : ""; }
...
const char* OMR::Node::printCannotOverflow() { return self()->chkCannotOverflow() ? "cannotOverflow " : ""; }
...
const char* OMR::Node::printIsNOPLongStore() { return self()->chkNOPLongStore() ? "NOPLongStore " : ""; }
...
const char* OMR::Node::printSetUseSignExtensionMode() { return self()->useSignExtensionMode() ? "SignExtMode " : ""; }
...
const char* OMR::Node::printIsInternalPointer() { return self()->isInternalPointer() ? "internalPtr " : ""; }
...
const char* OMR::Node::printArrayTRT() { return self()->chkArrayTRT() ? "arrayTRT " : ""; }
...
const char* OMR::Node::printCharArrayTRT() { return self()->chkCharArrayTRT() ? "charArrayTRT " : ""; }
...
bool OMR::Node::chkArrayCmpLen() { return self()->getOpCodeValue() == TR::arraycmp && _flags.testAny(arrayCmpLen); }

const char* OMR::Node::printArrayCmpLen() { return self()->chkArrayCmpLen() ? "arrayCmpLen " : ""; }
...
const char* OMR::Node::printArrayCmpSign() { return self()->chkArrayCmpSign() ? "arrayCmpSign " : ""; }
...
const char* OMR::Node::printIsForwardArrayCopy() { return self()->chkForwardArrayCopy() ? "forwardArrayCopy " : ""; }
...
const char* OMR::Node::printIsBackwardArrayCopy() { return self()->chkBackwardArrayCopy() ? "backwardArrayCopy " : ""; }
...
const char* OMR::Node::printXorBitOpMem() { return self()->chkXorBitOpMem() ? "SubOp=XOR " : ""; }
...
const char* OMR::Node::printOrBitOpMem() { return self()->chkOrBitOpMem() ? "SubOp=OR " : ""; }
...
const char* OMR::Node::printAndBitOpMem() { return self()->chkAndBitOpMem() ? "SubOp=AND " : ""; }
...
const char* OMR::Node::printIsSkipWrtBar() { return self()->chkSkipWrtBar() ? "skipWrtBar " : ""; }
...
const char* OMR::Node::printIsHeapObjectWrtBar() { return self()->chkHeapObjectWrtBar() ? "heapObjectWrtBar " : ""; }
...
const char* OMR::Node::printNeedsSignExtension() { return self()->needsSignExtension() ? "NeedsSignExt " : ""; }
...
const char* OMR::Node::printSkipSignExtension() { return self()->skipSignExtension() ? "SkipSignExt " : ""; }
...
bool OMR::Node::isNodeCreatedByPRE() { return self()->canChkNodeCreatedByPRE() && _flags.testAny(nodeCreatedByPRE); }
...
const char* OMR::Node::printIsNodeCreatedByPRE() { return self()->chkNodeCreatedByPRE() ? "createdByPRE " : ""; }
...
const char* OMR::Node::printIsProfiledGuard() { return self()->isProfiledGuard() ? "inlineProfiledGuard " : ""; }
...
const char* OMR::Node::printIsInterfaceGuard() { return self()->isInterfaceGuard() ? "inlineInterfaceGuard " : ""; }
...
const char* OMR::Node::printIsAbstractGuard() { return self()->isAbstractGuard() ? "inlineAbstractGuard " : ""; }
...
const char* OMR::Node::printIsHierarchyGuard() { return self()->isHierarchyGuard() ? "inlineHierarchyGuard " : ""; }
...
const char* OMR::Node::printIsSideEffectGuard() { return self()->isSideEffectGuard() ? "sideEffectGuard " : ""; }

bool OMR::Node::isDummyGuard() { return _flags.testValue(inlineGuardMask, dummyGuard) && self()->getOpCode().isIf(); }
...
const char* OMR::Node::printIsDummyGuard() { return self()->isDummyGuard() ? "dummyGuard " : ""; }

bool OMR::Node::isHCRGuard() { return _flags.testValue(inlineGuardMask, inlineHCRGuard) && self()->getOpCode().isIf(); }
...
const char* OMR::Node::printIsHCRGuard() { return self()->isHCRGuard() ? "inlineHCRGuard " : ""; }
...
const char* OMR::Node::printIsDirectMethodGuard() { return self()->isDirectMethodGuard() ? "directMethodGuard " : ""; }

bool OMR::Node::isOSRGuard() { return _flags.testValue(inlineGuardMask, osrGuard) && self()->getOpCode().isIf(); }
...
const char* OMR::Node::printIsBreakpointGuard() { return self()->isBreakpointGuard() ? "breakpointGuard " : ""; }

const char* OMR::Node::printIsOSRGuard() { return self()->isOSRGuard() ? "osrGuard " : ""; }
...
const char* OMR::Node::printIsSeenRealReference() { return self()->chkSeenRealReference() ? "SeenRealReference " : ""; }
...
const char* OMR::Node::printIsHighWordZero() { return self()->chkHighWordZero() ? "highWordZero " : ""; }
...
const char* OMR::Node::printIsUnsigned() { return self()->chkUnsigned() ? "Unsigned " : ""; }
...
const char* OMR::Node::printIsSkipSync() { return self()->chkSkipSync() ? "skipSync " : ""; }
...
const char* OMR::Node::printIsStaticMonitor() { return self()->chkStaticMonitor() ? "staticMonitor " : ""; }
...
const char* OMR::Node::printIsSyncMethodMonitor() { return self()->chkSyncMethodMonitor() ? "syncMethodMonitor " : ""; }
...
const char* OMR::Node::printIsReadMonitor() { return self()->chkReadMonitor() ? "readMonitor " : ""; }
...
const char* OMR::Node::printIsOmitSync() { return self()->chkOmitSync() ? "omitSync " : ""; }
...
const char* OMR::Node::printIsSimpleDivCheck() { return self()->chkSimpleDivCheck() ? "simpleDivCheck " : ""; }
...
const char* OMR::Node::printIsNormalizedShift() { return self()->chkNormalizedShift() ? "normalizedShift " : ""; }
...
const char* OMR::Node::printIsFPStrictCompliant() { return self()->isFPStrictCompliant() ? "FPPrecise " : ""; }
...
const char* OMR::Node::printIsUnneededConversion() { return self()->isUnneededConversion() ? "unneededConv " : ""; }
...
const char* OMR::Node::printReturnIsDummy() { return (self()->chkReturnIsDummy()) ? "returnIsDummy " : ""; }
