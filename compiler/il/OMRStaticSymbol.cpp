...
template <typename AllocatorType>
TR::StaticSymbol *
OMR::StaticSymbol::createWithAddress(AllocatorType m, TR::DataType d, void *address)
{
...
template <typename AllocatorType>
TR::StaticSymbol *
OMR::StaticSymbol::createWithSize(AllocatorType m, TR::DataType d, uint32_t size)
{
	// Explict cast to disambiguate constructor!
...
template <typename AllocatorType>
TR::StaticSymbol *
OMR::StaticSymbol::createNamed(AllocatorType m, TR::DataType d, const char *name)
{
...
template <typename AllocatorType>
TR::StaticSymbol *
OMR::StaticSymbol::createNamed(AllocatorType m, TR::DataType d, void *addr, const char *name)
{
