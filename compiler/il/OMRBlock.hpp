...
public:
	...
	{
		TR_ASSERT(0,
		        "blocks should not be freed until the destructor is updated to also free the catch block "
		        "extension");
	...
	static TR::Block *createEmptyBlock(
	        TR::Node *, TR::Compilation *, int32_t frequency = -1, TR::Block *block = NULL);
	...
	TR::Block *createConditionalSideExitBeforeTree(TR::TreeTop *tree, TR::TreeTop *compareTree,
	        TR::TreeTop *exitTree, TR::TreeTop *returnTree, TR::CFG *cfg, bool markCold = true);
	...
	//
	enum { CanCatchNullCheck = 0x00000001,
...
public:
	...
	TR_ExtendedBlockSuccessorIterator(TR::Block *b, TR::CFG *cfg) : _firstBlock(b), _cfg(cfg) {}
