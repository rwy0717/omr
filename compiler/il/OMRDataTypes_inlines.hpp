...
{
    return self()->getDataType() == TR::VectorInt8 || self()->getDataType() == TR::VectorInt16 || self()->getDataType() == TR::VectorInt32 || self()->getDataType() == TR::VectorInt64 || self()->getDataType() == TR::VectorFloat || self()->getDataType() == TR::VectorDouble;
}
