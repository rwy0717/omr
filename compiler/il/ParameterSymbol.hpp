...
protected:
	ParameterSymbol(TR::DataType d, int32_t slot) : OMR::ParameterSymbolConnector(d, slot) {}

	ParameterSymbol(TR::DataType d, int32_t slot, size_t size) : OMR::ParameterSymbolConnector(d, slot, size) {}
