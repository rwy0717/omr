...
protected:
	StaticSymbol(TR::DataType d) : TR::Symbol(d), _staticAddress(0), _assignedTOCIndex(0)
	{
		_flags.setValue(KindMask, IsStatic);
	}

	StaticSymbol(TR::DataType d, void *address) : TR::Symbol(d), _staticAddress(address), _assignedTOCIndex(0)
	{
		_flags.setValue(KindMask, IsStatic);
	}

	StaticSymbol(TR::DataType d, uint32_t s) : TR::Symbol(d, s), _staticAddress(0), _assignedTOCIndex(0)
	{
		_flags.setValue(KindMask, IsStatic);
	}
