...
protected:
	...
	RegisterMappedSymbol(TR::DataType d) : OMR::RegisterMappedSymbolConnector(d) {}

	RegisterMappedSymbol(TR::DataType d, uint32_t s) : OMR::RegisterMappedSymbolConnector(d, s) {}
