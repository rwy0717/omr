...
TR::OptionTable OMR::Options::_jitOptions[] = {
        ...
        {"abstractTimeGracePeriodInliningAggressiveness=", "O<nnn>Time to maintain full inlining aggressiveness\t",
                TR::Options::setStaticNumeric, (intptrj_t)&OMR::Options::_abstractTimeGracePeriod, 0, "F%d",
                NOT_IN_SUBSET},
        {"abstractTimeToReduceInliningAggressiveness=",
                "O<nnn>Time to lower inlining aggressiveness from highest to lowest level\t",
                TR::Options::setStaticNumeric, (intptrj_t)&OMR::Options::_abstractTimeToReduceInliningAggressiveness, 0,
                "F%d", NOT_IN_SUBSET},
        {"acceptHugeMethods", "O\tallow processing of really large methods", SET_OPTION_BIT(TR_ProcessHugeMethods),
                "F"},
        ...
        {"aggressiveRecompilationChances=",
                ...
                TR::Options::setStaticNumeric, (intptrj_t)&OMR::Options::_aggressiveRecompilationChances, 0, "F%d",
                NOT_IN_SUBSET},
        ...
        {"bigCalleeThresholdForColdCallsAtHot=",
                "O<nnn>\tInliner threshold for cold calls for opt level higher then warm", TR::Options::set32BitNumeric,
                offsetof(OMR::Options, _bigCalleeThresholdForColdCallsAtHot), 500, " %d"},
        {"bigCalleeThresholdForColdCallsAtWarm=",
                "O<nnn>\tInliner threshold for cold calls for opt level less or equal to warm",
                TR::Options::set32BitNumeric, offsetof(OMR::Options, _bigCalleeThresholdForColdCallsAtWarm), 100,
                " %d"},
        {"blockShufflingSequence=",
                "D<string>\tDescription of the particular block shuffling operations to perform; see source code for "
                "more details",
        ...
        {"breakOnCompile", "D\tdeprecated; equivalent to breakBeforeCompile", SET_OPTION_BIT(TR_BreakBeforeCompile),
                "F"},
        ...
        {"checkGRA",
                "D\tPreserve stores that would otherwise be removed by GRA, and then verify that the stored value "
                "matches the global register",
        ...
        {"classesWithFoldableFinalFields=",
                "O{regex}\tAllow hard-coding of values of final fields in the specified classes.  Default is to fold "
                "anything considered safe.",
        ...
        {"classRedefinitionUPICRatSize=", "M<nnn>\tsize of runtime assumption table for classRedefinitionUPIC",
                TR::Options::setStaticNumeric, (intptrj_t)&OMR::Options::_classRedefinitionUPICRatSize, 0, "F%d",
                NOT_IN_SUBSET},
        ...
        {"coldUpgradeSampleThreshold=",
                ...
                TR::Options::setStaticNumeric, (intptrj_t)&OMR::Options::_coldUpgradeSampleThreshold, 0, "P%d",
                NOT_IN_SUBSET},
        {"compilationStrategy=", "O<strategyname>\tname of the compilation strategy to use",
                TR::Options::setStaticString, (intptrj_t)(&OMR::Options::_compilationStrategyName), 0, "F%s",
                NOT_IN_SUBSET},
        ...
        {"compThreadCPUEntitlement=", "M<nnn>\tThreshold for CPU utilization of compilation threads",
                TR::Options::setStaticNumeric, (intptrj_t)&OMR::Options::_compThreadCPUEntitlement, 0, "F%d",
                NOT_IN_SUBSET},
        {"concurrentLPQ",
                "M\tCompilations from low priority queue can go in parallel with compilations from main queue",
        ...
        {"cpuExpensiveCompThreshold=", "M<nnn>\tthreshold for when compilations are considered cpu expensive",
                TR::Options::setStaticNumeric, (intptrj_t)&OMR::Options::_cpuExpensiveCompThreshold, 0, "F%d",
                NOT_IN_SUBSET},
        {"cpuUsageCircularBufferSize=", "O<nnn>\tSet the size of the CPU Usage Circular Buffer; Set it to 0 to disable",
                TR::Options::setStaticNumeric, (intptrj_t)&OMR::Options::_cpuUsageCircularBufferSize, 0, "F%d",
                NOT_IN_SUBSET},
        {"cpuUsageCircularBufferUpdateFrequencySec=", "O<nnn>\tFrequency of the CPU Usage Array update",
                TR::Options::setStaticNumeric, (intptrj_t)&OMR::Options::_cpuUsageCircularBufferUpdateFrequencySec, 0,
                "F%d", NOT_IN_SUBSET},
        ...
        {"debugCounters=",
                "D{regex}\tEnable dynamic debug counters with names matching regex (unless they fail to meet some "
                "other criterion)",
                TR::Options::setRegex, offsetof(OMR::Options, _enabledDynamicCounterNames), 0, "F"},
        {"debugCounterWarmupSeconds=",
                "D<nnn>\tDebug counters will be reset to zero after nnn seconds, so only increments after this point "
                "will end up in the final report",
        ...
        {"debugOnCompile", "D\tdeprecated; equivalent to debugBeforeCompile", SET_OPTION_BIT(TR_DebugBeforeCompile),
                "F"},
        ...
        {"disableAndSimplification", "O\tdisable and simplification", TR::Options::disableOptimization,
                andSimplification, 0, "P"},
        ...
        {"disableAOTStaticField", "O\tdisable AOT static field inlining", SET_OPTION_BIT(TR_DisableAOTStaticField),
                "F"},
        ...
        {"disableCatchBlockRemoval", "O\tdisable catch block removal", TR::Options::disableOptimization,
                catchBlockRemoval, 0, "P"},
        ...
        {"disableCompactNullChecks", "O\tdisable compact null checks", TR::Options::disableOptimization,
                compactNullChecks, 0, "P"},
        ...
        {"disableCompilationAfterDLT",
                "O\tdisable queueing of normal compilation for method that has been DLT compiled.",
        ...
        {"disableCPUUtilization", "M\tdisable tracking of cpu utilization", SET_OPTION_BIT(TR_DisableCPUUtilization),
                "F", NOT_IN_SUBSET},
        ...
        {"disableDeadStoreBailOut", "O\tdisable bail out of dead store", SET_OPTION_BIT(TR_DisableDeadStoreBailOut),
                "F"},
        ...
        {"disableDememoization",
                "O\talways call \"memoizing\" getters (like Integer.valueOf) rather than having Escape Analysis turn "
                "them into noncontiguous stack allocations",
        ...
        {"disableEscapeAnalysis", "O\tdisable escape analysis", TR::Options::disableOptimization, escapeAnalysis, 0,
                "P"},
        ...
        {"disableGLU", "O\tdisable general loop unroller", TR::Options::disableOptimization, generalLoopUnroller, 0,
                "P"},
        ...
        {"disableGuardedCallArgumentRemat",
                "O\tdon't rematerialize a guarded virtual call's arguments on the cold path; instead, leave the "
                "expressions on the mainline path",
        ...
        {"disableIdiomRecognition", "O\tdisable idiom recognition", TR::Options::disableOptimization, idiomRecognition,
                0, "P"},
#endif
        ...
        {DisableInliningOfNativesString, "O\tdisable inlining of natives", SET_OPTION_BIT(TR_DisableInliningOfNatives),
                "F"},
        {"disableInnerPreexistence", "O\tdisable inner preexistence", TR::Options::disableOptimization,
                innerPreexistence, 0, "P"},
        ...
        {"disableLiveRangeSplitter", "O\tdisable live range splitter", SET_OPTION_BIT(TR_DisableLiveRangeSplitter),
                "F"},
        ...
        {"disableLocalReordering", "O\tdisable local reordering", TR::Options::disableOptimization, localReordering, 0,
                "P"},
        {"disableLocalVP", "O\tdisable local value propagation", TR::Options::disableOptimization,
                localValuePropagation, 0, "P"},
        ...
        {"disableLoopAliasRefiner", "O\tdisable loop alias refinement", TR::Options::disableOptimization,
                loopAliasRefiner, 0, "P"},
        ...
        {"disableLoopReplicator", "O\tdisable loop replicator", TR::Options::disableOptimization, loopReplicator, 0,
                "P"},
        ...
        {"disableMarshallingIntrinsics",
                "O\tDisable packed decimal to binary marshalling and un-marshalling optimization. They will not be "
                "inlined.",
                SET_OPTION_BIT(TR_DisableMarshallingIntrinsics), "F"},
        {"disableMaskVFTPointers", "O\tdisable masking of VFT Pointers", SET_OPTION_BIT(TR_DisableMaskVFTPointers),
                "F"},
        ...
        {"disableMethodIsCold",
                "O\tdo not use heuristics to determine whether whole methods are cold based on how many times they "
        ...
        {"disableNextGenHCR", "O\tdisable HCR implemented with on-stack replacement",
        ...
        {"disablePackedDecimalIntrinsics",
                "O\tDisables packed decimal function optimizations and avoid generating exception triggering packed "
                "decimal instructions on z/Architecture.",
        ...
        {"disablePrefetchInsertion", "O\tdisable prefetch insertion", TR::Options::disableOptimization,
                prefetchInsertion, 0, "P"},
...
#ifdef J9_PROJECT_SPECIFIC
        {"disableProfileGenerator", "O\tdisable profile generator", TR::Options::disableOptimization, profileGenerator,
                0, "P"},
#endif
        ...
        {"disableRedundantAsyncCheckRemoval", "O\tdisable redundant async check removal",
        ...
        {"disableRematerialization", "O\tdisable rematerialization", TR::Options::disableOptimization,
                rematerialization, 0, "P"},
        ...
        {"disableSIMD",
                "O\tdisable SIMD exploitation and infrastructure on platforms supporting vector register and "
                "instructions",
        ...
        {"disableStringBuilderTransformer",
                "O\tenable transforming StringBuilder constructor to preallocate a buffer for String concatenation "
                "operations",
        ...
        {"disableSwitchAnalyzer", "O\tdisable switch analyzer", TR::Options::disableOptimization, switchAnalyzer, 0,
                "P"},
        ...
        {"disableThunkTupleJ2I",
                "D\tdo not replace initialInvokeExactThunk with J2I thunk / helper address in ThunkTuple",
        ...
        {"disableTlhPrefetch", "O\tdisable software prefetch on allocation", SET_OPTION_BIT(TR_DisableTLHPrefetch),
                "F"},
        ...
        {"disableUpdateAOTBytesSize",
                "M\tDon't send VM size of bodies that could have been AOT'd if the SCC wasn't full",
                SET_OPTION_BIT(TR_DisableUpdateAOTBytesSize), "F", NOT_IN_SUBSET},
        {"disableUpdateJITBytesSize",
                "M\tDon't send VM size of IProfiler Entires and Hints that could have been persisted if the SCC wasn't "
                "full",
        ...
        {"disableVectorBCD", "O\tdisable vector instructions for DAA BCD intrinsics ",
        ...
        {"disableVMCSProfiling", "O\tdisable VM data for virtual call sites", SET_OPTION_BIT(TR_DisableVMCSProfiling),
                "F", NOT_IN_SUBSET},
        ...
        {"disableZ13LoadImmediateOnCond",
                "O\tdisable load halfword immediate on condition instruction generation on z13",
        ...
        {"dontDowngradeToColdDuringGracePeriod",
                "M\tdon't downgrade first time compilations from warm to cold during grace period (first second of "
                "run)",
        ...
        {"dontDowngradeWhenRIIsTemporarilyOff", "M\t", SET_OPTION_BIT(TR_DontDowngradeWhenRIIsTemporarilyOff), "F",
                NOT_IN_SUBSET},
        {"dontIncreaseCountsForNonBootstrapMethods", "M\t", RESET_OPTION_BIT(TR_IncreaseCountsForNonBootstrapMethods),
                "F", NOT_IN_SUBSET}, // Xjit: option
        ...
        {"dontJitIfSlotsSharedByRefAndNonRef",
                "O\tfail the compilation (in FSD mode) if a slot needs to be shared between an address and a "
                "nonaddress.",
        ...
        {"dontUseIdleTime", "M\tDo not use cpu idle time to compile more aggressively",
                RESET_OPTION_BIT(TR_UseIdleTime), "F", NOT_IN_SUBSET},
        {"dontUsePersistentIprofiler",
                "M\tdon't use iprofiler data stored int he shared cache, even if it is available",
        ...
        {"dumbInlinerBytecodeSizeDivisor=", "O<nnn>\thigher values will allow more inlining",
                TR::Options::set32BitNumeric, offsetof(OMR::Options, _dumbInlinerBytecodeSizeDivisor), 0, " %d"},
        ...
        {"enableBasicBlockHoisting", "O\tenable basic block hoisting", TR::Options::enableOptimization,
                basicBlockHoisting, 0, "P"},
        ...
        {"enableEarlyCompilationDuringIdleCpu", "M\t", SET_OPTION_BIT(TR_EnableEarlyCompilationDuringIdleCpu), "F",
                NOT_IN_SUBSET},
        {"enableEBBCCInfo", "C\tenable tracking CCInfo in Extended Basic Block scope",
        ...
        {"enableIVTT", "O\tenable IV Type Transformation", TR::Options::enableOptimization, IVTypeTransformation, 0,
                "P"},
        ...
        {"enableLastRetrialLogging",
                "O\tenable fullTrace logging for last compilation attempt. Needs to have a log defined on the command "
                "line",
        ...
        {"enableLoopEntryAlignment", "O\tenable loop Entry alignment", SET_OPTION_BIT(TR_EnableLoopEntryAlignment),
                "F"},
        ...
        {"enableLowerCompilationLimitsDecisionMaking",
                "O\tenable the piece of code that lowers compilation limits when low on virtual memory (on Linux and "
                "z/OS)",
        ...
        {"enableMutableCallSiteGuards",
                "O\tenable virgual guards for calls to java.lang.invoke.MutableCallSite.getTarget().invokeExact(...) "
                "(including invokedynamic)",
        ...
        {"enableOSROnGuardFailure",
                "O\tperform a decompile using on-stack replacement every time a virtual guard fails",
        ...
        {"enableOutlinedNew", "O\tdo object allocation logic with a fast jit helper",
        ...
        {"enableSIMDLibrary", "M\tEnable recognized methods for SIMD library", SET_OPTION_BIT(TR_EnableSIMDLibrary),
                "F"},
        ...
        {"enableTailCallOpt", "R\tenable tall call optimization in peephole", SET_OPTION_BIT(TR_EnableTailCallOpt),
                "F"},
        ...
        {"enableZEpilogue", "O\tenable 64-bit 390 load-multiple breakdown.", SET_OPTION_BIT(TR_Enable39064Epilogue),
                "F"},
        ...
        {"fanInCallGraphFactor=",
                ...
                TR::Options::setStaticNumeric, (intptrj_t)&OMR::Options::INLINE_fanInCallGraphFactor, 0, " %d",
                NOT_IN_SUBSET},
        ...
        {"forceBCDInit",
                "O\tForce Binary Coded Decimal (BCD) loads to be initialized by forcing the field to a temporary",
        ...
        {"GCRCount=",
                "R<nnn>\tthe value to which the counter is set for a method containing GCR body. The default is the "
                "upgrade compilation count",
                TR::Options::setCount, offsetof(OMR::Options, _GCRCount), 0, " %d"},
        {"GCRdecCount=",
                "R<nnn>\tthe value by which the counter is decremented by guarded counting recompilations (postitive "
                "value)",
                TR::Options::setCount, offsetof(OMR::Options, _GCRDecCount), 0, " %d"},
        {"GCRresetCount=",
                "R<nnn>\tthe value to which the counter is reset to after being tripped by guarded counting "
                "recompilations (postive value)",
        ...
        {"hcrPatchClassPointers",
                "I\tcreate runtime assumptions for patching pointers to classes, even though they are now updated "
                "in-place",
        ...
        {"hotFieldThreshold=",
                "M<nnn>\t The normalized frequency of a reference to a field to be marked as hot.   Values are 0 to "
                "10000.  Default is 10",
                TR::Options::setStaticNumeric, (intptrj_t)&OMR::Options::_hotFieldThreshold, 0, " %d", NOT_IN_SUBSET},
        {"hotMaxStaticPICSlots=",
                " <nnn>\tmaximum number of polymorphic inline cache slots pre-populated from profiling info for hot "
                "and above.  A negative value -N means use N times the maxStaticPICSlots setting.",
        ...
        {"inlineCntrAllBucketSize=", "R<nnn>\tThe unit used to categorize all uninlined calls at once",
                TR::Options::set32BitNumeric, offsetof(OMR::Options, _inlineCntrAllBucketSize), 0, " %d",
                NOT_IN_SUBSET},
        {"inlineCntrCalleeTooBigBucketSize=",
                "R<nnn>\tThe unit used to categorize uninlined calls when the callee is too big",
                TR::Options::set32BitNumeric, offsetof(OMR::Options, _inlineCntrCalleeTooBigBucketSize), 0, " %d",
                NOT_IN_SUBSET},
        {"inlineCntrCalleeTooDeepBucketSize=",
                "R<nnn>\tThe unit used to categorize uninlined calls when the recursively computed size of the callee "
                "is too big",
                TR::Options::set32BitNumeric, offsetof(OMR::Options, _inlineCntrCalleeTooDeepBucketSize), 0, " %d",
                NOT_IN_SUBSET},
        ...
        {"inlineCntrDepthExceededBucketSize=",
                ...
                TR::Options::set32BitNumeric, offsetof(OMR::Options, _inlineCntrDepthExceededBucketSize), 0, " %d",
                NOT_IN_SUBSET},
        ...
        {"inlineCntrWarmCalleeHasTooManyNodesBucketSize=",
                ...
                TR::Options::set32BitNumeric, offsetof(OMR::Options, _inlineCntrWarmCalleeHasTooManyNodesBucketSize), 0,
                " %d", NOT_IN_SUBSET},
        {"inlineCntrWarmCalleeTooBigBucketSize=",
                "R<nnn>\tThe unit used to categorize uninlined calls when the warm callee is too big",
                TR::Options::set32BitNumeric, offsetof(OMR::Options, _inlineCntrWarmCalleeTooBigBucketSize), 0, " %d",
                NOT_IN_SUBSET},
        {"inlineCntrWarmCallerHasTooManyNodesBucketSize=",
                ...
                TR::Options::set32BitNumeric, offsetof(OMR::Options, _inlineCntrWarmCallerHasTooManyNodesBucketSize), 0,
                " %d", NOT_IN_SUBSET},
        ...
        {"inlinerArgumentHeuristicFractionBeyondWarm=",
                "O<nnn>\tAt hotness above warm, decreases estimated size by 1/N when the inliner's argument heuristic "
                "kicks in",
                TR::Options::set32BitNumeric, offsetof(OMR::Options, _inlinerArgumentHeuristicFractionBeyondWarm), 0,
                " %d"},
        {"inlinerArgumentHeuristicFractionUpToWarm=",
                "O<nnn>\tAt hotness up to and including warm, decreases estimated size by 1/N when the inliner's "
                "argument heuristic kicks in",
                TR::Options::set32BitNumeric, offsetof(OMR::Options, _inlinerArgumentHeuristicFractionUpToWarm), 0,
                " %d"},
        ...
        {"inlinerVeryLargeCompiledMethodAdjustFactor=", "O<nnn>\tFactor to multiply the perceived size of the method",
                TR::Options::setStaticNumeric, (intptrj_t)&OMR::Options::_inlinerVeryLargeCompiledMethodAdjustFactor, 0,
                "F%d", NOT_IN_SUBSET},
        {"inlinerVeryLargeCompiledMethodFaninThreshold=",
                "O<nnn>\tFanin threshold to disallow inlining of very large compiled methods",
                TR::Options::set32BitNumeric, offsetof(OMR::Options, _inlinerVeryLargeCompiledMethodFaninThreshold), 0,
                "F%d", NOT_IN_SUBSET},
        {"inlinerVeryLargeCompiledMethodThreshold=",
                "O<nnn>\tSize threshold to disallow inlining of very large compiled methods",
                TR::Options::set32BitNumeric, offsetof(OMR::Options, _inlinerVeryLargeCompiledMethodThreshold), 0,
                "F%d", NOT_IN_SUBSET},
        ...
        {"insertInliningCounters=", "O<nnn>\tInsert instrumentation for debugging counters",
                TR::Options::set32BitNumeric, offsetof(OMR::Options, _insertDebuggingCounters), 0, " %d",
                NOT_IN_SUBSET},
        {"interpreterSamplingDivisorInStartupMode=",
                ...
                TR::Options::setStaticNumeric, (intptrj_t)&OMR::Options::_interpreterSamplingDivisorInStartupMode, 0,
                " %d", NOT_IN_SUBSET},
        ...
        {"labelTargetNOPLimit=",
                "C<nnn>\t(labelTargetAddress&0xff) > _labelTargetNOPLimit are padded out with NOPs until the next 256 "
                "byte boundary",
                TR::Options::set32BitNumeric, offsetof(OMR::Options, _labelTargetNOPLimit), TR_LABEL_TARGET_NOP_LIMIT,
                "F%d"},
        ...
        {"lastOptSubIndex=",
                "O<nnn>\tindex of the last opt transformation to perform within the last optimization (see "
                "lastOptIndex)",
        ...
        {"log=", "L<filename>\twrite log output to filename", TR::Options::setString,
                offsetof(OMR::Options, _logFileName), 0, "P%s"},
        ...
        {"lowCodeCacheThreshold=", "M<nnn>\tthreshold for available code cache contiguous space",
                TR::Options::setStaticNumeric, (intptrj_t)&OMR::Options::_lowCodeCacheThreshold, 0, "F%d",
                NOT_IN_SUBSET},
        ...
        {"maxBytesToLeaveAllocatedInSharedPool=", "R<nnn>\tnumber of memory segments to leave allocated",
                TR::Options::setStaticNumeric, (intptrj_t)&OMR::Options::_maxBytesToLeaveAllocatedInSharedPool, 0,
                "F%d", NOT_IN_SUBSET},
        ...
        {"maxLimitedGRACandidates=", "C<nnn>\tThe max number of candidates to consider for limited GRA",
                TR::Options::set32BitNumeric, offsetof(OMR::Options, _maxLimitedGRACandidates),
                TR_MAX_LIMITED_GRA_CANDIDATES, "F%d"},
        {"maxLimitedGRARegs=", "C<nnn>\tThe max number of registers to assign for limited GRA",
                TR::Options::set32BitNumeric, offsetof(OMR::Options, _maxLimitedGRARegs), TR_MAX_LIMITED_GRA_REGS,
                "F%d"},
        {"maxNumPrexAssumptions=", "R<nnn>\tmaximum number of preexistence assumptions allowed per class",
                TR::Options::setStaticNumeric, (intptrj_t)&OMR::Options::_maxNumPrexAssumptions, 0, "P%d",
                NOT_IN_SUBSET},
        {"maxNumVisitedSubclasses=",
                "R<nnn>\tmaximum number of subclasses allowed per chtable lookup for a given call site",
                TR::Options::setStaticNumeric, (intptrj_t)&OMR::Options::_maxNumVisitedSubclasses, 0, "P%d",
                NOT_IN_SUBSET},
        {"maxPeekedBytecodeSize=", "O<nnn>\tmaximum number of bytecodes that can be peeked into",
                TR::Options::setStaticNumeric, (intptrj_t)&OMR::Options::_maxPeekedBytecodeSize, 0, "F%d",
                NOT_IN_SUBSET},
        ...
        {"maxSpreadCountLooply=",
                "O<nnn>\tnumber of maximum additional invocations before compiling methods with loops",
        ...
        {"memExpensiveCompThreshold=", "M<nnn>\tthreshold for when compilations are considered memory expensive",
                TR::Options::setStaticNumeric, (intptrj_t)&OMR::Options::_memExpensiveCompThreshold, 0, "F%d",
                NOT_IN_SUBSET},
        ...
        {"methodOverrideRatSize=", "M<nnn>\tsize of runtime assumption table for method override ops",
                TR::Options::setStaticNumeric, (intptrj_t)&OMR::Options::_methodOverrideRatSize, 0, "F%d",
                NOT_IN_SUBSET},
        ...
        {"minBytesToLeaveAllocatedInSharedPool=", "R<nnn>\tnumber of memory segments to leave allocated",
                TR::Options::setStaticNumeric, (intptrj_t)&OMR::Options::_minBytesToLeaveAllocatedInSharedPool, 0,
                "F%d", NOT_IN_SUBSET},
        {"minNumberOfTreeTopsInsideTMMonitor=", "R<nnn>\tMinimal number of tree tops needed for TM monitor",
                TR::Options::setStaticNumeric, (intptrj_t)&OMR::Options::_minimalNumberOfTreeTopsInsideTMMonitor, 0,
                "P%d", NOT_IN_SUBSET},
        {"minProfiledCheckcastFrequency=",
                "O<nnn>\tmin profiled frequency for which we generate checkcast test."
                "Percentage:  0-100",
                TR::Options::setStaticNumeric, (intptrj_t)&OMR::Options::_minProfiledCheckcastFrequency, 0, "F%d",
                NOT_IN_SUBSET},
        ...
        {"noregmap", "C\tgenerate GC maps without register maps", RESET_OPTION_BIT(TR_RegisterMaps), NULL,
                NOT_IN_SUBSET},
        ...
        {"numInterfaceCallCacheSlots=",
                "C<nnn>\tThe number of cache slots allocated per interface callpoint, 64 bit zseries only, default is "
                "4",
                TR::Options::set32BitNumeric, offsetof(OMR::Options, _numInterfaceCallCacheSlots), 4, "F%d"},
        {"numInterfaceCallStaticSlots=",
                "C<nnn>\tThe number of static slots allocated per interface callpoint, 64 bit zseries only, default is "
                "1",
        ...
        {"optFile=",
                "O<filename>\tRead in 'Performing' statements from <filename> and perform those opts instead of the "
                "usual ones",
        ...
        {"orderCompiles", "C\tcompile methods in limitfile order", SET_OPTION_BIT(TR_OrderCompiles), "P",
                NOT_IN_SUBSET},
        ...
        {"queueWeightThresholdForAppThreadYield=",
                ...
                TR::Options::setStaticNumeric, (intptrj_t)&OMR::Options::_queueWeightThresholdForAppThreadYield, 0,
                "F%d", NOT_IN_SUBSET},
        ...
        {"randomSeedSignatureHash",
                "R\tSet random seed value based on a hash of the method's signature, in order to get varying seeds "
        ...
        {"rtGCMapCheck", "D\tEnable runtime GC Map checking at every async check.", SET_OPTION_BIT(TR_RTGCMapCheck),
                "F"},
        ...
        {"sampleThreshold=",
                "R<nnn>\tThe maximum number of global samples taken during a sample interval for which the method will "
                "be recompiled",
        ...
        {"scratchSpaceLowerBound=", "C<nnn>\tlower bound of total heap and stack memory limit, in KB",
                TR::Options::setStaticNumericKBAdjusted, (intptrj_t)&OMR::Options::_scratchSpaceLowerBound, 0,
                " %d (KB)"},
        ...
        {"startupMethodDontDowngradeThreshold=",
                ...
                TR::Options::setStaticNumeric, (intptrj_t)&OMR::Options::_startupMethodDontDowngradeThreshold, 0, "F%d",
                NOT_IN_SUBSET},
        {"staticDebugCounters",
                "D\tEnable static versions of all enabled dynamic debug counters (unless staticDebugCounters={regex} "
                "is specified)",
                SET_OPTION_BIT(TR_StaticDebugCountersRequested), "F"},
        {"staticDebugCounters=", "D{regex}\tEnable static debug counters with names matching regex",
                TR::Options::setRegex, offsetof(OMR::Options, _enabledStaticCounterNames), 0, "F"},
        ...
        {"suffixLogsFormat=", "O\tadd the suffix in specified format to the file name of the logs",
                TR::Options::setString, offsetof(OMR::Options, _suffixLogsFormat), 0, "P%s"},
        ...
        {"traceAutoSIMD", "L\ttrace autoVectorization ", TR::Options::traceOptimization, SPMDKernelParallelization, 0,
                "P"},
        {"traceBasicBlockExtension", "L\ttrace basic block extension", TR::Options::traceOptimization,
                basicBlockExtension, 0, "P"},
        {"traceBasicBlockHoisting", "L\ttrace basic block hoisting", TR::Options::traceOptimization, basicBlockHoisting,
                0, "P"},
        {"traceBasicBlockPeepHole", "L\ttrace basic blocks peepHole", TR::Options::traceOptimization,
                basicBlockPeepHole, 0, "P"},
        ...
        {"traceBlockFrequencyGeneration", "L\ttrace block frequency generation", SET_OPTION_BIT(TR_TraceBFGeneration),
                "P"},
        {"traceBlockShuffling", "L\ttrace random rearrangement of blocks", TR::Options::traceOptimization,
                blockShuffling, 0, "P"},
        ...
        {"traceColdBlockMarker", "L\ttrace detection of cold blocks", TR::Options::traceOptimization, coldBlockMarker,
                0, "P"},
        ...
        {"traceExplicitNewInitialization", "L\ttrace explicit new initialization", TR::Options::traceOptimization,
                explicitNewInitialization, 0, "P"},
        {"traceFieldPrivatization", "L\ttrace field privatization", TR::Options::traceOptimization, fieldPrivatization,
                0, "P"},
        ...
        {"traceGeneralStoreSinking", "L\ttrace general store sinking", TR::Options::traceOptimization,
                generalStoreSinking, 0, "P"},
        ...
        {"traceGlobalLiveVariablesForGC", "L\ttrace global live variables for GC", TR::Options::traceOptimization,
                globalLiveVariablesForGC, 0, "P"},
        {"traceGlobalVP", "L\ttrace global value propagation", TR::Options::traceOptimization, globalValuePropagation,
                0, "P"},
        ...
        {"traceGRA", "L\ttrace tree based global register allocator", TR::Options::traceOptimization,
                tacticalGlobalRegisterAllocator, 0, "P"},
#ifdef J9_PROJECT_SPECIFIC
        {"traceIdiomRecognition", "L\ttrace idiom recognition", TR::Options::traceOptimization, idiomRecognition, 0,
                "P"},
#endif
        ...
        {"traceInnerPreexistence", "L\ttrace inner preexistence", TR::Options::traceOptimization, innerPreexistence, 0,
                "P"},
        {"traceInvariantArgumentPreexistence", "L\ttrace invariable argument preexistence",
        ...
        {"traceLiveMonitorMetadata", "L\ttrace live monitor metadata", SET_OPTION_BIT(TR_TraceLiveMonitorMetadata),
                "F"},
        ...
        {"traceLocalCSE", "L\ttrace local common subexpression elimination", TR::Options::traceOptimization, localCSE,
                0, "P"},
        ...
        {"traceOSRDefAnalysis", "L\ttrace OSR reaching defintions analysis", TR::Options::traceOptimization,
                osrDefAnalysis, 0, "P"},
#ifdef J9_PROJECT_SPECIFIC
        ...
        {"traceProfiledNodeVersioning", "L\ttrace profiled node versioning", TR::Options::traceOptimization,
                profiledNodeVersioning, 0, "P"},
#ifdef J9_PROJECT_SPECIFIC
        {"traceProfileGenerator", "L\ttrace profile generator", TR::Options::traceOptimization, profileGenerator, 0,
                "P"},
#endif
        ...
        {"traceRegisterPressureDetails",
                "L\tinclude extra register pressure annotations in register pressure simulation and tree evaluation "
                "traces",
        ...
        {"traceSamplingJProfiling", "L\ttrace samplingjProfiling", TR::Options::traceOptimization, samplingJProfiling,
                0, "P"},
        ...
        {"traceTreeSimplification", "L\ttrace tree simplification", TR::Options::traceOptimization, treeSimplification,
                0, "P"},
        ...
        {"trampolineSpacePercentage=", "R<nnn>\tpercent of code cache space to reserve for tranmpolines",
                TR::Options::setStaticNumeric, (intptrj_t)&OMR::Options::_trampolineSpacePercentage, 0, "F%d",
                NOT_IN_SUBSET},
        {"transactionalMemoryRetryCount=", "R<nnn>\tthe time of retries when transactions get abort",
                TR::Options::setStaticNumeric, (intptrj_t)&OMR::Options::_TransactionalMemoryRetryCount, 0, "F%d",
                NOT_IN_SUBSET},
#if defined(DEBUG)
        ...
        {"trustAllInterfaceTypeInfo",
                "O\tGive Java interface type information the same level of trust afforded to class info.  The Java "
                "spec is much more lackadasical about interface type safety, and requires us to be conservative.",
        ...
        {"useHigherCountsForNonSCCMethods",
                "M\tuse the default high counts for methods belonging to classes not in SCC",
        ...
        {"userSpaceVirtualMemoryMB=",
                "O<nnn>\tsize of the virtual memory that is user space in MB (not used on Windows, AIX, or 64 bit "
                "systems)",
                TR::Options::setStaticNumeric, (intptrj_t)&OMR::Options::_userSpaceVirtualMemoryMB, 0, "F%d",
                NOT_IN_SUBSET},
        ...
        {"virtualMemoryCheckFrequencySec=",
                ...
                TR::Options::setStaticNumeric, (intptrj_t)&OMR::Options::_virtualMemoryCheckFrequencySec, 0, "F%d",
                NOT_IN_SUBSET},
...
OMR::Options::getNumericValue(char *&option)
{
	...
	while (pendingOperation) {
		...
		case '*':
		case '/':
		case '%': pendingOperation = *option++; break;
		default: pendingOperation = 0; break;
		}
	}
	return result;
}
		...
		if (*position == '{') {
			for (; *position; ++position) {
				if (*position == '}') {
					++position;
					break;
				} else if (*position == ',') { // replace ',' seperators with spaces so addDebug can
					                       // parse them properly
					*position = ' ';
				}
			}
...
int32_t OMR::Options::_profilingCompNodecountThreshold = 30000; // this number should be smaller than USHRT_MAX
                                                                ...
                                                                // to avoid cloning in more cases for hot and very hot
                                                                // compilation
...
int32_t OMR::Options::_lowCodeCacheThreshold = 256 * 1024; // 256KB Turn off Iprofiler if available code cache space is
...
int32_t OMR::Options::_qsziMaxToTrackLowPriComp = 40; // If number of queued first time compilations is lower we allow
...
OMR::Options::Options(TR::Options &other) : _optionSets(0), _logListForOtherCompThreads(0)
{
	*this = other;
	...
	for (optionSet = options->_optionSets; optionSet; optionSet = optionSet->getNext()) {
		...
		if (newOptions) {
			...
			if (optionSet->getIndex() == TR_EXCLUDED_OPTIONSET_INDEX)
				TR::Options::findOrCreateDebug()->addExcludedMethodFilter(isAOT); // Not sure isAOT is
				                                                                  // exactly the right
				                                                                  // thing to pass here
		}
	}
...
OMR::Options::jitLatePostProcess(TR::OptionSet *optionSet, void *jitConfig)
{
	...
	if (self()->getOption(TR_FullSpeedDebug)) {
		...
		self()->setOption(TR_DisableMethodHandleThunks); // Can't yet transition a MH thunk frame into
		                                                 // equivalent interpreter frames
	}
	...
	if (!optionSet) {
		...
		if (_queueWeightThresholdForAppThreadYield == -1)
			_queueWeightThresholdForAppThreadYield = TR::Compiler->target.numberOfProcessors() <= 2 ? 10000
			                                                                                        : 22000;
		if (_queueWeightThresholdForStarvation == -1)
			_queueWeightThresholdForStarvation = TR::Compiler->target.numberOfProcessors() <= 2 ? 1600
			                                                                                    : 3200;
...
#ifdef J9_PROJECT_SPECIFIC
			TR::Options::_GCRQueuedThresholdForCounting = 400; // stop GCR counting if too many GCR requests
			                                                   // are queued
#endif
		...
		if (_startupMethodDontDowngradeThreshold == -1) // not yet set
		{
			...
			if (TR::Compiler->target.numberOfProcessors() <= 2) {
				_startupMethodDontDowngradeThreshold = 100; // avoid being aggressive on small number of
				                                            // processors
			}
		}
		...
		if (TR::Options::sharedClassCache()) // If AOT shared classes is used
		{
			...
			if (self()->getOption(TR_UseHigherMethodCounts)) {
				self()->setOption(TR_DisableDelayRelocationForAOTCompilations, true); // If scount has
				                                                                      // not been
				                                                                      // changed on the
				                                                                      // command line,
				                                                                      // adjust it here
		...
		if (self()->getOption(TR_MimicInterpreterFrameShape)) {
			...
			if (_countString) {
				...
				if (self()->isVerboseFileSet()) {
					if (TR::Options::isQuickstartDetected()) {
						TR_VerboseLog::write("<JIT: FullSpeedDebug: ignoring -Xquickstart "
						                     "option>\n");
					} else {
		...
		if (_logFileName) {
			...
			if (_debug) {
				_logFile = _debug->findLogFile(TR::Options::getAOTCmdLineOptions(),
				        TR::Options::getJITCmdLineOptions(), optionSet, _logFileName);
				if (_logFile == NULL)
					self()->openLogFile();
				else
					OMR::Options::_dualLogging = true; // a log file is used in two different option
					                                   // sets, or in in the master TR::Options
					                                   // object and in an option set
			}
...
OMR::Options::jitPreProcess()
{
	...
	_dumbInlinerBytecodeSizeCutoff = _dumbInlinerBytecodeSizeMaxCutoff; // may be changed dynamically; cannot be
	...
	_inlinerArgumentHeuristicFractionUpToWarm = 999999; // (Huge value here essentially disables this heuristic at
	                                                    // warm)
	...
	if (TR::isJ9()) {
...
#ifdef J9_PROJECT_SPECIFIC
		TR::Options::_weightOfJSR292 = 20; // set a large value for zOS 31-bit to force sequential compilation
		...
		if (this == OMR::Options::getJITCmdLineOptions() || this == OMR::Options::getAOTCmdLineOptions()) {
			if (_aggressivenessLevel >= 0 && _aggressivenessLevel <= 5) {
				...
				case OMR::Options::AGGRESSIVE_AOT: // aggressive AOT (Rely on AOT as much as possible)
					...
					break;
				case OMR::Options::AGGRESSIVE_QUICKSTART: // aggressive quickstart (Quickstart with
			...
			} else // Some message that the aggressivenessLevel is invalid
			{
				if (_aggressivenessLevel != -1) // -1 means not set
				{
					if (OMR::Options::isAnyVerboseOptionSet())
						TR_VerboseLog::write("\n<JIT: _aggressivenessLevel=%d; must be between "
						                     "0 and 5; Option ignored\n",
		...
		_enableSCHintFlags |= TR_HintLargeMemoryMethodW | TR_HintLargeMemoryMethodC | TR_HintLargeCompCPUW
...
void
OMR::Options::safelyCloseLogs(TR::Options *options, TR_MCTLogs *&closedLogs, TR_FrontEnd *fe)
{
...
TR::OptionSet *
OMR::Options::findOptionSet(TR_Memory *trMemory, int32_t index, int32_t lineNum, TR_ResolvedMethod *vmMethod,
		...
		if (index && optionSet->getIndex() == index) {
			...
			if (TR::SimpleRegex::match(optionSet->getMethodRegex(), methodSignature)) {
				...
				if (TR::SimpleRegex::matchIgnoringLocale(
				            optionSet->getOptLevelRegex(), hotnessLevelString))
					break;
			}
		}
	}
...
char *
OMR::Options::processOptionSet(char *options, char *envOptions, TR::OptionSet *optionSet)
{
...
char *
OMR::Options::processOptionSet(char *options, TR::OptionSet *optionSet, void *jitBase, bool isAOT)
{
		...
		if (!optionSet) {
			...
			if (*options == '{') {
				...
				if (*endOpt == '{') {
					...
					if (!optLevelRegex) {
						TR_VerboseLog::write(
						        "<JIT: Bad regular expression at --> '%s'>\n", endOpt);
						return options;
					}
				} else {
					optLevelRegex = NULL;
...
OMR::Options::jitPostProcess()
{
	...
	if (_logFileName) {
		...
		TR_VerboseLog::write("<JIT: the log file option must be specified when a trace options is used: "
		                     "log=<filename>)>\n");
		return false;
	}
	...
	if (_optFileName) {
		...
		if (_debug) {
			...
			if (_customStrategy) {
				for (_customStrategySize = 0; _customStrategy[_customStrategySize] != endOpts;
				        _customStrategySize++)
					;
				_customStrategySize++; // Include the endOpts terminator itself
			} else {
				TR_VerboseLog::write("<JIT: WARNING: ignoring optFile option; unable to read opts from "
				                     "'%s'\n",
				        _optFileName);
			}
		}
	...
	if (self()->getOption(TR_Randomize)) {
		...
		//
		// TODO: Do these belong here?  Perhaps -Xjit:randomize,deterministic=N should be the standard way to
		// achieve this.
		//
		self()->setOption(TR_DisableInterpreterProfiling, true);
	...
	// We allocate code cache memory on z/OS by asking the port library for typically small (~2MB) code cache
	// chunks. This is done because the port library can typically only allocate executable memory (code caches)
	// below the 2GB bar. When RMODE(64) is enabled however we are able to allocate executable memory above the 2GB
	// bar. This means two code caches could be very far apart from one another which is something we want to avoid
	// as it may cause performance issues. The solution is to enable the code cache consolidation which will
	// allocate larger
...
OMR::Options::printOptions(char *options, char *envOptions)
{
	...
	TR_Debug::dumpOptions(
	        optionsType, options, envOptions, self(), _jitOptions, TR::Options::_feOptions, _feBase, _fe);
...
void
OMR::Options::setLogForCompilationThread(int32_t compThreadID, TR::Options *masterOptions)
{
	...
	} else // no counts string specified
	{
		...
		if (_initialBCount == -1) {
			if (_samplingFrequency == 0 || self()->getOption(TR_DisableInterpreterSampling))
				_initialBCount = std::min(1, _initialCount); // If no help from sampling, then loopy
		...
		if (_initialMILCount == -1)
			_initialMILCount = std::min(
			        startupTimeMatters ? TR_QUICKSTART_INITIAL_MILCOUNT : TR_DEFAULT_INITIAL_MILCOUNT,
			        _initialBCount);
...
OMR::Options::getDefaultCountString()
{
	...
	if (self()->getFixedOptLevel() == -1) // Not a fixed opt level
	{
		if (self()->getOption(TR_MimicInterpreterFrameShape)) {
			...
			{
				str = "- - - - - - %d %d %d - - - - - -"; // why do we use fixed optlevel if no
				                                          // sampling?
			}
		}
	}
	...
	//
		...
		case noOpt: str = "%d %d %d"; break;
		case cold: str = "- - - %d %d %d"; break;
		case warm: str = "- - - - - - %d %d %d"; break;
		case hot: str = "- - - - - - - - - %d %d %d"; break;
		case veryHot: str = "- - - - - - - - - - - - %d %d %d"; break;
		case scorching: str = "- - - - - - - - - - - - - - - %d %d %d"; break;
		default: TR_ASSERT(false, "should be unreachable"); break;
		}
		...
		*((int32_t *)((char *)base + entry->parm1)) = 0; // Reset all bits to zero when this function is called
		...
		if (!regex)
			...
			if (*((int32_t *)((char *)base + entry->parm1)) == 0x00000000)
				TR_VerboseLog::write("<JIT: Address enumeration option not found.  No address "
	...
	if (entry->parm2 != 0) {
		...
		*((int32_t *)((char *)base + entry->parm1)) = 0x1; // enable basic tracing is any set is provided
		...
		if (!regex)
			...
			if (*((int32_t *)((char *)base + entry->parm1)) == 0x00000000)
				TR_VerboseLog::write("<JIT: Register assignment tracing options not found.  No "
...
char *
OMR::Options::clearBitsFromStringSet(char *option, void *base, TR::OptionTable *entry)
{
	int i;
...
char *
OMR::Options::setVerboseBitsHelper(
		...
		if (!regex)
			...
			for (int32_t i = 0; i < TR_NumVerboseOptions; i++) {
				if (TR::SimpleRegex::matchIgnoringLocale(regex, _verboseOptionNames[i], false)) {
					...
					foundMatch = true;
					if (i == TR_VerbosePerformance) // If verbose={performance} is specified, I
...
char *
OMR::Options::setSamplingJProfilingBits(char *option, void *base, TR::OptionTable *entry)
{
	TR::SimpleRegex *regex = TR::SimpleRegex::create(option);
...
bool
OMR::Options::counterIsEnabled(const char *name, int8_t fidelity, TR::SimpleRegex *nameRegex)
{
...
OMR::Options::setDefaultsForDeterministicMode()
{
	if (TR::Options::getDeterministicMode() != -1 // if deterministic mode was set
		...
		TR::Options::_smallMethodBytecodeSizeThresholdForCold = 0; // Don't try filter out small methods from
		                                                           // using GCR trees
#endif
