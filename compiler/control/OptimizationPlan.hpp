...
public:
	...
	enum { // list of flags
		...
		DontFailOnPurpose = 0x00100000, // Mostly needed to avoid failing for the purpose of upgrading to a
		                                // higher opt level
		RelaxedCompilationLimits = 0x00200000, // Compilation can use larger limits because method is very very
		                                       // hot
		DowngradedDueToSamplingJProfiling = 0x00400000, // Compilation was downgraded to cold just because we
