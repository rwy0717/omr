...
TR::Instruction *
generateInstruction(TR::CodeGenerator *cg, TR_ARMOpCodes op, TR::Node *node, TR::Instruction *prev)
{
	if (prev)
...
TR::Instruction *
generateAdminInstruction(TR::CodeGenerator *cg, TR_ARMOpCodes op, TR::Node *node,
...
TR::Instruction *
generateImmInstruction(TR::CodeGenerator *cg, TR_ARMOpCodes op, TR::Node *node, uint32_t imm,
...
TR::Instruction *
generateImmInstruction(TR::CodeGenerator *cg, TR_ARMOpCodes op, TR::Node *node, uint32_t imm, TR::Instruction *prev)
...
TR::Instruction *
generateImmSymInstruction(TR::CodeGenerator *cg, TR_ARMOpCodes op, TR::Node *node, uint32_t imm,
...
TR::Instruction *
generateMemSrc1Instruction(TR::CodeGenerator *cg, TR_ARMOpCodes op, TR::Node *node, TR::MemoryReference *mf,
        TR::Register *sreg, TR::Instruction *prev)
{
...
TR::Instruction *
generateTrg1MemInstruction(TR::CodeGenerator *cg, TR_ARMOpCodes op, TR::Node *node, TR::Register *treg,
...
TR::Instruction *
generateTrg1MemSrc1Instruction(TR::CodeGenerator *cg, TR_ARMOpCodes op, TR::Node *node, TR::Register *treg,
...
TR::Instruction *
generateTrg1ImmInstruction(TR::CodeGenerator *cg, TR_ARMOpCodes op, TR::Node *node, TR::Register *treg, uint32_t base,
...
TR::Instruction *
generateSrc1ImmInstruction(TR::CodeGenerator *cg, TR_ARMOpCodes op, TR::Node *node, TR::Register *s1reg, uint32_t base,
        uint32_t rotate, TR::Instruction *prev)
{
	TR_ARMOpCode opCode(op);
	TR_ARMOperand2 *operand = new (cg->trHeapMemory()) TR_ARMOperand2(base, rotate);
...
TR::Instruction *
generateSrc2Instruction(TR::CodeGenerator *cg, TR_ARMOpCodes op, TR::Node *node, TR::Register *s1reg,
...
TR::Instruction *
generateTrg1Src1Instruction(TR::CodeGenerator *cg, TR_ARMOpCodes op, TR::Node *node, TR::Register *treg,
        TR_ARMOperand2 *s1op, TR::Instruction *prev)
{
	if (prev)
...
TR::Instruction *
generateTrg1Src1Instruction(TR::CodeGenerator *cg, TR_ARMOpCodes op, TR::Node *node, TR::Register *treg,
        TR::Register *s1reg, TR::Instruction *prev)
{
	if (op == ARMOp_fmrs || op == ARMOp_fmsr) {
		...
		if (prev)
			return new (cg->trHeapMemory()) TR::ARMTrg1Src2Instruction(prev, op, node,
			        (op == ARMOp_fmrs) ? treg : s1reg, (op == ARMOp_fmrs) ? s1reg : treg, operand, cg);
		else
...
TR::Instruction *
generateTrg1Src1ImmInstruction(TR::CodeGenerator *cg, TR_ARMOpCodes op, TR::Node *node, TR::Register *treg,
...
TR::Instruction *
generateLoadStartPCInstruction(TR::CodeGenerator *cg, TR::Node *node, TR::Register *treg, TR::SymbolReference *sr,
...
TR::Instruction *
generateTrg1Src2Instruction(TR::CodeGenerator *cg, TR_ARMOpCodes op, TR::Node *node, TR::Register *treg,
...
#if (defined(__VFP_FP__) && !defined(__SOFTFP__))
TR::Instruction *
generateTrg2Src1Instruction(TR::CodeGenerator *cg, TR_ARMOpCodes op, TR::Node *node, TR::Register *t1reg,
        TR::Register *t2reg, TR::Register *sreg, TR::Instruction *prev)
{
	if (prev)
...
TR::Instruction *
generateTrg1Src2MulInstruction(TR::CodeGenerator *cg, TR_ARMOpCodes op, TR::Node *node, TR::Register *treg,
        TR::Register *s1reg, TR::Register *s2reg, TR::Instruction *prev)
{
	if (prev)
...
TR::Instruction *
generateTrg2Src2MulInstruction(TR::CodeGenerator *cg, TR_ARMOpCodes op, TR::Node *node, TR::Register *tregHi,
        TR::Register *tregLo, TR::Register *s1reg, TR::Register *s2reg, TR::Instruction *prev)
{
	if (prev)
...
TR::Instruction *
generateShiftLeftImmediate(TR::CodeGenerator *cg, TR_ARMOperand2Type type, TR::Node *node, TR::Register *trgReg,
        TR::Register *srcReg, int32_t shiftAmount, TR::Instruction *prev)
{
...
TR::Instruction *
generateShiftLeftByRegister(TR::CodeGenerator *cg, TR::Node *node, TR::Register *trgReg, TR::Register *srcReg,
        TR::Register *shiftRegister, TR::Instruction *prev)
{
...
generateShiftRightImmediate(TR::CodeGenerator *cg, TR::Node *node, TR::Register *trgReg, TR::Register *srcReg,
        int32_t shiftAmount, bool isLogical, TR::Instruction *prev)
{
...
TR::Instruction *
generateShiftRightByRegister(TR::CodeGenerator *cg, TR::Node *node, TR::Register *trgReg, TR::Register *srcReg,
        TR::Register *shiftRegister, bool isLogical, TR::Instruction *prev)
{
...
TR::Instruction *
generateLabelInstruction(TR::CodeGenerator *cg, TR_ARMOpCodes op, TR::Node *node, TR::LabelSymbol *sym,
...
TR::Instruction *
generatePreIncLoadInstruction(TR::CodeGenerator *cg, TR::Node *node, TR::Register *treg, TR::Register *baseReg,
