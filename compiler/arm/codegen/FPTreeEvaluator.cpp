...
static void ifFloatEvaluator(TR::Node* node, TR_ARMOpCodes opCode, TR_ARMConditionCode cond, TR::CodeGenerator* cg,
...
static TR::Register* setboolFloatEvaluator(TR::Node* node, TR_ARMOpCodes opCode, TR_ARMConditionCode cond,
...
TR::Register* OMR::ARM::TreeEvaluator::ifdcmpltEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
    ...
    ifFloatEvaluator(node, isDouble ? ARMOp_fcmpd : ARMOp_fcmps, unordered ? ARMConditionCodeLT : ARMConditionCodeCC,
        cg, isDouble, false);
    return NULL;
}
...
TR::Register* OMR::ARM::TreeEvaluator::ifdcmpgeEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
    ...
    ifFloatEvaluator(node, isDouble ? ARMOp_fcmpd : ARMOp_fcmps, unordered ? ARMConditionCodeCS : ARMConditionCodeGE,
        cg, isDouble, false);
    return NULL;
}
...
TR::Register* OMR::ARM::TreeEvaluator::ifdcmpgtEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
    ...
    ifFloatEvaluator(node, isDouble ? ARMOp_fcmpd : ARMOp_fcmps, unordered ? ARMConditionCodeHI : ARMConditionCodeGT,
        cg, isDouble, false);
    return NULL;
}
...
TR::Register* OMR::ARM::TreeEvaluator::ifdcmpleEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
    ...
    ifFloatEvaluator(node, isDouble ? ARMOp_fcmpd : ARMOp_fcmps, unordered ? ARMConditionCodeLE : ARMConditionCodeLS,
        cg, isDouble, false);
    return NULL;
}
...
static TR::Register* generateFloatMaxMin(TR::Node* node, TR::CodeGenerator* cg, bool max)
{
    ...
    if (isFloat) {
        cursor
            = generateSrc1ImmInstruction(cg, ARMOp_cmp, node, max ? trgReg : childReg, 0x80, 24, cursor); // 0x80000000
    } else {
    ...
    cursor->setConditionCode(ARMConditionCodeEQ);
    cursor
        = generateSrc2Instruction(cg, (isFloat) ? ARMOp_fcmps : ARMOp_fcmpd, node, childFloatReg, trgFloatReg, cursor);
