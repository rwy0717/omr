...
{ // If a register value is to be updated by the instruction, it is printed in capitals.
	switch (regNum) {
	case 0: return (W ? "R0" : "r0");
	case 1: return (W ? "R1" : "r1");
	case 2: return (W ? "R2" : "r2");
	case 3: return (W ? "R3" : "r3");
	case 4: return (W ? "R4" : "r4");
	case 5: return (W ? "R5" : "r5");
	case 6: return (W ? "R6" : "r6");
	case 7: return (W ? "R7" : "r7");
	case 8: return (W ? "R8" : "r8");
	case 9: return (W ? "R9" : "r9");
	case 10: return (W ? "R10" : "r10");
	case 11: return (W ? "R11" : "r11");
	case 12: return (W ? "R12" : "r12");
	case 13: return (W ? "R13" : "r13");
	case 14: return (W ? "R14" : "r14");
	case 15: return (W ? "PC" : "pc");
	default: return (W ? "R??" : "r??");
	}
}
#ifdef __VFP_FP__
const char *
...
{ // If a register value is to be updated by the instruction, it is printed in capitals.
	switch (regNum >> 1) {
	case 0: return (W ? "D0" : "d0");
	case 1: return (W ? "D1" : "d1");
	case 2: return (W ? "D2" : "d2");
	case 3: return (W ? "D3" : "d3");
	case 4: return (W ? "D4" : "d4");
	case 5: return (W ? "D5" : "d5");
	case 6: return (W ? "D6" : "d6");
	case 7: return (W ? "D7" : "d7");
	case 8: return (W ? "D8" : "d8");
	case 9: return (W ? "D9" : "d9");
	case 10: return (W ? "D10" : "d10");
	case 11: return (W ? "D11" : "d11");
	case 12: return (W ? "D12" : "d12");
	case 13: return (W ? "D13" : "d13");
	case 14: return (W ? "D14" : "d14");
	case 15: return (W ? "D15" : "d15");
	default: return (W ? "D??" : "d??");
	}
}
const char *
...
{ // If a register value is to be updated by the instruction, it is printed in capitals.
	switch (regNum) {
	case 0: return (W ? "S0" : "s0");
	case 1: return (W ? "S1" : "s1");
	case 2: return (W ? "S2" : "s2");
	case 3: return (W ? "S3" : "s3");
	case 4: return (W ? "S4" : "s4");
	case 5: return (W ? "S5" : "s5");
	case 6: return (W ? "S6" : "s6");
	case 7: return (W ? "S7" : "s7");
	case 8: return (W ? "S8" : "s8");
	case 9: return (W ? "S9" : "s9");
	case 10: return (W ? "S10" : "s10");
	case 11: return (W ? "S11" : "s11");
	case 12: return (W ? "S12" : "s12");
	case 13: return (W ? "S13" : "s13");
	case 14: return (W ? "S14" : "s14");
	case 15: return (W ? "S15" : "s15");
	case 16: return (W ? "S16" : "s16");
	case 17: return (W ? "S17" : "s17");
	case 18: return (W ? "S18" : "s18");
	case 19: return (W ? "S19" : "s19");
	case 20: return (W ? "S20" : "s20");
	case 21: return (W ? "S21" : "s21");
	case 22: return (W ? "S22" : "s22");
	case 23: return (W ? "S23" : "s23");
	case 24: return (W ? "S24" : "s24");
	case 25: return (W ? "S25" : "s25");
	case 26: return (W ? "S26" : "s26");
	case 27: return (W ? "S27" : "s27");
	case 28: return (W ? "S28" : "s28");
	case 29: return (W ? "S29" : "s29");
	case 30: return (W ? "S30" : "s30");
	case 31: return (W ? "S31" : "s31");
	default: return (W ? "S??" : "s??");
	}
}
#endif
...
miscInstr(int32_t *instrPtr, char *mBuf, char *iBuf)
{
	...
	case 0: moveStatusReg(instrPtr, mBuf, iBuf); break;
	case 1:
		if (!instrBits->bit22) {
		...
		break;
	case 3: branchExchange(instrPtr, mBuf, iBuf); break;
	case 5:
	...
	case 14:
		...
		break;
	default: constant32(instrPtr, mBuf, iBuf); // Invalid instruction
	}
}
...
dataProcessing(int32_t *instrPtr, char *mBuf, char *iBuf)
{
	...
	static char *opcodeName[] = {"and", "eor", "sub", "rsb", "add", "adc", "sbc", "rsc", "tst", "teq", "cmp", "cmn",
	        "orr", "mov", "bic", "mvn"};
	bool test_cmp = instrBits->bits23_24 == 2; // instr->opcode: 0b1000 || 0b1001 || 0b1010 || 0b1011 (tst, teq,
	                                           // cmp, cmn)
...
swap(int32_t *instrPtr, char *mBuf, char *iBuf)
{
	...
	if (instr->SBZ) {
		...
		sprintf(iBuf, "%s, %s, [%s]", regStr(instr->Rd, true), regStr(instr->Rm, false),
...
multiply(int32_t *instrPtr, char *mBuf, char *iBuf)
{
	...
	if (!instr->L) // MLA and MUL
	{
		...
		sprintf(iBuf, "%s, %s, %s%s", regStr(instr->Rd, true), regStr(instr->Rm, false),
	...
	} else // long multiplies: SMLAL, SMULL, UMLAL, UMULL
	{
		sprintf(mBuf, "%c%sl%s%s", instr->U ? 's' : 'u', instr->A ? "mla" : "mul", condName[instr->cond],
		        instr->A ? "s" : "");
		sprintf(iBuf, "%s, %s, %s, %s", regStr(instr->Rn, true), regStr(instr->Rd, true),
...
loadStore(int32_t *instrPtr, char *mBuf, char *iBuf, bool extra)
{
	...
	if ((!extra && !instrBits->bit25) || (extra && instrBits->bit22)) { // Immediate offset
		...
		sprintf(iBuf, "%s, [%s%s, #%s%u%s%s", regStr(instr->Rd, instr->L),
		        ...
		        extra ? concatImm4Imm4(instrImmMisc->immH, instrImmMisc->immL) : instrImm->immed,
	...
	} else // Scaled register offset/index
	{
		if (instr->shift == 3 && instr->shift_imm == 0) {
			...
			sprintf(iBuf, "%s, [%s%s, %s%s, %s #%u%s%s", regStr(instr->Rd, instr->L),
			        ...
			        (instr->shift_imm == 0 && (instr->shift == 1 || instr->shift == 2)) ? 32
			                                                                            : instr->shift_imm,
			        instr->P ? "]" : "", instr->W ? "!" : "");
		}
	}
...
mulAndExtraLoadStore(int32_t *instrPtr, char *mBuf, char *iBuf)
{
	...
	case 0:
		...
		break;
	case 1: loadStore(instrPtr, mBuf, iBuf, true); break;
	case 2:
	case 3:
		if (instrBits->bit20)
	...
	if (instr->D == 1 && instr->N == 0 && instr->s == 0 && instr->xfer == 1) {
		if (isDouble) {
			if (instr->r) // L-bit
			{
				...
				sprintf(iBuf, "%s, %s, %s", doubleRegStr(getVFPSecondOperand(instr), true),
...
loadStoreCoprocessor(int32_t *instrPtr, char *mBuf, char *iBuf)
{
	...
	case 5: {
		...
		if (isDouble) {
			...
			sprintf(mBuf, "%s%s%s", instr->L ? "fldm" : "fstm", (puw != 5) ? "ias" : "dbs",
			        condName[instr->cond]);
			sprintf(iBuf, "%s%s {%s%s%s}", (puw == 2) ? regStr(instr->Rn, false) : regStr(instr->Rn, true),
			        (puw != 2) ? "!," : ",", singleRegStr(start, false),
			        (instr->offset8 >= 2 * 2) ? ".." : "",
...
vfpExtension(int32_t *instrPtr, char *mBuf, char *iBuf)
{
	...
	case 11:
	case 14:
	case 15: constant32(instrPtr, mBuf, iBuf); break;
	case 4:
	...
	if (opCode == 0) {
		...
		if (isDouble) {
			if (instr->r) // L-bit
				...
				sprintf(iBuf, "%s[31:0], %s", doubleRegStr(getVFPFirstOperand(instr), true),
		...
		if (isDouble) {
			...
			if (instr->r) // L-bit
				...
				sprintf(iBuf, "%s[63:32], %s", doubleRegStr(getVFPFirstOperand(instr), true),
				        regStr(instr->Fd, false));
		} else
...
disassemble(int32_t *instrPtr, char *mBuf, char *iBuf)
{
	...
	case 2: loadStore(instrPtr, mBuf, iBuf, false); break;
	...
	case 4: loadStoreMultiple(instrPtr, mBuf, iBuf); break;

	case 5: branch(instrPtr, mBuf, iBuf); break;

	case 6: loadStoreCoprocessor(instrPtr, mBuf, iBuf); break;
