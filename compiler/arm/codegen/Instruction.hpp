...
public:
	...
	Instruction(TR::Node *node, TR::CodeGenerator *cg) : OMR::InstructionConnector(node, cg) {}

	Instruction(TR_ARMOpCodes op, TR::Node *node, TR::CodeGenerator *cg) : OMR::InstructionConnector(op, node, cg)
	{}
