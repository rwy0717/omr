...
inline bool
constantIsImmed8r(int32_t intValue, uint32_t *base, uint32_t *rotate, bool *negated)
{
...
public:
	...
	ARMImmInstruction(TR_ARMOpCodes op, TR::Node *node, TR::RegisterDependencyConditions *cond, uint32_t imm,
	        TR::CodeGenerator *cg)
...
public:
	...
	ARMLabelInstruction(TR_ARMOpCodes op, TR::Node *node, TR::RegisterDependencyConditions *cond,
...
public:
	ARMConditionalBranchInstruction(TR::Node *node, TR::CodeGenerator *cg)
	        : TR::ARMLabelInstruction(node, cg), _estimatedBinaryLocation(0), _farRelocation(false)
	{
	...
	ARMConditionalBranchInstruction(
	        ...
	        : TR::ARMLabelInstruction(op, node, sym, cg), _estimatedBinaryLocation(0), _farRelocation(false)
	{
		setConditionCode(cc);
	}
	...
	ARMConditionalBranchInstruction(TR_ARMOpCodes op, TR::Node *node, TR::RegisterDependencyConditions *cond,
	        ...
	        : TR::ARMLabelInstruction(op, node, cond, sym, cg), _estimatedBinaryLocation(0), _farRelocation(false)
	{
		setConditionCode(cc);
	}
	...
	ARMConditionalBranchInstruction(TR::Instruction *precedingInstruction, TR_ARMOpCodes op, TR::Node *node,
	        TR::RegisterDependencyConditions *cond, TR::LabelSymbol *sym, TR_ARMConditionCode cc,
	        TR::CodeGenerator *cg)
...
public:
	ARMVirtualGuardNOPInstruction(TR::Node *node, TR_VirtualGuardSite *site, TR::RegisterDependencyConditions *cond,
	        TR::LabelSymbol *sym, TR::CodeGenerator *cg)
	        : TR::ARMLabelInstruction(ARMOp_vgdnop, node, cond, sym, cg), _site(site)
	{}

	ARMVirtualGuardNOPInstruction(TR::Node *node, TR_VirtualGuardSite *site, TR::RegisterDependencyConditions *cond,
	        TR::LabelSymbol *sym, TR::Instruction *precedingInstruction, TR::CodeGenerator *cg)
	        : TR::ARMLabelInstruction(precedingInstruction, ARMOp_vgdnop, node, cond, sym, cg), _site(site)
	{}
...
public:
	...
	ARMAdminInstruction(TR::Instruction *precedingInstruction, TR_ARMOpCodes op, TR::Node *node,
...
public:
	ARMImmSymInstruction(TR::Node *node, TR::CodeGenerator *cg)
	        : TR::ARMImmInstruction(node, cg), _symbolReference(NULL), _snippet(NULL)
	{}
...
public:
	...
	ARMTrg1Src2Instruction(TR::Instruction *precedingInstruction, TR_ARMOpCodes op, TR::Node *node,
...
public:
	ARMLoadStartPCInstruction(
	        TR::Node *node, TR::Register *treg, TR::SymbolReference *symRef, TR::CodeGenerator *cg)
	        : TR::ARMTrg1Src2Instruction(ARMOp_sub, node, treg,
...
public:
	...
	ARMTrg1Src1Instruction(TR_ARMOpCodes op, TR::Node *node, TR::RegisterDependencyConditions *cond,
	...
	ARMTrg1Src1Instruction(TR::Instruction *precedingInstruction, TR_ARMOpCodes op, TR::Node *node,
	        TR::Register *treg, TR_ARMOperand2 *sop, TR::CodeGenerator *cg)
	        : TR::ARMTrg1Src2Instruction(precedingInstruction, op, node, cg)
	{
		setTarget1Register(treg);
...
public:
	...
	ARMTrg1Instruction(TR::Instruction *precedingInstruction, TR_ARMOpCodes op, TR::Node *node, TR::Register *treg,
	        TR::CodeGenerator *cg)
	        : TR::Instruction(precedingInstruction, op, node, cg), _target1Register(treg)
	{
		treg->incTotalUseCount();
	}
...
public:
	...
	ARMTrg2Src1Instruction(TR::Instruction *precedingInstruction, TR_ARMOpCodes op, TR::Node *node,
...
public:
	...
	ARMMulInstruction(TR_ARMOpCodes op, TR::Node *node, TR::Register *tregLo, TR::Register *s1reg,
	        TR::Register *s2reg, TR::CodeGenerator *cg)
	        : TR::Instruction(op, node, cg)
	...
	ARMMulInstruction(TR_ARMOpCodes op, TR::Node *node, TR::Register *tregHi, TR::Register *tregLo,
	        TR::Register *s1reg, TR::Register *s2reg, TR::CodeGenerator *cg)
	        : TR::Instruction(op, node, cg)
	        , _targetLoRegister(tregLo)
...
public:
	...
	ARMTrg1MemInstruction(TR::Instruction *precedingInstruction, TR_ARMOpCodes op, TR::Node *node,
...
public:
	...
	ARMMultipleMoveInstruction(
	        TR_ARMOpCodes op, TR::Node *node, TR::Register *mbr, uint16_t rl, TR::CodeGenerator *cg)
	        : TR::Instruction(op, node, cg)
