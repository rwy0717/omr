...
void TR_Debug::print(TR::FILE* pOutFile, TR::ARMImmSymInstruction* instr)
{
    ...
    bool longJump = imm && (distance > BRANCH_FORWARD_LIMIT || distance < BRANCH_BACKWARD_LIMIT)
...
const char* TR_Debug::getOpCodeName(TR_ARMOpCode* opCode) { return opCodeToNameMap[opCode->getOpCodeValue()]; }
