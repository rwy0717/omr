...
void
TR_VerboseLog::vwrite(const char *format, va_list args)
{
	// not implemented yet
...
void
TR::PatchNOPedGuardSite::compensate(TR_FrontEnd *fe, bool isSMP, uint8_t *location, uint8_t *destination)
{
	TR_UNIMPLEMENTED();
}
void
...
void
OMR::RuntimeAssumption::addToRAT(TR_PersistentMemory *persistentMemory, TR_RuntimeAssumptionKind kind, TR_FrontEnd *fe,
...
TR_PatchNOPedGuardSiteOnClassPreInitialize::make(TR_FrontEnd *fe, TR_PersistentMemory *, char *, unsigned int,
        unsigned char *, unsigned char *, OMR::RuntimeAssumption **)
{
	TR_UNIMPLEMENTED();
	return 0;
}
...
{}
void
TR_Debug::printAnnotationInfoEntry(J9AnnotationInfo *, J9AnnotationInfoEntry *, int32_t)
{}
void
