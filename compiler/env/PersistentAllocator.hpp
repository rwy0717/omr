...
inline void *
operator new(size_t size, OMR::PersistentAllocator &allocator, const std::nothrow_t &tag) throw()
{
...
inline void
operator delete(void *ptr, OMR::PersistentAllocator &allocator, const std::nothrow_t &tag) throw()
{
	allocator.deallocate(ptr);
}
