...
char *
TR_FrontEnd::getFormattedName(char *buf, int32_t bufLength, char *name, char *format, bool suffix)
{
...
TR_YesNoMaybe
TR_FrontEnd::isInstanceOf(TR_OpaqueClassBlock *instanceClass, TR_OpaqueClassBlock *castClass, bool instanceIsFixed,
        bool castIsFixed, bool optimizeForAOT)
{
	TR_UNIMPLEMENTED();
	return TR_maybe;
}
