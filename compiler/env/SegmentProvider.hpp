...
protected:
	explicit SegmentProvider(size_t defaultSegmentSize) : _defaultSegmentSize(defaultSegmentSize) {}

	SegmentProvider(const SegmentProvider &other) : _defaultSegmentSize(other._defaultSegmentSize) {}
