...
const char *objectName[] = {"Array", "Instruction", "ListElement", "Node", "BitVector", "Register", "MemoryReference",
        "CFGNode", "Symbol", "SymbolReference", "SymRefUnion", "BackingStore", "StorageReference", "PseudoRegister",
        "Link", "Machine", "CFGEdge", "TreeTop", "GCStackMap", "IlGenerator", "RegisterDependencyConditions", "Snippet",
        "Relocation", "VirtualGuard", "RegisterDependencyGroup", "RegisterDependency", "FrontEnd", "VMField",
        "VMFieldsInfo", "Method", "Pair", "HashTab", "HashTable", "HashTabEntry", "DebugCounter", "JSR292", "Memory",
        "CS2", "UnknownType",
        ...
        "RedundantAsycCheckRemoval", "RegionAnalysis", "RightNumberOfNames", "Structure", "SwitchAnalyzer",
        "UseDefInfo", "ValueNumberInfo", "ValuePropagation", "VirtualGuardTailSplitter", "InterProceduralAnalyzer",
        ...
        "CatchBlockProfileInfo", "CFG", "CHTable", "ClassLookahead", "CodeGenerator", "Compilation",
        "ExceptionTableEntry", "ExceptionTableEntryIterator", "ExtendedBlockSuccessorIterator", "ExtraInfoForNew",
        "GlobalRegister", "GCRegisterMap", "GCStackAtlas", "GRABlockInfo", "IdAddrNodes",

        // IA32 codegen
        "BetterSpillPlacement", "ClobberingInstruction", "OutlinedCode", "IA32ProcessorInfo",
        "X86AllocPrefetchGeometry", "X86TOCHashTable",
        ...
        "VirtualGuardSiteInfo", "WCode", "CallGraph", "CPOController", "RegisterIterator", "TRStats",
        "TR_OptimizationPlan", "TR_ClassHolder", "SmartBuffer", "TR_ListingInfo", "methodInfoType",
...
{
	switch (kind) {
	case persistentAlloc: _trPersistentMemory->freePersistentMemory(p); break;
...
GlobalSingletonAllocator::createInstance()
{
	TR_ASSERT(::trPersistentMemory != NULL,
	        "Attempting to use GlobalAllocator too early. It cannot be used until TR_PersistentMemory has been "
	        "initialized.");
