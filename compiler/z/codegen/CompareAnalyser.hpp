...
public:
	TR_S390CompareAnalyser(TR::CodeGenerator *cg) : _cg(cg), _machine(cg->machine()) {}
	...
	TR::RegisterDependencyConditions *longOrderedCompareAndBranchAnalyser(TR::Node *root,
	        ...
	        TR::InstOpCode::S390BranchCondition highReversedBranchCond, TR::LabelSymbol *trueLabel,
	        TR::LabelSymbol *falseLabel, bool &internalControlFlowStarted);
