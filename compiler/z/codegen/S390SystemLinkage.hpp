...
namespace TR {
class S390SystemLinkage;
}
namespace OMR {
typedef TR::S390SystemLinkage SystemLinkageConnector;
}
#endif
...
public:
    S390SystemLinkage(TR::CodeGenerator* cg, TR_S390LinkageConventions elc = TR_S390LinkageDefault,
    ...
    virtual TR::RealRegister::RegNum setDebugHooksRegister(TR::RealRegister::RegNum r)
    {
    ...
    virtual TR::Instruction* getputFPRs(
        TR::InstOpCode::Mnemonic opcode, TR::Instruction* cursor, TR::Node* node, TR::RealRegister* spReg = 0);
    virtual TR::Instruction* getputHPRs(
        TR::InstOpCode::Mnemonic opcode, TR::Instruction* cursor, TR::Node* node, TR::RealRegister* spReg = 0);
};
