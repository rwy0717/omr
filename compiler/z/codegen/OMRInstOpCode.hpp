...
public:
    ...
    {
        TR_ASSERT(arch > TR_UnknownArchitecture && arch <= TR_LatestArchitecture, "Invalid Processor Architecture.");
        _processorArchitecture = _processorArchitecture < arch ? _processorArchitecture
...
public:
     ...
     */
    TR_S390ProcessorInfo::TR_S390ProcessorArchitectures getMinimumALS() const { return metadata[_mnemonic].minimumALS; }
