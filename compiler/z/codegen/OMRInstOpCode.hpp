...
public:
	 ...
	 *      architecture level set (ALS) which introduced the instruction, and the various properties which model
	...
	static uint8_t getInstructionLength(Mnemonic i_opCode); /* Using a table that maps values of bit 0-1 to
