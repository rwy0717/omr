...
getBranchConditionForMask(uint32_t branchMask)
{
	...
	default: TR_ASSERT(0, "Unknown branch mask specified"); return TR::InstOpCode::COND_NOP;
	}
}
...
getMaskForBranchCondition(TR::InstOpCode::S390BranchCondition branchCond)
{
	...
	default: TR_ASSERT(0, "Unknown branch instruction specified"); return 0;
	}
}
...
{
	switch (bc) {
	case TR::InstOpCode::COND_BNH: return TR::InstOpCode::COND_BNL;
	case TR::InstOpCode::COND_BNHR: return TR::InstOpCode::COND_BNLR;
	case TR::InstOpCode::COND_BNP: return TR::InstOpCode::COND_BNM;
	case TR::InstOpCode::COND_BNL: return TR::InstOpCode::COND_BNH;
	case TR::InstOpCode::COND_BNLR: return TR::InstOpCode::COND_BNHR;
	case TR::InstOpCode::COND_BNM: return TR::InstOpCode::COND_BNP;
	case TR::InstOpCode::COND_BNMR: return TR::InstOpCode::COND_BNP;
	case TR::InstOpCode::COND_BL: return TR::InstOpCode::COND_BH;
	case TR::InstOpCode::COND_BLR: return TR::InstOpCode::COND_BHR;
	case TR::InstOpCode::COND_BM: return TR::InstOpCode::COND_BP;
	case TR::InstOpCode::COND_BMR: return TR::InstOpCode::COND_BPR;
	case TR::InstOpCode::COND_BH: return TR::InstOpCode::COND_BL;
	case TR::InstOpCode::COND_BHR: return TR::InstOpCode::COND_BLR;
	case TR::InstOpCode::COND_BP: return TR::InstOpCode::COND_BM;
	case TR::InstOpCode::COND_BPR: return TR::InstOpCode::COND_BMR;
	default: {
