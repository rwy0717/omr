...
TR::Register* OMR::Z::RegisterPair::setLowOrder(TR::Register* lo, TR::CodeGenerator* codeGen)
{
    // highword RA HPR upgrade
    if (lo)
        lo->setIsNotHighWordUpgradable(true);
...
TR::Register* OMR::Z::RegisterPair::setHighOrder(TR::Register* ho, TR::CodeGenerator* codeGen)
{
    // highword RA HPR upgrade
    if (ho)
        ho->setIsNotHighWordUpgradable(true);
