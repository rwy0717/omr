...
TR::Register *
inlineTrtEvaluator(TR::Node *node, TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic opCode, bool isFoldedIf,
        bool isFoldedLookup, TR::Node *parent)
{
	...
	if (cg->traceBCDCodeGen())
		traceMsg(comp,
		        "\tinlineTrtEvaluator %s (%p) -- numChildren %d, storeR1AndR2=%d, isSimple=%d, packR2=%d\n",
