...
////////////////////////////////////////////////////////////////////////////////
TR::Instruction *
generateS390BranchInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op,
...
TR::Instruction *
generateS390BranchInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *node,
...
TR::Instruction *
generateS390BranchInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n,
...
getReplacementCompareAndBranchOpCode(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic compareOpCode)
{
	...
	case TR::InstOpCode::CR: return TR::InstOpCode::CRJ; break;
	case TR::InstOpCode::CLR: return TR::InstOpCode::CLRJ; break;
	case TR::InstOpCode::CGR: return TR::InstOpCode::CGRJ; break;
	case TR::InstOpCode::CLGR: return TR::InstOpCode::CLGRJ; break;
	case TR::InstOpCode::C: return TR::InstOpCode::CIJ; break;
	case TR::InstOpCode::CL: return TR::InstOpCode::CLIJ; break;
	case TR::InstOpCode::CG: return TR::InstOpCode::CGIJ; break;
	case TR::InstOpCode::CLG: return TR::InstOpCode::CLGIJ; break;
	default: return TR::InstOpCode::BAD; break;
	}
}
	...
	if (!memRef->hasTemporaryNegativeOffset() && memRef->isLongDisplacementRequired()) {
		...
		if (longDisplacementMnemonic != TR::InstOpCode::BAD) {
			...
			TR::DebugCounter::incStaticDebugCounter(cg->comp(),
			        TR::DebugCounter::debugCounterName(cg->comp(),
			                "z/memref/long-displacement-upgrade/(%s)", cg->comp()->signature()));
		}
	}
 ...
 */
TR::Instruction *
generateS390CompareAndBranchInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic compareOpCode, TR::Node *node,
        TR::Register *first, TR::Register *second, TR::InstOpCode::S390BranchCondition bc,
	...
	// otherwise we'll generate with the compare opcode pased and an TR::InstOpCode::BRC.
		...
		if (!needsCC && comp->getOption(TR_EnableEBBCCInfo)
		        ...
		        && performTransformation(comp,
		                "O^O generateS390CompareAndBranchInstruction case 1 remove RR Compare[%s\t %s, %s]: "
		                "reuse CC from ccInst [%p].",
		                opcTmp.getMnemonicName(), debugObj->getName(first), debugObj->getName(second), ccInst))
			returnInstruction =
			        generateS390BranchInstruction(cg, TR::InstOpCode::BRC, bc, node, branchDestination);
		else if (!needsCC && comp->getOption(TR_EnableEBBCCInfo)
		        && cg->isActiveCompareCC(compareOpCode, second, first)
		        && performTransformation(comp,
		                "O^O generateS390CompareAndBranchInstruction case 2 remove RR Compare[%s\t %s, %s]: "
		                "reuse CC from ccInst [%p].",
		                opcTmp.getMnemonicName(), debugObj->getName(first), debugObj->getName(second), ccInst))
			...
			generateRRInstruction(
			        cg, compareOpCode, node, first, second, (TR::RegisterDependencyConditions *)0);
...
TR::Instruction *
generateS390CompareAndBranchInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic compareOpCode, TR::Node *node,
        TR::Register *first, imm32Or64Bit second, TR::InstOpCode::S390BranchCondition bc,
...
TR::Instruction *
generateRRInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *treg,
...
TR::Instruction *
generateRRInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *treg,
        int8_t secondConstant, TR::Instruction *preced)
{
	if (preced) {
...
TR::Instruction *
generateRRInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, int8_t firstConstant,
        int8_t secondConstant, TR::Instruction *preced)
{
	if (preced) {
...
TR::Instruction *
generateRRInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *treg,
        TR::Register *sreg, TR::RegisterDependencyConditions *cond, TR::Instruction *preced)
{
	TR::Instruction *instr;
...
TR::Instruction *
generateRRDInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *treg,
        TR::Register *sreg, TR::Register *sreg2, TR::Instruction *preced)
{
...
TR::Instruction *
generateRRFInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *treg,
        TR::Register *sreg, uint8_t mask, bool isMask3, TR::Instruction *preced)
{
...
TR::Instruction *
generateRRFInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *treg,
        TR::Register *sreg, uint8_t mask, bool isMask3, TR::RegisterDependencyConditions *cond, TR::Instruction *preced)
{
...
TR::Instruction *
generateRRFInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *treg,
        TR::Register *sreg, TR::Register *sreg2, uint8_t mask, TR::Instruction *preced)
{
...
TR::Instruction *
generateRRRInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *treg,
        TR::Register *sreg, TR::Register *sreg2, TR::Instruction *preced)
{
	if (preced) {
 ...
 */
bool
CheckForRegisterDependencyConditionsRealRegisterMergeConflict(TR_S390RegisterDependencyGroup *conds1,
...
TR::Instruction *
generateRXInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *treg,
...
TR::Instruction *
generateRXInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, uint8_t mask,
        TR::MemoryReference *mf, TR::Instruction *preced)
{
	// Handle long displacement if necessary
	op = getReplacementLongDisplacementOpCode(cg, op, mf);
...
TR::Instruction *
generateRXEInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *treg,
        TR::MemoryReference *mf, uint8_t mask3, TR::Instruction *preced)
{
	TR::Instruction *instr;
	if (preced)
...
TR::Instruction *
generateRXFInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *treg,
        TR::Register *sreg, TR::MemoryReference *mf, TR::Instruction *preced)
{
	TR::Instruction *instr;
	if (preced)
...
TR::Instruction *
generateRIInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *treg, int32_t imm,
        TR::Instruction *preced)
{
	if (preced) {
...
TR::Instruction *
generateRIInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *treg, char *data,
        TR::Instruction *preced)
{
	if (preced) {
...
TR::Instruction *
generateRILInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *treg,
        TR::SymbolReference *sr, void *addr, TR::Instruction *preced)
{
	if (preced) {
...
TR::Instruction *
generateRILInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *treg,
        TR::LabelSymbol *label, TR::Instruction *preced)
{
	if (preced)
...
TR::Instruction *
generateRILInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *treg, int32_t imm,
        TR::Instruction *preced)
{
	if (preced) {
		return new (INSN_HEAP) TR::S390RILInstruction(op, n, treg, imm, preced, cg);
...
TR::Instruction *
generateRILInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *treg, void *addr,
        TR::Instruction *preced)
{
	if (preced) {
...
TR::Instruction *
generateRILInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, uint32_t mask, void *addr,
        TR::Instruction *preced)
{
	if (preced) {
...
TR::Instruction *
generateRILInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *treg,
        TR::Snippet *ts, TR::Instruction *preced)
{
	if (preced) {
...
TR::Instruction *
generateRSInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *treg,
        TR::MemoryReference *mf, TR::Instruction *preced)
{
	...
	if (instructionFormat == RSa_FORMAT) {
		...
		TR_ASSERT_FATAL(instructionFormat == RSYa_FORMAT,
		        "Mnemonic (%s) is incorrectly used as an RSY instruction", TR::InstOpCode::metadata[op].name);
...
TR::Instruction *
generateRSInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *treg,
        uint32_t mask, TR::MemoryReference *mf, TR::Instruction *preced)
{
	// RS and RSY instructions do not have an index register
	preced = mf->separateIndexRegister(n, cg, false, preced);
...
TR::Instruction *
generateRSInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::RegisterPair *treg,
        TR::RegisterPair *sreg, TR::MemoryReference *mf, TR::Instruction *preced)
{
	// RS and RSY instructions do not have an index register
	preced = mf->separateIndexRegister(n, cg, false, preced);
...
TR::Instruction *
generateRSInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *freg,
        TR::Register *lreg, TR::MemoryReference *mf, TR::Instruction *preced)
{
	// RS and RSY instructions do not have an index register
	preced = mf->separateIndexRegister(n, cg, false, preced);
...
TR::Instruction *
generateRSInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::RegisterPair *regp,
        TR::MemoryReference *mf, TR::Instruction *preced)
{
...
TR::Instruction *
generateRSInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *treg,
        TR::Register *sreg, uint32_t imm, TR::Instruction *preced)
{
	if (preced) {
...
TR::Instruction *
generateRSWithImplicitPairStoresInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n,
...
TR::Instruction *
generateRRSInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *treg,
        TR::Register *sreg, TR::MemoryReference *branch, TR::InstOpCode::S390BranchCondition cond,
        TR::Instruction *preced)
{
	if (branch)
		preced = branch->separateIndexRegister(n, cg, true, preced); // enforce4KDisplacementLimit=true (no Y
		                                                             // form)
...
TR::Instruction *
generateRIEInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *treg,
        TR::Register *sreg, TR::LabelSymbol *branch, TR::InstOpCode::S390BranchCondition mask, TR::Instruction *preced)
{
	if (preced) {
...
TR::Instruction *
generateRIEInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *treg,
        int8_t immCompare, TR::LabelSymbol *branch, TR::InstOpCode::S390BranchCondition mask, TR::Instruction *preced)
{
	if (preced) {
...
TR::Instruction *
generateRIEInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *treg,
        TR::Register *sreg, int8_t immOne, int8_t immTwo, int8_t immThree, TR::Instruction *preced)
{
	if (preced) {
...
TR::Instruction *
generateRIEInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *treg,
        int16_t sourceImmediate, TR::InstOpCode::S390BranchCondition branchCondition, TR::Instruction *preced)
{
	if (preced) {
		return new (INSN_HEAP)
		        TR::S390RIEInstruction(op, n, treg, sourceImmediate, branchCondition, preced, cg);
	}
...
TR::Instruction *
generateRIEInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *treg,
        TR::Register *sreg, int16_t imm, TR::Instruction *preced)
{
	if (preced) {
...
TR::Instruction *
generateRISInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *leftSide,
        int8_t immCompare, TR::MemoryReference *branch, TR::InstOpCode::S390BranchCondition cond,
        TR::Instruction *preced)
{
	if (branch)
		preced = branch->separateIndexRegister(n, cg, true, preced); // enforce4KDisplacementLimit=true (no Y
...
TR::Instruction *
generateS390MemInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, int8_t memAccessMode,
        TR::MemoryReference *mf, TR::Instruction *preced)
{
	TR::Instruction *instr;
	if (preced)
...
TR::Instruction *
generateS390MemInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, int8_t constantField,
...
TR::Instruction *
generateRSLInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, uint16_t len,
...
TR::Instruction *
generateRSLbInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *reg,
        uint16_t length, TR::MemoryReference *mf1, uint8_t mask, TR::Instruction *preced)
{
	if (mf1)
		preced = mf1->enforceRSLFormatLimits(n, cg, preced);
...
TR::Instruction *
generateSS1Instruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, uint16_t len,
        TR::MemoryReference *mf1, TR::MemoryReference *mf2, TR::Instruction *preced)
{
	...
	if (sameBaseRegister && mf1->getBaseRegister() != mf2->getBaseRegister()) // avoid register copies on restricted
	                                                                          // regs
...
TR::Instruction *
generateSS1WithImplicitGPRsInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, uint16_t len,
        TR::MemoryReference *mf1, TR::MemoryReference *mf2, TR::RegisterDependencyConditions *cond,
        ...
        TR::Register *implicitRegTrg1, TR::Instruction *preced)
{
	...
	if (preced)
		...
		instr = new (INSN_HEAP) TR::S390SS1WithImplicitGPRsInstruction(op, n, len, mf1, mf2, cond,
		        implicitRegSrc0, implicitRegSrc1, implicitRegTrg0, implicitRegTrg1, cg);
...
TR::Instruction *
generateSS2Instruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, uint16_t len1,
...
#ifdef J9_PROJECT_SPECIFIC
	if (op == TR::InstOpCode::ZAP || op == TR::InstOpCode::CP || op == TR::InstOpCode::AP
	        || op == TR::InstOpCode::SP || op == TR::InstOpCode::MP || op == TR::InstOpCode::DP) {
...
TR::Instruction *
generateSS3Instruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, uint32_t len,
...
TR::Instruction *
generateSS4Instruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *lengthReg,
        TR::MemoryReference *mf1, TR::MemoryReference *mf2, TR::Register *sourceKeyReg, TR::Instruction *preced)
{
	if (mf1)
		preced = mf1->enforceSSFormatLimits(n, cg, preced);
	if (mf2)
...
TR::Instruction *
generateSS5Instruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *op1Reg,
        TR::MemoryReference *mf2, TR::Register *op3Reg, TR::MemoryReference *mf4, TR::Instruction *preced)
{
...
TR::Instruction *
generateSS5Instruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *op1Reg,
        TR::MemoryReference *mf2, TR::MemoryReference *mf4, TR::Instruction *preced)
{
...
TR::Instruction *
generateSS5WithImplicitGPRsInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n,
        ...
        TR::Register *implicitRegTrg1, TR::Instruction *preced)
{
	...
	if (sameBaseRegister && mf2->getBaseRegister() != mf4->getBaseRegister()) // avoid register copies on restricted
	                                                                          // regs
	...
	if (preced)
		...
		instr = new (INSN_HEAP) TR::S390SS5WithImplicitGPRsInstruction(op, n, op1Reg, mf2, op3Reg, mf4,
		        implicitRegSrc0, implicitRegSrc1, implicitRegTrg0, implicitRegTrg1, cg);
        ...
        TR::Register *implicitRegTrg0, TR::Register *implicitRegTrg1, TR::Instruction *preced)
{
	...
	if (preced)
		...
		instr = new (INSN_HEAP) TR::S390SS5WithImplicitGPRsInstruction(op, n, op1Reg, mf2, NULL, NULL,
		        implicitRegSrc0, implicitRegSrc1, implicitRegTrg0, implicitRegTrg1, cg);
        ...
        TR::Instruction *preced)
{
	...
	if (preced)
		...
		instr = new (INSN_HEAP) TR::S390SS5WithImplicitGPRsInstruction(op, n, op1Reg, mf2, NULL, mf4,
		        implicitRegSrc0, implicitRegSrc1, implicitRegTrg0, implicitRegTrg1, cg);
...
TR::Instruction *
generateSSFInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::RegisterPair *regp,
        TR::MemoryReference *mf1, TR::MemoryReference *mf2, TR::Instruction *preced)
{
	if (mf1)
		preced = mf1->enforceSSFormatLimits(n, cg, preced);
...
TR::Instruction *
generateSIInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::MemoryReference *mf,
        uint32_t imm, TR::Instruction *preced)
{
	...
	if (instructionFormat == SI_FORMAT) {
		...
		TR_ASSERT_FATAL(instructionFormat == SIY_FORMAT,
		        "Mnemonic (%s) is incorrectly used as an SIY instruction", TR::InstOpCode::metadata[op].name);
...
TR::Instruction *
generateSILInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::MemoryReference *mf,
        uint32_t imm, TR::Instruction *preced)
{
	if (mf->getIndexRegister() != NULL && mf->getBaseRegister() == NULL) {
		...
		if (mf)
			preced = mf->separateIndexRegister(n, cg, true, preced); // enforce4KDisplacementLimit=true (no
			                                                         // Y form)
	}
...
TR::Instruction *
generateSInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::MemoryReference *mf,
        TR::Instruction *preced)
{
	if (mf)
 ...
 */
TR::Instruction *
generateVRIaInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *targetReg,
        uint16_t constantImm2 /* 16 bits */, uint8_t mask3)
{
...
TR::Instruction *
generateVRIcInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *targetReg,
        TR::Register *sourceReg3, uint16_t constantImm2 /* 8 or 16 bits */, uint8_t mask4 /* 4 bits */)
{
	return new (INSN_HEAP) TR::S390VRIcInstruction(cg, op, n, targetReg, sourceReg3, constantImm2, mask4);
}

TR::Instruction *
generateVRIdInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *targetReg,
        TR::Register *sourceReg2, TR::Register *sourceReg3, uint8_t constantImm4 /* 8 bit */,
        uint8_t mask5 /* 4 bits */)
{
	return new (INSN_HEAP)
	        TR::S390VRIdInstruction(cg, op, n, targetReg, sourceReg2, sourceReg3, constantImm4, mask5);
}

TR::Instruction *
generateVRIeInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *targetReg,
        TR::Register *sourceReg2, uint16_t constantImm3 /* 12 bits */, uint8_t mask5 /* 4 bits */,
...
TR::Instruction *
generateVRIfInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *targetReg,
        TR::Register *sourceReg2, TR::Register *sourceReg3, uint8_t constantImm4, /* 8 bits  */
        uint8_t mask5) /* 4 bits */
{
	TR::Instruction *instr = new (INSN_HEAP)
	        TR::S390VRIfInstruction(cg, op, n, targetReg, sourceReg2, sourceReg3, constantImm4, mask5);

#ifdef J9_PROJECT_SPECIFIC
	if (op == TR::InstOpCode::VAP || op == TR::InstOpCode::VSP || op == TR::InstOpCode::VDP
	        || op == TR::InstOpCode::VMP || op == TR::InstOpCode::VMSP || op == TR::InstOpCode::VSDP
...
TR::Instruction *
generateVRIgInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *targetReg,
        TR::Register *sourceReg2, uint8_t constantImm3, /* 8 bits  */
        uint8_t constantImm4, /* 8 bits  */
        uint8_t mask5) /* 4 bits  */
{
	TR::Instruction *instr = new (INSN_HEAP)
	        TR::S390VRIgInstruction(cg, op, n, targetReg, sourceReg2, constantImm3, constantImm4, mask5);
...
TR::Instruction *
generateVRIhInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *targetReg,
...
TR::Instruction *
generateVRIiInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *targetReg,
        TR::Register *sourceReg2, uint8_t constantImm3, /* 8 bits  */
        uint8_t mask4) /* 4 bits  */
{
	TR::Instruction *instr = new (INSN_HEAP)
	        TR::S390VRIiInstruction(cg, op, n, targetReg, sourceReg2, constantImm3, mask4);
...
/****** VRR ******/
TR::Instruction *
generateVRRaInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *targetReg,
        TR::Register *sourceReg2, uint8_t mask5 /* 4 bits */, uint8_t mask4 /* 4 bits */, uint8_t mask3 /* 4 bits */,
        TR::Instruction *preced)
{
	if (preced)
		return new (INSN_HEAP)
		        TR::S390VRRaInstruction(cg, op, n, targetReg, sourceReg2, mask5, mask4, mask3, preced);
	else
...
TR::Instruction *
generateVRRaInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *targetReg,
        TR::Register *sourceReg2, TR::Instruction *preced)
{
	if (preced)
		...
		return new (INSN_HEAP) TR::S390VRRaInstruction(
		        cg, op, n, targetReg, sourceReg2, 0 /* mask5 */, 0 /* mask4 */, 0 /* mask3 */);
}

TR::Instruction *
generateVRRbInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *targetReg,
        TR::Register *sourceReg2, TR::Register *sourceReg3, uint8_t mask5 /* 4 bits */, uint8_t mask4 /* 4 bits */)
{
	return new (INSN_HEAP) TR::S390VRRbInstruction(cg, op, n, targetReg, sourceReg2, sourceReg3, mask5, mask4);
}

TR::Instruction *
generateVRRcInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *targetReg,
        TR::Register *sourceReg2, TR::Register *sourceReg3, uint8_t mask6 /* 4 bits */, uint8_t mask5 /* 4 bits */,
        uint8_t mask4 /* 4 bits */)
{
	return new (INSN_HEAP)
	        TR::S390VRRcInstruction(cg, op, n, targetReg, sourceReg2, sourceReg3, mask6, mask5, mask4);
}

TR::Instruction *
generateVRRcInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *targetReg,
        TR::Register *sourceReg2, TR::Register *sourceReg3, uint8_t mask4 /* 4 bits */)
{
	return new (INSN_HEAP) TR::S390VRRcInstruction(cg, op, n, targetReg, sourceReg2, sourceReg3, 0, 0, mask4);
}

TR::Instruction *
generateVRRdInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *targetReg,
        TR::Register *sourceReg2, TR::Register *sourceReg3, TR::Register *sourceReg4, uint8_t mask6 /* 4 bits */,
        uint8_t mask5 /* 4 bits */)
{
	return new (INSN_HEAP)
...
TR::Instruction *
generateVRReInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *targetReg,
        TR::Register *sourceReg2, TR::Register *sourceReg3, TR::Register *sourceReg4, uint8_t mask6 /* 4 bits */,
        uint8_t mask5 /* 4 bits */)
...
TR::Instruction *
generateVRRfInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *targetReg,
        TR::Register *sourceReg2 /* GPR */, TR::Register *sourceReg3 /* GPR */)
{
...
generateVRRgInstruction(
        TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *targetReg) /* Vector
                                                                                                     register
                                                                                                   */
{
...
TR::Instruction *
generateVRRhInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n,
        TR::Register *targetReg, /* Vector
                                    register
                                  */
...
TR::Instruction *
generateVRRiInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *targetReg, /* GPR
                                                                                                                   */
...
TR::Instruction *
generateVRSaInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *targetReg,
        TR::Register *sourceReg, TR::MemoryReference *mr, uint8_t mask4 /* 4 bits */, TR::Instruction *preced)
{
...
TR::Instruction *
generateVRSbInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *targetReg,
        TR::Register *sourceReg, TR::MemoryReference *mr, uint8_t mask4 /* 4 bits */, TR::Instruction *preced)
{
	preced = mr->enforceSSFormatLimits(n, cg, preced);
...
TR::Instruction *
generateVRScInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *targetReg,
        TR::Register *sourceReg, TR::MemoryReference *mr, uint8_t mask4 /* 4 bits */, TR::Instruction *preced)
{
	preced = mr->enforceSSFormatLimits(n, cg, preced);
...
TR::Instruction *
generateVRSdInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *targetReg, /* VRF
                                                                                                                   */
...
/****** VRV ******/
TR::Instruction *
generateVRVInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *sourceReg,
        TR::MemoryReference *mr, uint8_t mask3 /* 4 bits */, TR::Instruction *preced)
{
	preced = mr->enforceSSFormatLimits(n, cg, preced);
...
/****** VSI ******/
TR::Instruction *
generateVSIInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *reg, /* VRF */
...
TR::Instruction *
generateS390PseudoInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n,
...
TR::Instruction *
generateS390PseudoInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, int32_t regNum,
 ...
 */
TR::Instruction *
generateS390DebugCounterBumpInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n,
...
TR::Instruction *
generateS390ImmSymInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, uint32_t imm,
        TR::SymbolReference *sr, TR::RegisterDependencyConditions *cond, TR::Instruction *preced)
{
	if (preced) {
...
TR::Instruction *
generateShiftRightImmediate(TR::CodeGenerator *cg, TR::Node *node, TR::Register *trgReg, TR::Register *srcReg,
        ...
        TR::RegisterDependencyConditions *cond, TR::Instruction *preced)
{
	...
	// Direct calls on 64-bit systems may require a trampoline. As the trampoline will kill the EP register we
	// should always see the EP register defined in the post-dependencies of such calls.
	...
	if (myself) {
		TR::Instruction *instr = new (INSN_HEAP)
		        TR::S390RILInstruction(TR::InstOpCode::BRASL, callNode, RegRA, sym, callSymRef, cg);
...
#endif
		{
...
#endif
			{
				tempInst = (new (INSN_HEAP) TR::S390RILInstruction(TR::InstOpCode::BRASL, callNode,
				        RegRA, reinterpret_cast<void *>(imm), callSymRef, cg));
			}
#endif
#if !defined(TR_TARGET_64BIT) || (defined(TR_TARGET_64BIT) && defined(J9ZOS390))
...

			{
				tempInst = new (INSN_HEAP) TR::S390RILInstruction(
				        TR::InstOpCode::BRASL, callNode, RegRA, reinterpret_cast<void *>(imm), cg);
 ...
 */
TR::Instruction *
generateSnippetCall(TR::CodeGenerator *cg, TR::Node *callNode, TR::Snippet *s, TR::RegisterDependencyConditions *cond,
        TR::SymbolReference *callSymRef, TR::Instruction *preced)
{
	TR::Register *RegRA = cond->searchPostConditionRegister(cg->getReturnAddressRegister());
	...
	if (s->getKind() == TR::Snippet::IsVirtualUnresolved) {
		TR::RegisterDependencyConditions *preDeps = new (INSN_HEAP) TR::RegisterDependencyConditions(
		...
		callInstr = new (INSN_HEAP)
		        TR::S390RILInstruction(TR::InstOpCode::BRASL, callNode, RegRA, s, cond, callSymRef, cg);
	}
...
TR::Instruction *
generateRegLitRefInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *node, TR::Register *treg,
        int32_t imm, TR::RegisterDependencyConditions *cond, TR::Instruction *preced, TR::Register *base,
        bool isPICCandidate)
{
	TR::Compilation *comp = cg->comp();
	bool alloc = false;
	...
	if (comp->getOption(TR_EnableHCR) && isPICCandidate) {
		...
		if (node->isClassUnloadingConst()) {
			...
			bool isMethod = node->getOpCodeValue() == TR::loadaddr ? false
...
TR::Instruction *
generateRegLitRefInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *node, TR::Register *treg,
        uintptrj_t imm, int32_t reloType, TR::RegisterDependencyConditions *cond, TR::Instruction *preced,
        TR::Register *base)
{
	bool alloc = false;
	TR::Instruction *cursor;
	...
	if (TR::Compiler->target.cpu.getSupportsArch(TR::CPU::z10)) {
		if (op == TR::InstOpCode::LG || op == TR::InstOpCode::L) {
			...
			AOTcgDiag4(comp,
			        "generateRegLitRefInstruction constantDataSnippet=%x symbolReference=%x symbol=%x "
			        "reloType=%x\n",
			...
			cursor = (TR::S390RILInstruction *)generateRILInstruction(cg,
			        (op == TR::InstOpCode::LG) ? TR::InstOpCode::LGRL : TR::InstOpCode::LRL, node, treg,
			        targetSnippet, preced);
			return cursor;
		}
	}
	...
	AOTcgDiag5(comp,
	        "generateRegLitRefInstruction dataref=%x constantDataSnippet=%x symbolReference=%x symbol=%x "
	        "reloType=%x\n",
...
TR::Instruction *
generateRegLitRefInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *node, TR::Register *treg,
        TR::Snippet *snippet, TR::RegisterDependencyConditions *cond, TR::Instruction *preced, TR::Register *base)
{
...
TR::Instruction *
generateRegLitRefInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *node, TR::Register *treg,
        int64_t imm, TR::RegisterDependencyConditions *cond, TR::Instruction *preced, TR::Register *base,
        bool isPICCandidate)
{
	bool alloc = false;
	TR::Instruction *cursor;
	...
	if (comp->getOption(TR_EnableHCR) && isPICCandidate) {
		...
		if (node->isClassUnloadingConst()) {
			...
			if (isMethod) {
				unloadableClass = (TR_OpaqueClassBlock *)cg->fe()
				                          ->createResolvedMethod(cg->trMemory(),
				                                  (TR_OpaqueMethodBlock *)imm, comp->getCurrentMethod())
				                          ->classOfMethod();
				if (!TR::Compiler->cls.sameClassLoaders(
				            comp, unloadableClass, comp->getCurrentMethod()->classOfMethod()))
					comp->getMethodSnippetsToBePatchedOnClassUnload()->push_front(targetsnippet);
...
TR::Instruction *
generateRegLitRefInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *node, TR::Register *treg,
        uintptrj_t imm, TR::RegisterDependencyConditions *cond, TR::Instruction *preced, TR::Register *base,
        bool isPICCandidate)
{
	if (TR::Compiler->target.is64Bit()) {
...
TR::Instruction *
generateRegLitRefInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *node, TR::Register *treg,
        float imm, TR::Instruction *preced)
{
...
TR::Instruction *
generateRegLitRefInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *node, TR::Register *treg,
        double imm, TR::Instruction *preced)
{
 ...
 */
TR::Instruction *
generateRegUnresolvedSym(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *node, TR::Register *treg,
        TR::SymbolReference *symRef, TR::UnresolvedDataSnippet *uds, TR::Instruction *preced)
{
...
TR::Instruction *
generateEXDispatch(TR::Node *node, TR::CodeGenerator *cg, TR::Register *maskReg, TR::Register *useThisLitPoolReg,
...
TR::Instruction *
generateEXDispatch(TR::Node *node, TR::CodeGenerator *cg, TR::Register *maskReg, TR::Instruction *instr,
        TR::Instruction *preced, TR::RegisterDependencyConditions *deps)
{
...
TR::Instruction *
generateS390EInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *tgt,
...
TR::Instruction *
generateRuntimeInstrumentationInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *node,
...
TR::Instruction *
generateS390IEInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, uint8_t im1, uint8_t im2, TR::Node *n,
        TR::Instruction *preced)
{
	if (preced) {
 ...
 */
TR::Instruction *
generateReplicateNodeInVectorReg(TR::Node *node, TR::CodeGenerator *cg, TR::Register *targetVRF,
        TR::Node *srcElementNode, int elementSize, TR::Register *zeroReg, TR::Instruction *preced)
{
	...
	if (srcElementNode->getOpCode().isLoadConst()) {
		...
		} else if (srcElementNode->getIntegerNodeValue<uint64_t>() <= (uint64_t)(uint16_t)(-1)) // if source is
		                                                                                        // integral
		                                                                                        // loadconst
		                                                                                        // with value <=
		                                                                                        // max uint16_t
	...
	} else // old fall back method
	{
		...
		if (srcElementNode->getDataType() == TR::Double) {
			...
			if (srcReg->getRegisterPair() != NULL) {
				if (mask == 3) {
					generateVRSbInstruction(cg, TR::InstOpCode::VLVG, node, targetVRF,
					        srcReg->getHighOrder(), generateS390MemoryReference(zeroReg, 0, cg), 2);
					generateVRSbInstruction(cg, TR::InstOpCode::VLVG, node, targetVRF,
					        srcReg->getLowOrder(), generateS390MemoryReference(zeroReg, 1, cg), 2);
				} else
					generateVRSbInstruction(cg, TR::InstOpCode::VLVG, node, targetVRF,
					        srcReg->getLowOrder(), generateS390MemoryReference(zeroReg, 0, cg),
					        mask);
			} else
 ...
 */
void
generateShiftAndKeepSelected64Bit(TR::Node *node, TR::CodeGenerator *cg, TR::Register *aFirstRegister,
        ...
        bool aSetConditionCode)
{
	if (TR::Compiler->target.cpu.getSupportsArch(TR::CPU::zEC12) && !aSetConditionCode) {
		...
		generateRSInstruction(cg, TR::InstOpCode::SLLG, node, aFirstRegister, aFirstRegister,
 ...
 */
void
generateShiftAndKeepSelected31Bit(TR::Node *node, TR::CodeGenerator *cg, TR::Register *aFirstRegister,
        TR::Register *aSecondRegister, int aFromBit, int aToBit, int aShiftAmount, bool aClearOtherBits,
        bool aSetConditionCode)
{
	if (TR::Compiler->target.cpu.getSupportsArch(TR::CPU::z196)) {
		...
		generateRSInstruction(
		        cg, TR::InstOpCode::SLL, node, aFirstRegister, (31 - aToBit) + aShiftAmount + aFromBit);
		generateRSInstruction(cg, TR::InstOpCode::SRL, node, aFirstRegister, aFromBit);
	}
}

TR::Instruction *
generateZeroVector(TR::Node *node, TR::CodeGenerator *cg, TR::Register *vecZeroReg)
{
...
canThrowDecimalOverflowException(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op)
{
	...
	case TR::InstOpCode::VCVBG: return !cg->getIgnoreDecimalOverflowException();
	default: return false;
	}
}

void
generateS390DAAExceptionRestoreSnippet(
        TR::CodeGenerator *cg, TR::Node *n, TR::Instruction *instr, TR::InstOpCode::Mnemonic op, bool hasNOP)
{
	...
	if (BCDCHKNode && BCDCHKNode->getOpCodeValue() == TR::BCDCHK) {
		...
		// there might be cases that two or more insts generated will throw exception, and we only need one of
		// the label. so we will assume that at this moment the second child of BCDCHKNode is the label.
		...
		TR::S390RestoreGPR7Snippet *restoreSnippet = new (INSN_HEAP)
		        TR::S390RestoreGPR7Snippet(cg, n, restoreGPR7SnippetHandler, handlerLabel);
		...
		generateS390BranchInstruction(
		        cg, TR::InstOpCode::BRC, TR::InstOpCode::COND_NOP, n, restoreGPR7SnippetHandler);
		generateS390BranchInstruction(cg, TR::InstOpCode::BRC, bc, n, handlerLabel);

		// generate register deps so that we will not see spills between the instruction and the following
		// branch
