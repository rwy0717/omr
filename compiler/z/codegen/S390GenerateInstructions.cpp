    ...
    bool targetIsFarAndCold)
{
    ...
    if (!cg->comp()->getOption(TR_DisableCompareAndBranchInstruction) && !needsCC && replacementOpCode != TR::InstOpCode::BAD && cg->getS390ProcessorInfo()->supportsArch(TR_S390ProcessorInfo::TR_zEC12)) {
