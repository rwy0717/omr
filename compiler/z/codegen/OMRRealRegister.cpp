...
bool OMR::Z::RealRegister::isHighWordRegister() { return self() == self()->getHighWordRegister(); }

bool OMR::Z::RealRegister::isLowWordRegister() { return self() == self()->getLowWordRegister(); }
...
// static method
bool OMR::Z::RealRegister::isPseudoRealReg(RegNum reg) { return (reg < FirstGPR || reg > LastHPR); }

// static method
bool OMR::Z::RealRegister::isRealReg(RegNum reg) { return (reg >= FirstGPR && reg <= LastHPR); }
