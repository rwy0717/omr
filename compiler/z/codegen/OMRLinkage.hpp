 ...
 */
inline TR::S390PrivateLinkage* toS390PrivateLinkage(TR::Linkage* l) { return (TR::S390PrivateLinkage*)l; }
...
public:
    enum FrameType {
        ...
        noStackLeafFrame,
        StackLeafFrame,
        noStackForwardingFrame, ///< This method may have a single call that forwards on to another method that can be
                                ///< replaced by a jmp
    };
...
public:
    virtual bool findPossibleCallInstruction(TR::Instruction*& cursor, int32_t& numToCheck,
        TR::Instruction** callInstruction, bool* regs = 0, int32_t regsSize = 0);
...
public:
    ...
    virtual TR::RealRegister::RegNum setExtCodeBaseRegister(TR::RealRegister::RegNum r)
    {
        return TR::RealRegister::GPR7;
    }
