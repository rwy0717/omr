...
////////////////////////////////////////////////////////////////////////////////
bool TR_S390ProcessorInfo::checkz900() { return TR::Compiler->target.cpu.getS390SupportsZ900(); }

////////////////////////////////////////////////////////////////////////////////
// TR_S390ProcessorInfo::checkz990: returns true if it's Trex, otherwise false.
////////////////////////////////////////////////////////////////////////////////
bool TR_S390ProcessorInfo::checkz990() { return TR::Compiler->target.cpu.getS390SupportsZ990(); }
...
////////////////////////////////////////////////////////////////////////////////
bool TR_S390ProcessorInfo::checkz10() { return TR::Compiler->target.cpu.getS390SupportsZ10(); }

////////////////////////////////////////////////////////////////////////////////
// TR_S390ProcessorInfo::checkz196: returns true if it's zGryphon, otherwise false.
////////////////////////////////////////////////////////////////////////////////
bool TR_S390ProcessorInfo::checkz196() { return TR::Compiler->target.cpu.getS390SupportsZ196(); }

////////////////////////////////////////////////////////////////////////////////
// TR_S390ProcessorInfo::checkzEC12: returns true if it's zHelix, otherwise false.
////////////////////////////////////////////////////////////////////////////////
bool TR_S390ProcessorInfo::checkzEC12() { return TR::Compiler->target.cpu.getS390SupportsZEC12(); }

////////////////////////////////////////////////////////////////////////////////
// TR_S390ProcessorInfo::checkZ13: returns true if it's z13, otherwise false.
////////////////////////////////////////////////////////////////////////////////
bool TR_S390ProcessorInfo::checkZ13() { return TR::Compiler->target.cpu.getS390SupportsZ13(); }

////////////////////////////////////////////////////////////////////////////////
// TR_S390ProcessorInfo::checkZ14: returns true if it's z14, otherwise false.
////////////////////////////////////////////////////////////////////////////////
bool TR_S390ProcessorInfo::checkZ14() { return TR::Compiler->target.cpu.getS390SupportsZ14(); }

////////////////////////////////////////////////////////////////////////////////
// TR_S390ProcessorInfo::checkZNext: returns true if it's zNext, otherwise false.
////////////////////////////////////////////////////////////////////////////////
bool TR_S390ProcessorInfo::checkZNext() { return TR::Compiler->target.cpu.getS390SupportsZNext(); }
    ...
    , _previouslyAssignedTo(self()->comp()->allocator("LocalRA"))
{
    ...
    if (!(self()->getS390ProcessorInfo()->supportsArch(TR_S390ProcessorInfo::TR_z13)
    ...
    if (comp->getOptions()->getRegisterAssignmentTraceOption(TR_TraceRARegisterStates)) {
        ...
        self()->setHPRegisterIterator(new (self()->trHeapMemory())
                TR::RegisterIterator(self()->machine(), TR::RealRegister::FirstHPR, TR::RealRegister::LastHPR));
...
TR_GlobalRegisterNumber OMR::Z::CodeGenerator::getGlobalHPRFromGPR(TR_GlobalRegisterNumber n)
{
...
TR_GlobalRegisterNumber OMR::Z::CodeGenerator::getGlobalGPRFromHPR(TR_GlobalRegisterNumber n)
{
        ...
        if (!self()->comp()->getOption(TR_DisableRegisterPressureSimulation)) {
            ...
            for (grn = 0; grn < self()->getNumberOfGlobalRegisters(); grn++) {
                ...
                if (linkage->getIntegerArgument(reg) || linkage->getFloatArgument(reg)) {
                    if ((enableHighWordGRA)
                        && (grn >= self()->getFirstGlobalGPR() && grn <= self()->getLastGlobalGPR())) {
...
TR::S390PrivateLinkage* OMR::Z::CodeGenerator::getS390PrivateLinkage()
{
    return TR::toS390PrivateLinkage(self()->getLinkage());
}
...
{
    if (self()->use64BitRegsOn32Bit() && TR::Compiler->target.is32Bit() && reg->getKind() == TR_GPR)
...
bool OMR::Z::CodeGenerator::isLitPoolFreeForAssignment()
{
    ...
    } else if (self()->getS390ProcessorInfo()->supportsArch(TR_S390ProcessorInfo::TR_z10)
...
TR::Instruction* OMR::Z::CodeGenerator::upgradeToHPRInstruction(TR::Instruction* inst)
{
    ...
    if (s390Inst->getOpCode().is64bit() || (targetReg && targetReg->is64BitReg()) || (srcReg && srcReg->is64BitReg())) {
        return NULL;
    }
    ...
    if (targetUpgradable) {
        ...
        case TR::InstOpCode::BRCT:
            ...
            newInst = generateS390BranchInstruction(self(), TR::InstOpCode::BRCTH, node, targetReg,
                ((TR::S390LabeledInstruction*)inst)->getLabelSymbol(), inst->getPrev());
            targetReg->decTotalUseCount();
            break;
        ...
        case TR::InstOpCode::LR:
            ...
            newInst
                = generateExtendedHighWordInstruction(node, self(), newOpCode, targetReg, srcReg, 0, inst->getPrev());
            targetReg->decTotalUseCount();
            srcReg->decTotalUseCount();
            break;
        ...
        case TR::InstOpCode::LHI:
         ...
         case TR::InstOpCode::NR:
            ...
            newInst = generateExtendedHighWordInstruction(node, self(), newOpCode, targetReg, srcReg, 0,
         inst->getPrev()); targetReg->decTotalUseCount(); srcReg->decTotalUseCount(); break; case TR::InstOpCode::OR: if
         (srcUpgradable)
               {
            ...
            newInst = generateExtendedHighWordInstruction(node, self(), newOpCode, targetReg, srcReg, 0,
         inst->getPrev()); targetReg->decTotalUseCount(); srcReg->decTotalUseCount(); break; case TR::InstOpCode::XR: if
         (srcUpgradable)
               {
            ...
            newInst = generateExtendedHighWordInstruction(node, self(), newOpCode, targetReg, srcReg, 0,
         inst->getPrev()); targetReg->decTotalUseCount(); srcReg->decTotalUseCount(); break;
            --------------*/
        ...
        case TR::InstOpCode::LLHR:
         ...
         case TR::InstOpCode::NR:
            ...
            newInst = generateExtendedHighWordInstruction(node, self(), newOpCode, targetReg, srcReg, 0,
         inst->getPrev()); targetReg->decTotalUseCount(); srcReg->decTotalUseCount(); break; case TR::InstOpCode::OR:
            newOpCode = TR::InstOpCode::OLHR;
            newInst = generateExtendedHighWordInstruction(node, self(), newOpCode, targetReg, srcReg, 0,
         inst->getPrev()); targetReg->decTotalUseCount(); srcReg->decTotalUseCount(); break; case TR::InstOpCode::XR:
...
void OMR::Z::CodeGenerator::doRegisterAssignment(TR_RegisterKinds kindsToAssign)
{
    ...
    self()->machine()->allocateUpgradedBlockedList(new (self()->comp()->trStackMemory())
            TR_Stack<TR::RealRegister*>(self()->comp()->trMemory(), 16, true, stackAlloc));
         ...
         */
            ...
            for (int32_t i = first; i <= last; i++) {
                ...
                if (realReg->getState() == TR::RealRegister::Free
                    && realReg->getHighWordRegister()->getState() == TR::RealRegister::Free) {
...
void OMR::Z::CodeGenerator::doBinaryEncoding()
{
    ...
    TR_HashTab* branchHashTable
        = new (self()->trStackMemory()) TR_HashTab(self()->comp()->trMemory(), stackAlloc, 60, true);
...
int32_t OMR::Z::CodeGenerator::getMaximumNumberOfGPRsAllowedAcrossEdge(TR::Node* node)
{
    ...
    if (node->getOpCode().isSwitch()) {
        ...
        if (node->getSecondChild()->getOpCode().isLoadConst()) {
            ...
            if (self()->getS390ProcessorInfo()->supportsArch(TR_S390ProcessorInfo::TR_zEC12)
    ...
    if (!self()->canClobberNodesRegister(node, 1, &data, ignoreRefCount) || force_copy) {
        ...
        if (TR::Compiler->target.is32Bit() && !self()->use64BitRegsOn32Bit() && node->getType().isInt64()) {
            ...
            TR::RegisterPair* tempRegPair
                = allocatePair ? self()->allocateConsecutiveRegisterPair(lowRegister, highRegister) : trgRegPair;
            if (!data.canClobberLowWord()) {
                cursor = generateRRInstruction(
                    self(), TR::InstOpCode::LR, node, tempRegPair->getLowOrder(), trgRegPair->getLowOrder());
                if (debugObj) {
            ...
            if (!data.canClobberHighWord()) {
                cursor = generateRRInstruction(
                    self(), TR::InstOpCode::LR, node, tempRegPair->getHighOrder(), trgRegPair->getHighOrder());
                if (debugObj) {
                    debugObj->addInstructionComment(toS390RRInstruction(cursor), CLOBBER_EVAL);
                }
            }
        ...
        for (int32_t i = TR::RealRegister::FirstHPR; i <= TR::RealRegister::LastHPR; i++) {
            ...
            if (realReg->getHasBeenAssignedInMethod()) {
                ...
                if (virtReg && virtReg->containsCollectedReference() && virtReg->getAssignedRegister() == NULL) {
                    // 2 bits per register, '10' means HPR has collectible, '11' means both HPR and GPR have
                    // collectibles
...
bool OMR::Z::CodeGenerator::isAddressOfStaticSymRefWithLockedReg(TR::SymbolReference* symRef) { return false; }

bool OMR::Z::CodeGenerator::isAddressOfPrivateStaticSymRefWithLockedReg(TR::SymbolReference* symRef) { return false; }
    ...
    TR::Node* node, TR::Register* targetRegister, TR::Register* srcRegister, uint32_t numberOfBits)
{
    ...
    case 48:
        TR_ASSERT(TR::Compiler->target.is64Bit() || srcRegister->getKind() == TR_GPR64,
 ...
 */
bool OMR::Z::CodeGenerator::inlineNDmemcpyWithPad(TR::Node* node, int64_t* maxLengthPtr) { return false; }
