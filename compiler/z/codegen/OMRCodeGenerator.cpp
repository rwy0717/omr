...
////////////////////////////////////////////////////////////////////////////////
bool TR_S390ProcessorInfo::checkZ14()
{
...
////////////////////////////////////////////////////////////////////////////////
bool TR_S390ProcessorInfo::checkZNext()
{
...
void OMR::Z::CodeGenerator::doBinaryEncoding()
{
    ...
    while (data.cursorInstruction) {
        ...
        if (data.cursorInstruction->isBranchOp()) {
            ...
            if (data.cursorInstruction->getKind() == TR::Instruction::IsRIE && (toS390RIEInstruction(data.cursorInstruction)->getRieForm() == TR::S390RIEInstruction::RIE_RR || toS390RIEInstruction(data.cursorInstruction)->getRieForm() == TR::S390RIEInstruction::RIE_RI8)) {
    ...
    if (node->getOpCode().isSwitch()) {
        ...
        if (node->getSecondChild()->getOpCode().isLoadConst()) {
            ...
            } else // 32bit
            {
                ...
                if ((valueHigh >= MIN_IMMEDIATE_VAL && valueHigh <= MAX_IMMEDIATE_VAL) && (valueLow >= MIN_IMMEDIATE_VAL && valueLow <= MAX_IMMEDIATE_VAL)) {
...
bool OMR::Z::CodeGenerator::isAddressOfStaticSymRefWithLockedReg(TR::SymbolReference* symRef)
{
    return false;
}

bool OMR::Z::CodeGenerator::isAddressOfPrivateStaticSymRefWithLockedReg(TR::SymbolReference* symRef)
{
    return false;
}
...
bool OMR::Z::CodeGenerator::isActiveCompareCC(TR::InstOpCode::Mnemonic opcd, TR::Register* tReg, TR::Register* sReg)
{
    if (self()->hasCCInfo() && self()->hasCCCompare()) {
        ...
        if (self()->getS390ProcessorInfo()->supportsArch(TR_S390ProcessorInfo::TR_z10) && !self()->getS390ProcessorInfo()->supportsArch(TR_S390ProcessorInfo::TR_z196)) {
