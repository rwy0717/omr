...
public:
	S390BranchInstruction(TR::InstOpCode::Mnemonic op, TR::InstOpCode::S390BranchCondition branchCondition,
	        TR::Node *n, TR::LabelSymbol *sym, TR::CodeGenerator *cg)
	        : S390LabeledInstruction(op, n, sym, cg), _branchCondition(branchCondition)
	{}

	S390BranchInstruction(TR::InstOpCode::Mnemonic op, TR::InstOpCode::S390BranchCondition branchCondition,
	        TR::Node *n, TR::LabelSymbol *sym, TR::RegisterDependencyConditions *cond, TR::CodeGenerator *cg)
	        : S390LabeledInstruction(op, n, sym, cond, cg), _branchCondition(branchCondition)
	{}

	S390BranchInstruction(TR::InstOpCode::Mnemonic op, TR::InstOpCode::S390BranchCondition branchCondition,
	        TR::Node *n, TR::LabelSymbol *sym, TR::Instruction *precedingInstruction, TR::CodeGenerator *cg)
	        : S390LabeledInstruction(op, n, sym, precedingInstruction, cg), _branchCondition(branchCondition)
	{}

	S390BranchInstruction(TR::InstOpCode::Mnemonic op, TR::InstOpCode::S390BranchCondition branchCondition,
	        TR::Node *n, TR::LabelSymbol *sym, TR::RegisterDependencyConditions *cond,
	        TR::Instruction *precedingInstruction, TR::CodeGenerator *cg)
	        : S390LabeledInstruction(op, n, sym, cond, precedingInstruction, cg), _branchCondition(branchCondition)
	{}

	S390BranchInstruction(TR::InstOpCode::Mnemonic op, TR::InstOpCode::S390BranchCondition branchCondition,
	        TR::Node *n, TR::Snippet *s, TR::CodeGenerator *cg)
	        : S390LabeledInstruction(op, n, s, cg), _branchCondition(branchCondition)
	{}

	S390BranchInstruction(TR::InstOpCode::Mnemonic op, TR::InstOpCode::S390BranchCondition branchCondition,
	        TR::Node *n, TR::Snippet *s, TR::RegisterDependencyConditions *cond, TR::CodeGenerator *cg)
	        : S390LabeledInstruction(op, n, s, cond, cg), _branchCondition(branchCondition)
	{}

	S390BranchInstruction(TR::InstOpCode::Mnemonic op, TR::InstOpCode::S390BranchCondition branchCondition,
	        TR::Node *n, TR::Snippet *s, TR::Instruction *precedingInstruction, TR::CodeGenerator *cg)
	        : S390LabeledInstruction(op, n, s, precedingInstruction, cg), _branchCondition(branchCondition)
	{}

	S390BranchInstruction(TR::InstOpCode::Mnemonic op, TR::InstOpCode::S390BranchCondition branchCondition,
	        TR::Node *n, TR::Snippet *s, TR::RegisterDependencyConditions *cond,
	        TR::Instruction *precedingInstruction, TR::CodeGenerator *cg)
	        : S390LabeledInstruction(op, n, s, cond, precedingInstruction, cg), _branchCondition(branchCondition)
	{}
...
public:
	S390VirtualGuardNOPInstruction(TR::Node *node, TR_VirtualGuardSite *site,
	        TR::RegisterDependencyConditions *cond, TR::LabelSymbol *label, TR::CodeGenerator *cg)
	        : S390BranchInstruction(TR::InstOpCode::BRC, TR::InstOpCode::COND_VGNOP, node, label, cond, cg)
	        , _site(site)
	{}

	S390VirtualGuardNOPInstruction(TR::Node *node, TR_VirtualGuardSite *site,
	        TR::RegisterDependencyConditions *cond, TR::LabelSymbol *label, TR::Instruction *precedingInstruction,
	        TR::CodeGenerator *cg)
...
public:
	...
	S390BranchOnIndexInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *sourceReg,
	        TR::Register *targetReg, TR::LabelSymbol *sym, TR::Instruction *precedingInstruction,
	        TR::CodeGenerator *cg)
	        : S390LabeledInstruction(op, n, sym, precedingInstruction, cg)
	{
		useTargetRegister(targetReg);
...
public:
	...
	/**
	 * A real register must only be assigned for DCB to use if it is guaranteed to be free at the cursor position
	 * where DCB is inserted
...
public:
	...
	S390AnnotationInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n, int16_t regionNum, int32_t statementNum,
	        int32_t flags, bool printNumber, char *annotation, TR::Instruction *precedingInstruction,
	        TR::CodeGenerator *cg)
	        : TR::Instruction(op, n, precedingInstruction, cg)
...
public:
	S390ImmSnippetInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n, uint32_t imm, TR::UnresolvedDataSnippet *us,
	        ...
	        : S390ImmInstruction(op, n, imm, cg), _unresolvedSnippet(us), _snippet(s)
	{}

	S390ImmSnippetInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n, uint32_t imm, TR::UnresolvedDataSnippet *us,
	        TR::Snippet *s, TR::Instruction *precedingInstruction, TR::CodeGenerator *cg)
	        : S390ImmInstruction(op, n, imm, precedingInstruction, cg), _unresolvedSnippet(us), _snippet(s)
	{}
...
public:
	        ...
	        : TR::Instruction(op, n, cg), _branchCondition(TR::InstOpCode::COND_NOP), _firstConstant(-1)
	{
		...
		// ShouldUseRegPairForTarget returns true for those instructions that require consequtive even-odd
		// register pairs. CanUseRegPairForTarget returns true for all the above instructions + STM/LTM (which
		// can potentially take a register pair range).

		// So, if we find a register pair passed in, we check to make sure the instruction CAN use a register
		// pair. If we do not find a register pair, we check to make sure the instruction SHOULD NOT use a
		// register pair.
	...
	//   } TR::Register  *setTargetRegister(TR::Register *r) {assume0(_targetRegSize != 0); return
	//   (targetRegBase())[0] = r;}
...
public:
	...
	//   TR::Register  *getSourceRegister()                {return (_sourceRegSize!=0) ? (sourceRegBase())[0] :
	//   NULL;  } TR::Register  *setSourceRegister(TR::Register *sr) { (sourceRegBase())[0] = sr; return sr; }
...
public:
	...
	//   TR::Register *setTableRegister(TR::Register* tableReg)        {return (sourceRegBase())[tr_tblidx] =
	//   tableReg;}
...
public:
	...
	S390RRFInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *treg, TR::Register *sreg,
	        uint8_t mask, bool isMask3, TR::CodeGenerator *cg)
	        : S390RRInstruction(op, n, treg, sreg, cg)
	        , _encodeAsRRD(false)
	...
	S390RRFInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *treg, TR::Register *sreg,
	        uint8_t mask, bool isMask3, TR::RegisterDependencyConditions *cond, TR::CodeGenerator *cg)
	...
	S390RRFInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *treg, TR::Register *sreg,
	        uint8_t mask3, uint8_t mask4, TR::CodeGenerator *cg)
	        : S390RRInstruction(op, n, treg, sreg, cg)
	        , _mask3(mask3)
	        , _mask4(mask4)
	        , _encodeAsRRD(false)
...
public:
	...
	S390RIInstruction(
	        TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *treg, char *data, TR::CodeGenerator *cg)
	...
	S390RIInstruction(
	        TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *treg, int32_t imm, TR::CodeGenerator *cg)
...
public:
	...
	S390RILInstruction(
	        TR::InstOpCode::Mnemonic op, TR::Node *n, uint32_t mask, void *targetPtr, TR::CodeGenerator *cg)
	        : TR::Instruction(op, n, cg)
	        , _targetPtr(targetPtr)
	        , _targetSnippet(NULL)
	        , _targetSymbol(NULL)
	...
	S390RILInstruction(
	        TR::InstOpCode::Mnemonic op, TR::Node *n, uint32_t mask, TR::Snippet *ts, TR::CodeGenerator *cg)
	        : TR::Instruction(op, n, cg)
	        , _targetPtr(NULL)
	        , _targetSnippet(ts)
	        , _targetSymbol(NULL)
	...
	//   TR::Register  *getTargetRegister()               { return (_targetRegSize!=0) ? (targetRegBase())[0] :
	//   NULL;} TR::Register  *setTargetRegister(TR::Register *r) { assume0(_targetRegSize!=0); (targetRegBase())[0]
	//   = r; return r; }
	bool matchesTargetRegister(TR::Register *reg)
	{
		TR::RealRegister *realReg = NULL;
...
protected:
	...
	/// Set to true if a mask value was specified during the construction of this object, indicating an RS
...
public:
	...
	{
		// 1 Register is specified - If it is not a register pair, make sure instruction doesn't take a range
		// (i.e. STM).
	...
	S390RSInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *treg, uint32_t imm,
	        TR::RegisterDependencyConditions *_conditions, TR::Instruction *precedingInstruction,
	        TR::CodeGenerator *cg)
	...
	S390RSInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *treg, TR::Register *sreg,
...
public:
	...
	S390RSWithImplicitPairStoresInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n, TR::RegisterPair *regp,
	        TR::RegisterPair *regp2, TR::MemoryReference *mf, TR::Instruction *precedingInstruction,
	        TR::CodeGenerator *cg)
...
public:
	...
	S390RIEInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *targetRegister,
	        int8_t sourceImmediate, TR::LabelSymbol *branchDestination,
	        TR::InstOpCode::S390BranchCondition branchCondition, TR::CodeGenerator *cg)
	        : S390RegInstruction(op, n, targetRegister, cg)
	...
	S390RIEInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *targetRegister,
	        TR::Register *sourceRegister, int8_t sourceImmediateOne, int8_t sourceImmediateTwo,
	...
	S390RIEInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *targetRegister,
	        TR::Register *sourceRegister, int8_t sourceImmediateOne, int8_t sourceImmediateTwo,
	        int8_t sourceImmediate, TR::Instruction *precedingInstruction, TR::CodeGenerator *cg)
	        : S390RegInstruction(op, n, targetRegister, precedingInstruction, cg)
	        , _instructionFormat(RIE_IMM)
	        , _branchDestination(0)
	        , _branchCondition(TR::InstOpCode::COND_NOPR)
	...
	S390RIEInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *targetRegister,
	        int16_t sourceImmediate, TR::InstOpCode::S390BranchCondition branchCondition, TR::CodeGenerator *cg)
	        : S390RegInstruction(op, n, targetRegister, cg)
	...
	S390RIEInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *targetRegister,
	        int16_t sourceImmediate, TR::InstOpCode::S390BranchCondition branchCondition,
	        TR::Instruction *precedingInstruction, TR::CodeGenerator *cg)
	        : S390RegInstruction(op, n, targetRegister, precedingInstruction, cg)
	        , _instructionFormat(RIE_RI16A)
	        , _branchDestination(0)
	...
	//   virtual void setSourceRegister(TR::Register * reg) { assume0(_sourceRegSize==1); (sourceRegBase())[0] =
	//   reg; }
...
public:
	...
	{}
	S390MIIInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n, uint8_t mask, TR::LabelSymbol *inst2,
	        TR::SymbolReference *inst3, TR::RegisterDependencyConditions *cond,
	        TR::Instruction *precedingInstruction, TR::CodeGenerator *cg)
	        : TR::Instruction(op, n, cond, precedingInstruction, cg)
	        , _mask(mask)
	        , _callSymRef(inst3)
...
public:
	...
	S390RISInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *targetRegister,
	        int8_t sourceImmediate, TR::MemoryReference *branchDestination,
	        TR::InstOpCode::S390BranchCondition branchCondition, TR::CodeGenerator *cg)
...
public:
	S390MemMemInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n, TR::MemoryReference *mf1,
...
public:
	S390SS1WithImplicitGPRsInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n, uint16_t len,
	...
	S390SS1WithImplicitGPRsInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n, uint16_t len,
	        TR::MemoryReference *mf1, TR::MemoryReference *mf2, TR::RegisterDependencyConditions *cond,
	        TR::Instruction *precedingInstruction, TR::Register *implicitRegSrc0, TR::Register *implicitRegSrc1,
	        TR::Register *implicitRegTrg0, TR::Register *implicitRegTrg1, TR::CodeGenerator *cg)
...
public:
	S390SS2Instruction(TR::InstOpCode::Mnemonic op, TR::Node *n, uint16_t len1, TR::MemoryReference *mf1,
	        uint16_t len2, TR::MemoryReference *mf2, TR::CodeGenerator *cg)
	        : S390SS1Instruction(op, n, len1, mf1, mf2, cg), _len2(len2), _shiftAmount(0)
	{}

	S390SS2Instruction(TR::InstOpCode::Mnemonic op, TR::Node *n, uint16_t len1, TR::MemoryReference *mf1,
	        uint16_t len2, TR::MemoryReference *mf2, TR::Instruction *precedingInstruction, TR::CodeGenerator *cg)
...
public:
	        ...
	        : S390SS4Instruction(op, n, op1, mf2, mf4, op3, cg)
	{
		...
		if (implicitRegSrc1 != NULL)
			useSourceRegister(implicitRegSrc1);
		// Because op1 and op3 are source registers let all source registers be first. Infrastructure can handle
		// target after source but as long as they are contiguous
		if (implicitRegTrg0 != NULL)
			useTargetRegister(implicitRegTrg0);
		if (implicitRegTrg1 != NULL)
			useTargetRegister(implicitRegTrg1);
		// The first 2 (explictSourceRegSize) register operands are in place followed by the up to two memory
		// operands Move all the added implicit registers adjacents to the first two register operands
...
protected:
	S390VRIInstruction(TR::CodeGenerator *cg = NULL, TR::InstOpCode::Mnemonic op = TR::InstOpCode::BAD,
	        TR::Node *n = NULL, TR::Register *targetReg = NULL, uint16_t constantImm16 = 0,
	        uint8_t constantImm8 = 0, uint8_t m3 = 0, /*  4 bits (28 - 31 bit) */
	        uint8_t m4 = 0, /*  4 bits (28 - 31 bit) */
	        uint8_t m5 = 0) /*  4 bits (32 - 35 bit) */
	        : S390VInstruction(cg, op, n, targetReg), _constantImm16(constantImm16), _constantImm8(constantImm8)
	{
		_mask3 = m3;
		_mask4 = m4;
		_mask5 = m5;
...
public:
	S390VRRbInstruction(TR::CodeGenerator *cg = NULL, TR::InstOpCode::Mnemonic op = TR::InstOpCode::BAS,
	        TR::Node *n = NULL, TR::Register *targetReg = NULL, TR::Register *sourceReg2 = 0,
	        TR::Register *sourceReg3 = 0, uint8_t mask5 = 0, /* 4 bits */
	        uint8_t mask4 = 0) /* 4 bits */
...
public:
	S390VSIInstruction(TR::CodeGenerator *cg = NULL, TR::InstOpCode::Mnemonic op = TR::InstOpCode::BAD,
	        TR::Node *n = NULL, TR::Register *v1Reg = NULL, TR::MemoryReference *memRef = NULL,
	...
	S390VSIInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *v1Reg,
	        ...
	        : S390VStorageInstruction(cg, op, n, v1Reg, NULL, memRef, 0, preced), _constantImm3(constantImm3)
	{}
...
public:
	S390EInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n, TR::CodeGenerator *cg) : TR::Instruction(op, n, cg)
	{
		setBinaryLength(2);
		setEstimatedBinaryLength(2);
	}
