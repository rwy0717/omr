...
const OMR::ILValidationStrategy OMR::postILgenValidatonStrategy[] = {{OMR::soundnessRule}, {OMR::validateChildCount},
        {OMR::validateChildTypes}, {OMR::validateLivenessBoundaries}, {OMR::validateNodeRefCountWithinBlock},
        {OMR::endRules}};
 ...
 */
const OMR::ILValidationStrategy OMR::preCodegenValidationStrategy[] = {{OMR::soundnessRule}, {OMR::validateChildCount},
        {OMR::validateChildTypes}, {OMR::validateLivenessBoundaries}, {OMR::validateNodeRefCountWithinBlock},
        {OMR::validate_ireturnReturnType}, {OMR::endRules}};
