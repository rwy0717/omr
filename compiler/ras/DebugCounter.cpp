...
intptrj_t TR::DebugCounter::getBumpCountAddress() { return (intptrj_t)&_bumpCount; }
...
intptrj_t TR::DebugCounterAggregation::getBumpCountAddress() { return (intptrj_t)&_bumpCount; }
