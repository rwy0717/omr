...
bool TR_Debug::methodSigCanBeCompiled(const char* methodSig, TR_FilterBST*& filter, TR_Method::Type methodType)
{
...
bool TR_Debug::methodSigCanBeFound(const char* methodSig, TR::CompilationFilters* filters, TR_FilterBST*& filter, TR_Method::Type methodType)
{
...
bool TR_Debug::methodSigCanBeCompiledOrRelocated(const char* methodSig, TR_FilterBST*& filter, bool loadLimit, TR_Method::Type methodType)
{
