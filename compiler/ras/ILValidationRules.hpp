...
public:
	MethodValidationRule(TR::Compilation *comp, OMR::ILValidationRule id) : _comp(comp), _id(id) {}
	/**
...
private:
	void checkNodeSoundness(TR::TreeTop *location, TR::Node *node, TR::NodeChecklist &ancestorNodes,
...
public:
	BlockValidationRule(TR::Compilation *comp, OMR::ILValidationRule id) : _comp(comp), _id(id) {}
	/**
	 * @return returns on success.
	 */
...
public:
	NodeValidationRule(TR::Compilation *comp, OMR::ILValidationRule id) : _comp(comp), _id(id) {}
	/**
	 * @return returns on success.
	 */
