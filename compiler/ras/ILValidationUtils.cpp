...
TR::LiveNodeWindow::LiveNodeWindow(NodeSideTable<NodeState> &sideTable, TR_Memory *memory)
        : _sideTable(sideTable), _basis(0), _liveOffsets(10, memory, stackAlloc, growable)
{}
...
void
TR::checkILCondition(TR::Node *node, bool condition, TR::Compilation *comp, const char *formatStr, ...)
{
	if (!condition) {
