...
static const char* commonNonhelperSymbolNames[] = { "<contiguousArraySize>", "<discontiguousArraySize>",
    ...
    "<isClassAndDepthFlags>", "<initializeStatusFromClass>", "<isClassFlags>", "<vft>", "<currentThread>",
    ...
    "<currentTimeMaxPrecision>", "<headerFlags>", "<singlePrecisionSQRT>", "<threadPrivateFlags>",
    ...
    "<potentialOSRPointHelper>", "<osrFearPointHelper>", "<lowTenureAddress>", "<highTenureAddress>",
    "<fragmentParent>", "<globalFragment>", "<instanceShape>", "<instanceDescription>", "<descriptionWordFromPtr>",
    "<classFromJavaLangClassAsPrimitive>", "<javaVM>", "<heapBase>", "<heapTop>", "<j9methodExtraField>",
    "<j9methodConstantPoolField>", "<startPCLinkageInfo>", "<instanceShapeFromROMClass>", "<synchronizedFieldLoad>",
    "<atomicAdd32Bit>", "<atomicAdd64Bit>", "<atomicFetchAndAdd32Bit>", "<atomicFetchAndAdd64Bit>", "<atomicSwap32Bit>",
    "<atomicSwap64Bit>", "<atomicCompareAndSwap32Bit>", "<atomicCompareAndSwap64Bit>", "<pythonFrame_CodeObject>",
    "<pythonFrame_FastLocals>", "<pythonFrame_Globals>", "<pythonFrame_Builtins>", "<pythonCode_Constants>",
    "<pythonCode_NumLocals>", "<pythonCode_Names>", "<pythonObject_Type>", "<pythonType_IteratorMethod>",
    ...
    if (symRef->getSymbol()) {
        ...
        if (symRef->getSymbol()->isPythonLocalVariableShadowSymbol()) {
            ...
            return symRef->getOwningMethod(comp)->localName(
                symRef->getOffset() / TR::DataType::getSize(TR::Address), -1, comp->trMemory());
        }
...
const char* TR_Debug::getRuntimeHelperName(int32_t index)
{
    ...
    if (index < TR_FSRH) {
        ...
        case RubyHelper_vm_send_woblock_jit_inline_frame:
            return "vm_send_woblock_jit_inline_frame";
        ...
        case RubyHelper_vm_setconstant:
            return "vm_setconstant";
        case RubyHelper_rb_vm_env_write:
            return "rb_vm_env_write";
        case RubyHelper_vm_jit_stack_check:
            return "vm_jit_stack_check";
        case RubyHelper_rb_str_freeze:
            return "rb_str_freeze";
        case RubyHelper_rb_ivar_set:
            return "rb_ivar_set";
        case RubyHelper_vm_compute_case_dest:
            return "vm_compute_case_dest";
        case RubyHelper_vm_getinstancevariable:
            return "vm_getinstancevariable";
        case RubyHelper_vm_setinstancevariable:
            return "vm_setinstancevariable";
        }
    }
#endif
