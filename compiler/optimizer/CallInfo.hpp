...
public:
	...
	public:
		SetCurrentCallNode(TR_CallStack &cs, TR::Node *callNode) : _cs(cs), _originalValue(cs._currentCallNode)
		{
...
struct TR_CallTarget : public TR_Link<TR_CallTarget> {
	...
	TR_PrexArgInfo *_ecsPrexArgInfo; // used by ECS and findInlineTargets to assist in choosing correct inline
	                                 // targets
...
#define TR_CALLSITE_INHERIT_CONSTRUCTOR_COMMON(EXTENDED, BASE) \
	EXTENDED(TR_ResolvedMethod *callerResolvedMethod, TR::TreeTop *callNodeTreeTop, TR::Node *parent, \
	        ...
	        TR::ResolvedMethodSymbol *initialCalleeSymbol, bool isIndirectCall, bool isInterface, \
	        TR_ByteCodeInfo &bcInfo, TR::Compilation *comp, int32_t depth = -1, bool allConsts = false) \
	        : BASE(callerResolvedMethod, callNodeTreeTop, parent, callNode, interfaceMethod, receiverClass, \
	                vftSlot, cpIndex, initialCalleeMethod, initialCalleeSymbol, isIndirectCall, isInterface, \
	                bcInfo, comp, depth, allConsts)
...
struct TR_CallSite : public TR_Link<TR_CallSite> {
	...
	TR_CallSite(TR_ResolvedMethod *callerResolvedMethod, TR::TreeTop *callNodeTreeTop, TR::Node *parent,
	        ...
	        bool isIndirectCall, bool isInterface, TR_ByteCodeInfo &bcInfo, TR::Compilation *comp,
	...
	vcount_t _visitCount; // a woefully bad choice of name.  The number of times we have visited this callsite
	                      // during inlining.  In theory, when you have multiple targets for a callsite, you will
