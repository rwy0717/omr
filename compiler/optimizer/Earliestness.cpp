...
void
TR_Earliestness::analyzeNode(TR::Node *, vcount_t, TR_BlockStructure *, TR_BitVector *)
{}
...
//
void
TR_Earliestness::analyzeTreeTopsInBlockStructure(TR_BlockStructure *blockStructure)
{
	...
	*(_blockAnalysisInfo[blockStructure->getNumber()]) &= *_temp;
	...
	_temp->setAll(_numberOfBits);
	*_temp -=
	        *(_globalAnticipatability->_localTransparency.getAnalysisInfo(blockStructure->getBlock()->getNumber()));
