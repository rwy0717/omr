...
public:
	TR_BlockManipulator(TR::OptimizationManager *manager) : TR::Optimization(manager) {}

	int32_t performChecksAndTreesMovement(
	        TR::Block *, TR::Block *, TR::Block *, TR::TreeTop *, vcount_t, TR::Optimizer *);
...
public:
	...
	bool optimizeArraysetIfPossible(TR::Node *, TR::Node *, TR::TreeTop *, TR::Node *, TR_BitVector *,
	        TR_BitVector *, TR_BitVector *, vcount_t, TR::TreeTop *);
	virtual const char *optDetailString() const throw();
};
...
public:
	...
	bool replacePassThroughIfPossible(TR::Node *, TR::Node *, TR::Node *, TR::Node *, bool *, TR_BitVector *,
...
public:
	...
	void removeNodeFromList(TR::Node *node, List<TR::Node> *nodes, List<List<TR::Node> > *parents,
	...
	void rematerializeNode(TR::TreeTop *, TR::Node *, TR::Node *, vcount_t, List<TR::Node> *, List<TR::Node> *,
	        List<List<TR::Node> > *, List<TR::Node> *, List<List<TR::Node> > *, List<TR::Node> *, List<TR::Node> *,
	        bool);
...
private:
	...
	public:
		...
		TR_IndexedBinaryHeapElement(TR::Block *object, uint32_t index) : _object(object), _index(index) {}
	...
	public:
		TR_BinaryHeap(TR_Memory *m, uint32_t size = 0)
		        : TR_Array<TR_IndexedBinaryHeapElement *>(m, size == 0 ? 8 : size), _maxSize(size)
		{}
...
public:
	TR_CheckcastAndProfiledGuardCoalescer(TR::OptimizationManager *manager) : TR::Optimization(manager){};
	static TR::Optimization *create(TR::OptimizationManager *manager)
	{
...
public:
	TR_ProfiledNodeVersioning(TR::OptimizationManager *manager) : TR::Optimization(manager) {}
	static TR::Optimization *create(TR::OptimizationManager *manager)
	{
...
public:
	TR_TrivialBlockExtension(TR::OptimizationManager *manager) : TR::Optimization(manager) {}
	static TR::Optimization *create(TR::OptimizationManager *manager)
	{
