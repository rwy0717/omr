...
void
TR_LiveOnAllPaths::analyzeNode(TR::Node *, vcount_t, TR_BlockStructure *, TR_BitVector *)
{}
...
TR_LiveOnAllPaths::TR_LiveOnAllPaths(TR::Compilation *comp, TR::Optimizer *optimizer, TR_Structure *rootStructure,
        ...
        : TR_BackwardIntersectionBitVectorAnalysis(
                comp, comp->getFlowGraph(), optimizer, comp->getOption(TR_TraceLiveness))
{
	if (trace())
...
void
TR_LiveOnAllPaths::analyzeTreeTopsInBlockStructure(TR_BlockStructure *blockStructure)
{
