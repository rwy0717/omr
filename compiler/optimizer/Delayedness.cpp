...
void
TR_Delayedness::analyzeNode(TR::Node *, vcount_t, TR_BlockStructure *, ContainerType *)
{}
...
//
void
TR_Delayedness::analyzeTreeTopsInBlockStructure(TR_BlockStructure *blockStructure)
{
	if (trace()) {
