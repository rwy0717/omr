...
TR::Node* lushrSimplifier(TR::Node* node, TR::Block* block, TR::Simplifier* s)
{
    ...
    //
    if (secondChild->getOpCode().isLoadConst() && (firstChild->getOpCodeValue() == TR::lushl || firstChild->getOpCodeValue() == TR::lshl) && firstChild->getSecondChild()->getOpCode().isLoadConst()) {
