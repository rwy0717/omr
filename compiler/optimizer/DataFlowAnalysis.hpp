...
public:
	TR_BasicDFSetAnalysis(TR::Compilation *comp, TR::CFG *cfg, TR::Optimizer *optimizer, bool trace)
	        : TR_DataFlowAnalysis(comp, cfg, optimizer, trace), _traceBVA(comp->getOption(TR_TraceBVA))
	{
		initialize();
	}
...
protected:
	virtual void findUseOfLocal(TR::Node *node, int32_t blockNum, TR_BitVector **genSetInfo,
	        TR_BitVector **killSetInfo, TR_BitVector *commonedLoads, bool movingForwardThroughTrees,
	        vcount_t visitCount);
...
private:
	...
	typedef TR::typed_allocator<std::pair<const int32_t, TR_BitVector *>, TR::Region &>
...
public:
	TR_Liveness(TR::Compilation *comp, TR::Optimizer *optimizer, TR_Structure *, bool ignoreOSRUses = false,
	        TR_LiveVariableInformation *liveVariableInfo = NULL, bool splitLongs = false,
...
private:
	...
	// void initializeGenAndKillSetInfoForNode(TR::Node *node, bool seenException, int32_t blockNum, TR::Node
	// *parent);
