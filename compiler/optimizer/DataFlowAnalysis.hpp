...
//
template <class Container> class TR_BackwardIntersectionDFSetAnalysis<Container*> : public TR_BackwardDFSetAnalysis<Container*> {
public:
...
//
template <class Container> class TR_BackwardUnionDFSetAnalysis<Container*> : public TR_BackwardDFSetAnalysis<Container*> {
public:
