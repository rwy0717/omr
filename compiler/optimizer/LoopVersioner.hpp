...
protected:
	...
	public:
		 ...
		 */
		LoopImprovement(TR_LoopVersioner *versioner, LoopEntryPrep *prep) : _versioner(versioner), _prep(prep)
		{}
	...
	struct PrivTemp {
		PrivTemp(TR::SymbolReference *symRef, TR::DataType type) : _symRef(symRef), _type(type) {}
	...
	public:
		...
		Hoist(TR_LoopVersioner *versioner, LoopEntryPrep *prep) : LoopImprovement(versioner, prep) {}
	...
	public:
		...
		RemoveArrayStoreCheck(
		        TR_LoopVersioner *versioner, LoopEntryPrep *prep, TR::TreeTop *arrayStoreCheckTree)
		        : LoopImprovement(versioner, prep), _arrayStoreCheckTree(arrayStoreCheckTree)
		{}
	...
	public:
		...
		FoldConditional(TR_LoopVersioner *versioner, LoopEntryPrep *prep, TR::Node *conditionalNode,
		        bool reverseBranch, bool original)
	...
	bool detectInvariantTrees(TR_RegionStructure *whileLoop, List<TR::TreeTop> *, bool, bool *,
	        SharedSparseBitVector &reverseBranchInLoops);
	...
	bool isExprInvariant(TR::Node *, bool ignoreHeapificationStore = false); // ignoreHeapificationStore flags for
	                                                                         // both
	...
	bool isBranchSuitableToDoLoopTransfer(
	...
	bool detectChecksToBeEliminated(TR_RegionStructure *, List<TR::Node> *, List<TR::TreeTop> *, List<int32_t> *,
	        ...
	        List<TR::TreeTop> *, List<TR::TreeTop> *, List<TR::TreeTop> *, List<TR::Node> *,
	...
	void updateDefinitionsAndCollectProfiledExprs(TR::Node *, TR::Node *, vcount_t, List<TR::Node> *,
	        List<TR_NodeParentSymRef> *, List<TR_NodeParentSymRefWeightTuple> *, TR::Node *, bool, TR::Block *,
	        int32_t);
