...
public:
	...
	TR_NodeParentPair(TR::Node *node, TR::Node *parent) : _node(node), _parent(parent) {}
...
protected:
	...
	void detectWhileLoops(ListAppender<TR_Structure> &whileLoopsInnerFirst, List<TR_Structure> &whileLoops,
	        ListAppender<TR_Structure> &doWhileLoopsInnerFirst, List<TR_Structure> &doWhileLoops,
	...
	void detectWhileLoopsInSubnodesInOrder(ListAppender<TR_Structure> &whileLoopsInnerFirst,
	        List<TR_Structure> &whileLoops, ListAppender<TR_Structure> &doWhileLoopsInnerFirst,
	        List<TR_Structure> &doWhileLoops, TR_RegionStructure *region, vcount_t visitCount,
...
public:
	...
	int32_t _topDfNum;
	int32_t _counter;
	int32_t _loopDrivingInductionVar, _nextExpression, _startExpressionForThisInductionVariable,
...
private:
	...
	virtual bool examineTreeForInductionVariableUse(
	        TR::Block *loopInvariantBlock, TR::Node *, int32_t, TR::Node *, vcount_t, TR::SymbolReference **);
	void placeInitializationTreeInLoopPreHeader(TR::Block *b, TR::Node *node,
	        TR::SymbolReference *newSymbolReference, TR::SymbolReference *primaryInductionVar,
	        TR::SymbolReference *derivedInductionVar);
	...
	bool checkIfOrderOfBlocksIsKnown(TR_RegionStructure *naturalLoop, TR::Block *entryBlock,
...
public:
	TR_RedundantInductionVarElimination(TR::OptimizationManager *manager) : TR_LoopCanonicalizer(manager) {}
	static TR::Optimization *create(TR::OptimizationManager *manager)
	{
