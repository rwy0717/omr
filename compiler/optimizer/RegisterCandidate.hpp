...
private:
	void collectBlocks();
	void collectReferencedAutoSymRefs(
...
public:
	...
	public:
		...
		BlockInfo(TR::Region &region)
		        : _blockMap((InfoMapComparator()), (InfoMapAllocator(region))), _candidateBlocks(region)
		{}
	...
	void setWeight(TR::Block **, int32_t *, TR::Compilation *, TR_Array<int32_t> &, TR_Array<int32_t> &,
	        TR_Array<int32_t> &, TR_BitVector *, TR_Array<TR::Block *> &startOfExtendedBB, TR_BitVector &,
	        TR_BitVector &);
	...
	void processLiveOnEntryBlocks(TR::Block **, int32_t *, TR::Compilation *, TR_Array<int32_t> &,
	        TR_Array<int32_t> &, TR_Array<int32_t> &, TR_BitVector *, TR_Array<TR::Block *> &startOfExtendedBB,
	        bool removeUnusedLoops = false);
	void removeAssignedCandidateFromLoop(
	        TR::Compilation *, TR_Structure *, int32_t, TR_BitVector *, TR_BitVector *, bool);

	void extendLiveRangesForLiveOnExit(
	        TR::Compilation *, TR::Block **, TR_Array<TR::Block *> &startOfExtendedBBForBB);
...
private:
	...
	TR_RegisterCandidate *reprioritizeCandidates(TR_RegisterCandidate *, TR::Block **, int32_t *, int32_t,
	        TR::Block *, TR::Compilation *, bool reprioritizeFP, bool onlyReprioritizeLongs,
	        TR_BitVector *referencedBlocks, TR_Array<int32_t> &blockGPRCount, TR_Array<int32_t> &blockFPRCount,
	        TR_Array<int32_t> &blockVRFCount, TR_BitVector *, bool);
...
public:
	...
	void setCurrentRegisterCandidate(TR_RegisterCandidate *rc, vcount_t, TR::Block *, int32_t, TR::Compilation *,
	...
	TR::Node *createStoreToRegister(
	        TR::TreeTop *, TR::Node *, vcount_t, TR::Compilation *, TR_GlobalRegisterAllocator *);
