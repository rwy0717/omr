...
public:
    ...
    struct VPStringCached {
        ...
        VPStringCached(TR::TreeTop* append1, TR::TreeTop* append2, TR::Node* appendString1, TR::Node* appendString2,
            TR::TreeTop* newTree, TR::TreeTop* toStringTree)
            : _treetop1(append1)
            , _treetop2(append2)
            , _appendedString1(appendString1)
            , _appendedString2(appendString2)
            , _newTree(newTree)
            , _toStringTree(toStringTree)
        {}
        TR::TreeTop* _treetop1;
        TR::TreeTop* _treetop2;
