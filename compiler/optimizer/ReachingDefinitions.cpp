...
TR_ReachingDefinitions::TR_ReachingDefinitions(TR::Compilation *comp, TR::CFG *cfg, TR::Optimizer *optimizer,
        ...
        : TR_UnionBitVectorAnalysis(comp, cfg, optimizer, trace), _useDefInfo(useDefInfo), _aux(aux)
{
...
void
TR_ReachingDefinitions::analyzeBlockZeroStructure(TR_BlockStructure *blockStructure)
{
