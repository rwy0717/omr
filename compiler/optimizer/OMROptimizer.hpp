...
public:
	...
	static TR::Optimizer *createOptimizer(
	...
	// allowBCDSignPromotion -- if true and node1 has conservatively 'better' sign state then node2 then also
	// consider nodes equivalent (used only by certain optimizations such as CSE)
