...
const OptimizationStrategy cheapObjectAllocationOpts[] = { { eachEscapeAnalysisPassGroup,
...
const OptimizationStrategy eachEscapeAnalysisPassOpts[]
    = { { escapeAnalysis }, { eachEscapeAnalysisPassGroup, IfEnabled }, // if another pass requested
          { endGroup } };
...
const OptimizationStrategy earlyLocalOpts[] = { { localValuePropagation },
    ...
    { localReordering }, { treeSimplification, IfEnabled }, // simplify any exprs created by LCP/LCSE
#ifdef J9_PROJECT_SPECIFIC
...
inline TR::Optimizer* OMR::Optimizer::self() { return (static_cast<TR::Optimizer*>(this)); }
