...
private:
	...
	static bool insertIfMissing(TR::Compilation *comp, const char *name, bool flag, TR::TreeTop *tt,
...
public:
	...
	static void insertInliningCounterOK(const char *name, TR::Compilation *comp, TR::TreeTop *origTT,
	        TR::TreeTop *tt, int32_t size = 0, int32_t numLocals = 0);
