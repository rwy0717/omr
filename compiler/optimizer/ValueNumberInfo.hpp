...
public:
	TR_HashValueNumberInfo(TR::Compilation *, TR::Optimizer *, bool requiresGlobals = false,
	...
	struct VNHashFunc {
		static CS2::HashValue Hash(
		        const VNHashKey &v1, const CS2::HashValue hv = CS2::CS2_DEFAULT_INITIALHASHVALUE)
		{
			return v1._hashVal;
		}
