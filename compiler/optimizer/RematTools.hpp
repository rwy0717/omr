...
class RematTools {
	...
	static void walkNodesCalculatingRematSafety(TR::Compilation *comp, TR::Node *currentNode,
	        ...
	        TR::SparseBitVector &unsafeSymRefs, bool trace, TR::SparseBitVector &visitedNodes);
...
public:
	...
	static bool walkTreesCalculatingRematSafety(TR::Compilation *comp, TR::TreeTop *start, TR::TreeTop *end,
	        TR::SparseBitVector &scanTargets, TR::SparseBitVector &unsafeSymRefs, TR_BitVector *blocksToVisit,
	        bool trace);
