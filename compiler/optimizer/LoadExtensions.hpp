...
private:
	/** \brief
	 *     Determines whether the conversion of a load can be skipped based on the loads extension preference and if
	 * the conversion can be skipped determine whether the respective load needs to be sign/zero extended.
	 *
	 *  \param conversion
	 *     The conversion to examine.
	 *
	 *  \param child
	 *     The child on which the conversion acts. Note this may not necessarily be the conversions first child as
	 * the conversion may act indirectly on a globally allocated register.
	 *
	...
	/** \brief
	 *     Flags conversions with the unneededConv flag and sets preference of loads to zero/sign extend at source
	 * by flagging them with signExtendTo[32|64]BitAtSource and zeroExtendTo[32|64]BitAtSource flags.
	 *
	 *  \param node
	 *     The node to flag.
	 */
	...
	/** \brief
	 *     Determines whether a node is of the supported type for skipping conversion operations or forcing sign or
	 * zero extensions on loads.
	 *
	 *  \param node
	 *     The node to examine.
	 *
	 ...
	 *
	 *  \return
	 *     Negative value if this \p load prefers to be zero extended and a positive value if this \p load prefers
	 * to be sign extended.
	 */
