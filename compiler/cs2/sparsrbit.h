...
public:
	...
	// Copy constructor
	ASparseBitVector(const ASparseBitVector &v) : Allocator(v), fBase(NULL), fNumberOfSegments(v.fNumberOfSegments)
	{
	...
	// Determine if the vector is cleared to null, ie is the zero measure set "null set" which is also the empty
	// set.
	bool IsNull() const;
...
private:
	...
	public:
		...
		{
			fSegment =
			        (uint16_t *)a.reallocate(size * sizeof(uint16_t), fSegment, fSize * sizeof(uint16_t));
			fSize = size;
		}
	...
	//
	// if numValues is given, then it must accommodate numValues. Thus if numValues exceeds given size then grow
	// size by some factor more. The new size is then guaranteed to exceed numValues.
...
public:
	...
	public:
		...
		{}
		IntersectionCursor(const IntersectionCursor &adoptCursor) : c1(adoptCursor.c1), c2(adoptCursor.c2) {}
	...
	public:
		...
		{}
		MaskCursor(const MaskCursor &adoptCursor) : c(adoptCursor.c), m(adoptCursor.m) {}
...
template <class Allocator>
inline void
ASparseBitVector<Allocator>::GrowTo(SparseBitIndex index, bool geometric, bool forceGeometric)
{
	if (IsZero()) {
		Clear();
		return;
...
template <class Allocator>
inline SparseBitIndex
ASparseBitVector<Allocator>::PopulationCount(const ASparseBitVector<Allocator> &mask) const
{
...
template <class Allocator>
inline bool
ASparseBitVector<Allocator>::Intersects(const ASparseBitVector<Allocator> &inputVector) const
{
...
template <class Allocator>
inline bool
ASparseBitVector<Allocator>::operator!=(const ASparseBitVector &inputVector) const
{
...
template <class Allocator>
inline SparseBitIndex
ASparseBitVector<Allocator>::FindIndex(const typename ASparseBitVector<Allocator>::Segment &thisSegment,
...
template <class Allocator>
inline SparseBitIndex
ASparseBitVector<Allocator>::AdvanceIndex(const typename ASparseBitVector<Allocator>::Segment &thisSegment, uint16_t s,
        SparseBitIndex l, SparseBitIndex h) const
{
...
template <class Allocator>
inline void
ASparseBitVector<Allocator>::SetSegment(typename ASparseBitVector<Allocator>::Segment &thisSegment, SparseBitIndex bit)
{
	...
	CS2Assert(thisSegment.fNumValues < thisSegment.AllocatedSize(),
	        ("Segment Overflow %d(%d %d)>=%d", (thisSegment.fNumValues - 1 - t) + (t + 1), thisSegment.fNumValues,
...
template <class Allocator>
inline typename ASparseBitVector<Allocator>::Segment *
ASparseBitVector<Allocator>::AddSegment(SparseBitIndex index, SparseBitIndex count)
{
...
template <class Allocator>
inline typename ASparseBitVector<Allocator>::Segment *
ASparseBitVector<Allocator>::AddSegment(SparseBitIndex index, SparseBitIndex count, uint16_t *bits)
{
...
template <class Allocator>
inline typename ASparseBitVector<Allocator>::Segment *
ASparseBitVector<Allocator>::OrSegment(SparseBitIndex index, SparseBitIndex count, uint16_t *bits)
{
...
template <class Allocator>
inline void
ASparseBitVector<Allocator>::CompactSegment(typename ASparseBitVector<Allocator>::Segment &thisSegment)
{
...
template <class Allocator>
inline bool
ASparseBitVector<Allocator>::OrSegment(typename ASparseBitVector<Allocator>::Segment &thisSegment,
...
template <class Allocator>
inline bool
ASparseBitVector<Allocator>::OrSegment(const typename ASparseBitVector<Allocator>::Segment &thisSegment,
        const typename ASparseBitVector<Allocator>::Segment &inputSegment,
...
template <class Allocator>
inline bool
ASparseBitVector<Allocator>::OrSegmentMask(typename ASparseBitVector<Allocator>::Segment &thisSegment,
        const typename ASparseBitVector<Allocator>::Segment &inputSegment,
...
template <class Allocator>
inline bool
ASparseBitVector<Allocator>::AndSegment(typename ASparseBitVector<Allocator>::Segment &thisSegment,
        const typename ASparseBitVector<Allocator>::Segment &inputSegment)
{
	if (thisSegment.IsZero())
		return false;
...
template <class Allocator>
inline bool
ASparseBitVector<Allocator>::AndSegment(const typename ASparseBitVector<Allocator>::Segment &thisSegment,
        const typename ASparseBitVector<Allocator>::Segment &inputSegment,
        typename ASparseBitVector<Allocator>::Segment &outputSegment)
{
	if (thisSegment.IsZero()) {
...
template <class Allocator>
inline bool
ASparseBitVector<Allocator>::AndcSegment(typename ASparseBitVector<Allocator>::Segment &thisSegment,
        const typename ASparseBitVector<Allocator>::Segment &inputSegment)
{
	if (thisSegment.IsZero())
		return false;
...
template <class Allocator>
inline bool
ASparseBitVector<Allocator>::AndcSegment(const typename ASparseBitVector<Allocator>::Segment &thisSegment,
        const typename ASparseBitVector<Allocator>::Segment &inputSegment,
        typename ASparseBitVector<Allocator>::Segment &outputSegment)
{
...
template <class Allocator>
inline bool
ASparseBitVector<Allocator>::IsSubset(const typename ASparseBitVector<Allocator>::Segment &thisSegment,
...
template <class str>
inline void
ASparseBitVector<Allocator>::DumpSegment(str &out, const typename ASparseBitVector<Allocator>::Segment &s) const
{
	SparseBitIndex i;
...
template <class Allocator>
inline void
ASparseBitVector<Allocator>::TruncateSegment(typename ASparseBitVector<Allocator>::Segment &thisSegment)
{
...
template <class Allocator>
inline bool
ASparseBitVector<Allocator>::Andc(const ASparseBitVector<Allocator> &inputVector)
{
	if (IsZero())
		return false;
...
template <class Allocator>
inline void
ASparseBitVector<Allocator>::Or(ASparseBitVector<Allocator> **vs, SparseBitIndex nvs)
{
	if (nvs == 0)
		return;
	if (nvs == 1) {
...
template <class Allocator>
inline bool
ASparseBitVector<Allocator>::operator==(const ASparseBitVector<Allocator> &inputVector) const
{
	if (IsZero() && inputVector.IsZero())
		return true;
	if (IsZero() || inputVector.IsZero())
