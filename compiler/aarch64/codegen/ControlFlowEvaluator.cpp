...
ificmpHelper(TR::Node *node, TR::ARM64ConditionCode cc, bool is64bit, TR::CodeGenerator *cg)
{
...
static TR::Register *
icmpHelper(TR::Node *node, TR::ARM64ConditionCode cc, bool is64bit, TR::CodeGenerator *cg)
{
...
OMR::ARM64::TreeEvaluator::tableEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	...
	if (0 < defaultChild->getNumChildren()) {
		...
		conditions = conditions->clone(
		        cg, generateRegisterDependencyConditions(cg, defaultChild->getFirstChild(), 0));
	}
	...
	if (5 > numBranchTableEntries) {
		...
		generateTrg1ImmInstruction(cg, TR::InstOpCode::adr, node, tmpRegister, 12); // distance between this
...
{
	// TODO:ARM64: Enable TR::TreeEvaluator::ZEROCHKEvaluator in compiler/aarch64/codegen/TreeEvaluatorTable.hpp
	// when Implemented.
	return OMR::ARM64::TreeEvaluator::unImpOpEvaluator(node, cg);
}
...
{
	// TODO:ARM64: Enable TR::TreeEvaluator::ArrayCHKEvaluator in compiler/aarch64/codegen/TreeEvaluatorTable.hpp
	// when Implemented.
	return OMR::ARM64::TreeEvaluator::unImpOpEvaluator(node, cg);
}
...
TR::Register *
OMR::ARM64::TreeEvaluator::igotoEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
