...
void
OMR::ARM64::RegisterDependencyConditions::unionNoRegPostCondition(TR::Register *reg, TR::CodeGenerator *cg)
{
...
void
OMR::ARM64::RegisterDependencyConditions::incRegisterTotalUseCounts(TR::CodeGenerator *cg)
{
...
OMR::ARM64::RegisterDependencyConditions::clone(TR::CodeGenerator *cg, TR::RegisterDependencyConditions *added)
{
	TR_UNIMPLEMENTED();
	return NULL;
}
...
void
TR_ARM64RegisterDependencyGroup::assignRegisters(TR::Instruction *currentInstruction, TR_RegisterKinds kindToBeAssigned,
		...
		for (i = 0; i < numberOfRegisters; i++) {
			...
			if (dependentRegNum == TR::RealRegister::SpilledReg) {
				...
				if (virtReg->getAssignedRealRegister()) {
					...
					switch (rk) {
					case TR_GPR: opCode = TR::InstOpCode::ldrimmx; break;
					case TR_FPR: opCode = TR::InstOpCode::vldrimmd; break;
