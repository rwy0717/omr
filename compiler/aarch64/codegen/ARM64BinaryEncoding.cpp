...
int32_t
TR::ARM64ConditionalBranchInstruction::estimateBinaryLength(int32_t currentEstimate)
{
	setEstimatedBinaryLength(ARM64_INSTRUCTION_LENGTH);
	return currentEstimate + getEstimatedBinaryLength();
}
...
int32_t
TR::ARM64VirtualGuardNOPInstruction::estimateBinaryLength(int32_t currentEstimate)
{
