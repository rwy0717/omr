...
static void
fpBitsMovHelper(TR::Node *node, TR::InstOpCode::Mnemonic op, TR::Register *trgReg, TR::CodeGenerator *cg)
{
...
iffcmpHelper(TR::Node *node, TR::ARM64ConditionCode cc, bool isDouble, bool needsExplicitUnorderedCheck,
        TR::CodeGenerator *cg)
{
	TR::Node *firstChild = node->getFirstChild();
	TR::Node *secondChild = node->getSecondChild();
...
static TR::Register *
fcmpHelper(TR::Node *node, TR::ARM64ConditionCode cc, bool isDouble, TR::CodeGenerator *cg)
{
	TR::Register *trgReg = cg->allocateRegister();
	TR::Node *firstChild = node->getFirstChild();
	TR::Node *secondChild = node->getSecondChild();
...
{
	// TODO:ARM64: Enable TR::TreeEvaluator::dcmpequEvaluator in compiler/aarch64/codegen/TreeEvaluatorTable.hpp
	// when Implemented.
	return OMR::ARM64::TreeEvaluator::unImpOpEvaluator(node, cg);
}
...
{
	// TODO:ARM64: Enable TR::TreeEvaluator::dcmpltuEvaluator in compiler/aarch64/codegen/TreeEvaluatorTable.hpp
	// when Implemented.
	return OMR::ARM64::TreeEvaluator::unImpOpEvaluator(node, cg);
}
...
{
	// TODO:ARM64: Enable TR::TreeEvaluator::dcmpgeuEvaluator in compiler/aarch64/codegen/TreeEvaluatorTable.hpp
	// when Implemented.
	return OMR::ARM64::TreeEvaluator::unImpOpEvaluator(node, cg);
}
...
{
	// TODO:ARM64: Enable TR::TreeEvaluator::dcmpgtuEvaluator in compiler/aarch64/codegen/TreeEvaluatorTable.hpp
	// when Implemented.
	return OMR::ARM64::TreeEvaluator::unImpOpEvaluator(node, cg);
}
...
{
	// TODO:ARM64: Enable TR::TreeEvaluator::dcmpleuEvaluator in compiler/aarch64/codegen/TreeEvaluatorTable.hpp
	// when Implemented.
	return OMR::ARM64::TreeEvaluator::unImpOpEvaluator(node, cg);
}
