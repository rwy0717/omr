...
public:
	ARM64ImmSymInstruction(TR::InstOpCode::Mnemonic op, TR::Node *node, uintptr_t imm,
	        ...
	        : TR::Instruction(op, node, cond, cg), _addrImmediate(imm), _symbolReference(sr), _snippet(s)
	{}
...
public:
	...
	ARM64ConditionalBranchInstruction(TR::InstOpCode::Mnemonic op, TR::Node *node, TR::LabelSymbol *sym,
	        ...
	        : ARM64LabelInstruction(op, node, sym, cg), _cc(cc), _estimatedBinaryLocation(0)
	{}
	...
	ARM64ConditionalBranchInstruction(TR::InstOpCode::Mnemonic op, TR::Node *node, TR::LabelSymbol *sym,
	        ...
	        : ARM64LabelInstruction(op, node, sym, precedingInstruction, cg), _cc(cc), _estimatedBinaryLocation(0)
	{}
	...
	ARM64ConditionalBranchInstruction(TR::InstOpCode::Mnemonic op, TR::Node *node, TR::LabelSymbol *sym,
	        ...
	        : ARM64LabelInstruction(op, node, sym, cond, cg), _cc(cc), _estimatedBinaryLocation(0)
	{}
...
public:
	 ...
	 * @param[in] cg : CodeGenerator
	 */
	ARM64CompareBranchInstruction(TR::InstOpCode::Mnemonic op, TR::Node *node, TR::Register *sreg,
	        TR::LabelSymbol *sym, TR::CodeGenerator *cg)
	        : ARM64LabelInstruction(op, node, sym, cg), _source1Register(sreg), _estimatedBinaryLocation(0)
	{
		useRegister(sreg);
	}
...
public:
	...
	ARM64Trg1Src2Instruction(TR::InstOpCode::Mnemonic op, TR::Node *node, TR::Register *treg, TR::Register *s1reg,
	        ...
	        : ARM64Trg1Src1Instruction(op, node, treg, s1reg, precedingInstruction, cg), _source2Register(s2reg)
	{
		useRegister(s2reg);
	}
...
public:
	 ...
	 * @param[in] cg : CodeGenerator
	 */
	ARM64CondTrg1Src2Instruction(TR::InstOpCode::Mnemonic op, TR::Node *node, TR::Register *treg,
	        TR::Register *s1reg, TR::Register *s2reg, TR::ARM64ConditionCode cc, TR::CodeGenerator *cg)
	 ...
	 */
	ARM64CondTrg1Src2Instruction(TR::InstOpCode::Mnemonic op, TR::Node *node, TR::Register *treg,
	        TR::Register *s1reg, TR::Register *s2reg, TR::ARM64ConditionCode cc,
	        TR::Instruction *precedingInstruction, TR::CodeGenerator *cg)
...
public:
	 ...
	 * @param[in] cg : CodeGenerator
	 */
	ARM64Trg1MemInstruction(TR::InstOpCode::Mnemonic op, TR::Node *node, TR::Register *treg,
...
public:
	 ...
	 * @param[in] cg : CodeGenerator
	 */
	ARM64MemSrc1Instruction(TR::InstOpCode::Mnemonic op, TR::Node *node, TR::MemoryReference *mr,
...
public:
	 ...
	 */
	ARM64Trg1MemSrc1Instruction(TR::InstOpCode::Mnemonic op, TR::Node *node, TR::Register *treg,
	        TR::MemoryReference *mr, TR::Register *sreg, TR::Instruction *precedingInstruction,
	        TR::CodeGenerator *cg)
...
public:
	...
	ARM64Src2Instruction(TR::InstOpCode::Mnemonic op, TR::Node *node, TR::Register *s1reg, TR::Register *s2reg,
	        TR::Instruction *precedingInstruction, TR::CodeGenerator *cg)
	        : ARM64Src1Instruction(op, node, s1reg, precedingInstruction, cg), _source2Register(s2reg)
	{
		useRegister(s2reg);
	}
...
public:
	 ...
	 * @param[in] cg : CodeGenerator
	 */
	ARM64SynchronizationInstruction(
	        TR::InstOpCode::Mnemonic op, TR::Node *node, uint32_t imm, TR::CodeGenerator *cg)
...
public:
	ARM64VirtualGuardNOPInstruction(TR::Node *node, TR_VirtualGuardSite *site,
	        ...
	        : TR::ARM64LabelInstruction(TR::InstOpCode::vgdnop, node, sym, cond, cg), _site(site)
	{}
