 ...
 */
inline bool constantIsImm9(int32_t intValue) { return (-256 <= intValue && intValue < 256); }
 ...
 */
inline bool constantIsUnsignedImm12(uint32_t intValue) { return (intValue < 4096); }
