...
void OMR::ARM64::Linkage::mapSingleAutomatic(TR::AutomaticSymbol* p, uint32_t& stackIndex) { /* do nothing */ }
...
bool OMR::ARM64::Linkage::hasToBeOnStack(TR::ParameterSymbol* parm) { return (false); }
...
TR_HeapMemory OMR::ARM64::Linkage::trHeapMemory() { return self()->trMemory(); }

TR_StackMemory OMR::ARM64::Linkage::trStackMemory() { return self()->trMemory(); }
