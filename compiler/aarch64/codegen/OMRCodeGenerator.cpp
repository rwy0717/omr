...
void OMR::ARM64::CodeGenerator::beginInstructionSelection()
{
    ...
    if (comp->getMethodSymbol()->getLinkageConvention() == TR_Private) {
        ...
        _returnTypeInfoInstruction
            = new (self()->trHeapMemory()) TR::ARM64ImmInstruction(TR::InstOpCode::dd, startNode, 0, self());
    } else {
...
bool OMR::ARM64::CodeGenerator::hasDataSnippets() { return (_constantData == NULL) ? false : true; }
