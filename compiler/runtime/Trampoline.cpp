      ...
      // bits are not 0 extended.. Use li/oris when the 16th bit is off
		...
		*(int32_t *)buffer = 0x4e800420;
		...
		const char *helperName =
		        TR::Options::findOrCreateDebug()->getRuntimeHelperName((TR_RuntimeHelper)cookie);
...
void
ppcCodeCacheParameters(int32_t *trampolineSize, void **callBacks, int32_t *numHelpers, int32_t *CCPreLoadedCodeSize)
{
#if defined(TR_TARGET_64BIT)
...
void
amd64CodeCacheParameters(int32_t *trampolineSize, OMR::CodeCacheCodeGenCallbacks *callBacks, int32_t *numHelpers,
...
void
ia32CodeCacheParameters(int32_t *trampolineSize, OMR::CodeCacheCodeGenCallbacks *callBacks, int32_t *numHelpers,
        int32_t *CCPreLoadedCodeSize)
{
	*trampolineSize = 0;
...
void
armCodeCacheParameters(int32_t *trampolineSize, void **callBacks, int32_t *numHelpers, int32_t *CCPreLoadedCodeSize)
{
	*trampolineSize = TRAMPOLINE_SIZE;
...
void
arm64CodeCacheParameters(int32_t *trampolineSize, void **callBacks, int32_t *numHelpers, int32_t *CCPreLoadedCodeSize)
{
	*trampolineSize = TRAMPOLINE_SIZE;
...
void
setupCodeCacheParameters(int32_t *trampolineSize, OMR::CodeCacheCodeGenCallbacks *callBacks, int32_t *numHelpers,
        int32_t *CCPreLoadedCodeSize)
{
#if defined(TR_TARGET_POWER)
