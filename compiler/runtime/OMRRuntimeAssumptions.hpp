...
public:
    ...
    bool enqueueInListOfAssumptionsForJittedBody(
        RuntimeAssumption** sentinel); // must be executed under assumptionTableMutex
...
protected:
    RuntimeAssumption* _nextAssumptionForSameJittedBody; // links assumptions that pertain to the same method body
                                                         ...
                                                         // Lower bit is used to mark assumptions that will be removed
                                                         // after all marking is completed
