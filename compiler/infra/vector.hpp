...
TR::vector<T, Alloc>::vector(const allocator_type &allocator) : container_type(allocator)
{}

template <typename T, class Alloc>
TR::vector<T, Alloc>::vector(size_type size, const allocator_type &allocator) : container_type(size, T(), allocator)
{}
...
template <typename T, class Alloc>
TR::vector<T, Alloc>::vector(const vector<T, Alloc> &other) : container_type(other)
{}
