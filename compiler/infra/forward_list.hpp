...
template <typename T, typename Alloc>
TR::forward_list<T, Alloc>::forward_list(const allocator_type &allocator) : _head(NULL), _allocator(allocator)
{}
...
template <typename T, typename Alloc>
TR::forward_list<T, Alloc>::forward_list(const forward_list &prototype) : _head(NULL), _allocator(prototype._allocator)
{
...
template <typename T, typename Alloc>
TR::forward_list<T, Alloc>::const_iterator::const_iterator() : _element(degenerate())
{}

template <typename T, typename Alloc>
TR::forward_list<T, Alloc>::const_iterator::const_iterator(const const_iterator &other) : _element(other._element)
{}

template <typename T, typename Alloc>
TR::forward_list<T, Alloc>::const_iterator::const_iterator(const Link *element) : _element(element)
{}
...
template <typename T, typename Alloc>
TR::forward_list<T, Alloc>::iterator::iterator(const iterator &other) : _element(other._element)
{}

template <typename T, typename Alloc>
TR::forward_list<T, Alloc>::iterator::iterator(Link *element) : _element(element)
{}
