...
TR::CFGEdge* OMR::CFG::addEdge(TR::CFGNode* f, TR::CFGNode* t, TR_AllocationKind allocKind)
{
...
void OMR::CFG::addExceptionEdge(TR::CFGNode* f, TR::CFGNode* t, TR_AllocationKind allocKind)
{
    if (comp()->getOption(TR_TraceAddAndRemoveEdge)) {
...
bool TR::CFGNode::hasSuccessor(TR::CFGNode* n) { return (bool)getSuccessorEdge(n); }

bool TR::CFGNode::hasExceptionSuccessor(TR::CFGNode* n) { return (bool)getExceptionSuccessorEdge(n); }

bool TR::CFGNode::hasPredecessor(TR::CFGNode* n) { return (bool)getPredecessorEdge(n); }

bool TR::CFGNode::hasExceptionPredecessor(TR::CFGNode* n) { return (bool)getExceptionPredecessorEdge(n); }
