...
TR::deque<T, Alloc>::deque(const allocator_type &allocator) : container_type(allocator)
{}

template <typename T, class Alloc>
TR::deque<T, Alloc>::deque(size_type size, const allocator_type &allocator) : container_type(size, T(), allocator)
{}
...
template <typename T, class Alloc>
TR::deque<T, Alloc>::deque(const deque<T, Alloc> &other) : container_type(other)
{}
