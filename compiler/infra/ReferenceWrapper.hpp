...
template <typename T>
reference_wrapper<T>::reference_wrapper(reference_type ref) throw() : m_ref(&ref)
{}

template <typename T>
reference_wrapper<T>::reference_wrapper(const reference_wrapper &other) throw() : m_ref(other.m_ref)
{}
