...
TR::Instruction *
generateMvFprGprInstructions(TR::CodeGenerator *cg, TR::Node *node, MvFprGprMode mode, bool nonops, TR::Register *reg0,
        TR::Register *reg1, TR::Register *reg2, TR::Register *reg3, TR::Instruction *cursor)
{
	...
	bool checkp8DirectMove = TR::Compiler->target.cpu.id() >= TR_PPCp8 && !disableDirectMove
	...
	if (checkp8DirectMove && mode == fpr2gprHost64) {
		...
		cursor =
		        generateTrg1Src2ImmInstruction(cg, TR::InstOpCode::xxpermdi, node, reg0, reg3, reg3, 2, cursor);
	...
	} else // otherwise, do generic load/store sequences for moving from fpr2gpr or gpr2fpr
	{
		...
		if ((mode == gprSp2fpr) || (mode == fpr2gprSp) || (mode == gprLow2fpr)) {
			...
			if (mode == fpr2gprHost32)
				tempMRLoad1 = new (cg->trHeapMemory())
				        TR::MemoryReference(node, *tempMRStore1, isLittleEndian ? 4 : 0, 4, cg);
			if ((mode == fpr2gprHost64) || (mode == gpr2fprHost64))
				tempMRLoad1 = new (cg->trHeapMemory())
				        TR::MemoryReference(node, *tempMRStore1, 0, 8, cg);
			else
				tempMRLoad2 = new (cg->trHeapMemory())
				        TR::MemoryReference(node, *tempMRStore1, isLittleEndian ? 0 : 4, 4, cg);
		}
		...
		if (mode == fpr2gprHost64)
			...
			cursor =
			        generateTrg1MemInstruction(cg, TR::InstOpCode::lfiwax, node, reg0, tempMRLoad1, cursor);
...
TR::Instruction *
generateInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Instruction *preced)
{
	if (preced)
...
TR::Instruction *
generateAlignmentNopInstruction(TR::CodeGenerator *cg, TR::Node *n, uint32_t alignment, TR::Instruction *preced)
{
...
TR::Instruction *
generateImmInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, uint32_t imm,
...
TR::Instruction *
generateImm2Instruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, uint32_t imm, uint32_t imm2,
...
TR::Instruction *
generateDepInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n,
...
TR::Instruction *
generateMemSrc1Instruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::MemoryReference *mf,
...
TR::Instruction *
generateTrg1MemInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *treg,
...
TR::Instruction *
generateMemInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::MemoryReference *mf,
        TR::Instruction *preced)
{
	if (preced)
...
TR::Instruction *
generateTrg1MemInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, int32_t hint, TR::Node *n,
...
TR::Instruction *
generateTrg1ImmInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *treg,
...
TR::Instruction *
generateDepLabelInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::LabelSymbol *sym,
        TR::RegisterDependencyConditions *cond, TR::Instruction *preced)
{
	if (preced)
...
TR::Instruction *
generateConditionalBranchInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, bool likeliness, TR::Node *n,
        TR::LabelSymbol *sym, TR::Register *cr, TR::Instruction *preced)
{
	...
	if (preced)
		return new (cg->trHeapMemory())
		        TR::PPCConditionalBranchInstruction(op, n, sym, cr, preced, cg, likeliness);
	return new (cg->trHeapMemory()) TR::PPCConditionalBranchInstruction(op, n, sym, cr, cg, likeliness);
}

TR::Instruction *
generateDepConditionalBranchInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, bool likeliness,
...
TR::Instruction *
generateConditionalBranchInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n,
        TR::LabelSymbol *sym, TR::Register *cr, TR::Instruction *preced)
{
	if (cr->isFlippedCCR())
		op = flipBranch(cg, op);
...
TR::Instruction *
generateDepConditionalBranchInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n,
	...
	if (prediction) {
		if (preced)
			return new (cg->trHeapMemory())
			        TR::PPCDepConditionalBranchInstruction(op, n, sym, cr, cond, preced, cg, likeliness);
		return new (cg->trHeapMemory())
		        TR::PPCDepConditionalBranchInstruction(op, n, sym, cr, cond, cg, likeliness);
	}
...
TR::Instruction *
generateTrg1Src1ImmInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *treg,
        TR::Register *s1reg, intptrj_t imm, TR::Instruction *preced)
{
...
TR::Instruction *
generateTrg1Src1ImmInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *treg,
        TR::Register *s1reg, TR::Register *cr0reg, int32_t imm, TR::Instruction *preced)
{
	if (TR::Compiler->target.cpu.id() == TR_PPCp6)
		cr0reg->resetFlippedCCR();
	if (preced)
		return new (cg->trHeapMemory())
		        TR::PPCTrg1Src1ImmInstruction(op, n, treg, s1reg, cr0reg, imm, preced, cg);
	return new (cg->trHeapMemory()) TR::PPCTrg1Src1ImmInstruction(op, n, treg, s1reg, cr0reg, imm, cg);
}

TR::Instruction *
generateSrc1Instruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *s1reg,
...
TR::Instruction *
generateSrc2Instruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *s1reg,
...
TR::Instruction *
generateTrg1Src1Instruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *treg,
...
TR::Instruction *
generateTrg1Src2Instruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *treg,
...
TR::Instruction *
generateTrg1Src2Instruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *treg,
        TR::Register *s1reg, TR::Register *s2reg, TR::Register *cr0Reg, TR::Instruction *preced)
{
	if (TR::Compiler->target.cpu.id() == TR_PPCp6)
		cr0Reg->resetFlippedCCR();
...
TR::Instruction *
generateTrg1Src2ImmInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *treg,
        TR::Register *s1reg, TR::Register *s2reg, int64_t imm, TR::Instruction *preced)
{
	if (preced)
		return new (cg->trHeapMemory())
...
TR::Instruction *
generateTrg1Src3Instruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *treg,
...
TR::Instruction *
generateTrg1Src1Imm2Instruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *trgReg,
        TR::Register *srcReg, int32_t imm1, int64_t imm2, TR::Instruction *preced)
{
	if (preced)
		return new (cg->trHeapMemory())
		        TR::PPCTrg1Src1Imm2Instruction(op, n, trgReg, srcReg, imm1, imm2, preced, cg);
	return new (cg->trHeapMemory()) TR::PPCTrg1Src1Imm2Instruction(op, n, trgReg, srcReg, imm1, imm2, cg);
}

TR::Instruction *
generateTrg1Src1Imm2Instruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *trgReg,
        TR::Register *srcReg, TR::Register *cr0reg, int32_t imm1, int64_t imm2, TR::Instruction *preced)
{
	if (TR::Compiler->target.cpu.id() == TR_PPCp6)
		cr0reg->resetFlippedCCR();
	if (preced)
...
TR::Instruction *
generateShiftLeftImmediate(TR::CodeGenerator *cg, TR::Node *n, TR::Register *trgReg, TR::Register *srcReg,
        int32_t shiftAmount, TR::Instruction *preced)
{
	...
	if (shiftAmount == 1) {
		...
		return new (cg->trHeapMemory())
		        TR::PPCTrg1Src2Instruction(TR::InstOpCode::add, n, trgReg, srcReg, srcReg, cg);
	}
	if (preced)
...
TR::Instruction *
generateShiftRightLogicalImmediate(TR::CodeGenerator *cg, TR::Node *n, TR::Register *trgReg, TR::Register *srcReg,
        int32_t shiftAmount, TR::Instruction *preced)
{
...
TR::Instruction *
generateShiftLeftImmediateLong(TR::CodeGenerator *cg, TR::Node *n, TR::Register *trgReg, TR::Register *srcReg,
        int32_t shiftAmount, TR::Instruction *preced)
{
	int64_t mask;
...
TR::Instruction *
generateShiftRightLogicalImmediateLong(TR::CodeGenerator *cg, TR::Node *n, TR::Register *trgReg, TR::Register *srcReg,
        int32_t shiftAmount, TR::Instruction *preced)
{
...
TR::Instruction *
generateControlFlowInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n,
        TR::RegisterDependencyConditions *deps, TR::Instruction *preced, bool useRegPairForResult,
...
TR::Instruction *
generateDepImmInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, uint32_t imm,
        TR::RegisterDependencyConditions *cond, TR::Instruction *preced)
{
	if (preced)
...
TR::Instruction *
generateDepImmSymInstruction(TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic op, TR::Node *n, uintptrj_t imm,
...
{
	switch (op) {
	case TR::InstOpCode::bge: return TR::InstOpCode::ble;
	case TR::InstOpCode::bgel: return TR::InstOpCode::blel;
	case TR::InstOpCode::bgt: return TR::InstOpCode::blt;
	case TR::InstOpCode::bgtl: return TR::InstOpCode::bltl;
	case TR::InstOpCode::ble: return TR::InstOpCode::bge;
	case TR::InstOpCode::blel: return TR::InstOpCode::bgel;
	case TR::InstOpCode::blt: return TR::InstOpCode::bgt;
	case TR::InstOpCode::bltl: return TR::InstOpCode::bgtl;
	case TR::InstOpCode::beq:
	case TR::InstOpCode::beql:
	case TR::InstOpCode::bne:
	case TR::InstOpCode::bnel:
	case TR::InstOpCode::bdz:
	case TR::InstOpCode::bdnz: return op;
	default:
        ...
        TR::Node *node, TR::Register *trgReg, TR::Register *srcReg, int32_t bitsInTarget, TR::CodeGenerator *cg)
{
	...
	generateTrg1Src1Imm2Instruction(cg,
	        TR::Compiler->target.is64Bit() ? TR::InstOpCode::rldicl : TR::InstOpCode::rlwinm, node, trgReg, srcReg,
	        0, mask);
}
        ...
        TR::Node *node, TR::Register *trgReg, TR::Register *srcReg, TR::CodeGenerator *cg, int32_t operandSize)
{
	...
	switch (operandSize) {
	case 0x1: signExtendOp = TR::InstOpCode::extsb; break;
	case 0x2: signExtendOp = TR::InstOpCode::extsh; break;
	case 0x4: signExtendOp = TR::InstOpCode::extsw; break;
	default: TR_ASSERT(0, "unexpected operand size %d\n", operandSize); break;
	}
	generateTrg1Src1Instruction(cg, signExtendOp, node, trgReg, srcReg);
}

void
generateSignExtendInstruction(TR::Node *node, TR::Register *trgReg, TR::Register *srcReg, TR::CodeGenerator *cg)
{
