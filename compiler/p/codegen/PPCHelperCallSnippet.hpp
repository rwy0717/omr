...
public:
	PPCArrayCopyCallSnippet(TR::CodeGenerator *cg, TR::Node *node, TR::LabelSymbol *snippetlab,
	        TR::SymbolReference *helper, TR::RealRegister::RegNum lengthRegNum,
	        TR::LabelSymbol *restartLabel = NULL)
	        : TR::PPCHelperCallSnippet(cg, node, snippetlab, helper, restartLabel), _lengthRegNum(lengthRegNum)
	{}
