...
class PPCAlignmentNopInstruction : public TR::Instruction {
	...
	{
		TR_ASSERT_FATAL((alignment % PPC_INSTRUCTION_LENGTH) == 0,
		        "Alignment must be a multiple of the nop instruction length");
		_alignment = alignment != 0 ? alignment : PPC_INSTRUCTION_LENGTH;
	}

public:
	PPCAlignmentNopInstruction(
	        TR::InstOpCode::Mnemonic op, TR::Node *n, uint32_t alignment, TR::CodeGenerator *codeGen)
...
public:
	PPCSrc1Instruction(TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *sreg, uint32_t imm,
	        TR::Instruction *precedingInstruction, TR::CodeGenerator *codeGen)
	        : PPCImmInstruction(op, n, imm, precedingInstruction, codeGen), _source1Register(sreg)
	{
		useRegister(sreg);
	}
...
public:
	...
	PPCDepLabelInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n, TR::LabelSymbol *sym,
	        ...
	        TR::CodeGenerator *codeGen)
	        : PPCLabelInstruction(op, n, sym, precedingInstruction, codeGen), _conditions(cond)
	{
		cond->bookKeepingRegisterUses(this, codeGen);
	}
...
public:
	...
	PPCConditionalBranchInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n, TR::LabelSymbol *sym,
	        TR::Register *cr, TR::Instruction *precedingInstruction, TR::CodeGenerator *codeGen, bool likeliness)
	...
	PPCConditionalBranchInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n, TR::LabelSymbol *sym,
	        TR::Register *cr, TR::Instruction *precedingInstruction, TR::CodeGenerator *codeGen)
	        : PPCLabelInstruction(op, n, sym, precedingInstruction, codeGen)
	        , _conditionRegister(cr)
	        , _estimatedBinaryLocation(0)
	        , _exceptBranch(false)
...
public:
	PPCDepConditionalBranchInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n, TR::LabelSymbol *sym,
	        TR::Register *cr, TR::RegisterDependencyConditions *cond, TR::CodeGenerator *codeGen, bool likeliness)
	...
	PPCDepConditionalBranchInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n, TR::LabelSymbol *sym,
	        TR::Register *cr, TR::RegisterDependencyConditions *cond, TR::CodeGenerator *codeGen)
	...
	PPCDepConditionalBranchInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n, TR::LabelSymbol *sym,
	        TR::Register *cr, TR::RegisterDependencyConditions *cond, TR::Instruction *precedingInstruction,
	...
	PPCDepConditionalBranchInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n, TR::LabelSymbol *sym,
	        TR::Register *cr, TR::RegisterDependencyConditions *cond, TR::Instruction *precedingInstruction,
	        TR::CodeGenerator *codeGen)
	        : PPCConditionalBranchInstruction(op, n, sym, cr, precedingInstruction, codeGen), _conditions(cond)
	{
		cond->bookKeepingRegisterUses(this, codeGen);
	}
...
public:
	...
	PPCDepImmInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n, uint32_t imm,
	        TR::RegisterDependencyConditions *cond, TR::Instruction *precedingInstruction,
	        TR::CodeGenerator *codeGen)
	        : PPCDepInstruction(op, n, cond, precedingInstruction, codeGen), _sourceImmediate(imm)
	{}
...
public:
	PPCDepImmSymInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n, uintptrj_t imm,
	        ...
	        TR::CodeGenerator *codeGen)
	        : PPCDepInstruction(op, n, cond, codeGen), _addrImmediate(imm), _symbolReference(sr), _snippet(s)
	{}
...
public:
	PPCTrg1Src1ImmInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *treg, TR::Register *sreg,
	        ...
	        : PPCTrg1Src1Instruction(op, n, treg, sreg, codeGen), _source1Immediate(imm){};

	PPCTrg1Src1ImmInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *treg, TR::Register *sreg,
	        uintptrj_t imm, TR::Instruction *precedingInstruction, TR::CodeGenerator *codeGen)
	        : PPCTrg1Src1Instruction(op, n, treg, sreg, precedingInstruction, codeGen), _source1Immediate(imm){};
...
public:
	PPCTrg1Src1Imm2Instruction(TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *treg, TR::Register *sreg,
	        ...
	        : PPCTrg1Src1ImmInstruction(op, n, treg, sreg, imm, precedingInstruction, codeGen), _mask(m)
	{}
	...
	PPCTrg1Src1Imm2Instruction(TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *treg, TR::Register *sreg,
	        ...
	        : PPCTrg1Src1ImmInstruction(op, n, treg, sreg, cr0reg, imm, codeGen), _mask(m)
	{}

	PPCTrg1Src1Imm2Instruction(TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *treg, TR::Register *sreg,
	        TR::Register *cr0reg, uint32_t imm, uint64_t m, TR::Instruction *precedingInstruction,
	        TR::CodeGenerator *codeGen)
	        : PPCTrg1Src1ImmInstruction(op, n, treg, sreg, cr0reg, imm, precedingInstruction, codeGen), _mask(m)
	{}
...
public:
	...
	PPCTrg1Src2Instruction(TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *treg, TR::Register *s1reg,
	        ...
	        : PPCTrg1Src1Instruction(op, n, treg, s1reg, precedingInstruction, codeGen), _source2Register(s2reg)
	{
		useRegister(s2reg);
	}

	PPCTrg1Src2Instruction(TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *treg, TR::Register *s1reg,
	        TR::Register *s2reg, TR::Register *cr0reg, TR::Instruction *precedingInstruction,
	        TR::CodeGenerator *codeGen)
	        : PPCTrg1Src1Instruction(op, n, treg, s1reg, precedingInstruction, codeGen), _source2Register(s2reg)
	{
		useRegister(s2reg);
...
public:
	...
	PPCTrg1Src2ImmInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *treg, TR::Register *s1reg,
	        ...
	        : PPCTrg1Src2Instruction(op, n, treg, s1reg, s2reg, precedingInstruction, codeGen), _mask(m)
	{}
...
public:
	...
	PPCTrg1Src3Instruction(TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *treg, TR::Register *s1reg,
	        TR::Register *s2reg, TR::Register *s3reg, TR::Instruction *precedingInstruction,
	        TR::CodeGenerator *codeGen)
...
public:
	PPCControlFlowInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n, TR::CodeGenerator *codeGen,
	        TR::RegisterDependencyConditions *deps = NULL, bool useRegPairForResult = false,
	...
	PPCControlFlowInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Instruction *preceedingInstruction,
	        TR::CodeGenerator *codeGen, TR::RegisterDependencyConditions *deps = NULL,
