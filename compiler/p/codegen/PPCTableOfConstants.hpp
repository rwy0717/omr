...
public:
	TR_PPCTableOfConstants(uint32_t size) : TableOfConstants(size), _tocBase(NULL)
	{
	...
	static int32_t lookUp(int32_t val, struct TR_tocHashEntry *lk, int32_t *s, TR::CodeGenerator *cg); // return
	                                                                                                   // index
	static int32_t lookUp(int8_t *n, int32_t len, bool isAddr, intptrj_t loader, TR::CodeGenerator *cg); // return
	                                                                                                     // index
...
public:
	...
	TR_PPCLoadLabelItem(int32_t o, TR::LabelSymbol *l) : _label(l), _tocOffset(o) {}
