...
TR_PPCOutOfLineCodeSection::generatePPCOutOfLineCodeSectionDispatch()
{
	...
	generateLabelInstruction(
	        _cg, TR::InstOpCode::label, _callNode, TR::LabelSymbol::create(_cg->trHeapMemory(), _cg));
...
TR_PPCOutOfLineCodeSection::assignRegisters(TR_RegisterKinds kindsToBeAssigned)
{
	...
	_cg->toggleIsInOOLSection(); // toggle it back because swapInstructionListsWithCompilation() also calls
	                             // toggle...
