...
TR_Debug::print(TR::FILE *pOutFile, TR::Instruction *instr)
{
	...
	case OMR::Instruction::IsAlignmentNop: print(pOutFile, (TR::PPCAlignmentNopInstruction *)instr); break;
	case OMR::Instruction::IsImm: print(pOutFile, (TR::PPCImmInstruction *)instr); break;
	case OMR::Instruction::IsImm2: print(pOutFile, (TR::PPCImm2Instruction *)instr); break;
	case OMR::Instruction::IsSrc1: print(pOutFile, (TR::PPCSrc1Instruction *)instr); break;
	case OMR::Instruction::IsDep: print(pOutFile, (TR::PPCDepInstruction *)instr); break;
	case OMR::Instruction::IsDepImm: print(pOutFile, (TR::PPCDepImmInstruction *)instr); break;
	case OMR::Instruction::IsDepImmSym: print(pOutFile, (TR::PPCDepImmSymInstruction *)instr); break;
	case OMR::Instruction::IsLabel: print(pOutFile, (TR::PPCLabelInstruction *)instr); break;
	case OMR::Instruction::IsDepLabel: print(pOutFile, (TR::PPCDepLabelInstruction *)instr); break;
#ifdef J9_PROJECT_SPECIFIC
	case OMR::Instruction::IsVirtualGuardNOP: print(pOutFile, (TR::PPCVirtualGuardNOPInstruction *)instr); break;
#endif
	...
	case OMR::Instruction::IsDepConditionalBranch:
		...
		break;
	case OMR::Instruction::IsAdmin: print(pOutFile, (TR::PPCAdminInstruction *)instr); break;
	case OMR::Instruction::IsTrg1: print(pOutFile, (TR::PPCTrg1Instruction *)instr); break;
	case OMR::Instruction::IsTrg1Imm: print(pOutFile, (TR::PPCTrg1ImmInstruction *)instr); break;
	case OMR::Instruction::IsTrg1Src1: print(pOutFile, (TR::PPCTrg1Src1Instruction *)instr); break;
	case OMR::Instruction::IsTrg1Src1Imm: print(pOutFile, (TR::PPCTrg1Src1ImmInstruction *)instr); break;
	case OMR::Instruction::IsTrg1Src1Imm2: print(pOutFile, (TR::PPCTrg1Src1Imm2Instruction *)instr); break;
	case OMR::Instruction::IsTrg1Src2: print(pOutFile, (TR::PPCTrg1Src2Instruction *)instr); break;
	case OMR::Instruction::IsTrg1Src2Imm: print(pOutFile, (TR::PPCTrg1Src2ImmInstruction *)instr); break;
	case OMR::Instruction::IsTrg1Src3: print(pOutFile, (TR::PPCTrg1Src3Instruction *)instr); break;
	case OMR::Instruction::IsTrg1Mem: print(pOutFile, (TR::PPCTrg1MemInstruction *)instr); break;
	case OMR::Instruction::IsSrc2: print(pOutFile, (TR::PPCSrc2Instruction *)instr); break;
	case OMR::Instruction::IsMem: print(pOutFile, (TR::PPCMemInstruction *)instr); break;
	case OMR::Instruction::IsMemSrc1: print(pOutFile, (TR::PPCMemSrc1Instruction *)instr); break;
	case OMR::Instruction::IsControlFlow: print(pOutFile, (TR::PPCControlFlowInstruction *)instr); break;
	default:
	...
	if (cursor) {
		if (label) {
			...
			if (refNum < TR_PPCnumRuntimeHelpers) {
				targetAddress =
				        TR::CodeCacheManager::instance()->findHelperTrampoline(refNum, (void *)cursor);
			} else {
...
TR_Debug::print(TR::FILE *pOutFile, TR::PPCTrg1ImmInstruction *instr)
{
	...
	if (instr->getOpCodeValue() == TR::InstOpCode::mtcrf) {
		...
		if (instr->getOpCodeValue() != TR::InstOpCode::mfcr) {
			trfprintf(
			        pOutFile, ", " POINTER_PRINTF_FORMAT, (intptrj_t)(int32_t)instr->getSourceImmediate());
		}
	}
...
TR_Debug::print(TR::FILE *pOutFile, TR::PPCTrg1Src1Imm2Instruction *instr)
{
	...
	if (TR::Compiler->target.is64Bit())
		trfprintf(pOutFile, ", " POINTER_PRINTF_FORMAT ", " POINTER_PRINTF_FORMAT, instr->getSourceImmediate(),
		        lmask);
	else
		...
		if (map->getMap() & (1 << i))
			trfprintf(pOutFile, "%s ",
			        getName(machine->getRealRegister(
			                (TR::RealRegister::RegNum)(31 - i + TR::RealRegister::FirstGPR))));
	}
...
TR_Debug::getOutlinedTargetIfAny(TR::Instruction *instr)
{
	...
	case TR::Instruction::IsDepConditionalBranch: break;
	default: return NULL;
	}
...
TR_Debug::printp(TR::FILE *pOutFile, TR::Snippet *snippet)
{
	...
	switch (snippet->getKind()) {
#ifdef J9_PROJECT_SPECIFIC
	case TR::Snippet::IsCall: print(pOutFile, (TR::PPCCallSnippet *)snippet); break;
	case TR::Snippet::IsUnresolvedCall: print(pOutFile, (TR::PPCUnresolvedCallSnippet *)snippet); break;
	case TR::Snippet::IsVirtual: print(pOutFile, (TR::PPCVirtualSnippet *)snippet); break;
	case TR::Snippet::IsVirtualUnresolved: print(pOutFile, (TR::PPCVirtualUnresolvedSnippet *)snippet); break;
	case TR::Snippet::IsInterfaceCall: print(pOutFile, (TR::PPCInterfaceCallSnippet *)snippet); break;
	case TR::Snippet::IsInterfaceCastSnippet: print(pOutFile, (TR::PPCInterfaceCastSnippet *)snippet); break;
	case TR::Snippet::IsStackCheckFailure: print(pOutFile, (TR::PPCStackCheckFailureSnippet *)snippet); break;
	case TR::Snippet::IsForceRecompilation: print(pOutFile, (TR::PPCForceRecompilationSnippet *)snippet); break;
	case TR::Snippet::IsRecompilation: print(pOutFile, (TR::PPCRecompilationSnippet *)snippet); break;
#endif
	case TR::Snippet::IsArrayCopyCall:
	case TR::Snippet::IsHelperCall: print(pOutFile, (TR::PPCHelperCallSnippet *)snippet); break;
	...
	case TR::Snippet::IsNonZeroAllocPrefetch: snippet->print(pOutFile, this); break;
