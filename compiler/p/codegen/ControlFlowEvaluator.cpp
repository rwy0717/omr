...
TR::Register *
OMR::Power::TreeEvaluator::ifacmpltEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
...
TR::Register *
OMR::Power::TreeEvaluator::ifacmpgeEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	if (TR::Compiler->target.is64Bit())
...
TR::Register *
OMR::Power::TreeEvaluator::ifacmpgtEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	if (TR::Compiler->target.is64Bit())
...
TR::Register *
OMR::Power::TreeEvaluator::ifacmpleEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	if (TR::Compiler->target.is64Bit())
...
TR::Register *
OMR::Power::TreeEvaluator::acmpltEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	if (TR::Compiler->target.is64Bit())
...
TR::Register *
OMR::Power::TreeEvaluator::acmpgeEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	if (TR::Compiler->target.is64Bit())
...
TR::Register *
OMR::Power::TreeEvaluator::acmpgtEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	if (TR::Compiler->target.is64Bit())
...
TR::Register *
OMR::Power::TreeEvaluator::acmpleEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	if (TR::Compiler->target.is64Bit())
...
TR::Register *
OMR::Power::TreeEvaluator::compareIntsForOrder(TR::InstOpCode::Mnemonic branchOp, TR::LabelSymbol *dstLabel,
...
static void
fixDepsForLongCompare(TR::RegisterDependencyConditions *deps, TR::Register *src1High, TR::Register *src1Low,
...
static TR::Register *
compareLongsForOrderWithAnalyser(TR::InstOpCode::Mnemonic branchOp, TR::InstOpCode::Mnemonic reversedBranchOp,
        TR::Register *condReg, TR::LabelSymbol *destinationLabel, TR::RegisterDependencyConditions *deps,
...
TR::Register *
OMR::Power::TreeEvaluator::compareLongsForOrder(TR::InstOpCode::Mnemonic branchOp,
        ...
        bool isSigned, bool isHint, bool likeliness)
{
	...
	if (TR::Compiler->target.is64Bit()) {
		...
		if (node->getOpCode().isIf() && node->getNumChildren() == 3) {
			...
			cg->evaluate(thirdChild);
			if (isHint && TR::Compiler->target.cpu.id() >= TR_PPCgp)
				generateDepConditionalBranchInstruction(cg, branchOp, likeliness, node, dstLabel,
				        condReg, generateRegisterDependencyConditions(cg, thirdChild, 0));
			else
				generateDepConditionalBranchInstruction(cg, branchOp, node, dstLabel, condReg,
				        generateRegisterDependencyConditions(cg, thirdChild, 0));
			cg->decReferenceCount(thirdChild);
	...
	} else // 32 bit target
	{
		...
		TR::Register *src2Reg;
		src1Reg = cg->evaluate(firstChild);
		bool useImmed = secondChild->getOpCode().isLoadConst() && secondChild->getRegister() == NULL
...
TR::Register *
compareLongAndSetOrderedBoolean(
...
TR::Register *
OMR::Power::TreeEvaluator::ireturnEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
...
TR::Register *
OMR::Power::TreeEvaluator::lreturnEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	TR::Register *returnRegister = cg->evaluate(node->getFirstChild());
	const TR::PPCLinkageProperties &linkageProperties = cg->getProperties();
...
cmp2bun(TR::ILOpCodes op)
{
	...
	case TR::dcmpgt:
	case TR::dcmpgeu:
	case TR::dcmpleu: return TR::InstOpCode::bad;
	case TR::fcmpge:
	case TR::fcmple:
	case TR::dcmpge:
	case TR::dcmple: return TR::InstOpCode::beq;
	case TR::fcmpequ:
	case TR::fcmpltu:
	case TR::fcmpgtu:
	case TR::dcmpequ:
	case TR::dcmpltu:
	case TR::dcmpgtu: return TR::InstOpCode::bun;
...
cmp2branch(TR::ILOpCodes op, TR::CodeGenerator *cg)
{
	...
	case TR::fcmpequ:
	case TR::dcmpequ:
	case TR::bcmpeq: return TR::InstOpCode::beq;
	case TR::icmpne:
	case TR::acmpne:
	case TR::lcmpne:
	case TR::fcmpne:
	...
	case TR::fcmpneu:
	case TR::dcmpneu:
	case TR::bcmpne: return TR::InstOpCode::bne;
	case TR::icmplt:
	case TR::iucmplt:
	case TR::acmplt:
	case TR::lcmplt:
	...
	case TR::dcmpltu:
	case TR::bucmplt:
	case TR::bcmplt: return TR::InstOpCode::blt;
	case TR::icmpge:
	case TR::iucmpge:
	case TR::acmpge:
	case TR::lcmpge:
	...
	case TR::dcmpgeu:
	case TR::bucmpge:
	case TR::bcmpge: return TR::InstOpCode::bge;
	case TR::icmpgt:
	case TR::iucmpgt:
	case TR::acmpgt:
	case TR::lcmpgt:
	...
	case TR::dcmpgtu:
	case TR::bucmpgt:
	case TR::bcmpgt: return TR::InstOpCode::bgt;
	case TR::icmple:
	case TR::iucmple:
	case TR::acmple:
	case TR::lcmple:
	...
	case TR::dcmpleu:
	case TR::bucmple:
	case TR::bcmple: return TR::InstOpCode::ble;
	default: TR_ASSERT(false, "assertion failure");
	}
...
cmp2cmp(TR::ILOpCodes op, TR::CodeGenerator *cg)
{
	...
	case TR::bcmpge:
	case TR::bcmpgt:
	case TR::bcmple: return TR::InstOpCode::cmp4;
	case TR::iucmplt:
	case TR::iucmpge:
	case TR::iucmpgt:
	case TR::iucmple:
	...
	case TR::bucmpge:
	case TR::bucmpgt:
	case TR::bucmple: return TR::InstOpCode::cmpl4;
	case TR::lcmpeq:
	case TR::lcmpne:
	case TR::lcmplt:
	case TR::lcmpge:
	case TR::lcmpgt:
	case TR::lcmple: return TR::Compiler->target.is64Bit() ? TR::InstOpCode::cmp8 : TR::InstOpCode::cmp4;
	case TR::lucmplt:
	case TR::lucmpge:
	case TR::lucmpgt:
	case TR::lucmple:
	...
	case TR::acmpge:
	case TR::acmpgt:
	case TR::acmple: return TR::Compiler->target.is64Bit() ? TR::InstOpCode::cmpl8 : TR::InstOpCode::cmpl4;
	default: TR_ASSERT(false, "assertion failure");
	}
	return TR::InstOpCode::bad;
}
...
cmp2cmpi(TR::ILOpCodes op, TR::CodeGenerator *cg)
{
	...
	case TR::bcmpge:
	case TR::bcmpgt:
	case TR::bcmple: return TR::InstOpCode::cmpi4;
	case TR::iucmplt:
	case TR::iucmpge:
	case TR::iucmpgt:
	case TR::iucmple:
	...
	case TR::bucmpge:
	case TR::bucmpgt:
	case TR::bucmple: return TR::InstOpCode::cmpli4;
	case TR::lcmpeq:
	case TR::lcmpne:
	case TR::lcmplt:
	case TR::lcmpge:
	case TR::lcmpgt:
	case TR::lcmple: return TR::Compiler->target.is64Bit() ? TR::InstOpCode::cmpi8 : TR::InstOpCode::cmpi4;
	case TR::lucmplt:
	case TR::lucmpge:
	case TR::lucmpgt:
	case TR::lucmple:
	...
	case TR::acmpge:
	case TR::acmpgt:
	case TR::acmple: return TR::Compiler->target.is64Bit() ? TR::InstOpCode::cmpli8 : TR::InstOpCode::cmpli4;
	default: TR_ASSERT(false, "assertion failure");
	}
	return TR::InstOpCode::bad;
}
...
TR::Register *
OMR::Power::TreeEvaluator::iternaryEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	...
	TR::Register *resultReg = two_reg
	        ...
	        : (type.getDataType() == TR::Float ? cg->allocateSinglePrecisionRegister()
	...
	TR::InstOpCode::Mnemonic move_opcode = (type.isIntegral() || type.isAddress()) ? TR::InstOpCode::mr
	                                                                               : TR::InstOpCode::fmr;
	TR::Node *firstChild = node->getFirstChild();
	...
	if (firstChild->getOpCode().isBooleanCompare() && firstChild->getRegister() == NULL
		...
		if (compare_type.isIntegral() || compare_type.isAddress()) {
			...
			if (useImmediateCompare) {
				generateTrg1Src1ImmInstruction(
				        cg, cmp2cmpi(firstChild->getOpCodeValue(), cg), node, ccr, cmp1Reg, value);
			} else {
				generateTrg1Src2Instruction(
				        cg, cmp2cmp(firstChild->getOpCodeValue(), cg), node, ccr, cmp1Reg, cmp2Reg);
			}

			if (two_reg) {
				generateTrg1Src1Instruction(
				        cg, move_opcode, node, resultReg->getHighOrder(), trueReg->getHighOrder());
				generateTrg1Src1Instruction(
				        cg, move_opcode, node, resultReg->getLowOrder(), trueReg->getLowOrder());
			} else {
			...
			if (two_reg) {
				generateTrg1Src1Instruction(
				        cg, move_opcode, node, resultReg->getHighOrder(), falseReg->getHighOrder());
				generateTrg1Src1Instruction(
				        cg, move_opcode, node, resultReg->getLowOrder(), falseReg->getLowOrder());
			} else {
...
TR::Register *
OMR::Power::TreeEvaluator::compareIntsForEquality(TR::Node *node, TR::CodeGenerator *cg)
{
	TR::InstOpCode::Mnemonic branchOp = node->getOpCode().isCompareTrueIfEqual() ? TR::InstOpCode::beq
	                                                                             : TR::InstOpCode::bne;
...
TR::Register *
OMR::Power::TreeEvaluator::compareIntsForEquality(TR::InstOpCode::Mnemonic branchOp, TR::LabelSymbol *dstLabel,
        TR::Node *node, TR::CodeGenerator *cg, bool isHint, bool likeliness)
{
	...
	if (cg->profiledPointersRequireRelocation() && secondChild->getOpCodeValue() == TR::aconst
		...
		if (node->isProfiledGuard()) {
			...
			TR_ASSERT(!(node->isNopableInlineGuard()),
			        "Should not evaluate class or method pointer constants underneath NOPable guards as "
			        "they are runtime assumptions handled by virtualGuardHelper");
	...
	if (firstChild->getOpCodeValue() == TR::b2i && firstChild->getOpCodeValue() == secondChild->getOpCodeValue() &&
		...
		// 3) had we evaluated the child, the grandchild's refcount would have been decremented, so we have to
		// decrement it instead If a child is in a register, regardless of whether or not we evaluated it, we
		// don't have to decrement the grandchild
...
TR::Register *
OMR::Power::TreeEvaluator::ificmpeqEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
...
TR::Register *
OMR::Power::TreeEvaluator::ificmpltEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
...
TR::Register *
OMR::Power::TreeEvaluator::ificmpgeEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
...
TR::Register *
OMR::Power::TreeEvaluator::ificmpgtEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
...
TR::Register *
OMR::Power::TreeEvaluator::ificmpleEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
...
TR::Register *
OMR::Power::TreeEvaluator::ifiucmpltEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
...
TR::Register *
OMR::Power::TreeEvaluator::ifiucmpgeEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
...
TR::Register *
OMR::Power::TreeEvaluator::ifiucmpgtEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
...
TR::Register *
OMR::Power::TreeEvaluator::ifiucmpleEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
...
TR::Register *
OMR::Power::TreeEvaluator::compareLongsForEquality(TR::Node *node, TR::CodeGenerator *cg)
{
	TR::InstOpCode::Mnemonic branchOp = node->getOpCode().isCompareTrueIfEqual() ? TR::InstOpCode::beq
	                                                                             : TR::InstOpCode::bne;
...
TR::Register *
OMR::Power::TreeEvaluator::compareLongsForEquality(TR::InstOpCode::Mnemonic branchOp, TR::LabelSymbol *dstLabel,
        TR::Node *node, TR::CodeGenerator *cg, bool isHint, bool likeliness)
{
	if (TR::Compiler->target.is64Bit()) {
		if (virtualGuardHelper(node, cg))
			...
			if (firstShiftValue > 32 && secondShiftValue > 32) {
				...
				if (node->getOpCode().isIf()) {
					TR::Node::recreate(node,
					        node->getOpCode().isCompareTrueIfEqual() ? TR::ificmpeq : TR::ificmpne);
				} else {
					TR::Node::recreate(node,
	...
	if (TR::Compiler->target.is64Bit()) {
		...
		if (cg->profiledPointersRequireRelocation() && secondChild->getOpCodeValue() == TR::aconst
			...
			if (node->isProfiledGuard()) {
				...
				TR_ASSERT(!(node->isNopableInlineGuard()),
				        "Should not evaluate class or method pointer constants underneath NOPable "
				        "guards as they are runtime assumptions handled by virtualGuardHelper");
				cg->evaluate(secondChild);
			}
		}
#endif
...
TR::Register *
OMR::Power::TreeEvaluator::iflcmpeqEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
...
TR::Register *
OMR::Power::TreeEvaluator::iflcmpltEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
...
TR::Register *
OMR::Power::TreeEvaluator::iflcmpgeEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
...
TR::Register *
OMR::Power::TreeEvaluator::iflcmpgtEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
...
TR::Register *
OMR::Power::TreeEvaluator::iflcmpleEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
...
TR::Register *
OMR::Power::TreeEvaluator::iflucmpltEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
...
TR::Register *
OMR::Power::TreeEvaluator::iflucmpgeEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
...
TR::Register *
OMR::Power::TreeEvaluator::iflucmpgtEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
...
TR::Register *
OMR::Power::TreeEvaluator::iflucmpleEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
...
TR::Register *
OMR::Power::TreeEvaluator::ifacmpeqEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	if (TR::Compiler->target.is64Bit()) {
...
TR::Register *
OMR::Power::TreeEvaluator::ifacmpneEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	if (TR::Compiler->target.is64Bit()) {
...
TR::Register *
OMR::Power::TreeEvaluator::icmpeqEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	TR::Register *trgReg = cg->allocateRegister();
	TR::Node *firstChild = node->getFirstChild();
	TR::Node *secondChild = node->getSecondChild();
...
TR::Register *
OMR::Power::TreeEvaluator::icmpneEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	TR::Register *trgReg = cg->allocateRegister();
	TR::Node *firstChild = node->getFirstChild();
	TR::Node *secondChild = node->getSecondChild();
...
void
OMR::Power::TreeEvaluator::genBranchSequence(TR::Node *node, TR::Register *src1Reg, TR::Register *src2Reg,
...
TR::Register *
OMR::Power::TreeEvaluator::icmpltEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	TR::Node *firstChild = node->getFirstChild();
	TR::Node *secondChild = node->getSecondChild();
	TR::Register *src1Reg = cg->evaluate(firstChild);
	...
	if (secondChild->getOpCode().isLoadConst() && secondChild->getRegister() == NULL) {
		...
		TR::TreeEvaluator::genBranchSequence(
		        node, src1Reg, src2Reg, trgReg, TR::InstOpCode::blt, TR::InstOpCode::cmp4, cg);
	}
	node->setRegister(trgReg);
	cg->decReferenceCount(firstChild);
	cg->decReferenceCount(secondChild);
...
TR::Register *
OMR::Power::TreeEvaluator::icmpleEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	TR::Node *firstChild = node->getFirstChild();
	TR::Node *secondChild = node->getSecondChild();
	TR::Register *src1Reg = cg->evaluate(firstChild);
	...
	if (secondChild->getOpCode().isLoadConst() && secondChild->getRegister() == NULL) {
		...
		TR::Register *src2Reg = cg->evaluate(secondChild);
		TR::TreeEvaluator::genBranchSequence(
		        node, src1Reg, src2Reg, trgReg, TR::InstOpCode::ble, TR::InstOpCode::cmp4, cg);
	}
	node->setRegister(trgReg);
	cg->decReferenceCount(firstChild);
	cg->decReferenceCount(secondChild);
...
TR::Register *
OMR::Power::TreeEvaluator::icmpgeEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	TR::Node *firstChild = node->getFirstChild();
	TR::Node *secondChild = node->getSecondChild();
	TR::Register *src1Reg = cg->evaluate(firstChild);
	...
	if (secondChild->getOpCode().isLoadConst() && secondChild->getRegister() == NULL) {
		...
		TR::Register *src2Reg = cg->evaluate(secondChild);
		TR::TreeEvaluator::genBranchSequence(
		        node, src1Reg, src2Reg, trgReg, TR::InstOpCode::bge, TR::InstOpCode::cmp4, cg);
	}
	node->setRegister(trgReg);
	cg->decReferenceCount(firstChild);
	cg->decReferenceCount(secondChild);
...
TR::Register *
OMR::Power::TreeEvaluator::icmpgtEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	TR::Node *firstChild = node->getFirstChild();
	TR::Node *secondChild = node->getSecondChild();
	TR::Register *src1Reg = cg->evaluate(firstChild);
	...
	if (secondChild->getOpCode().isLoadConst() && secondChild->getRegister() == NULL) {
		...
		TR::Register *src2Reg = cg->evaluate(secondChild);
		TR::TreeEvaluator::genBranchSequence(
		        node, src1Reg, src2Reg, trgReg, TR::InstOpCode::bgt, TR::InstOpCode::cmp4, cg);
	}
	node->setRegister(trgReg);
	cg->decReferenceCount(firstChild);
	cg->decReferenceCount(secondChild);
...
TR::Register *
OMR::Power::TreeEvaluator::iucmpltEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	TR::Node *firstChild = node->getFirstChild();
	TR::Node *secondChild = node->getSecondChild();
	TR::Register *src1Reg = cg->evaluate(firstChild);
...
TR::Register *
OMR::Power::TreeEvaluator::iucmpleEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	TR::Node *firstChild = node->getFirstChild();
	TR::Node *secondChild = node->getSecondChild();
	TR::Register *src1Reg = cg->evaluate(firstChild);
	...
	TR::TreeEvaluator::genBranchSequence(
	        node, src1Reg, src2Reg, trgReg, TR::InstOpCode::ble, TR::InstOpCode::cmpl4, cg);
	node->setRegister(trgReg);
	cg->decReferenceCount(firstChild);
	cg->decReferenceCount(secondChild);
	return trgReg;
...
TR::Register *
OMR::Power::TreeEvaluator::iucmpgeEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	TR::Node *firstChild = node->getFirstChild();
	TR::Node *secondChild = node->getSecondChild();
	TR::Register *src1Reg = cg->evaluate(firstChild);
...
TR::Register *
OMR::Power::TreeEvaluator::iucmpgtEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	TR::Node *firstChild = node->getFirstChild();
	TR::Node *secondChild = node->getSecondChild();
	TR::Register *src1Reg = cg->evaluate(firstChild);
	...
	TR::TreeEvaluator::genBranchSequence(
	        node, src1Reg, src2Reg, trgReg, TR::InstOpCode::bgt, TR::InstOpCode::cmpl4, cg);
	node->setRegister(trgReg);
	cg->decReferenceCount(firstChild);
	cg->decReferenceCount(secondChild);
	return trgReg;
...
TR::Register *
OMR::Power::TreeEvaluator::lcmpeqEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
...
TR::Register *
OMR::Power::TreeEvaluator::lcmpneEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	if (TR::Compiler->target.is32Bit()) {
...
TR::Register *
OMR::Power::TreeEvaluator::lcmpltEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	if (TR::Compiler->target.is32Bit())
	...
	if (secondChild->getOpCode().isLoadConst() && secondChild->getRegister() == NULL) {
		...
		TR::Register *src2Reg = cg->evaluate(secondChild);
		TR::TreeEvaluator::genBranchSequence(
		        node, src1Reg, src2Reg, trgReg, TR::InstOpCode::blt, TR::InstOpCode::cmp8, cg);
	}
	node->setRegister(trgReg);
	cg->decReferenceCount(firstChild);
	cg->decReferenceCount(secondChild);
...
TR::Register *
OMR::Power::TreeEvaluator::lcmpleEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	if (TR::Compiler->target.is32Bit())
	...
	if (secondChild->getOpCode().isLoadConst() && secondChild->getRegister() == NULL) {
		...
		TR::Register *src2Reg = cg->evaluate(secondChild);
		TR::TreeEvaluator::genBranchSequence(
		        node, src1Reg, src2Reg, trgReg, TR::InstOpCode::ble, TR::InstOpCode::cmp8, cg);
	}
	node->setRegister(trgReg);
	cg->decReferenceCount(firstChild);
	cg->decReferenceCount(secondChild);
...
TR::Register *
OMR::Power::TreeEvaluator::lcmpgeEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	if (TR::Compiler->target.is32Bit())
	...
	if (secondChild->getOpCode().isLoadConst() && secondChild->getRegister() == NULL) {
		...
		TR::Register *src2Reg = cg->evaluate(secondChild);
		TR::TreeEvaluator::genBranchSequence(
		        node, src1Reg, src2Reg, trgReg, TR::InstOpCode::bge, TR::InstOpCode::cmp8, cg);
	}
	node->setRegister(trgReg);
	cg->decReferenceCount(firstChild);
	cg->decReferenceCount(secondChild);
...
TR::Register *
OMR::Power::TreeEvaluator::lcmpgtEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	if (TR::Compiler->target.is32Bit())
	...
	if (secondChild->getOpCode().isLoadConst() && secondChild->getRegister() == NULL) {
		...
		TR::Register *src2Reg = cg->evaluate(secondChild);
		TR::TreeEvaluator::genBranchSequence(
		        node, src1Reg, src2Reg, trgReg, TR::InstOpCode::bgt, TR::InstOpCode::cmp8, cg);
	}
...
TR::Register *
OMR::Power::TreeEvaluator::lucmpltEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	if (TR::Compiler->target.is32Bit())
	...
	TR::Register *trgReg = cg->allocateRegister();
	TR::TreeEvaluator::genBranchSequence(
	        node, src1Reg, src2Reg, trgReg, TR::InstOpCode::blt, TR::InstOpCode::cmpl8, cg);
...
TR::Register *
OMR::Power::TreeEvaluator::lucmpleEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	if (TR::Compiler->target.is32Bit())
	...
	TR::Register *trgReg = cg->allocateRegister();
	TR::TreeEvaluator::genBranchSequence(
	        node, src1Reg, src2Reg, trgReg, TR::InstOpCode::ble, TR::InstOpCode::cmpl8, cg);
...
TR::Register *
OMR::Power::TreeEvaluator::lucmpgeEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	if (TR::Compiler->target.is32Bit())
	...
	TR::Register *trgReg = cg->allocateRegister();
	TR::TreeEvaluator::genBranchSequence(
	        node, src1Reg, src2Reg, trgReg, TR::InstOpCode::bge, TR::InstOpCode::cmpl8, cg);
...
TR::Register *
OMR::Power::TreeEvaluator::lucmpgtEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	if (TR::Compiler->target.is32Bit())
	...
	TR::Register *trgReg = cg->allocateRegister();
	TR::TreeEvaluator::genBranchSequence(
	        node, src1Reg, src2Reg, trgReg, TR::InstOpCode::bgt, TR::InstOpCode::cmpl8, cg);
...
TR::Register *
OMR::Power::TreeEvaluator::acmpeqEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	if (TR::Compiler->target.is64Bit())
...
TR::Register *
OMR::Power::TreeEvaluator::acmpneEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	if (TR::Compiler->target.is64Bit())
...
static void
lookupScheme1(TR::Node *node, bool unbalanced, bool fromTableEval, TR::CodeGenerator *cg)
{
	int32_t total = node->getNumChildren();
	...
	for (int i = 2; i < total; i++) {
		...
		if (unbalanced) {
			...
			if (child->getNumChildren() > 0) {
				...
				bcond = bcond->clone(
				        cg, generateRegisterDependencyConditions(cg, child->getFirstChild(), 0));
			}
...
static void
lookupScheme2(TR::Node *node, bool unbalanced, bool fromTableEval, TR::CodeGenerator *cg)
{
	int32_t total = node->getNumChildren();
	TR::Register *selector = cg->evaluate(node->getFirstChild());
	TR::Register *cndRegister = cg->allocateRegister(TR_CCR);
	...
	for (int i = 2; i < total; i++) {
		...
		if (isInt64) {
			if (TR::Compiler->target.is64Bit()) {
				...
				generateTrg1Src2Instruction(cg, TR::InstOpCode::cmp4, node, cndRegister,
				        selector->getHighOrder(), valRegister->getHighOrder());
				generateConditionalBranchInstruction(
				        cg, TR::InstOpCode::bne, node, toDefaultLabel, cndRegister);
				generateTrg1Src2Instruction(cg, TR::InstOpCode::cmp4, node, cndRegister,
				        selector->getLowOrder(), valRegister->getLowOrder());
			}
		} else {
		...
		if (i < total - 1) {
			...
			if (!isInt64)
				generateTrg1Src1ImmInstruction(
				        cg, TR::InstOpCode::addi2, node, valRegister, valRegister, (int32_t)diff);
			else
...
lookupScheme3(TR::Node *node, bool unbalanced, TR::CodeGenerator *cg)
{
	...
	if (isInt64) {
		dataTableSize *= 2;
		dataTable64 =
		        (int64_t *)cg->allocateCodeMemory(dataTableSize, cg->getCurrentEvaluationBlock()->isCold());
	} else
	...
	if (TR::Compiler->target.is64Bit()) {
		...
		if (offset != PTOC_FULL_INDEX) {
			...
			if (offset < LOWER_IMMED || offset > UPPER_IMMED) {
				generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::addis, node, addrRegister,
				        cg->getTOCBaseRegister(), cg->hiValue(offset));
	...
	else // if 32bit mode
	{
		rel1 = generateTrg1ImmInstruction(
		        cg, TR::InstOpCode::lis, node, addrRegister, cg->hiValue(address) & 0x0000ffff);

		if (isInt64) {
			nextAddress = LO_VALUE(address);
			if (nextAddress == 32760) {
				rel2 = generateTrg1MemInstruction(cg, TR::InstOpCode::lwz, node,
				        dataRegister->getHighOrder(),
				        new (cg->trHeapMemory()) TR::MemoryReference(addrRegister, nextAddress, 4, cg));
				nextAddress += 4;
				rel2 = generateTrg1MemInstruction(cg, TR::InstOpCode::lwzu, node,
		...
		cg->getAheadOfTimeCompile()->getRelocationList().push_front(
		        new (cg->trHeapMemory()) TR::PPCPairedRelocation(
		                rel1, rel2, (uint8_t *)recordInfo, TR_AbsoluteMethodAddressOrderedPair, node));
	...
	for (int32_t ii = 2; ii < total; ii++) {
		...
		if (isInt64) {
			if (TR::Compiler->target.is64Bit()) {
				...
				generateTrg1Src2Instruction(cg, TR::InstOpCode::cmp4, node, cndRegister,
				        selector->getHighOrder(), dataRegister->getHighOrder());
				generateConditionalBranchInstruction(
				        cg, TR::InstOpCode::bne, node, toDefaultLabel, cndRegister);
				generateTrg1Src2Instruction(cg, TR::InstOpCode::cmp4, node, cndRegister,
				        selector->getLowOrder(), dataRegister->getLowOrder());
			}
		} else {
			generateTrg1Src2Instruction(
		...
		if (ii < total - 1) {
			if (isInt64) {
				if (TR::Compiler->target.is64Bit()) {
					...
					if (nextAddress == 32760) {
						generateTrg1MemInstruction(cg, TR::InstOpCode::lwz, node,
						        dataRegister->getHighOrder(),
						        new (cg->trHeapMemory())
						                TR::MemoryReference(addrRegister, nextAddress, 4, cg));
						nextAddress += 4;
						generateTrg1MemInstruction(cg, TR::InstOpCode::lwzu, node,
						        dataRegister->getLowOrder(),
						        new (cg->trHeapMemory())
						                TR::MemoryReference(addrRegister, nextAddress, 4, cg));
						nextAddress = 4;
...
lookupScheme4(TR::Node *node, TR::CodeGenerator *cg)
{
	...
	if (secondChild->getNumChildren() > 0) {
		...
		conditions = conditions->clone(
		        cg, generateRegisterDependencyConditions(cg, secondChild->getFirstChild(), 0));
	}
	...
	if (TR::Compiler->target.is64Bit()) {
		...
		if (offset != PTOC_FULL_INDEX) {
			...
			TR_PPCTableOfConstants::setTOCSlot(offset, address);
			if (offset < LOWER_IMMED || offset > UPPER_IMMED) {
				generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::addis, node, pivotRegister,
				        cg->getTOCBaseRegister(), cg->hiValue(offset));
				generateTrg1MemInstruction(cg, TR::InstOpCode::Op_load, node, addrRegister,
				        new (cg->trHeapMemory())
			...
			loadAddressConstant(
			        cg, cg->needRelocationsForLookupEvaluationData(), node, address, addrRegister);
		}
	} else {
...
TR::Register *
OMR::Power::TreeEvaluator::lookupEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
        ...
        TR::CodeGenerator *cg, TR::Register *trgReg, TR::Node *node, bool nullPtrSymRefRequired)
{
	...
	if (cg->getHasResumableTrapHandler()) {
		...
		if (snippetLabel == NULL) {
			...
			cg->addSnippet(
			        new (cg->trHeapMemory()) TR::PPCHelperCallSnippet(cg, node, snippetLabel, symRef));
		}
		...
		if (TR::Compiler->target.cpu.id() >= TR_PPCgp)
			...
			gcPoint = generateDepConditionalBranchInstruction(cg, TR::InstOpCode::beql,
			        PPCOpProp_BranchUnlikely, node, snippetLabel, condReg, conditions);
		else
...
TR::Register *
OMR::Power::TreeEvaluator::ZEROCHKEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	...
	TR_PPCOutOfLineCodeSection *outlinedHelperCall = new (cg->trHeapMemory())
	        TR_PPCOutOfLineCodeSection(node, TR::call, NULL, slowPathLabel, restartLabel, cg);
	...
	if (valueToCheck->getOpCode().isBooleanCompare() && valueToCheck->getChild(0)->getOpCode().isIntegerOrAddress()
		...
		if (valueToCheck->getOpCode().isCompareForOrder()) {
			if (valueToCheck->getChild(0)->getOpCode().is8Byte()
				...
				TR::TreeEvaluator::compareLongsForOrder(branchOp, reverseBranchOp, slowPathLabel,
				        valueToCheck, cg, valueToCheck->getOpCode().isUnsignedCompare(), true,
...
virtualGuardHelper(TR::Node *node, TR::CodeGenerator *cg)
{
	...
	if (cg->comp()->compileRelocatableCode()) {
		...
		case TR_HCRGuard: aotSite->setGuard(virtualGuard); break;

		case TR_ProfiledGuard: break;

		default:
			TR_ASSERT(0,
			        "got AOT guard in node but virtual guard not one of known guards supported for AOT. "
			        "Guard: %d",
...
generateMaxMin(TR::Node *node, TR::CodeGenerator *cg, bool max)
{
	...
	case TR::imax:
	case TR::imin: cmp_op = TR::InstOpCode::cmp4; break;
	case TR::iumax:
	case TR::iumin: cmp_op = TR::InstOpCode::cmpl4; break;
	case TR::lmax:
	case TR::lmin: cmp_op = TR::InstOpCode::cmp8; break;
	case TR::lumax:
	case TR::lumin: cmp_op = TR::InstOpCode::cmpl8; break;
	case TR::fmax:
	case TR::fmin:
	case TR::dmax:
	case TR::dmin: cmp_op = TR::InstOpCode::fcmpu; break;
	...
	if (cg->canClobberNodesRegister(child)) {
		...
		switch (data_type) {
		case TR::Int32: trgReg = cg->allocateRegister(); break;
		case TR::Int64:
			if (two_reg)
			...
			break;
		case TR::Float: trgReg = cg->allocateSinglePrecisionRegister(); break;
		case TR::Double: trgReg = cg->allocateRegister(TR_FPR); break;
		default: TR_ASSERT(false, "assertion failure");
		}
		if (two_reg) {
	...
	for (int i = 1; i < n; i++) {
		...
		if (two_reg) {
			...
			generateConditionalBranchInstruction(
			        cg, max ? TR::InstOpCode::bge : TR::InstOpCode::ble, node, label, condReg);
			generateTrg1Src1Instruction(cg, move_op, node, trgReg, reg);
...
TR::Register *
OMR::Power::TreeEvaluator::ifxcmpoEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	...
	generateTrg1Src1ImmInstruction(
	        cg, nodeIs64Bit ? TR::InstOpCode::cmpi8 : TR::InstOpCode::cmpi4, node, cr, res, 0);
