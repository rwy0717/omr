...
TR_MethodParameterIterator* TR_Method::getParameterIterator(TR::Compilation&, TR_ResolvedMethod*)
{
...
{
    notImplemented("isInterpretedForHeuristics");
    return false;
}
...
{
    notImplemented("ConstantDynamic");
    return 0;
}
...
void TR_ResolvedMethod::setMethodHandleLocation(uintptrj_t* location) { notImplemented("setMethodHandleLocation"); }
