...
enum TR_Hotness
        ...
        : int8_t // use only 8 bits to save space; The ifdef is needed because xlC BE compiler does not accept the
                 // syntax
#endif
{ noOpt,
	deadCold = noOpt,
...
public:
	...
	TR_PrefetchInfo(TR::TreeTop *defTree, TR::TreeTop *useTree, TR::Node *addrNode, TR::Node *useNode,
