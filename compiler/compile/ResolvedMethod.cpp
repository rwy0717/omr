...
bool
TR_ResolvedMethod::isCold(TR::Compilation *, bool, TR::ResolvedMethodSymbol * /* = NULL */)
{
	TR_UNIMPLEMENTED();
	return false;
}
...
TR_OpaqueClassBlock *
TR_ResolvedMethod::getDeclaringClassFromFieldOrStatic(TR::Compilation *comp, int32_t cpIndex)
{
	TR_UNIMPLEMENTED();
	return 0;
}
...
char *
TR_ResolvedMethod::fieldName(int32_t, int32_t &, TR_Memory *, TR_AllocationKind kind)
{
	TR_UNIMPLEMENTED();
	return 0;
}
char *
TR_ResolvedMethod::staticName(int32_t, int32_t &, TR_Memory *, TR_AllocationKind kind)
{
	TR_UNIMPLEMENTED();
	return 0;
}
...
bool
TR_ResolvedMethod::fieldsAreSame(int32_t, TR_ResolvedMethod *, int32_t, bool &sigSame)
{
	TR_UNIMPLEMENTED();
	return false;
}
bool
TR_ResolvedMethod::staticsAreSame(int32_t, TR_ResolvedMethod *, int32_t, bool &sigSame)
{
	TR_UNIMPLEMENTED();
	return false;
}
...
bool
TR_ResolvedMethod::fieldAttributes(
...
bool
TR_ResolvedMethod::staticAttributes(
...
TR_ResolvedMethod *
TR_ResolvedMethod::getResolvedVirtualMethod(TR::Compilation *, int32_t, bool, bool *)
{
	TR_UNIMPLEMENTED();
	return 0;
}
...
TR_ResolvedMethod *
TR_ResolvedMethod::getResolvedHandleMethodWithSignature(TR::Compilation *, int32_t, char *)
{
	TR_UNIMPLEMENTED();
	return 0;
}
...
TR_ResolvedMethod::_genMethodILForPeeking(
...
TR_ResolvedMethod::makeParameterList(TR::ResolvedMethodSymbol *methodSym)
{
	...
	for (int32_t parmIndex = 0; parmIndex < parmSlots; ++parmIndex) {
		parmSymbol =
		        methodSym->comp()->getSymRefTab()->createParameterSymbol(methodSym, slot, parmType(parmIndex));
...
TR::SymbolReferenceTable *
TR_ResolvedMethod::genMethodILForPeeking(
