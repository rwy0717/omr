...
public:
	...
	virtual TR_ResolvedMethod *getResolvedStaticMethod(
	        TR::Compilation *, int32_t cpIndex, bool *unresolvedInCP = 0);
	virtual TR_ResolvedMethod *getResolvedSpecialMethod(
	        TR::Compilation *, int32_t cpIndex, bool *unresolvedInCP = 0);
	...
	virtual int32_t exceptionData(
	        int32_t exceptionNumber, int32_t *startIndex, int32_t *endIndex, int32_t *catchType);
	...
	/** \brief
	 *     Generate IL for a method for peeking even under method redefinition mode. To be called by optimizations
	 * that have protections against method redefinition, e.g. inlining with TR_HCRGuard.
	 *
	 *  \param methodSymbol
	...
	TR::SymbolReferenceTable *genMethodILForPeekingEvenUnderMethodRedefinition(
	        TR::ResolvedMethodSymbol *methodSymbol, TR::Compilation *comp, bool resetVisitCount = false,
	...
	virtual TR::SymbolReferenceTable *_genMethodILForPeeking(TR::ResolvedMethodSymbol *methodSymbol,
	        TR::Compilation *, bool resetVisitCount, TR_PrexArgInfo *argInfo);
