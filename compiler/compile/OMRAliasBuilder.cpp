...
OMR::AliasBuilder::createAliasInfo()
{
	...
	if (symRefTab()->element(TR::SymbolReferenceTable::contiguousArraySizeSymbol))
		defaultMethodUseAliases().set(symRefTab()
	...
	if (symRefTab()->element(TR::SymbolReferenceTable::vftSymbol))
		defaultMethodUseAliases().set(
		        symRefTab()->element(TR::SymbolReferenceTable::vftSymbol)->getReferenceNumber());
...
void
OMR::AliasBuilder::gatherLocalUseInfo(TR::Block *block, TR_BitVector &storeVector,
...
{
	static char *disableConservativeGenericIntShadowAliasing = feGetEnv("TR_"
	                                                                    "disableConservativeGenericIntShadowAliasin"
	                                                                    "g");
