...
public:
	...
	TR_RegisterAssignerState(TR::Machine *m)
	        : _machine(m), _registerFile(NULL), _registerAssociations(NULL), _spilledRegistersList(NULL)
	{}
...
public:
	...
	TR::Instruction *fpStackFXCH(
	        TR::Instruction *currentInstruction, TR::Register *virtReg, bool generateCode = true);
...
protected:
	Machine(uint8_t numIntRegs, uint8_t numFPRegs, TR::CodeGenerator *cg, TR::Register **registerAssociations,
	        uint8_t numGlobalGPRs, uint8_t numGlobal8BitGPRs, uint8_t numGlobalFPRs,
