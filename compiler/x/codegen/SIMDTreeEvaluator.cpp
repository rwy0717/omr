...
TR::Register* OMR::X86::TreeEvaluator::SIMDgetvelemEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
    ...
    case TR::VectorInt16:
        TR_ASSERT(
            false, "unsupported vector type %s in SIMDgetvelemEvaluator.\n", firstChild->getDataType().toString());
        break;
    case TR::VectorInt32:
        elementCount = 4;
    ...
    default:
        TR_ASSERT(
            false, "unrecognized vector type %s in SIMDgetvelemEvaluator.\n", firstChild->getDataType().toString());
    }
        ...
        } else // 2 == elementCount
        {
            ...
            if (TR::VectorInt64 == firstChild->getDataType()) {
                if (TR::Compiler->target.is32Bit()) {
                    ...
                    generateRegRegImmInstruction(
                        PSHUFDRegRegImm1, node, dstReg, srcVectorReg, (0 == elem) ? 0x03 : 0x01, cg);
