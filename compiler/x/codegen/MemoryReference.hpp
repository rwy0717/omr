...
public:
	...
	MemoryReference(intptrj_t disp, TR::CodeGenerator *cg) : OMR::MemoryReferenceConnector(disp, cg) {}
	...
	MemoryReference(TR::X86DataSnippet *cds, TR::CodeGenerator *cg) : OMR::MemoryReferenceConnector(cds, cg) {}

	MemoryReference(TR::LabelSymbol *label, TR::CodeGenerator *cg) : OMR::MemoryReferenceConnector(label, cg) {}
	...
	MemoryReference(TR::SymbolReference *symRef, TR::CodeGenerator *cg) : OMR::MemoryReferenceConnector(symRef, cg)
	{}
