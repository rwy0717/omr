...
public:
	X86RestartSnippet(TR::CodeGenerator *cg, TR::Node *n, TR::LabelSymbol *restartlab, TR::LabelSymbol *snippetlab,
	        bool isGCSafePoint)
	        : TR::Snippet(cg, n, snippetlab, isGCSafePoint), _restartLabel(restartlab), _forceLongRestartJump(false)
	{}
	...
	uint32_t estimateRestartJumpLength(
	        TR_X86OpCodes branchOp, int32_t estimatedSnippetLocation, TR::LabelSymbol *label)
	{
