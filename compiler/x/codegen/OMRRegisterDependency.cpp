        ...
        if (registers.find(globalReg)) {
            ...
            if (child->getOpCodeValue() == TR::PassThrough && globalReg->getKind() == TR_X87) {
                ...
                if ((fpChild->getDataType() == TR::Float) || (fpChild->getDataType() == TR::Double)) {
                    ...
                    for (int j = 0; j < TR_X86FPStackRegister::NumRegisters && fpGlobalReg != child->getRegister();
                         j++) {
                    ...
                    if (fpGlobalReg != child->getRegister()) {
                        ...
                        machine->setFPStackRegister(child->getGlobalRegisterNumber() - machine->getNumGlobalGPRs(),
                ...
                if (_dependencies[i].getGlobalFPRegister()) {
                    ...
                    if (assignedRegister) {
                        ...
                        int32_t currentStackHeight
                            = machine->getFPTopOfStack() - assignedRegister->getFPStackRegisterNumber();
