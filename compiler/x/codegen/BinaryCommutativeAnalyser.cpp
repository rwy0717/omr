...
void TR_X86BinaryCommutativeAnalyser::longDualMultiplyAnalyser(TR::Node* root)
{
    ...
    generateRegRegInstruction(
        MUL4AccReg, root, eax, r4, depsMul[0], _cg); //   2  MUL    R4          // EDX:EAX = al * bl
    ...
    generateRegRegInstruction(
        MUL4AccReg, root, eax, r3, depsMul[1], _cg); //   5  MUL    R3          // EDX:EAX = al * bh
    generateRegRegInstruction(XCHG4RegReg, root, r3, edx, _cg); //   6  XCHG   R3, EDX     // R3 = (al * bh)h; EDX = bh
    generateRegRegInstruction(
        ADD4RegReg, root, r2, eax, _cg); //   7  ADD    R2, EAX     // R2 = (al * bl)h + (al * bh)l
    ...
    generateRegRegInstruction(
        ADD4RegReg, root, r3, eax, _cg); //  12  ADD    R3, EAX     // R3 = (al * bh)l + (ah * bh)l
