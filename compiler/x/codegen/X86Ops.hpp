...
#define IA32OpProp_TestsSomeFlag \
	(IA32OpProp_TestsZeroFlag | IA32OpProp_TestsSignFlag | IA32OpProp_TestsCarryFlag \
	        | IA32OpProp_TestsOverflowFlag | IA32OpProp_TestsParityFlag)
...
class TR_X86OpCode {
	...
	struct OpCode_t {
		...
		inline uint8_t ImmediateSize() const
		{
			...
			case Immediate_0: return 0;
			case Immediate_S:
			case Immediate_1: return 1;
			case Immediate_2: return 2;
			case Immediate_4: return 4;
			case Immediate_8: return 8;
			}
		...
		// finalize instruction prefix information, currently only in-use for AVX instructions for VEX.vvvv
		// field
	...
	// Instructions from Group 7 OpCode Extensions need special handling as they requires specific low 3 bits of
	// ModR/M byte
