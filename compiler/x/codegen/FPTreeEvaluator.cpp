    ...
    TR::CodeGenerator* cg)
{
    ...
    if (((isFloat && cg->useSSEForSinglePrecision()) || (!isFloat && cg->useSSEForDoublePrecision())) && ((!firstRegister && !secondRegister) || (firstRegister && firstRegister->getKind() == TR_FPR) || (secondRegister && secondRegister->getKind() == TR_FPR))) {
