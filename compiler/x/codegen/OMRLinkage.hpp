...
public:
	...
	{
		switch (type) {
		case TR::Double: return Float8;
		case TR::Float: return Float4;
		case TR::Int64: return TR_MovDataTypes::Int8;
		case TR::Address: return TR::Compiler->target.is64Bit() ? TR_MovDataTypes::Int8 : TR_MovDataTypes::Int4;
		default: return Int4;
		}
	}
	...
	{
		switch (reg->getKind()) {
		case TR_GPR: return TR::Compiler->target.is64Bit() ? TR_MovDataTypes::Int8 : TR_MovDataTypes::Int4;
		case TR_FPR: return Float8;
		default: TR_ASSERT(0, "unsupported register kind"); return TR_MovDataTypes::Int8;
		}
	}

	static inline TR_X86OpCodes movOpcodes(TR_MovOperandTypes operandType, TR_MovDataTypes dataType)
	{
		TR_ASSERT(TR::Compiler->target.is64Bit() || dataType != TR_MovDataTypes::Int8,
...
protected:
	...
	void coerceFPReturnValueToXMMR(
	        TR::Node *, TR::RegisterDependencyConditions *, TR::MethodSymbol *, TR::Register *);
