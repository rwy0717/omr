...
public:
    ...
    X86LabelInstruction(TR::LabelSymbol* sym, TR_X86OpCodes op, TR::Instruction* precedingInstruction,
...
protected:
    ...
    {
        aboutToAssignRegister(getTargetRegister(), TR_ifUses64bitTarget, TR_ifModifies32or64bitTarget);
    }
};
...
protected:
    ...
    {
        aboutToAssignRegister(getSourceRegister(), TR_if64bitSource, TR_ifModifies32or64bitSource);
    }
};
...
inline TR::X86LabelInstruction* generateLabelInstruction(
    TR::Instruction* i, TR_X86OpCodes op, TR::LabelSymbol* sym, bool needsVMThreadRegister, TR::CodeGenerator* cg)
{
