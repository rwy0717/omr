...
public:
    ...
    enum TR_UpperHalfRefConditions {
        ...
        TR_ifUses64bitSourceOrTarget, // A conservative default for when to setIsUpperHalfDead(true).  Shouldn't really
                                      // be needed.
    ...
    void aboutToAssignUsedRegister(
        TR::Register* reg, TR_UpperHalfRefConditions usesUpperHalf = TR_ifUses64bitSourceOrTarget);
    void aboutToAssignDefdRegister(TR::Register* reg, TR_UpperHalfRefConditions defsUpperHalf = TR_never);

    void aboutToAssignRegister(TR::Register* reg,
    ...
    void aboutToAssignRegDeps(TR_UpperHalfRefConditions usesUpperHalf = TR_ifUses64bitSourceOrTarget,
        TR_UpperHalfRefConditions defsUpperHalf = TR_never);
