...
TR::Register *
OMR::X86::I386::TreeEvaluator::longArithmeticCompareRegisterWithImmediate(TR::Node *node, TR::Register *cmpRegister,
        ...
        TR::Node *node, TR_X86OpCodes highSetOpCode, TR_X86OpCodes lowSetOpCode, TR::CodeGenerator *cg)
{
	...
	if (secondChild->getOpCodeValue() == TR::lconst && testRegister == NULL
	        && performTransformation(comp,
	                "O^O compareLongAndSetOrderedBoolean: checking that the second child node does not have an "
	                "assigned register: %d\n",
	                testRegister)) {
...
void
OMR::X86::I386::TreeEvaluator::compareLongsForOrder(TR::Node *node, TR_X86OpCodes highOrderBranchOp,
        TR_X86OpCodes highOrderReversedBranchOp, TR_X86OpCodes lowOrderBranchOp, TR::CodeGenerator *cg)
{
	...
	if (secondChild->getOpCodeValue() == TR::lconst && testRegister == NULL
	        && performTransformation(comp,
	                "O^O compareLongsForOrder: checking that the second child node does not have an assigned "
	                "register: %d\n",
	                testRegister)) {
		int32_t lowValue = secondChild->getLongIntLow();
		int32_t highValue = secondChild->getLongIntHigh();
...
//
TR::Register *
OMR::X86::I386::TreeEvaluator::aconstEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
...
TR::Register *
OMR::X86::I386::TreeEvaluator::lconstEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
...
TR::Register *
OMR::X86::I386::TreeEvaluator::lstoreEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	TR::Compilation *comp = cg->comp();
	TR::Node *valueChild;
		...
		if (valueReg) {
			...
			if (isVolatile) {
				if (cg->useSSEForDoublePrecision()
					...
					instr = generateRegMemInstruction(L4RegMem, node, eaxReg, lowMR, cg); // forming
					                                                                      // the
					                                                                      // EDX:EAX
					                                                                      // pair
					...
					generateRegRegInstruction(MOV4RegReg, node, ebxReg, valueReg->getLowOrder(),
				...
				instr = generateRegMemInstruction(L4RegMem, node, eaxReg, lowMR, cg); // forming the
				                                                                      // EDX:EAX pair
				generateRegMemInstruction(L4RegMem, node, edxReg, highMR, cg);
				lowMR->setIgnoreVolatile();
				highMR->setIgnoreVolatile();
				...
				TR::MemoryReference *cmpxchgMR = generateX86MemoryReference(node, cg);
				generateMemInstruction(TR::Compiler->target.isSMP() ? LCMPXCHG8BMem : CMPXCHG8BMem,
...
TR::Register *
OMR::X86::I386::TreeEvaluator::integerPairReturnEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	...
	if (cg->enableSinglePrecisionMethods() && comp->getJittedMethodSymbol()->usesSinglePrecisionMode()) {
		generateMemInstruction(LDCWMem, node,
		        generateX86MemoryReference(
		                cg->findOrCreate2ByteConstant(node, DOUBLE_PRECISION_ROUND_TO_NEAREST), cg),
		        cg);
	}
...
TR::Register *
OMR::X86::I386::TreeEvaluator::integerPairAddEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
...
TR::Register *
OMR::X86::I386::TreeEvaluator::integerPairSubEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	TR::Node *firstChild = node->getFirstChild();
	TR::Node *secondChild = node->getSecondChild();
	TR::Register *targetRegister = NULL;
...
TR::Register *
OMR::X86::I386::TreeEvaluator::integerPairDualMulEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
...
TR::Register *
OMR::X86::I386::TreeEvaluator::integerPairMulEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	...
	if (secondChild->getOpCodeValue() == TR::lconst) {
		...
		if (lowValue == 0 && highValue == 0) {
			...
			if (absValue == 3 || absValue == 5 || absValue == 9) {
				...
				if (firstIU2L && firstChild->getReferenceCount() == 1
					...
					multiplierRegister = cg->evaluate(firstChild);
				        ...
				        && firstChild->getReferenceCount() == 1 && firstChild->getRegister() == 0) {
					firstChild = firstChild->getFirstChild();
				...
				TR_X86IntegerMultiplyDecomposer *mulDecomposer = new (cg->trHeapMemory())
				        TR_X86IntegerMultiplyDecomposer((int64_t)absValue, multiplierRegister, node, cg,
			...
			if (!firstIU2L && !intMul) {
				generateRegRegInstruction(TEST4RegReg, node, multiplierRegister->getHighOrder(),
				...
				TR_X86IntegerMultiplyDecomposer *mulDecomposer = new (cg->trHeapMemory())
				        TR_X86IntegerMultiplyDecomposer((int64_t)lowValue,
				                multiplierRegister->getHighOrder(), node, cg,
				                firstChild->getReferenceCount() == 1 ? true : false);
				TR::Register *tempRegister =
				        mulDecomposer->decomposeIntegerMultiplier(tempRegArraySize, tempRegArray);
				...
				if (tempRegister == 0) // decomposition failed
				{
					...
					generateRegRegImmInstruction(opCode, node, tempRegister,
					        multiplierRegister->getHighOrder(), lowValue, cg);
				}
		...
		} else // i.e. if (highValue !=0 && lowValue != 0)
		{
			...
			if (absValue == 3 || absValue == 5 || absValue == 9) {
				...
				TR_X86IntegerMultiplyDecomposer *mulDecomposer = new (cg->trHeapMemory())
				        TR_X86IntegerMultiplyDecomposer((int64_t)absValue, sourceLow, node, cg,
				...
				if (tempRegister == 0) {
					tempRegister = cg->allocateRegister();
					TR_ASSERT(
					        tempRegArraySize <= TR_X86IntegerMultiplyDecomposer::MAX_NUM_REGISTERS,
					        "Too many temporary registers to handle");
					tempRegArray[tempRegArraySize++] = tempRegister;
...
TR::Register *
OMR::X86::I386::TreeEvaluator::integerPairDivEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
#ifdef J9_PROJECT_SPECIFIC
	TR::Node *firstChild = node->getFirstChild();
	TR::Node *secondChild = node->getSecondChild();
	...
	divInstr = generateRegRegInstruction(
	        DIV4AccReg, node, lowRegister, secondRegister->getLowOrder(), idivDependencies, cg);
...
TR::Register *
OMR::X86::I386::TreeEvaluator::integerPairRemEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
...
TR::Register *
OMR::X86::I386::TreeEvaluator::integerPairNegEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	TR::Node *firstChild = node->getFirstChild();
...
TR::Register *
OMR::X86::I386::TreeEvaluator::integerPairAbsEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
...
TR::Register *
OMR::X86::I386::TreeEvaluator::integerPairShlEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	TR::Register *targetRegister;
	TR::Node *secondChild = node->getSecondChild();
	TR::Node *firstChild = node->getFirstChild();
	if (secondChild->getOpCodeValue() == TR::iconst) {
		...
		if (value == 0) {
			...
			generateRegRegInstruction(
			        MOV4RegReg, node, targetRegister->getHighOrder(), tempRegister->getHighOrder(), cg);
			TR::MemoryReference *tempMR = generateX86MemoryReference(cg);
			...
			generateRegRegImmInstruction(SHLD4RegRegImm1, node, targetRegister->getHighOrder(),
		...
		generateRegRegInstruction(SHLD4RegRegCL, node, targetRegister->getHighOrder(),
		...
		generateRegRegInstruction(
		        CMOVNE4RegReg, node, targetRegister->getHighOrder(), targetRegister->getLowOrder(), cg);
...
TR::Register *
OMR::X86::I386::TreeEvaluator::integerPairRolEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	TR::Register *targetRegister;
	TR::Node *firstChild = node->getFirstChild();
	TR::Node *secondChild = node->getSecondChild();
	...
	if (secondChild->getOpCode().isLoadConst()) {
		...
		if (value != 0) {
			...
			if (value != 0) {
				...
				generateRegRegImmInstruction(
				        SHLD4RegRegImm1, node, targetRegister->getLowOrder(), tempHighReg, value, cg);
		...
		generateRegRegInstruction(SHLD4RegRegCL, node, targetRegister->getHighOrder(),
		        targetRegister->getLowOrder(), shiftDependencies, cg);
		generateRegRegInstruction(
		        SHLD4RegRegCL, node, targetRegister->getLowOrder(), scratchReg, shiftDependencies, cg);
...
TR::Register *
OMR::X86::I386::TreeEvaluator::integerPairShrEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	TR::Node *secondChild = node->getSecondChild();
	TR::Node *firstChild = node->getFirstChild();
	TR::Register *targetRegister;
	if (secondChild->getOpCodeValue() == TR::iconst) {
		...
		if (value == 0)
			...
			generateRegRegImmInstruction(SHRD4RegRegImm1, node, targetRegister->getLowOrder(),
			...
			generateRegRegInstruction(
			        MOV4RegReg, node, targetRegister->getLowOrder(), targetRegister->getHighOrder(), cg);
		...
		TR::Register *scratchReg = cg->allocateRegister();
		generateRegRegInstruction(SHRD4RegRegCL, node, targetRegister->getLowOrder(),
		...
		generateRegImmInstruction(TEST1RegImm1, node, shiftAmountReg, 32, cg);
		generateRegRegInstruction(
		        CMOVNE4RegReg, node, targetRegister->getLowOrder(), targetRegister->getHighOrder(), cg);
...
TR::Register *
OMR::X86::I386::TreeEvaluator::integerPairUshrEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	TR::Node *secondChild = node->getSecondChild();
	TR::Node *firstChild = node->getFirstChild();
	TR::Register *targetRegister;
...
TR::Register *
OMR::X86::I386::TreeEvaluator::landEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	TR::Register *targetRegister = NULL;
	TR::Node *firstChild = node->getFirstChild();
	TR::Node *secondChild = node->getSecondChild();
	...
	if (secondChild->getOpCodeValue() == TR::lconst && secondChild->getRegister() == NULL) {
		...
		temp.genericLongAnalyser(
		        node, AND4RegReg, AND4RegReg, AND4RegMem, AND2RegMem, AND1RegMem, AND4RegMem, MOV4RegReg);
...
TR::Register *
OMR::X86::I386::TreeEvaluator::lorEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	TR::Register *targetRegister = NULL;
	...
	if (secondChild->getOpCodeValue() == TR::lconst && secondChild->getRegister() == NULL) {
		...
		temp.genericLongAnalyser(
		        node, OR4RegReg, OR4RegReg, OR4RegMem, OR2RegMem, OR1RegMem, OR4RegMem, MOV4RegReg);
...
TR::Register *
OMR::X86::I386::TreeEvaluator::lxorEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	TR::Register *targetRegister = NULL;
	TR::Node *firstChild = node->getFirstChild();
	TR::Node *secondChild = node->getSecondChild();
	...
	if (secondChild->getOpCodeValue() == TR::lconst && secondChild->getRegister() == NULL) {
		...
		temp.genericLongAnalyser(
		        node, XOR4RegReg, XOR4RegReg, XOR4RegMem, XOR2RegMem, XOR1RegMem, XOR4RegMem, MOV4RegReg);
...
TR::Register *
OMR::X86::I386::TreeEvaluator::l2iEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	TR::Node *child = node->getFirstChild();
	TR::Register *targetRegister;
...
TR::Register *
OMR::X86::I386::TreeEvaluator::ifacmpeqEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
...
TR::Register *
OMR::X86::I386::TreeEvaluator::acmpeqEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
...
TR::Register *
OMR::X86::I386::TreeEvaluator::lcmpeqEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	TR::Node *secondChild = node->getSecondChild();
	TR::Register *targetRegister;
	if (secondChild->getOpCodeValue() == TR::lconst && secondChild->getRegister() == NULL) {
...
TR::Register *
OMR::X86::I386::TreeEvaluator::lcmpneEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	TR::Node *secondChild = node->getSecondChild();
	TR::Register *targetRegister;
	if (secondChild->getOpCodeValue() == TR::lconst && secondChild->getRegister() == NULL) {
...
TR::Register *
OMR::X86::I386::TreeEvaluator::lcmpltEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	return compareLongAndSetOrderedBoolean(node, SETL1Reg, SETB1Reg, cg);
}

TR::Register *
OMR::X86::I386::TreeEvaluator::lcmpgeEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	return compareLongAndSetOrderedBoolean(node, SETG1Reg, SETAE1Reg, cg);
}

TR::Register *
OMR::X86::I386::TreeEvaluator::lcmpgtEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	return compareLongAndSetOrderedBoolean(node, SETG1Reg, SETA1Reg, cg);
}

TR::Register *
OMR::X86::I386::TreeEvaluator::lcmpleEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	return compareLongAndSetOrderedBoolean(node, SETL1Reg, SETBE1Reg, cg);
}

TR::Register *
OMR::X86::I386::TreeEvaluator::lucmpltEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	return compareLongAndSetOrderedBoolean(node, SETB1Reg, SETB1Reg, cg);
}

TR::Register *
OMR::X86::I386::TreeEvaluator::lucmpgeEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	return compareLongAndSetOrderedBoolean(node, SETA1Reg, SETAE1Reg, cg);
}

TR::Register *
OMR::X86::I386::TreeEvaluator::lucmpgtEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	return compareLongAndSetOrderedBoolean(node, SETA1Reg, SETA1Reg, cg);
}

TR::Register *
OMR::X86::I386::TreeEvaluator::lucmpleEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
...
// also handles lucmp
TR::Register *
OMR::X86::I386::TreeEvaluator::lcmpEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	TR::Node *secondChild = node->getSecondChild();
	TR::Node *firstChild = node->getFirstChild();
	TR::Register *targetRegister;
...
TR::Register *
OMR::X86::I386::TreeEvaluator::lRegLoadEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
...
TR::Register *
OMR::X86::I386::TreeEvaluator::i2lEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	TR::Node *child = node->getFirstChild();
...
TR::Register *
OMR::X86::I386::TreeEvaluator::iu2lEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	TR::Node *child = node->getFirstChild();
	TR::Register *childReg = cg->intClobberEvaluate(child);
	TR::Register *highReg = cg->allocateRegister();
...
TR::Register *
OMR::X86::I386::TreeEvaluator::b2lEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	TR::Node *child = node->getFirstChild();
	TR::Register *longReg;
...
TR::Register *
OMR::X86::I386::TreeEvaluator::bu2lEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	TR::Node *child = node->getFirstChild();
	TR::Register *longReg;
...
TR::Register *
OMR::X86::I386::TreeEvaluator::s2lEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	TR::Node *child = node->getFirstChild();
	TR::Register *longReg;
...
TR::Register *
OMR::X86::I386::TreeEvaluator::su2lEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	TR::Node *child = node->getFirstChild();
	TR::Register *longReg;
...
TR::Register *
OMR::X86::I386::TreeEvaluator::c2lEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	TR::Node *child = node->getFirstChild();
	TR::Register *longReg;
...
TR::Register *
OMR::X86::I386::TreeEvaluator::dstoreEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	...
	if ((valueChild->getOpCodeValue() == TR::lbits2d) && !valueChild->getRegister()) {
		...
		if (valueChild->getOpCode().isLoadConst()) {
			instr = generateMemImmInstruction(S4MemImm4, node,
			...
			generateRegMemInstruction(
			        L4RegMem, node, tempRegister, generateX86MemoryReference(*loadLowMR, 4, cg), cg);
			instr = generateMemRegInstruction(
			        S4MemReg, node, generateX86MemoryReference(*storeLowMR, 4, cg), tempRegister, cg);
...
TR::Register *
OMR::X86::I386::TreeEvaluator::l2fEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	TR::Node *child = node->getFirstChild();
	...
	if (child->getRegister() == NULL && child->getReferenceCount() == 1 && child->getOpCode().isLoadVar()) {
		...
		generateMemRegInstruction(
		        S4MemReg, node, generateX86MemoryReference(*lowMR, 4, cg), longReg->getHighOrder(), cg);
...
TR::Register *
OMR::X86::I386::TreeEvaluator::l2dEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	TR::Node *child = node->getFirstChild();
...
TR::Register *
OMR::X86::I386::TreeEvaluator::performLload(TR::Node *node, TR::MemoryReference *sourceMR, TR::CodeGenerator *cg)
{
	TR::Compilation *comp = cg->comp();
	...
	if (isVolatile || (symRef && symRef->isUnresolved())) {
		...
		if (cg->useSSEForDoublePrecision()
		        && performTransformation(
		                comp, "O^O Using SSE for volatile load %s\n", cg->getDebug()->getName(node))) {
			...
			generateMemInstruction(
			        TR::Compiler->target.isSMP() ? LCMPXCHG8BMem : CMPXCHG8BMem, node, sourceMR, deps, cg);
		...
		highRegister = loadMemory(
		        node, generateX86MemoryReference(*sourceMR, 4, cg), TR_RematerializableInt, false, cg);
...
// also handles ilload
TR::Register *
OMR::X86::I386::TreeEvaluator::lloadEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
...
TR::Register *
OMR::X86::I386::TreeEvaluator::lbits2dEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	TR::Node *child = node->getFirstChild();
	...
	if (child->getRegister() == NULL && child->getOpCode().isLoadVar() && child->getReferenceCount() == 1) {
		...
		generateMemRegInstruction(
		        S4MemReg, node, generateX86MemoryReference(*tempMR, 4, cg), longReg->getHighOrder(), cg);
...
TR::Register *
OMR::X86::I386::TreeEvaluator::dbits2lEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	TR::Node *child = node->getFirstChild();
...
TR::Register *
OMR::X86::I386::TreeEvaluator::iflcmpeqEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	TR::Compilation *comp = cg->comp();
	TR::Node *secondChild = node->getSecondChild();
	TR::LabelSymbol *destinationLabel = node->getBranchDestination()->getNode()->getLabel();
...
TR::Register *
OMR::X86::I386::TreeEvaluator::iflcmpneEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	TR::Compilation *comp = cg->comp();
	TR::Node *secondChild = node->getSecondChild();
	TR::LabelSymbol *destinationLabel = node->getBranchDestination()->getNode()->getLabel();
...
TR::Register *
OMR::X86::I386::TreeEvaluator::iflcmpltEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
...
TR::Register *
OMR::X86::I386::TreeEvaluator::iflcmpgeEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	if (generateLAddOrSubForOverflowCheck(node, cg)) {
...
TR::Register *
OMR::X86::I386::TreeEvaluator::iflcmpgtEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	TR_X86OpCodes compareOp = node->getOpCode().isUnsigned() ? JA4 : JG4;
	TR_X86OpCodes reverseCompareOp = node->getOpCode().isUnsigned() ? JB4 : JL4;
...
TR::Register *
OMR::X86::I386::TreeEvaluator::iflcmpleEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	TR_X86OpCodes compareOp = node->getOpCode().isUnsigned() ? JB4 : JL4;
	TR_X86OpCodes reverseCompareOp = node->getOpCode().isUnsigned() ? JA4 : JG4;
...
TR::Register *
OMR::X86::I386::TreeEvaluator::lternaryEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	...
	bool longCompare =
	        (condition->getOpCode().isBooleanCompare() && condition->getFirstChild()->getOpCode().isLong());
	if (!longCompare && condOp.isCompareForEquality()
		...
		if (condOp.isCompareTrueIfEqual()) {
			generateRegRegInstruction(CMOVNE4RegReg, node, trueReg->getRegisterPair()->getLowOrder(),
			...
			generateRegRegInstruction(CMOVE4RegReg, node, trueReg->getRegisterPair()->getLowOrder(),
			        falseReg->getRegisterPair()->getLowOrder(), cg);
		...
		generateRegRegInstruction((condOp.isCompareTrueIfEqual())
		        ...
		        node, trueReg->getRegisterPair()->getLowOrder(), falseReg->getRegisterPair()->getLowOrder(),
		        cg);
		generateRegRegInstruction((condOp.isCompareTrueIfEqual())
		                ? ((condOp.isCompareTrueIfGreater()) ? CMOVL4RegReg : CMOVG4RegReg)
		                : ((condOp.isCompareTrueIfGreater()) ? CMOVLE4RegReg : CMOVGE4RegReg),
		        node, trueReg->getRegisterPair()->getHighOrder(), falseReg->getRegisterPair()->getHighOrder(),
		        cg);
	} else {
...
OMR::X86::I386::TreeEvaluator::integerPairMinMaxEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	...
	case TR::lmax:
		...
		SETccLo = SETA1Reg;
		break;
	default: TR_ASSERT(false, "INCORRECT IL OPCODE."); break;
	}
	...
	generateRegRegInstruction(CMOVE4RegReg, node, result->getHighOrder(), result->getLowOrder(), cg); // if (high0
	                                                                                                  // == high1)
	                                                                                                  // then t2 =
	                                                                                                  // t1 = (low0
	                                                                                                  // < low1)
...
OMR::X86::I386::TreeEvaluator::lcmpsetEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	...
	TR::Register *compareReg = cg->longClobberEvaluate(compareValue); // clobber evaluate because edx:eax may
...
TR::Register *
OMR::X86::I386::TreeEvaluator::awrtbarEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
...
TR::Register *
OMR::X86::I386::TreeEvaluator::awrtbariEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
	// The wrtbar IL op represents a store with side effects.
	// Currently we don't use the side effect node. So just evaluate it and decrement the reference count.
