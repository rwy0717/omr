...
class AMD64Win64FastCallLinkage : public virtual TR::AMD64SystemLinkage {
	...
	// instructions. R12:R15                   Nonvolatile   Must be preserved by called function. RDI Nonvolatile
	// Must be preserved by called function. RSI                       Nonvolatile   Must be preserved by called
	// function. RBX                       Nonvolatile   Must be preserved by called function. RBP Nonvolatile   Can
	// be used as a frame pointer. Must be preserved by called function. RSP                       Nonvolatile Stack
	// Pointer. XMM0                      Volatile      First FP argument. XMM1                      Volatile Second
	// FP argument. XMM2                      Volatile      Third FP argument. XMM3                      Volatile
	// Fourth FP argument. XMM4:XMM5                 Volatile      Must be preserved as required by caller.
	...
	//
	// In the case of the nonvolatile XMM registers, only the lower 64 bits must be preserved by the called
	// function. The 128-bit values that are stored in the XMM register should not be registered across calls.
	//
...
class AMD64ABILinkage : public virtual TR::AMD64SystemLinkage {
	// Register                  Status        Use
	// --------                  ------        ---
	// RAX                       Volatile      Temporary register; with variable arguments passes information about
	// the
	...
	// R10                       Volatile      Temporary register, used for passing a function's static chain
	// pointer R11                       Volatile      Temporary register R12:R15                   Nonvolatile
	// Callee-saved registers XMM0:XMM1                 Volatile      Used to pass and return floating point
	// arguments. XMM2:XMM7                 Volatile      Used to pass floating point arguments XMM8:XMM15 Volatile
	// Temporary registers
	//
	// Arguments evaluation order: left to right
	// Argument cleanup done by  : caller
