...
OMR::X86::AMD64::Machine::Machine(TR::CodeGenerator *cg)
        : OMR::X86::Machine(AMD64_NUM_GPR, // TODO:AMD64: What do these actually do? Possibly
                ...
                TR::Machine::enableNewPickRegister() ? (AMD64_MAX_GLOBAL_GPRS - TR::Machine::numGPRRegsWithheld(cg))
                                                     : 8,
                TR::Machine::enableNewPickRegister() ? (AMD64_MAX_8BIT_GLOBAL_GPRS - TR::Machine::numRegsWithheld(cg))
                                                     : 8,
