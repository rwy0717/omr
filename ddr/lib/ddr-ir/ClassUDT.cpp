...
DDR_RC
ClassUDT::acceptVisitor(const TypeVisitor& visitor) { return visitor.visitClass(this); }

bool ClassUDT::operator==(const Type& rhs) const { return rhs.compareToClass(*this); }
