...
DDR_RC
Type::acceptVisitor(const TypeVisitor& visitor) { return visitor.visitType(this); }
...
void Type::addMacro(Macro* macro) { /* No-op: macros cannot be associated with base types. */ }
...
bool Type::operator==(const Type& rhs) const { return rhs.compareToType(*this); }
