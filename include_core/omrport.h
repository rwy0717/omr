...
#define omrsysinfo_is_running_in_container(param1) \
    privateOmrPortLibrary->sysinfo_is_running_in_container(privateOmrPortLibrary, param1)
...
#define omrsysinfo_cgroup_subsystem_iterator_next(param1, param2, param3, param4) \
    privateOmrPortLibrary->sysinfo_cgroup_subsystem_iterator_next(privateOmrPortLibrary, param1, param2, param3, param4)
