...
#define EsOpenForMapping \
	0x100 /* Required for WinCE for file memory mapping, ignored on other platforms. WINCE is not supported so \
	         this flag is obsolete now. */
...
typedef struct J9PortVmemParams {
	 ...
	 *			- used to allocate memory in 4K pages using system macros instead of malloc() or
	 *__malloc31() routines
	 ...
	 * 			- if this flag is set and the 2to32G support is not there omrvmem_reserve_memory_ex will
	 *return failure \arg OMRPORT_VMEM_ALLOC_QUICK
	 ...
	 *		- this option is based on the observation that mmap would take the given address as a hint about
	 *where to place the mapping
	 *		- this option does not apply to large page allocations as the allocation is done with shmat
	 *instead of mmap
	 */
	uintptr_t options;
...
#define OMRPORT_SIG_FLAG_SIGALLASYNC \
	(OMRPORT_SIG_FLAG_SIGALRM | OMRPORT_SIG_FLAG_SIGQUIT | OMRPORT_SIG_FLAG_SIGABRT | OMRPORT_SIG_FLAG_SIGTERM \
	        | OMRPORT_SIG_FLAG_SIGRECONFIG | OMRPORT_SIG_FLAG_SIGINT | OMRPORT_SIG_FLAG_SIGXFSZ \
	        | OMRPORT_SIG_FLAG_SIGCHLD | OMRPORT_SIG_FLAG_SIGTSTP | OMRPORT_SIG_FLAG_SIGIO \
	        | OMRPORT_SIG_FLAG_SIGHUP | OMRPORT_SIG_FLAG_SIGCONT | OMRPORT_SIG_FLAG_SIGWINCH \
	        | OMRPORT_SIG_FLAG_SIGUSR1 | OMRPORT_SIG_FLAG_SIGUSR2 | OMRPORT_SIG_FLAG_SIGURG \
	        | OMRPORT_SIG_FLAG_SIGXCPU | OMRPORT_SIG_FLAG_SIGVTALRM | OMRPORT_SIG_FLAG_SIGPROF \
	        | OMRPORT_SIG_FLAG_SIGPIPE | OMRPORT_SIG_FLAG_SIGSYS | OMRPORT_SIG_FLAG_SIGTTIN \
	        | OMRPORT_SIG_FLAG_SIGTTOU | OMRPORT_SIG_FLAG_SIGINFO | OMRPORT_SIG_FLAG_SIGIOT \
	        | OMRPORT_SIG_FLAG_SIGPOLL)
...
#define OMRPORT_SIG_FLAG_SIGALLASYNC \
	(OMRPORT_SIG_FLAG_SIGQUIT | OMRPORT_SIG_FLAG_SIGABRT | OMRPORT_SIG_FLAG_SIGTERM | OMRPORT_SIG_FLAG_SIGRECONFIG \
	        | OMRPORT_SIG_FLAG_SIGXFSZ | OMRPORT_SIG_FLAG_SIGINT | OMRPORT_SIG_FLAG_SIGHUP \
	        | OMRPORT_SIG_FLAG_SIGCONT | OMRPORT_SIG_FLAG_SIGWINCH | OMRPORT_SIG_FLAG_SIGPIPE \
	        | OMRPORT_SIG_FLAG_SIGALRM | OMRPORT_SIG_FLAG_SIGCHLD | OMRPORT_SIG_FLAG_SIGTSTP \
	        | OMRPORT_SIG_FLAG_SIGUSR1 | OMRPORT_SIG_FLAG_SIGUSR2 | OMRPORT_SIG_FLAG_SIGURG \
	        | OMRPORT_SIG_FLAG_SIGXCPU | OMRPORT_SIG_FLAG_SIGVTALRM | OMRPORT_SIG_FLAG_SIGPROF \
	        | OMRPORT_SIG_FLAG_SIGIO | OMRPORT_SIG_FLAG_SIGSYS)
...
typedef struct OMRPortLibrary {
	...
	int32_t (*sysinfo_env_iterator_init)(struct OMRPortLibrary *portLibrary,
	        struct J9SysinfoEnvIteratorState *state, void *buffer, uintptr_t bufferSizeBytes);
	...
	int32_t (*sysinfo_env_iterator_next)(struct OMRPortLibrary *portLibrary,
	        struct J9SysinfoEnvIteratorState *state, J9SysinfoEnvElement *envElement);
	...
	intptr_t (*file_blockingasync_read)(
	...
	intptr_t (*filestream_write_text)(struct OMRPortLibrary *portLibrary, OMRFileStream *fileStream,
	...
	int32_t (*filestream_setbuffer)(struct OMRPortLibrary *portLibrary, OMRFileStream *fileStream, char *buffer,
	...
	uintptr_t (*sl_lookup_name)(struct OMRPortLibrary *portLibrary, uintptr_t descriptor, char *name,
	        uintptr_t *func, const char *argSignature);
	...
	void *(*vmem_reserve_memory_ex)(struct OMRPortLibrary *portLibrary, struct J9PortVmemIdentifier *identifier,
	...
	intptr_t (*str_set_token)(struct OMRPortLibrary *portLibrary, struct J9StringTokens *tokens, const char *key,
	        const char *format, ...);
	/** see @ref omrstr.c::omrstr_subst_tokens "omrstr_subst_tokens"*/
	uintptr_t (*str_subst_tokens)(struct OMRPortLibrary *portLibrary, char *buf, uintptr_t bufLen,
	...
	int32_t (*str_convert)(struct OMRPortLibrary *portLibrary, int32_t fromCode, int32_t toCode,
	...
	void (*nls_vprintf)(struct OMRPortLibrary *portLibrary, uintptr_t flags, uint32_t module_name,
	...
	int32_t (*sig_register_os_handler)(struct OMRPortLibrary *portLibrary, uint32_t portlibSignalFlag,
	...
	uintptr_t (*str_ftime)(struct OMRPortLibrary *portLibrary, char *buf, uintptr_t bufLen, const char *format,
	        int64_t timeMillis);
	...
	int32_t (*sysinfo_cgroup_subsystem_iterator_metricKey)(struct OMRPortLibrary *portLibrary,
	...
	int32_t (*sock_getaddrinfo)(struct OMRPortLibrary *portLibrary, char *node, char *service,
	        omrsock_addrinfo_t hints, omrsock_addrinfo_t result);
	/** see @ref omrsock.c::omrsock_getaddrinfo_length "omrsock_getaddrinfo_length"*/
	int32_t (*sock_getaddrinfo_length)(
	...
	int32_t (*sock_socket)(struct OMRPortLibrary *portLibrary, omrsock_socket_t *sock, int32_t family,
	...
	int32_t (*cuda_deviceCanAccessPeer)(struct OMRPortLibrary *portLibrary, uint32_t deviceId,
	...
	int32_t (*cuda_deviceGetAttribute)(struct OMRPortLibrary *portLibrary, uint32_t deviceId,
	...
	int32_t (*cuda_deviceGetStreamPriorityRange)(struct OMRPortLibrary *portLibrary, uint32_t deviceId,
	...
	int32_t (*cuda_funcMaxPotentialBlockSize)(struct OMRPortLibrary *portLibrary, uint32_t deviceId,
	        J9CudaFunction function, J9CudaBlockToDynamicSharedMemorySize dynamicSharedMemoryFunction,
	        uintptr_t userData, uint32_t blockSizeLimit, uint32_t flags, uint32_t *minGridSizeOut,
	        uint32_t *maxBlockSizeOut);
	/** see @ref omrcuda.cpp::omrcuda_funcSetCacheConfig "omrcuda_funcSetCacheConfig" */
	int32_t (*cuda_funcSetCacheConfig)(struct OMRPortLibrary *portLibrary, uint32_t deviceId,
	...
	int32_t (*cuda_funcSetSharedMemConfig)(struct OMRPortLibrary *portLibrary, uint32_t deviceId,
	...
	int32_t (*cuda_linkerCreate)(struct OMRPortLibrary *portLibrary, uint32_t deviceId, J9CudaJitOptions *options,
	...
	int32_t (*cuda_memcpy2DDeviceToDevice)(struct OMRPortLibrary *portLibrary, uint32_t deviceId,
	...
	int32_t (*cuda_memcpyDeviceToHostAsync)(struct OMRPortLibrary *portLibrary, uint32_t deviceId,
	        void *targetAddress, const void *sourceAddress, uintptr_t byteCount, J9CudaStream stream);
	...
	int32_t (*cuda_memcpyHostToDeviceAsync)(struct OMRPortLibrary *portLibrary, uint32_t deviceId,
	        void *targetAddress, const void *sourceAddress, uintptr_t byteCount, J9CudaStream stream);
	...
	int32_t (*cuda_memcpyPeerAsync)(struct OMRPortLibrary *portLibrary, uint32_t targetDeviceId,
	...
	int32_t (*cuda_streamCreateWithPriority)(struct OMRPortLibrary *portLibrary, uint32_t deviceId,
	        int32_t priority, uint32_t flags, J9CudaStream *streamOut);
...
#define omrcuda_funcMaxActiveBlocksPerMultiprocessor( \
	...
	privateOmrPortLibrary->cuda_funcMaxActiveBlocksPerMultiprocessor(privateOmrPortLibrary, (deviceId), \
	        (function), (blockSize), (dynamicSharedMemorySize), (flags), (valueOut))
#define omrcuda_funcMaxPotentialBlockSize(deviceId, function, dynamicSharedMemoryFunction, userData, blockSizeLimit, \
	...
	privateOmrPortLibrary->cuda_funcMaxPotentialBlockSize(privateOmrPortLibrary, (deviceId), (function), \
	        (dynamicSharedMemoryFunction), (userData), (blockSizeLimit), (flags), (minGridSizeOut), \
	        (maxBlockSizeOut))
...
#define omrcuda_launchKernel(deviceId, function, gridDimX, gridDimY, gridDimZ, blockDimX, blockDimY, blockDimZ, \
	...
	privateOmrPortLibrary->cuda_launchKernel(privateOmrPortLibrary, (deviceId), (function), (gridDimX), \
	        (gridDimY), (gridDimZ), (blockDimX), (blockDimY), (blockDimZ), (sharedMemBytes), (stream), \
	        (kernelParms))
...
#define omrcuda_memcpyPeer(targetDeviceId, targetAddress, sourceDeviceId, sourceAddress, byteCount) \
	privateOmrPortLibrary->cuda_memcpyPeer(privateOmrPortLibrary, (targetDeviceId), (targetAddress), \
