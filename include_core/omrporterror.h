 ...
 *
 * Errors reported by the OS may be recorded by calling the port library functions @ref
 * omrerror.c::omrerror_set_last_error "omrerror_set_last_error()" or @ref
 * omrerror.c::omrerror_set_last_error_with_message "omrerror_set_last_error_with_message()" or @ref
 * omrerror.c::omrerror_set_last_error_with_message_format "omrerror_set_last_error_with_message_format()". The mapping
 * of the OS specific error code to a portable error code is the responsibility of the calling module.
 */
...
/**
 * @name Generic Errors
 * Generic error codes for modules that do not have their own specific errors.  Where possible it is recommended that
 * all modules that return error codes have their own set
 *
