 ...
 */
int64_t omrthread_get_self_user_time(omrthread_t self) { return omrthread_get_user_time(self); }
 ...
 *
 */
uintptr_t omrthread_get_stack_size(omrthread_t thread) { return thread->stacksize; }
