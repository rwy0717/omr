 ...
 */
MM_VerboseManager* MM_VerboseManager::newInstance(MM_EnvironmentBase* env, OMR_VM* vm)
{
...
MM_VerboseHandlerOutput* MM_VerboseManager::createVerboseHandlerOutputObject(MM_EnvironmentBase* env)
{
...
WriterType MM_VerboseManager::parseWriterType(
    MM_EnvironmentBase* env, char* filename, uintptr_t fileCount, uintptr_t iterations)
{
    MM_GCExtensionsBase* extensions = env->getExtensions();
...
MM_VerboseWriter* MM_VerboseManager::createWriter(
