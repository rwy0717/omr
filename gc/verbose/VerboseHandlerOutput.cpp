...
const char* MM_VerboseHandlerOutput::getCycleType(uintptr_t type) { return "unknown"; }
...
bool MM_VerboseHandlerOutput::hasAllocationFailureStartInnerStanzas() { return false; }
...
void MM_VerboseHandlerOutput::enterAtomicReportingBlock() { /* default implementation needs no special support */ }

void MM_VerboseHandlerOutput::exitAtomicReportingBlock() { /* default implementation needs no special support */ }
...
const char* MM_VerboseHandlerOutput::getSubSpaceType(uintptr_t typeFlags) { return "default"; }
