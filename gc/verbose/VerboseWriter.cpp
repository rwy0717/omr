...
const char* MM_VerboseWriter::getHeader(MM_EnvironmentBase* env) { return _header; }

const char* MM_VerboseWriter::getFooter(MM_EnvironmentBase* env) { return _footer; }

MM_VerboseWriter* MM_VerboseWriter::getNextWriter() { return _nextWriter; }

void MM_VerboseWriter::setNextWriter(MM_VerboseWriter* writer) { _nextWriter = writer; }
