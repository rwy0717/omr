 ...
 */
void MM_VerboseWriterStreamOutput::tearDown(MM_EnvironmentBase* env) { MM_VerboseWriter::tearDown(env); }

/**
 * Flushes the verbose buffer to the output stream.
 */
void MM_VerboseWriterStreamOutput::endOfCycle(MM_EnvironmentBase* env) { /* Nothing to really do */ }
