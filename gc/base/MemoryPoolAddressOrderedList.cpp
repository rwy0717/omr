 ...
 */
void* MM_MemoryPoolAddressOrderedList::getFirstFreeStartingAddr(MM_EnvironmentBase* env) { return _heapFreeList; }
 ...
 */
void MM_MemoryPoolAddressOrderedList::lock(MM_EnvironmentBase* env) { _heapLock.acquire(); }

/**
 * Unlock any free list information for use.
 */
void MM_MemoryPoolAddressOrderedList::unlock(MM_EnvironmentBase* env) { _heapLock.release(); }
