...
bool MM_OverflowSegregated::initialize(MM_EnvironmentBase* env) { return MM_WorkPacketOverflow::initialize(env); }

void MM_OverflowSegregated::tearDown(MM_EnvironmentBase* env) { MM_WorkPacketOverflow::tearDown(env); }
...
void MM_OverflowSegregated::fillFromOverflow(MM_EnvironmentBase* env, MM_Packet* packet) { Assert_MM_unreachable(); }
