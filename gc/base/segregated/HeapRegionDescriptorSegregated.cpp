...
void MM_HeapRegionDescriptorSegregated::joinFreeRangeComplete() { setFree(getRange()); }
...
uintptr_t MM_HeapRegionDescriptorSegregated::debugCountFreeBytes() { return _memoryPoolACL.debugCountFreeBytes(); }
