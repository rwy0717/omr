 ...
 *
 */
bool MM_SweepSchemeSegregated::initialize(MM_EnvironmentBase* env) { return true; }
...
void MM_SweepSchemeSegregated::preSweep(MM_EnvironmentBase* env) { _memoryPool->moveInUseToSweep(env); }

void MM_SweepSchemeSegregated::postSweep(MM_EnvironmentBase* env) { incrementalCoalesceFreeRegions(env); }
...
uintptr_t MM_SweepSchemeSegregated::resetCoalesceFreeRegionCount(MM_EnvironmentBase* env) { return 0; }

bool MM_SweepSchemeSegregated::updateCoalesceFreeRegionCount(uintptr_t range) { return false; }
