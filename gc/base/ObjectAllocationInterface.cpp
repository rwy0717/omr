 ...
 */
void MM_ObjectAllocationInterface::flushCache(MM_EnvironmentBase* env) { /* Do nothing */ }
 ...
 */
void MM_ObjectAllocationInterface::restartCache(MM_EnvironmentBase* env) { /* Do nothing */ }
