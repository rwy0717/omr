 ...
 */
enum { mm_msschild_iterator_current_subspace, /**< Process the current subspace */
	mm_msschild_iterator_children_subspace, /**< Process the children of the current subspace */
	mm_msschild_iterator_next_subspace /**< Move to the next sibling (or parent if unavailable) of the current
	                                      subspace */
};
