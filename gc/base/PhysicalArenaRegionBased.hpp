...
public:
protected:
	MM_PhysicalSubArenaRegionBased *_physicalSubArena; /**< The subarena attached to this arena (currently only one
	                                                      but more will be required before phase4 is over to support
	                                                      gencon) */
private:
public:
