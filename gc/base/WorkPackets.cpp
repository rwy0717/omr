...
void MM_WorkPackets::reset(MM_EnvironmentBase* env) { _overflowHandler->reset(env); }
 ...
 */
float MM_WorkPackets::getHeapCapacityFactor(MM_EnvironmentBase* env) { return (float)0.002; }
...
void MM_WorkPackets::clearOverflowFlag() { _overflowHandler->_overflow = false; }
