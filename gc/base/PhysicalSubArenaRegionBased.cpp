...
void MM_PhysicalSubArenaRegionBased::tearDown(MM_EnvironmentBase* env) { MM_PhysicalSubArena::tearDown(env); }
...
bool MM_PhysicalSubArenaRegionBased::canContract(MM_EnvironmentBase* env) { return _resizable; }
