...
uintptr_t MM_MemorySpace::getActiveMemorySize() { return getActiveMemorySize(getAllTypeFlags()); }
 ...
 * @return the total free memory currently available for allocation.
 */
uintptr_t MM_MemorySpace::getActualActiveFreeMemorySize() { return getActualActiveFreeMemorySize(getAllTypeFlags()); }
 ...
 */
uintptr_t MM_MemorySpace::maxExpansion(MM_EnvironmentBase* env) { return (uintptr_t)(_maximumSize - _currentSize); }
 ...
 *
 */
void MM_MemorySpace::heapReconfigured(MM_EnvironmentBase* env) { _heap->heapReconfigured(env); }
 ...
 * @return the amount by which the receiver can expand
 */
uintptr_t MM_MemorySpace::maxContraction(MM_EnvironmentBase* env) { return (uintptr_t)(_currentSize - _minimumSize); }
 ...
 */
uintptr_t MM_MemorySpace::getAllTypeFlags() { return MEMORY_TYPE_OLD | MEMORY_TYPE_NEW; }
