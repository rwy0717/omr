 ...
 */
uintptr_t MM_MemorySubSpaceGeneric::getMemoryPoolCount() { return _memoryPool->getMemoryPoolCount(); }

/**
 * Return the number of active memory pools associated to the receiver.
 * @return count of number of memory pools
 */
uintptr_t MM_MemorySubSpaceGeneric::getActiveMemoryPoolCount() { return _memoryPool->getActiveMemoryPoolCount(); }
 ...
 * @return MM_MemoryPool
 */
MM_MemoryPool* MM_MemorySubSpaceGeneric::getMemoryPool(void* addr) { return _memoryPool->getMemoryPool(addr); }
 ...
 * @return MM_MemoryPool
 */
MM_MemoryPool* MM_MemorySubSpaceGeneric::getMemoryPool(uintptr_t size) { return _memoryPool->getMemoryPool(size); }
...
uintptr_t MM_MemorySubSpaceGeneric::getActiveMemorySize() { return getCurrentSize(); }
 ...
 */
uintptr_t MM_MemorySubSpaceGeneric::getActualActiveFreeMemorySize() { return _memoryPool->getActualFreeMemorySize(); }
 ...
 ****************************************
 */
MM_MemorySubSpace* MM_MemorySubSpaceGeneric::getDefaultMemorySubSpace() { return _parent->getDefaultMemorySubSpace(); }

MM_MemorySubSpace* MM_MemorySubSpaceGeneric::getTenureMemorySubSpace() { return _parent->getTenureMemorySubSpace(); }
