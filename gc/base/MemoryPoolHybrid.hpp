...
private:
     ...
     */
    void appendToFreeList(MM_EnvironmentBase* env, J9ModronFreeList* freeList, MM_HeapLinkedFreeHeader* freeListTail,
     ...
     */
    void appendToFreeList(MM_EnvironmentBase* env, J9ModronFreeList* freeList, MM_HeapLinkedFreeHeader* freeListTail,
        void* lowAddress, uintptr_t size);
    ...
    /**
     * this one will try to contract range of free memory from last free entry in the freelist. If the range is larger
     * than last free entry size, contract is ignored, If the range is smaller than last free Entry, create last
