...
public:
     ...
     */
    MMINLINE static void fillWithSingleSlotHoles(void* addrBase, uintptr_t freeEntrySize)
    {
#if defined(SPLIT_NEXT_POINTER)
     ...
     */
    MMINLINE static MM_HeapLinkedFreeHeader* fillWithHoles(void* addrBase, uintptr_t freeEntrySize)
    {
     ...
     */
    MMINLINE static void linkInAsHead(volatile uintptr_t* currentHead, MM_HeapLinkedFreeHeader* nextHead)
    {
