...
public:
    static MMINLINE uintptr_t convertBytesToSlots(uintptr_t x) { return x >> conversionBitShift; }

    static MMINLINE uintptr_t convertSlotsToBytes(uintptr_t x) { return x << conversionBitShift; }

    static MMINLINE uintptr_t convertBytesToU32Slots(uintptr_t x) { return x >> conversionBitShift; }

    static MMINLINE uintptr_t convertBytesToObjectFieldSlots(uintptr_t x) { return x >> conversionObjectFieldBitShift; }
