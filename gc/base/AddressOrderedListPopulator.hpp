...
class MM_AddressOrderedListPopulator : public MM_ObjectHeapBufferedIteratorPopulator {
public:
	MM_AddressOrderedListPopulator() : MM_ObjectHeapBufferedIteratorPopulator() { _typeId = __FUNCTION__; }
