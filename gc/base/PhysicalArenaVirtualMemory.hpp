...
enum { modron_pavm_attach_policy_none = 0, modron_pavm_attach_policy_high_memory };
...
public:
	...
	bool canExpand(MM_EnvironmentBase *env, MM_PhysicalSubArenaVirtualMemory *subArena, void *expandAddress,
	        uintptr_t expandSize);
	uintptr_t maxExpansion(
