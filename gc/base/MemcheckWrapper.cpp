...
void
valgrindCreateMempool(MM_GCExtensionsBase *extensions, MM_EnvironmentBase *env, uintptr_t poolAddr)
{
...
void
valgrindMempoolAlloc(MM_GCExtensionsBase *extensions, uintptr_t baseAddress, uintptr_t size)
{
...
{
	int objSize = (int)((GC_ObjectModel)extensions->objectModel)
...
void
valgrindClearRange(MM_GCExtensionsBase *extensions, uintptr_t baseAddress, uintptr_t size)
{
	if (size == 0) {
		return;
	}
...
valgrindFreeObject(MM_GCExtensionsBase *extensions, uintptr_t baseAddress)
{
	...
	*/
		omrobjectptr_t fwObject =
		        MM_ForwardedHeader((omrobjectptr_t)baseAddress, compressed).getForwardedObject();
...
bool
valgrindCheckObjectInPool(MM_GCExtensionsBase *extensions, uintptr_t baseAddress)
{
#if defined(VALGRIND_REQUEST_LOGS)
...
void
valgrindResizeObject(MM_GCExtensionsBase *extensions, uintptr_t baseAddress, uintptr_t oldSize, uintptr_t newSize)
{
