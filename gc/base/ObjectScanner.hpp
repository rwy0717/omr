...
protected:
     ...
     *
     * GC_ObjectScanner(MM_EnvironmentBase *, omrobjectptr_t, fomrobject_t *, uintptr_t, uintptr_t, uintptr_t,
     * uintptr_t)
     *
     ...
     * fields support)
     */
    GC_ObjectScanner(MM_EnvironmentBase* env, omrobjectptr_t parentObjectPtr, fomrobject_t* scanPtr, uintptr_t scanMap,
        uintptr_t flags, uintptr_t hotFieldsDescriptor = 0)
        : MM_BaseVirtual()
