 ...
 */
void MM_EnvironmentBase::popVMstate(uintptr_t newState) { _omrVMThread->vmState = newState; }
...
bool MM_EnvironmentBase::isExclusiveAccessRequestWaiting() { return _delegate.isExclusiveAccessRequestWaiting(); }
...
uintptr_t MM_EnvironmentBase::relinquishExclusiveVMAccess() { return _delegate.relinquishExclusiveVMAccess(); }
...
MM_MemorySubSpace* MM_EnvironmentBase::getTenureMemorySubSpace() { return getMemorySpace()->getTenureMemorySubSpace(); }
