 ...
 */
MM_SweepPoolManagerSplitAddressOrderedList* MM_SweepPoolManagerSplitAddressOrderedList::newInstance(
    MM_EnvironmentBase* env)
{
    MM_SweepPoolManagerSplitAddressOrderedList* sweepPoolManager;

    sweepPoolManager = (MM_SweepPoolManagerSplitAddressOrderedList*)env->getForge()->allocate(
        sizeof(MM_SweepPoolManagerSplitAddressOrderedList), OMR::GC::AllocationCategory::FIXED, OMR_GET_CALLSITE());
    if (sweepPoolManager) {
