...
protected:
     ...
     */
    MMINLINE fomrobject_t* getObjectHeaderSlotAddress(omrobjectptr_t objectPtr)
    {
...
public:
    ...
    {
        return ((*getObjectHeaderSlotAddress(objectPtr)) >> getObjectHeaderSlotFlagsShift())
    ...
    MMINLINE bool atomicSetObjectFlags(omrobjectptr_t objectPtr, uintptr_t bitsToClear, uintptr_t bitsToSet)
    {
        ...
        while (
            oldFlags != MM_AtomicOperations::lockCompareExchange(flagsPtr, (uintptr_t)oldFlags, (uintptr_t)newFlags));
    ...
    MMINLINE bool atomicSwitchReferencedState(omrobjectptr_t objectPtr, uintptr_t fromState, uintptr_t toState)
    {
        ...
        fomrobject_t rememberedMask
            = (fomrobject_t)(OMR_OBJECT_METADATA_REMEMBERED_BITS << getObjectHeaderSlotFlagsShift());
        fomrobject_t oldFlags;
        fomrobject_t newFlags;
