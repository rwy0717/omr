 ...
 */
MM_PhysicalArenaRegionBased* MM_PhysicalArenaRegionBased::newInstance(MM_EnvironmentBase* env, MM_Heap* heap)
{
 ...
 */
void MM_PhysicalArenaRegionBased::detachSubArena(MM_EnvironmentBase* env, MM_PhysicalSubArena* subArena)
{
 ...
 */
bool MM_PhysicalArenaRegionBased::attachSubArena(
 ...
 */
uintptr_t MM_PhysicalArenaRegionBased::maxExpansion(MM_EnvironmentBase* env, MM_PhysicalSubArenaRegionBased* subArena)
{
