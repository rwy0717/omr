...
bool MM_Configuration::initializeRunTimeObjectAlignmentAndCRShift(MM_EnvironmentBase* env, MM_Heap* heap)
{
    ...
    /* s390 benefits from smaller shift values but other platforms don't so just force the shift to 3 if it was not 0 to
     * save on testing resources. (still honour the "canChangeShift" flag, though, since we want our testing options to
     * still work)
     */
