...
MM_ObjectMap* MM_ObjectMap::newInstance(MM_EnvironmentBase* env)
{
    ...
    objectMap = (MM_ObjectMap*)env->getForge()->allocate(
        sizeof(MM_ObjectMap), OMR::GC::AllocationCategory::FIXED, OMR_GET_CALLSITE());
    if (objectMap) {
...
bool MM_ObjectMap::heapAddRange(
...
bool MM_ObjectMap::heapRemoveRange(MM_EnvironmentBase* env, MM_MemorySubSpace* subspace, uintptr_t size,
...
uintptr_t MM_ObjectMap::setMarkBitsInRange(MM_EnvironmentBase* env, void* heapBase, void* heapTop, bool clear)
{
