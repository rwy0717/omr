...
protected:
	...
	enum { slave_status_inactive = 0, /* Must be 0 - set at initialization time by memset */
	...
	omrthread_monitor_t _dispatcherMonitor; /**< Provides signalling between threads for startup and shutting down
	                                           as well as the thread that initiated the shutdown */
...
public:
	...
	static MM_ParallelDispatcher *newInstance(
