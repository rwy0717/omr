...
protected:
	...
	uintptr_t _approximateFreeMemorySize; /**< The approximate number of bytes free that could be made part of the
	                                         free list */
...
public:
	...
	/**
	 * Allocates the contiguous portion of an object.  This means all mixed objects, all indexable objects outside
	 * of arraylet VMs, and arraylet spines (including their leaves, if inline) take this path.
	 */
	...
	virtual void *contractWithRange(
	        MM_EnvironmentBase *env, uintptr_t contractSize, void *lowAddress, void *highAddress) = 0;
