 ...
 */
uintptr_t MM_Collector::getCollectorExpandSize(MM_EnvironmentBase* env) { return 0; }
 ...
 */
void MM_Collector::abortCollection(MM_EnvironmentBase* env, CollectionAbortReason reason) { Assert_MM_unreachable(); }
 ...
 */
void MM_Collector::collectorShutdown(MM_GCExtensionsBase* extensions) { Assert_MM_unreachable(); }
