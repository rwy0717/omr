...
/**
 * Walk all memory pools for the given subspace. Based on nextPool() - the only difference is that when we want to move
 * to next _memorySubSpace we set it to NULL. The list traversal is preorder, in that all parent nodes are visited
