...
MM_CopyScanCacheChunk* MM_CopyScanCacheChunk::newInstance(MM_EnvironmentBase* env, uintptr_t cacheEntryCount,
    MM_CopyScanCacheChunk* nextChunk, MM_CopyScanCacheStandard** sublistTail)
{
    ...
    chunk = (MM_CopyScanCacheChunk*)env->getForge()->allocate(
        sizeof(MM_CopyScanCacheChunk) + cacheEntryCount * sizeof(MM_CopyScanCacheStandard),
...
bool MM_CopyScanCacheChunk::initialize(MM_EnvironmentBase* env, uintptr_t cacheEntryCount,
    MM_CopyScanCacheChunk* nextChunk, uintptr_t flags, MM_CopyScanCacheStandard** sublistTail)
{
