...
MMINLINE uintptr_t makeMask(intptr_t maskSize) { return ((uintptr_t)1 << maskSize) - 1; }
...
bool MM_CompactScheme::initialize(MM_EnvironmentBase* env) { return _delegate.initialize(env, _omrVM, _markMap, this); }

void MM_CompactScheme::tearDown(MM_EnvironmentBase* env) { _delegate.tearDown(env); }
