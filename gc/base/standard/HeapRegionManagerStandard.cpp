...
bool MM_HeapRegionManagerStandard::initialize(MM_EnvironmentBase* env) { return MM_HeapRegionManager::initialize(env); }

void MM_HeapRegionManagerStandard::tearDown(MM_EnvironmentBase* env) { MM_HeapRegionManager::tearDown(env); }
