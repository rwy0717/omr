...
private:
    uintptr_t const
        _bytesToScan; /**< The number of bytes that this must scan before it will stop trying to do more work */
...
public:
    ...
    MM_ConcurrentScavengeTask(MM_EnvironmentBase* env, MM_Dispatcher* dispatcher, MM_Scavenger* scavenger,
        ConcurrentAction action, uintptr_t bytesToScan, MM_CycleState* cycleState)
