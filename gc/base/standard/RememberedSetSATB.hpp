...
public:
    ...
    void initializeFragment(
        MM_EnvironmentBase* env, J9VMGCRememberedSetFragment* fragment); /* "Nulls" out a fragment. */
    void storeInFragment(MM_EnvironmentBase* env, J9VMGCRememberedSetFragment* fragment,
    ...
    void preserveLocalFragmentIndex(MM_EnvironmentBase* env,
        J9VMGCRememberedSetFragment* fragment); /* Called by the code that enables the double-barrier. */
    void restoreLocalFragmentIndex(MM_EnvironmentBase* env,
        J9VMGCRememberedSetFragment* fragment); /* Called by the root scanner to disable the double-barrier. */
