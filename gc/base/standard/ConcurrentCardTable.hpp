...
private:
    ...
    bool freeCardTableEntriesForHeapRange(MM_EnvironmentBase* env, uintptr_t size, void* lowAddress, void* highAddress,
        void* lowValidAddress, void* highValidAddress);
    bool allocateTLHMarkMapEntriesForHeapRange(
        MM_EnvironmentBase* env, MM_MemorySubSpace* subspace, uintptr_t size, void* lowAddress, void* highAddress);
    bool freeTLHMarkMapEntriesForHeapRange(MM_EnvironmentBase* env, uintptr_t size, void* lowAddress, void* highAddress,
        void* lowValidAddress, void* highValidAddress);
...
public:
     ...
     * @param[in] markingScheme The marking scheme which the card table will use to find object starts for precise card
     * area marking
     ...
     * @param[in] cleanNewCards True if the new cards included in this range should be cleared (true if the subspace is
     * collectable)
     ...
     * subspaces. The purpose of this call is to clear the cards backing active nursery heap ranges, under the gencon
     * policy.
