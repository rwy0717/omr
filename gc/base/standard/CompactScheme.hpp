...
private:
    ...
    struct SubAreaEntry {
        ...
        enum { none = 0, setting_real_limits, evacuating, fixing_up, rebuilding_mark_bits, fixing_heap_for_walk };
...
protected:
    ...
    MM_HeapRegionManager* _rootManager; /**< The root region manager which holds the MM_HeapRegionDescriptor instances
                                           which manage the properties of the regions */
...
protected:
    ...
    omrobjectptr_t doCompact(MM_EnvironmentStandard* env, MM_MemorySubSpace* memorySubSpace, omrobjectptr_t start,
        omrobjectptr_t finish, omrobjectptr_t& deadObject, uintptr_t& objectCount, uintptr_t& byteCount, bool evacuate);
     ...
     */
    void fixupSubArea(MM_EnvironmentStandard* env, omrobjectptr_t firstObject, omrobjectptr_t finish, bool markedOnly,
