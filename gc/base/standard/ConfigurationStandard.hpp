...
protected:
	 ...
	 * @param appendCollectorLargeAllocateStats - if true, configure the pool to append Collector allocates to
	 * Mutator allocates (default is to gather only Mutator)
	 */
