...
protected:
	...
	uint8_t *_currentSweepBits; /*< The base address of the raw bits used by the _currentMarkMap (sweep knows about
	                               this in order to perform some optimized types of map walking) */
...
protected:
	...
	void sweepMarkMapBody(uintptr_t *&markMapCurrent, uintptr_t *&markMapChunkTop, uintptr_t *&markMapFreeHead,
	        uintptr_t &heapSlotFreeCount, uintptr_t *&heapSlotFreeCurrent, uintptr_t *&heapSlotFreeHead);
	void sweepMarkMapHead(uintptr_t *markMapFreeHead, uintptr_t *markMapChunkBase, uintptr_t *&heapSlotFreeHead,
...
public:
	...
	/**
	 * Sets the mark map to be used by the sweep scheme for this sweep operation.  Called by the ParallelGlobalGC to
	 * configure sweep and could be called again, if sweep is to change to operate on a new mark map.
	 ...
	 */
	uintptr_t performSamplingCalculations(
