...
public:
	 ...
	 */
	static MM_CopyScanCacheChunkInHeap *newInstance(MM_EnvironmentStandard *env, MM_CopyScanCacheChunk *nextChunk,
	...
	MM_CopyScanCacheChunkInHeap(void *addBase, void *addrTop, MM_MemorySubSpace *memorySubSpace)
	        : MM_CopyScanCacheChunk(), _addrBase(addBase), _addrTop(addrTop), _memorySubSpace(memorySubSpace)
	{
