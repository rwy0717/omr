 ...
 */
void MM_ParallelSweepTask::run(MM_EnvironmentBase* env) { _sweepScheme->internalSweep(env); }
 ...
 *
 */
void MM_ParallelSweepScheme::heapReconfigured(MM_EnvironmentBase* env) { _sweepHeapSectioning->update(env); }
