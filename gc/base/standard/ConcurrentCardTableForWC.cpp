 ...
 */
MMINLINE void MM_ConcurrentCardTableForWC::releaseExclusiveCardTableAccess(MM_EnvironmentBase* env)
{
 ...
 */
uintptr_t MM_ConcurrentCardTableForWC::countCardsInRange(MM_EnvironmentBase* env, Card* chunkStart, Card* chunkEnd)
{
