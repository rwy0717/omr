...
private:
    ...
    enum { _minTraceSize = 1000, _maxTraceSize = 0x20000000, _conHelperCleanSize = 0x10000, _meteringHistorySize = 5 };
    void* _heapBase;
...
protected:
    typedef enum { CONCURRENT_HELPER_WAIT = 1, CONCURRENT_HELPER_MARK, CONCURRENT_HELPER_SHUTDOWN } ConHelperRequest;
...
protected:
    ...
    uintptr_t doConcurrentTrace(MM_EnvironmentBase* env, MM_AllocateDescription* allocDescription,
        uintptr_t sizeToTrace, MM_MemorySubSpace* subspace, bool tlhAllocation);
