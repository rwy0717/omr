 ...
 */
void MM_RememberedSetSATB::initializeFragment(MM_EnvironmentBase* env, J9VMGCRememberedSetFragment* fragment)
{
 ...
 */
void MM_RememberedSetSATB::storeInFragment(MM_EnvironmentBase* env, J9VMGCRememberedSetFragment* fragment, UDATA* value)
{
 ...
 */
bool MM_RememberedSetSATB::isFragmentValid(MM_EnvironmentBase* env, const J9VMGCRememberedSetFragment* fragment)
{
 ...
 */
void MM_RememberedSetSATB::preserveLocalFragmentIndex(MM_EnvironmentBase* env, J9VMGCRememberedSetFragment* fragment)
{
 ...
 */
void MM_RememberedSetSATB::restoreLocalFragmentIndex(MM_EnvironmentBase* env, J9VMGCRememberedSetFragment* fragment)
{
    assume((fragment->localFragmentIndex == J9GC_REMEMBERED_SET_RESERVED_INDEX),
 ...
 * is to be updated.
 */
bool MM_RememberedSetSATB::refreshFragment(MM_EnvironmentBase* env, J9VMGCRememberedSetFragment* fragment)
{
