...
public:
    MMINLINE static MM_HeapRegionManagerStandard* getHeapRegionManager(MM_Heap* heap)
    {
        return (MM_HeapRegionManagerStandard*)heap->getHeapRegionManager();
    }
    MMINLINE static MM_HeapRegionManagerStandard* getHeapRegionManager(MM_HeapRegionManager* manager)
    {
