...
uintptr_t MM_ParallelCompactTask::getVMStateID() { return OMRVMSTATE_GC_COMPACT; }
...
void MM_ParallelCompactTask::setup(MM_EnvironmentBase* env) { env->_compactStats.clear(); }
