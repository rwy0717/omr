 ...
 ****************************************
 */
MM_MemorySubSpace* MM_MemorySubSpaceSemiSpace::getDefaultMemorySubSpace() { return _memorySubSpaceAllocate; }
 ...
 ****************************************
 */
uintptr_t MM_MemorySubSpaceSemiSpace::getActiveMemorySize() { return _memorySubSpaceAllocate->getActiveMemorySize(); }
...
void MM_MemorySubSpaceSemiSpace::abandonHeapChunk(void* addrBase, void* addrTop) { Assert_MM_unreachable(); }
...
void MM_MemorySubSpaceSemiSpace::flip(MM_EnvironmentBase* env, Flip_step step)
{
    ...
    case restore_allocation_and_set_survivor:
        ...
        _avgBytesAllocatedDuringConcurrent = (uintptr_t)MM_Math::weightedAverage(
            (float)_avgBytesAllocatedDuringConcurrent, (float)(_bytesAllocatedDuringConcurrent), 0.5);
