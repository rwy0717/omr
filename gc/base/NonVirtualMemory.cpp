 ...
 */
bool MM_NonVirtualMemory::commitMemory(void* address, uintptr_t size) { return true; }
...
bool MM_NonVirtualMemory::setNumaAffinity(uintptr_t numaNode, void* address, uintptr_t byteAmount) { return true; }
