...
class MM_BumpAllocatedListPopulator : public MM_ObjectHeapBufferedIteratorPopulator {
public:
	MM_BumpAllocatedListPopulator() : MM_ObjectHeapBufferedIteratorPopulator() { _typeId = __FUNCTION__; }
