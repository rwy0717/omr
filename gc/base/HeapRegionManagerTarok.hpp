...
public:
    ...
    /**
     * Releases the heap regions described by the given rootRegion (joined through "_nextInSet" links) to the heap for
     * other uses.
     */
...
protected:
    ...
    /**
     * Sets the NUMA node for the regions in the heap range [lowHeapEdge..highHeapEdge) and then adds them to the free
     * region table and internally links them together.
     *
