 ...
 * @note All subSpaces, with the exception of the semi-space, are active by default.
 */
bool MM_MemorySubSpace::isChildActive(MM_MemorySubSpace* memorySubSpace) { return true; }
 ...
 * @return MM_MemoryPool
 */
MM_MemoryPool* MM_MemorySubSpace::getMemoryPool(void* addr) { return getMemoryPool(); }
 ...
 * @return MM_MemoryPool
 */
MM_MemoryPool* MM_MemorySubSpace::getMemoryPool(uintptr_t size) { return getMemoryPool(); }
...
uintptr_t MM_MemorySubSpace::getActiveMemorySize() { return getActiveMemorySize(MEMORY_TYPE_OLD | MEMORY_TYPE_NEW); }
 ...
 */
MM_AllocationFailureStats* MM_MemorySubSpace::getAllocationFailureStats() { return &_allocationFailureStats; }
 ...
 */
uintptr_t MM_MemorySubSpace::maxExpansion(MM_EnvironmentBase* env) { return _maximumSize - _currentSize; }
 ...
 */
uintptr_t MM_MemorySubSpace::maxContraction(MM_EnvironmentBase* env) { return _currentSize - _minimumSize; }
...
MM_HeapRegionDescriptor* MM_MemorySubSpace::getFirstRegion() { return _regionList; }
