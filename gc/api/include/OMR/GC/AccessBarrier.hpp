...
void
preWriteBarrier(OMR::GC::Context &cx, omrobjectptr_t object, SlotHandleT slot, ValueT value) {
}

template <typename SlotHandleT, typename ValueT>
void
postWriteBarrier(OMR::GC::Context &cx, omrobjectptr_t object, SlotHandleT slot, ValueT value) {
...
template <typename SlotHandleT, typename ValueT>
void
preReadBarrier(OMR::GC::Context &cx, omrobjectptr_t object, SlotHandleT slot) {
}

template <typename SlotHandleT, typename ValueT>
void
postReadBarrier(OMR::GC::Context &cx, omrobjectptr_t object, SlotHandleT slot) {
}

template <typename SlotHandleT, typename ValueT>
void
store(OMR::GC::Context &cx, omrobjectptr_t object, SlotHandleT slot, ValueT *value) {
...
template <typename SlotHandleT, typename ValueT>
ValueT
load(OMR::GC::Context &cx, omrobjectptr_t object, SlotHandleT slot) {
