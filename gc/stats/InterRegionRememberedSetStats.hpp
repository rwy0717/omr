...
public:
    ...
    uintptr_t _clearFromRegionReferencesCardsProcessed; /**< references (cards) visited during clear-from-CS-region pass
                                                           (effectively all cards from all RSCLs) */
    ...
    void merge(MM_InterRegionRememberedSetStats* statsToMerge)
    {
        ...
        _rebuildCompressedCardTableTimesus
            = OMR_MAX(_rebuildCompressedCardTableTimesus, statsToMerge->_rebuildCompressedCardTableTimesus);
        _clearFromRegionReferencesTimesus
            = OMR_MAX(_clearFromRegionReferencesTimesus, statsToMerge->_clearFromRegionReferencesTimesus);
