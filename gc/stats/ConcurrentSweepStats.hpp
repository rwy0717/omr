...
enum { concurrentsweep_mode_off = 0,
...
public:
	...
	volatile uintptr_t _totalChunkSweptCount; /**< Total number of chunks that have been swept through concurrent
	                                             sweep */
	/**
	 * @}
	 */
	...
	uintptr_t _minimumFreeEntryBytesConnected; /**< Total bytes connected in heap while finding minimum free sized
	                                              entry */
	/**
	 * @}
	 */
	...
	volatile uintptr_t _concurrentCompleteSweepBytesSwept; /**< Bytes swept during the concurrent completion of
	                                                          sweep phase */
	/**
	 * @}
	 */
