...
public:
    ...
    uintptr_t
        _arrayletUnknownLeaves; /**< Count (total) of arraylet leaves of unknown arraylet type (if class is unloaded) */
    ...
    uintptr_t _rememberedSetBeingRebuiltRegionCount; /**< Count of overflowed regions that are being rebuilt currently
                                                        by GMP */
