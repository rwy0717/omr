...
public:
	...
	uintptr_t _scanTargetInBytes; /**< The number of bytes a given concurrent task was expected to scan before
	                                 terminating */
	...
	bool _terminationWasRequested; /**< todo: remove after downstream projects start using _terminationRequestType
	                                */
	enum TerminationRequestType { terminationRequest_None, terminationRequest_ByGC, terminationRequest_External };
	TerminationRequestType _terminationRequestType; /**< Reason for concurrent task termination, asynchronous
	                                                   external event or itself GC (work or survivor space exhausted
	                                                   etc). */
...
protected:
public:
	bool isTerminationRequested() { return terminationRequest_None != _terminationRequestType; }
	bool isTerminationRequestExternal() { return terminationRequest_External == _terminationRequestType; }
