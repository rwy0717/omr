...
public:
    ...
    {
        return concurrentCleanedCardsPhase1 + concurrentCleanedCardsPhase2 + concurrentCleanedCardsPhase3;
    };
    ...
    MMINLINE void incFinalCleanedCardsPhase1(uintptr_t numCards) { incrementCount(finalCleanedCardsPhase1, numCards); };

    MMINLINE uintptr_t getFinalCleanedCardsPhase2() { return finalCleanedCardsPhase2; };
    MMINLINE void incFinalCleanedCardsPhase2(uintptr_t numCards) { incrementCount(finalCleanedCardsPhase2, numCards); };
