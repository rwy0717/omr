...
public:
	 ...
	 * Return returnedPuddle to the list of puddles. It should be a puddle returned by a previous call to this
	 * function. This is protected by a lock, so may safely be called by multiple threads.
	 *
