...
template <typename T>
IlType *
toIlType(typename OMR::EnableIf<OMR::IsIntegral<T>::VALUE && (sizeof(T) == 1)>::Type * = 0)
{
	return Int8;
}
template <typename T>
IlType *
toIlType(typename OMR::EnableIf<OMR::IsIntegral<T>::VALUE && (sizeof(T) == 2)>::Type * = 0)
{
	return Int16;
}
template <typename T>
IlType *
toIlType(typename OMR::EnableIf<OMR::IsIntegral<T>::VALUE && (sizeof(T) == 4)>::Type * = 0)
{
	return Int32;
}
template <typename T>
IlType *
toIlType(typename OMR::EnableIf<OMR::IsIntegral<T>::VALUE && (sizeof(T) == 8)>::Type * = 0)
{
	return Int64;
}
...
template <typename T>
IlType *
toIlType(typename OMR::EnableIf<OMR::IsFloatingPoint<T>::VALUE && (sizeof(T) == 4)>::Type * = 0)
{
	return Float;
}
template <typename T>
IlType *
toIlType(typename OMR::EnableIf<OMR::IsFloatingPoint<T>::VALUE && (sizeof(T) == 8)>::Type * = 0)
{
	return Double;
}
...
template <typename T>
IlType *
toIlType(typename OMR::EnableIf<OMR::IsPointer<T>::VALUE
