...
public:
	...
	ResolvedMethod(const char *fileName, const char *lineNumber, char *name, int32_t numParms,
	        TR::IlType **parmTypes, TR::IlType *returnType, void *entryPoint, TR::IlInjector *ilInjector)
	        : _fileName(fileName)
...
public:
	ResolvedMethod(TR_OpaqueMethodBlock *method) : JitBuilder::ResolvedMethod(method) {}
	...
	ResolvedMethod(char *fileName, char *lineNumber, char *name, int32_t numArgs, TR::IlType **parmTypes,
	        ...
	        : JitBuilder::ResolvedMethod(
	                fileName, lineNumber, name, numArgs, parmTypes, returnType, entryPoint, ilInjector)
	{}

	ResolvedMethod(TR::MethodBuilder *methodBuilder) : JitBuilder::ResolvedMethod(methodBuilder) {}
};
} // namespace TR
