...
void JitBuilder::ResolvedMethod::makeParameterList(TR::ResolvedMethodSymbol* methodSym)
{
    ...
    for (int32_t parmIndex = 0; parmIndex < parmSlots; ++parmIndex) {
        ...
        parmSymbol
            = methodSym->comp()->getSymRefTab()->createParameterSymbol(methodSym, slot, type->getPrimitiveType());
...
TR::DataType JitBuilder::ResolvedMethod::returnType() { return _returnType->getPrimitiveType(); }
