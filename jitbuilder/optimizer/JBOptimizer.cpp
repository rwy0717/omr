    ...
    : OMR::Optimizer(comp, methodSymbol, isIlGen, strategy, VNType)
{
    ...
    _opts[OMR::trivialStoreSinking] = new (comp->allocator())
        TR::OptimizationManager(self(), TR_TrivialSinkStores::create, OMR::trivialStoreSinking);
...
inline TR::Optimizer* Optimizer::self() { return (static_cast<TR::Optimizer*>(this)); }
