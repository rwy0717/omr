...
static const OptimizationStrategy tacticalGlobalRegisterAllocatorOpts[] = {
        ...
        {OMR::liveRangeSplitter, OMR::IfLoops}, {OMR::redundantGotoElimination, OMR::IfNotProfiling}, // need to be run
                                                                                                      // before global
                                                                                                      // register
                                                                                                      // allocator
        ...
        {OMR::localCSE}, // localCSE after post-PRE + post-GRA globalCopyPropagation to clean up whole expression remat
                         // (rtc 64659)
        {OMR::globalDeadStoreGroup, OMR::IfEnabled}, {OMR::redundantGotoElimination, OMR::IfEnabled}, // if global
                                                                                                      // register
                                                                                                      // allocator
                                                                                                      // created new
                                                                                                      // block
...
static const OptimizationStrategy JBwarmStrategyOpts[] = {
        ...
        {OMR::loopCanonicalization, OMR::IfLoops}, // canonicalization must run before inductionVariableAnalysis else
                                                   // indvar data gets messed up
