...
CreateStructArrayMethod::CreateStructArrayMethod(OMR::JitBuilder::TypeDictionary *d) : OMR::JitBuilder::MethodBuilder(d)
{
...
ReadStructArrayMethod::ReadStructArrayMethod(OMR::JitBuilder::TypeDictionary *d) : OMR::JitBuilder::MethodBuilder(d)
{
	DefineLine(LINETOSTR(__LINE__));
	DefineFile(__FILE__);
	...
	DefineFunction(
	        "printStructElems", __FILE__, PRINTSTRUCTELEMS_LINE, (void *)&printStructElems, NoType, 2, Int8, Int32);

	DefineFunction("printElemOffsets", __FILE__, PRINTELEMOFFSETS_LINE, (void *)&printElemOffsets, NoType, 2, Int32,
	        Int32);
}
