...
public:
	TestState() : OMR::JitBuilder::VirtualMachineState(), _stack(NULL), _stackTop(NULL) {}

	TestState(OMR::JitBuilder::VirtualMachineOperandStack *stack, OMR::JitBuilder::VirtualMachineRegister *stackTop)
	        : OMR::JitBuilder::VirtualMachineState(), _stack(stack), _stackTop(stackTop)
	{}
...
OperandStackTestMethod::verifyStack(const char *step, int32_t max, int32_t num, ...)
{
	...
	REPORT2((realSP - _realStack) == (num - 1), "_realStackTop-_realStack", (realSP - _realStack), "num-1",
	        (num - 1));
...
OperandStackTestMethod::OperandStackTestMethod(OMR::JitBuilder::TypeDictionary *d) : OMR::JitBuilder::MethodBuilder(d)
{
