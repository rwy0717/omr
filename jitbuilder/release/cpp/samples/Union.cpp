...
SetUnionByteBuilder::SetUnionByteBuilder(OMR::JitBuilder::TypeDictionary *d) : OMR::JitBuilder::MethodBuilder(d)
{
	DefineFile(__FILE__);
...
GetUnionByteBuilder::GetUnionByteBuilder(OMR::JitBuilder::TypeDictionary *d) : OMR::JitBuilder::MethodBuilder(d)
{
	DefineFile(__FILE__);
	DefineLine(LINETOSTR(__LINE__));
...
SetUnionStrBuilder::SetUnionStrBuilder(OMR::JitBuilder::TypeDictionary *d) : OMR::JitBuilder::MethodBuilder(d)
{
	DefineFile(__FILE__);
	DefineLine(LINETOSTR(__LINE__));
...
GetUnionStrBuilder::GetUnionStrBuilder(OMR::JitBuilder::TypeDictionary *d) : OMR::JitBuilder::MethodBuilder(d)
{
	DefineFile(__FILE__);
	DefineLine(LINETOSTR(__LINE__));
