...
AtomicInt32Add::AtomicInt32Add(OMR::JitBuilder::TypeDictionary *d) : OMR::JitBuilder::MethodBuilder(d)
{
...
AtomicInt64Add::AtomicInt64Add(OMR::JitBuilder::TypeDictionary *d) : OMR::JitBuilder::MethodBuilder(d)
{
	DefineLine(LINETOSTR(__LINE__));
	DefineFile(__FILE__);
