...
MatMult::MatMult(OMR::JitBuilder::TypeDictionary *types) : OMR::JitBuilder::MethodBuilder(types)
{
...
void
MatMult::Store2D(OMR::JitBuilder::IlBuilder *bldr, OMR::JitBuilder::IlValue *base, OMR::JitBuilder::IlValue *first,
...
MatMult::Load2D(OMR::JitBuilder::IlBuilder *bldr, OMR::JitBuilder::IlValue *base, OMR::JitBuilder::IlValue *first,
...
VectorMatMult::VectorMatMult(OMR::JitBuilder::TypeDictionary *types) : OMR::JitBuilder::MethodBuilder(types)
{
	DefineLine(LINETOSTR(__LINE__));
	DefineFile(__FILE__);
...
void
VectorMatMult::VectorStore2D(OMR::JitBuilder::IlBuilder *bldr, OMR::JitBuilder::IlValue *base,
...
OMR::JitBuilder::IlValue *
VectorMatMult::VectorLoad2D(OMR::JitBuilder::IlBuilder *bldr, OMR::JitBuilder::IlValue *base,
        OMR::JitBuilder::IlValue *first, OMR::JitBuilder::IlValue *second, OMR::JitBuilder::IlValue *N)
{
...
OMR::JitBuilder::IlValue *
VectorMatMult::Load2D(OMR::JitBuilder::IlBuilder *bldr, OMR::JitBuilder::IlValue *base, OMR::JitBuilder::IlValue *first,
        OMR::JitBuilder::IlValue *second, OMR::JitBuilder::IlValue *N)
{
	return bldr->LoadAt(pDouble, bldr->IndexAt(pDouble, base, bldr->Add(bldr->Mul(first, N), second)));
}
