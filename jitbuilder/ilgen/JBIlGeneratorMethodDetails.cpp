...
IlGeneratorMethodDetails::IlGeneratorMethodDetails(TR_ResolvedMethod *method)
        : OMR::IlGeneratorMethodDetailsConnector(), _method(static_cast<TR::ResolvedMethod *>(method))
{}
...
TR_IlGenerator *
IlGeneratorMethodDetails::getIlGenerator(TR::ResolvedMethodSymbol *methodSymbol, TR_FrontEnd *fe, TR::Compilation *comp,
