...
void spaceSavingClear(OMRSpaceSaving* spaceSaving) { rankingClear(spaceSaving->ranking); }
...
uintptr_t spaceSavingGetCurSize(OMRSpaceSaving* spaceSaving) { return spaceSaving->ranking->curSize; }
