...
dataForType<int32_t>()
{
	static int32_t values[] = {0, 1, 2, -1, -2, 99999, -99999, std::numeric_limits<int32_t>::max(),
...
dataForType<int64_t>()
{
	static int64_t values[] = {0, 1, 2, -1, -2, 99999, -99999, std::numeric_limits<int64_t>::max(),
...
TYPED_TEST(SimplifierFoldAbsNegTest, FoldAbsAbs)
{
	...
	std::snprintf(inputTrees, sizeof(inputTrees),
	        ...
	        "   (%sabs                      "
	        "    (%sabs (%sload parm=0))))))",
	        nameForType<TypeParam>(), nameForType<TypeParam>(), prefixForType<TypeParam>(),
	        prefixForType<TypeParam>(), prefixForType<TypeParam>(), prefixForType<TypeParam>());
