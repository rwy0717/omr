...
template <typename T> static std::vector<std::tuple<T, int32_t> > test_input_values()
{
...
INSTANTIATE_TEST_CASE_P(ShiftAndRotateTest, Int32ShiftAndRotate, ::testing::Combine(::testing::ValuesIn(static_cast<std::vector<std::tuple<int32_t, int32_t> > (*)(void)>(test_input_values)()), ::testing::Values(std::make_tuple("ishl", static_cast<int32_t (*)(int32_t, int32_t)>(shift_left)), std::make_tuple("ishr", static_cast<int32_t (*)(int32_t, int32_t)>(shift_right)), std::make_tuple("irol", static_cast<int32_t (*)(int32_t, int32_t)>(rotate)))));
...
INSTANTIATE_TEST_CASE_P(ShiftAndRotateTest, Int64ShiftAndRotate, ::testing::Combine(::testing::ValuesIn(static_cast<std::vector<std::tuple<int64_t, int32_t> > (*)(void)>(test_input_values)()), ::testing::Values(std::make_tuple("lshl", static_cast<int64_t (*)(int64_t, int32_t)>(shift_left)), std::make_tuple("lshr", static_cast<int64_t (*)(int64_t, int32_t)>(shift_right)), std::make_tuple("lrol", static_cast<int64_t (*)(int64_t, int32_t)>(rotate)))));
...
INSTANTIATE_TEST_CASE_P(ShiftAndRotateTest, Int8ShiftAndRotate, ::testing::Combine(::testing::ValuesIn(static_cast<std::vector<std::tuple<int8_t, int32_t> > (*)(void)>(test_input_values)()), ::testing::Values(std::make_tuple("bshl", static_cast<int8_t (*)(int8_t, int32_t)>(shift_left)), std::make_tuple("bshr", static_cast<int8_t (*)(int8_t, int32_t)>(shift_right)))));
...
INSTANTIATE_TEST_CASE_P(ShiftAndRotateTest, Int16ShiftAndRotate, ::testing::Combine(::testing::ValuesIn(static_cast<std::vector<std::tuple<int16_t, int32_t> > (*)(void)>(test_input_values)()), ::testing::Values(std::make_tuple("sshl", static_cast<int16_t (*)(int16_t, int32_t)>(shift_left)), std::make_tuple("sshr", static_cast<int16_t (*)(int16_t, int32_t)>(shift_right)))));
...
INSTANTIATE_TEST_CASE_P(ShiftAndRotateTest, UInt32ShiftAndRotate, ::testing::Combine(::testing::ValuesIn(static_cast<std::vector<std::tuple<uint32_t, int32_t> > (*)(void)>(test_input_values)()), ::testing::Values(std::make_tuple("iushr", static_cast<uint32_t (*)(uint32_t, int32_t)>(shift_right)))));
...
INSTANTIATE_TEST_CASE_P(ShiftAndRotateTest, UInt64ShiftAndRotate, ::testing::Combine(::testing::ValuesIn(static_cast<std::vector<std::tuple<uint64_t, int32_t> > (*)(void)>(test_input_values)()), ::testing::Values(std::make_tuple("lushr", static_cast<uint64_t (*)(uint64_t, int32_t)>(shift_right)))));
...
INSTANTIATE_TEST_CASE_P(ShiftAndRotateTest, UInt8ShiftAndRotate, ::testing::Combine(::testing::ValuesIn(static_cast<std::vector<std::tuple<uint8_t, int32_t> > (*)(void)>(test_input_values)()), ::testing::Values(std::make_tuple("bushr", static_cast<uint8_t (*)(uint8_t, int32_t)>(shift_right)))));
...
INSTANTIATE_TEST_CASE_P(ShiftAndRotateTest, UInt16ShiftAndRotate, ::testing::Combine(::testing::ValuesIn(static_cast<std::vector<std::tuple<uint16_t, int32_t> > (*)(void)>(test_input_values)()), ::testing::Values(std::make_tuple("sushr", static_cast<uint16_t (*)(uint16_t, int32_t)>(shift_right)))));
