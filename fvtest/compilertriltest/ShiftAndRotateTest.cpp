...
static std::vector<std::tuple<T, int32_t> > test_input_values()
{
    ...
    return TRTest::combine(
        TRTest::const_values<T>(), std::vector<int32_t>(inputArray, inputArray + sizeof(inputArray) / sizeof(int32_t)));
}
...
TEST_P(Int64ShiftAndRotate, UsingConst)
{
    ...
    char inputTrees[120] = { 0 };
    std::snprintf(inputTrees, 120, "(method return=Int64 (block (lreturn (%s (lconst %lld) (iconst %d)) )))",
        param.opcode.c_str(), param.lhs, param.rhs);
    auto trees = parseString(inputTrees);
...
TEST_P(Int64ShiftAndRotate, UsingLoadParam)
{
    ...
    char inputTrees[120] = { 0 };
    std::snprintf(inputTrees, 120,
        "(method return=Int64 args=[Int64, Int32] (block (lreturn (%s (lload parm=0) (iload parm=1)) )))",
        param.opcode.c_str());
    auto trees = parseString(inputTrees);
...
TEST_P(Int8ShiftAndRotate, UsingConst)
{
    ...
    char inputTrees[120] = { 0 };
    std::snprintf(inputTrees, 120, "(method return=Int8 (block (ireturn (b2i (%s (bconst %d) (iconst %d)) ))))",
        param.opcode.c_str(), param.lhs, param.rhs);
    auto trees = parseString(inputTrees);
...
TEST_P(Int8ShiftAndRotate, UsingLoadParam)
{
    ...
    char inputTrees[120] = { 0 };
    std::snprintf(inputTrees, 120,
        "(method return=Int8 args=[Int8, Int32] (block (ireturn (b2i (%s (bload parm=0) (iload parm=1)) ))))",
        param.opcode.c_str());
    auto trees = parseString(inputTrees);
...
TEST_P(Int16ShiftAndRotate, UsingConst)
{
    ...
    char inputTrees[120] = { 0 };
    std::snprintf(inputTrees, 120, "(method return=Int16 (block (ireturn (s2i (%s (sconst %d) (iconst %d)) ))))",
        param.opcode.c_str(), param.lhs, param.rhs);
    auto trees = parseString(inputTrees);
...
TEST_P(Int16ShiftAndRotate, UsingLoadParam)
{
    ...
    char inputTrees[120] = { 0 };
    std::snprintf(inputTrees, 120,
        "(method return=Int16 args=[Int16, Int32] (block (ireturn (s2i (%s (sload parm=0) (iload parm=1)) ))))",
        param.opcode.c_str());
    auto trees = parseString(inputTrees);
...
TEST_P(UInt64ShiftAndRotate, UsingConst)
{
    ...
    char inputTrees[120] = { 0 };
    std::snprintf(inputTrees, 120, "(method return=Int64 (block (lreturn (%s (lconst %llu) (iconst %d)) )))",
        param.opcode.c_str(), param.lhs, param.rhs);
    auto trees = parseString(inputTrees);
...
TEST_P(UInt8ShiftAndRotate, UsingConst)
{
    ...
    char inputTrees[120] = { 0 };
    std::snprintf(inputTrees, 120, "(method return=Int8 (block (ireturn (bu2i (%s (bconst %d) (iconst %d)) ))))",
        param.opcode.c_str(), param.lhs, param.rhs);
    auto trees = parseString(inputTrees);
...
TEST_P(UInt8ShiftAndRotate, UsingLoadParam)
{
    ...
    char inputTrees[120] = { 0 };
    std::snprintf(inputTrees, 120,
        "(method return=Int8 args=[Int8, Int32] (block (ireturn (bu2i (%s (bload parm=0) (iload parm=1)) ))))",
        param.opcode.c_str());
    auto trees = parseString(inputTrees);
...
TEST_P(UInt16ShiftAndRotate, UsingConst)
{
    ...
    char inputTrees[120] = { 0 };
    std::snprintf(inputTrees, 120, "(method return=Int16 (block (ireturn (su2i (%s (sconst %d) (iconst %d)) ))))",
        param.opcode.c_str(), param.lhs, param.rhs);
    auto trees = parseString(inputTrees);
...
TEST_P(UInt16ShiftAndRotate, UsingLoadParam)
{
    ...
    char inputTrees[120] = { 0 };
    std::snprintf(inputTrees, 120,
        "(method return=Int16 args=[Int16, Int32] (block (ireturn (su2i (%s (sload parm=0) (iload parm=1)) ))))",
        param.opcode.c_str());
    auto trees = parseString(inputTrees);
