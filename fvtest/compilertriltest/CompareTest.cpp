...
INSTANTIATE_TEST_CASE_P(CompareTest, Int32Compare, ::testing::Combine(::testing::ValuesIn(TRTest::const_value_pairs<int32_t, int32_t>()), ::testing::Values(std::make_tuple("icmpeq", icmpeq), std::make_tuple("icmpne", icmpne), std::make_tuple("icmpgt", icmpgt), std::make_tuple("icmpge", icmpge), std::make_tuple("icmplt", icmplt), std::make_tuple("icmple", icmple))));
...
INSTANTIATE_TEST_CASE_P(CompareTest, UInt32Compare, ::testing::Combine(::testing::ValuesIn(TRTest::const_value_pairs<uint32_t, uint32_t>()), ::testing::Values(std::make_tuple("iucmpeq", iucmpeq), std::make_tuple("iucmpne", iucmpne), std::make_tuple("iucmpgt", iucmpgt), std::make_tuple("iucmpge", iucmpge), std::make_tuple("iucmplt", iucmplt), std::make_tuple("iucmple", iucmple))));
...
INSTANTIATE_TEST_CASE_P(CompareTest, Int64Compare, ::testing::Combine(::testing::ValuesIn(TRTest::const_value_pairs<int64_t, int64_t>()), ::testing::Values(std::make_tuple("lcmpeq", lcmpeq), std::make_tuple("lcmpne", lcmpne), std::make_tuple("lcmpgt", lcmpgt), std::make_tuple("lcmpge", lcmpge), std::make_tuple("lcmplt", lcmplt), std::make_tuple("lcmple", lcmple), std::make_tuple("lcmp", lcmp))));
...
INSTANTIATE_TEST_CASE_P(CompareTest, FloatCompare, ::testing::Combine(::testing::ValuesIn(TRTest::filter(TRTest::const_value_pairs<float, float>(), smallFp_filter<float>)), ::testing::Values(std::make_tuple("fcmpeq", fcmpeq), std::make_tuple("fcmpne", fcmpne), std::make_tuple("fcmpgt", fcmpgt), std::make_tuple("fcmpge", fcmpge), std::make_tuple("fcmplt", fcmplt), std::make_tuple("fcmple", fcmple))));
...
INSTANTIATE_TEST_CASE_P(CompareTest, DoubleCompare, ::testing::Combine(::testing::ValuesIn(TRTest::filter(TRTest::const_value_pairs<double, double>(), smallFp_filter<double>)), ::testing::Values(std::make_tuple("dcmpeq", dcmpeq), std::make_tuple("dcmpne", dcmpne), std::make_tuple("dcmpgt", dcmpgt), std::make_tuple("dcmpge", dcmpge), std::make_tuple("dcmplt", dcmplt), std::make_tuple("dcmple", dcmple))));
...
INSTANTIATE_TEST_CASE_P(CompareTest, FloatIfCompare, ::testing::Combine(::testing::ValuesIn(TRTest::filter(TRTest::const_value_pairs<float, float>(), smallFp_filter<float>)), ::testing::Values(std::make_tuple("iffcmpeq", iffcmpeq), std::make_tuple("iffcmpne", iffcmpne), std::make_tuple("iffcmplt", iffcmplt), std::make_tuple("iffcmple", iffcmple), std::make_tuple("iffcmpge", iffcmpge), std::make_tuple("iffcmpgt", iffcmpgt))));
...
INSTANTIATE_TEST_CASE_P(CompareTest, DoubleIfCompare, ::testing::Combine(::testing::ValuesIn(TRTest::filter(TRTest::const_value_pairs<double, double>(), smallFp_filter<double>)), ::testing::Values(std::make_tuple("ifdcmpeq", ifdcmpeq), std::make_tuple("ifdcmpne", ifdcmpne), std::make_tuple("ifdcmplt", ifdcmplt), std::make_tuple("ifdcmple", ifdcmple), std::make_tuple("ifdcmpge", ifdcmpge), std::make_tuple("ifdcmpgt", ifdcmpgt))));
