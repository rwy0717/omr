...
int32_t i2lInput[] = {0x0, 0x1, 0x0000FFFF, 0x2, 0x3E, (int32_t)0x80000000, (int32_t)0xFFFF0000, 0x40000000, 0x7C000000,
        (int32_t)0xFFFFFFFF, 0x0003C000, 0x40000001};
...
public:
	...
	{
		const char *options = "-Xjit:disableTreeSimplification,disableAsyncCompilation,acceptHugeMethods,"
...
to_struct(const std::tuple<VarType, ConstType, ConstType (*)(VarType, ConstType)> &param)
{
...
TEST_P(i2lLongAndAsRotateTest, iConstTest)
{
	...
	ASSERT_EQ(param.oracle((param.variableValue & constValue), param.constantValue),
...
TEST_P(i2lLongAndAsRotateTest, GreaterThanOneRefCount2)
{
	...
	ASSERT_EQ(param.oracle((param.variableValue & constValue2), param.constantValue),
	        entry_point(param.variableValue));
}
