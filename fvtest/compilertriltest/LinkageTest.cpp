...
TYPED_TEST(LinkageTest, InvalidLinkageTest)
{
	...
	SKIP_IF(OMRPORT_ARCH_HAMMER != arch, MissingImplementation) << "Test is skipped on non-x86-64 platforms "
	                                                               "because calls are not currently supported on "
	                                                               "other platforms (see issue #1645)";

	char inputTrees[200] = {0};
	const auto format_string = "(method return=Int32  args=[Int32] (block (ireturn (icall address=0x%jX "
...
TYPED_TEST(LinkageTest, SystemLinkageParameterPassingFourArg)
{
	...
	const auto format_string = "(method return=%s args=[%s,%s,%s,%s] (block (%sreturn (%scall address=0x%jX "
	                           "args=[%s,%s,%s,%s] linkage=system"
	                           " (%sload parm=0)"
	                           " (%sload parm=1)"
	                           " (%sload parm=2)"
	                           " (%sload parm=3)"
	...
	std::snprintf(inputTrees, 400, format_string, TypeToString<TypeParam>::type, // Return
	        ...
	        TypeToString<TypeParam>::prefix, // return
	        TypeToString<TypeParam>::prefix, // call
	        reinterpret_cast<uintmax_t>(static_cast<TypeParam (*)(TypeParam, TypeParam, TypeParam, TypeParam)>(
...
TYPED_TEST(LinkageTest, SystemLinkageParameterPassingFiveArg)
{
	...
	std::snprintf(inputTrees, 400, format_string, TypeToString<TypeParam>::type, // Return
	        ...
	        reinterpret_cast<uintmax_t>(
	                static_cast<TypeParam (*)(TypeParam, TypeParam, TypeParam, TypeParam, TypeParam)>(
	...
	auto entry_point =
	        compiler.getEntryPoint<TypeParam (*)(TypeParam, TypeParam, TypeParam, TypeParam, TypeParam)>();
...
TEST_F(LinkageWithMixedTypesTest, SystemLinkageParameterPassingFiveArgWithMixedTypes)
{
	...
	const auto format_string = "(method return=Double args=[Double,Int32,Double,Int32,Double]"
	                           "  (block (dreturn (dcall address=0x%jX args=[Double,Int32,Double,Int32,Double] "
	                           "linkage=system"
	                           " (dload parm=0)"
	                           " (iload parm=1)"
	                           " (dload parm=2)"
