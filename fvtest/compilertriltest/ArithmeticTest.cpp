...
TEST_P(UInt64Arithmetic, UsingConst)
{
	...
	std::string arch = omrsysinfo_get_CPU_architecture();
	SKIP_IF(param.opcode == "ludiv" && (OMRPORT_ARCH_PPC64 == arch || OMRPORT_ARCH_PPC64LE == arch),
	        MissingImplementation)
...
TEST_P(Int16Arithmetic, UsingConst)
{
	...
	SKIP_IF(OMRPORT_ARCH_X86 == arch || OMRPORT_ARCH_HAMMER == arch, MissingImplementation) << "smul/sdiv not yet "
	                                                                                           "implemented on x86 "
	                                                                                           "(see Issue #4408)";
...
TEST_P(Int8Arithmetic, UsingConst)
{
	...
	SKIP_IF(OMRPORT_ARCH_X86 == arch || OMRPORT_ARCH_HAMMER == arch, MissingImplementation) << "bmul/bdiv not yet "
	                                                                                           "implemented on x86 "
	                                                                                           "(see Issue #4408)";
...
INSTANTIATE_TEST_CASE_P(DivArithmeticTest, UInt32Arithmetic,
        ::testing::Combine(::testing::ValuesIn(TRTest::filter(
                                   TRTest::const_value_pairs<uint32_t, uint32_t>(), udiv_filter<uint32_t>)),
...
INSTANTIATE_TEST_CASE_P(DivArithmeticTest, UInt64Arithmetic,
        ::testing::Combine(::testing::ValuesIn(TRTest::filter(
                                   TRTest::const_value_pairs<uint64_t, uint64_t>(), udiv_filter<uint64_t>)),
...
INSTANTIATE_TEST_CASE_P(ArithmeticTest, FloatUnaryArithmetic,
        ::testing::Combine(
                ::testing::ValuesIn(TRTest::filter(TRTest::const_values<float>(), smallFp_unary_filter<float>)),
...
INSTANTIATE_TEST_CASE_P(ArithmeticTest, DoubleUnaryArithmetic,
        ::testing::Combine(
                ::testing::ValuesIn(TRTest::filter(TRTest::const_values<double>(), smallFp_unary_filter<double>)),
