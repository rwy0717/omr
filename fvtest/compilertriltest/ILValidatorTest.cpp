...
TEST_P(IllformedTrees, FailCompilation)
{
	...
	ASSERT_EQ(compiler.compile(), COMPILATION_IL_VALIDATION_FAILURE) << "Compilation did not fail due to "
	                                                                    "ill-formed input trees";
}
...
INSTANTIATE_TEST_CASE_P(ILValidatorTest, WellformedTrees,
        ::testing::Values("(method return=Int32 (block (ireturn (iconst 3))))",
...
TEST_P(CommoningTest, CommoningUnderSameTree)
{
	auto param = GetParam();
	auto tril = TRIL(
	        (method return = Int32 args = [ Int32, Int32 ](block(ireturn(icmpeq(imul(iadd(iload parm = 0 id = "load"
	                                                                                                          "Parm"
	                                                                                                          "0")(
	                 iload parm = 1 id = "loadParm1"))(isub(@id "loadParm0")(@id "loadParm1")))(
...
TEST_P(CommoningTest, CommoningWithinBlock)
{
	...
	auto tril = TRIL((method return = Int32 args = [ Int32,
		Int32 ](block(iload parm = 0 id = "loadParm0")(iload parm = 1 id = "loadParm1")(ireturn(icmpeq(
	                          imul(iadd(@id "loadParm0")(@id "loadParm1"))(isub(@id "loadParm0")(@id "loadParm1")))(
	                          isub(imul(@id "loadParm0")(@id "loadParm0"))(imul(@id "loadParm1")(@id "loadParm"
	                                                                                                 "1"))))))));
...
TEST_F(InvalidCommoningTest, CommoningAcrossBlock)
{
	...
	// invalid commoning.
	auto tril = TRIL((method return = Int32 args = [Int32](block name = "first"(iload parm = 0 id = "parm0")(
