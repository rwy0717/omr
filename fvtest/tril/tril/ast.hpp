...
inline bool operator!=(const ASTValue& lhs, const ASTValue& rhs) { return !(lhs == rhs); }
...
inline bool operator!=(const ASTNodeArg& lhs, const ASTNodeArg& rhs) { return !(lhs == rhs); }
