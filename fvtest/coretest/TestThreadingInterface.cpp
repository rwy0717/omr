...
#include <OMR/SystemInterface.hpp>
...
/**
 * Note: Since the ThreadingInterface may only be initialized once per process,
 * this test must be location in it's own isolated test executable.
 */
