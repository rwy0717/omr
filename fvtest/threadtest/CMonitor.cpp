...
char const* CMonitor::GetName(void) const { return ((J9ThreadMonitor*)m_monitor)->name; }
...
intptr_t CMonitor::TryEnter(void) { return omrthread_monitor_try_enter(m_monitor); }
...
intptr_t CMonitor::Wait(int64_t millis) { return omrthread_monitor_wait_timed(m_monitor, millis, 0); }
...
intptr_t CMonitor::WaitInterruptable(void) { return omrthread_monitor_wait_interruptable(m_monitor, 0, 0); }
