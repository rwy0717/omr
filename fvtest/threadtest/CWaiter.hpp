...
public:
	...
	static const char *MapReturnValueToString(intptr_t retval)
	{
		...
		switch (retval) {
		case 0: pRetVal = "0 (zero)"; break;
		case J9THREAD_INVALID_ARGUMENT: pRetVal = "J9THREAD_INVALID_ARGUMENT"; break;
		case J9THREAD_ILLEGAL_MONITOR_STATE: pRetVal = "J9THREAD_ILLEGAL_MONITOR_STATE"; break;
		case J9THREAD_INTERRUPTED: pRetVal = "J9THREAD_INTERRUPTED"; break;
		case J9THREAD_PRIORITY_INTERRUPTED: pRetVal = "J9THREAD_PRIORITY_INTERRUPTED"; break;
		case J9THREAD_TIMED_OUT: pRetVal = "J9THREAD_TIMED_OUT"; break;
		}
		return pRetVal;
	}
...
protected:
	virtual intptr_t Run()
	{
		...
		if (m_timeToWait < 0) {
			...
			m_waitRetVal = (m_interruptable) ? m_monitor.WaitInterruptable(m_timeToWait)
