...
public:
	ResolvedMethod(TR_OpaqueMethodBlock *method) : TestCompiler::ResolvedMethod(method) {}
	...
	ResolvedMethod(TR::MethodBuilder *methodBuilder) : TestCompiler::ResolvedMethod(methodBuilder) {}
};
} // namespace TR
