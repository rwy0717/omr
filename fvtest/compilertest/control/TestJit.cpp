...
extern "C" bool initializeJitWithOptions(char* options) { return initializeTestJit(0, 0, 0, options); }

extern "C" bool initializeJit() { return initializeTestJit(0, 0, 0, (char*)"-Xjit:useILValidator"); }
