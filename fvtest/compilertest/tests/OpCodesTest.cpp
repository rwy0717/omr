...
void OpCodesTest::compileCompareTestMethods()
{
    ...
    compileOpCodeMethod(
        _ifLuCmpeq, _numberOfBinaryArgs, TR::iflucmpeq, "ifLuCmpeq", _argTypesBinaryLong, TR::Int32, rc);
    compileOpCodeMethod(
        _ifLuCmpne, _numberOfBinaryArgs, TR::iflucmpne, "ifLuCmpne", _argTypesBinaryLong, TR::Int32, rc);
    compileOpCodeMethod(
...
void OpCodesTest::invokeCompareTests()
{
    ...
    uint64_t luCmpeqDataArr[][2] = { ULONG_POS, ULONG_MINIMUM, ULONG_MINIMUM, ULONG_POS, ULONG_MAXIMUM, ULONG_MINIMUM,
        ULONG_MINIMUM, ULONG_MAXIMUM, ULONG_MAXIMUM, ULONG_MAXIMUM };
    uint64_t luCmpneDataArr[][2] = { ULONG_MAXIMUM, ULONG_POS, ULONG_POS, ULONG_MAXIMUM, ULONG_MINIMUM, ULONG_POS,
        ULONG_POS, ULONG_MINIMUM, ULONG_MAXIMUM, ULONG_MAXIMUM };
    ...
    uint32_t ifIuCmpeqDataArr[][2] = { UINT_POS, UINT_MINIMUM, UINT_MINIMUM, UINT_POS, UINT_MAXIMUM, UINT_MINIMUM,
        UINT_MINIMUM, UINT_MAXIMUM, UINT_MAXIMUM, UINT_MAXIMUM };
    uint32_t ifIuCmpneDataArr[][2] = { UINT_MAXIMUM, UINT_POS, UINT_POS, UINT_MAXIMUM, UINT_MINIMUM, UINT_POS, UINT_POS,
    ...
    uint64_t ifLuCmpeqDataArr[][2] = { ULONG_POS, ULONG_MINIMUM, ULONG_MINIMUM, ULONG_POS, ULONG_MAXIMUM, ULONG_MINIMUM,
        ULONG_MINIMUM, ULONG_MAXIMUM, ULONG_MAXIMUM, ULONG_MAXIMUM };
    uint64_t ifLuCmpneDataArr[][2] = { ULONG_MAXIMUM, ULONG_POS, ULONG_POS, ULONG_MAXIMUM, ULONG_MINIMUM, ULONG_POS,
        ULONG_POS, ULONG_MINIMUM, ULONG_MAXIMUM, ULONG_MAXIMUM };
    ...
    for (uint32_t i = 0; i < testCaseNum; ++i) {
        OMR_CT_EXPECT_EQ(_luCmpeq, compareEQ(luCmpeqDataArr[i][0], luCmpeqDataArr[i][1]),
            _luCmpeq(luCmpeqDataArr[i][0], luCmpeqDataArr[i][1]));

        sprintf(resolvedMethodName, "luCmpeqConst1_TestCase%d", i + 1);
        compileOpCodeMethod(luCompareConst, _numberOfBinaryArgs, TR::lucmpeq, resolvedMethodName, _argTypesBinaryLong,
            TR::Int32, rc, 4, 1, &(luCmpeqDataArr[i][0]), 2, &(luCmpeqDataArr[i][1]));
        OMR_CT_EXPECT_EQ(luCompareConst, compareEQ(luCmpeqDataArr[i][0], luCmpeqDataArr[i][1]),
            luCompareConst(LONG_PLACEHOLDER_1, LONG_PLACEHOLDER_2));

        sprintf(resolvedMethodName, "luCmpeqConst2_TestCase%d", i + 1);
        compileOpCodeMethod(luCompareConst, _numberOfBinaryArgs, TR::lucmpeq, resolvedMethodName, _argTypesBinaryLong,
            TR::Int32, rc, 2, 1, &(luCmpeqDataArr[i][0]));
        OMR_CT_EXPECT_EQ(luCompareConst, compareEQ(luCmpeqDataArr[i][0], luCmpeqDataArr[i][1]),
            luCompareConst(LONG_PLACEHOLDER_1, luCmpeqDataArr[i][1]));

        sprintf(resolvedMethodName, "luCmpeqConst3_TestCase%d", i + 1);
        compileOpCodeMethod(luCompareConst, _numberOfBinaryArgs, TR::lucmpeq, resolvedMethodName, _argTypesBinaryLong,
            TR::Int32, rc, 2, 2, &(luCmpeqDataArr[i][1]));
        OMR_CT_EXPECT_EQ(luCompareConst, compareEQ(luCmpeqDataArr[i][0], luCmpeqDataArr[i][1]),
    ...
    for (uint32_t i = 0; i < testCaseNum; ++i) {
        OMR_CT_EXPECT_EQ(_luCmpne, compareNE(luCmpneDataArr[i][0], luCmpneDataArr[i][1]),
            _luCmpne(luCmpneDataArr[i][0], luCmpneDataArr[i][1]));

        sprintf(resolvedMethodName, "luCmpneConst1_TestCase%d", i + 1);
        compileOpCodeMethod(luCompareConst, _numberOfBinaryArgs, TR::lucmpne, resolvedMethodName, _argTypesBinaryLong,
            TR::Int32, rc, 4, 1, &(luCmpneDataArr[i][0]), 2, &(luCmpneDataArr[i][1]));
        OMR_CT_EXPECT_EQ(luCompareConst, compareNE(luCmpneDataArr[i][0], luCmpneDataArr[i][1]),
            luCompareConst(LONG_PLACEHOLDER_1, LONG_PLACEHOLDER_2));

        sprintf(resolvedMethodName, "luCmpneConst2_TestCase%d", i + 1);
        compileOpCodeMethod(luCompareConst, _numberOfBinaryArgs, TR::lucmpne, resolvedMethodName, _argTypesBinaryLong,
            TR::Int32, rc, 2, 1, &(luCmpneDataArr[i][0]));
        OMR_CT_EXPECT_EQ(luCompareConst, compareNE(luCmpneDataArr[i][0], luCmpneDataArr[i][1]),
            luCompareConst(LONG_PLACEHOLDER_1, luCmpneDataArr[i][1]));

        sprintf(resolvedMethodName, "luCmpneConst3_TestCase%d", i + 1);
        compileOpCodeMethod(luCompareConst, _numberOfBinaryArgs, TR::lucmpne, resolvedMethodName, _argTypesBinaryLong,
            TR::Int32, rc, 2, 2, &(luCmpneDataArr[i][1]));
        OMR_CT_EXPECT_EQ(luCompareConst, compareNE(luCmpneDataArr[i][0], luCmpneDataArr[i][1]),
    ...
    for (uint32_t i = 0; i < testCaseNum; ++i) {
        OMR_CT_EXPECT_EQ(_ifIuCmpeq, compareEQ(ifIuCmpeqDataArr[i][0], ifIuCmpeqDataArr[i][1]),
            _ifIuCmpeq(ifIuCmpeqDataArr[i][0], ifIuCmpeqDataArr[i][1]));

        sprintf(resolvedMethodName, "ifIuCmpeqConst1_TestCase%d", i + 1);
        compileOpCodeMethod(iuCompareConst, _numberOfBinaryArgs, TR::ifiucmpeq, resolvedMethodName, _argTypesBinaryInt,
            TR::Int32, rc, 4, 1, &(ifIuCmpeqDataArr[i][0]), 2, &(ifIuCmpeqDataArr[i][1]));
        OMR_CT_EXPECT_EQ(iuCompareConst, compareEQ(ifIuCmpeqDataArr[i][0], ifIuCmpeqDataArr[i][1]),
            iuCompareConst(INT_PLACEHOLDER_1, INT_PLACEHOLDER_2));

        sprintf(resolvedMethodName, "ifIuCmpeqConst2_TestCase%d", i + 1);
        compileOpCodeMethod(iuCompareConst, _numberOfBinaryArgs, TR::ifiucmpeq, resolvedMethodName, _argTypesBinaryInt,
            TR::Int32, rc, 2, 1, &(ifIuCmpeqDataArr[i][0]));
        OMR_CT_EXPECT_EQ(iuCompareConst, compareEQ(ifIuCmpeqDataArr[i][0], ifIuCmpeqDataArr[i][1]),
            iuCompareConst(INT_PLACEHOLDER_1, ifIuCmpeqDataArr[i][1]));

        sprintf(resolvedMethodName, "ifIuCmpeqConst3_TestCase%d", i + 1);
        compileOpCodeMethod(iuCompareConst, _numberOfBinaryArgs, TR::ifiucmpeq, resolvedMethodName, _argTypesBinaryInt,
            TR::Int32, rc, 2, 2, &(ifIuCmpeqDataArr[i][1]));
        OMR_CT_EXPECT_EQ(iuCompareConst, compareEQ(ifIuCmpeqDataArr[i][0], ifIuCmpeqDataArr[i][1]),
    ...
    for (uint32_t i = 0; i < testCaseNum; ++i) {
        OMR_CT_EXPECT_EQ(_ifIuCmpne, compareNE(ifIuCmpneDataArr[i][0], ifIuCmpneDataArr[i][1]),
            _ifIuCmpne(ifIuCmpneDataArr[i][0], ifIuCmpneDataArr[i][1]));

        sprintf(resolvedMethodName, "ifIuCmpneConst1_TestCase%d", i + 1);
        compileOpCodeMethod(iuCompareConst, _numberOfBinaryArgs, TR::ifiucmpne, resolvedMethodName, _argTypesBinaryInt,
            TR::Int32, rc, 4, 1, &(ifIuCmpneDataArr[i][0]), 2, &(ifIuCmpneDataArr[i][1]));
        OMR_CT_EXPECT_EQ(iuCompareConst, compareNE(ifIuCmpneDataArr[i][0], ifIuCmpneDataArr[i][1]),
            iuCompareConst(INT_PLACEHOLDER_1, INT_PLACEHOLDER_2));

        sprintf(resolvedMethodName, "ifIuCmpneConst2_TestCase%d", i + 1);
        compileOpCodeMethod(iuCompareConst, _numberOfBinaryArgs, TR::ifiucmpne, resolvedMethodName, _argTypesBinaryInt,
            TR::Int32, rc, 2, 1, &(ifIuCmpneDataArr[i][0]));
        OMR_CT_EXPECT_EQ(iuCompareConst, compareNE(ifIuCmpneDataArr[i][0], ifIuCmpneDataArr[i][1]),
            iuCompareConst(INT_PLACEHOLDER_1, ifIuCmpneDataArr[i][1]));

        sprintf(resolvedMethodName, "ifIuCmpneConst3_TestCase%d", i + 1);
        compileOpCodeMethod(iuCompareConst, _numberOfBinaryArgs, TR::ifiucmpne, resolvedMethodName, _argTypesBinaryInt,
            TR::Int32, rc, 2, 2, &(ifIuCmpneDataArr[i][1]));
        OMR_CT_EXPECT_EQ(iuCompareConst, compareNE(ifIuCmpneDataArr[i][0], ifIuCmpneDataArr[i][1]),
    ...
    for (uint32_t i = 0; i < testCaseNum; ++i) {
        OMR_CT_EXPECT_EQ(_ifLuCmpeq, compareEQ(ifLuCmpeqDataArr[i][0], ifLuCmpeqDataArr[i][1]),
            _ifLuCmpeq(ifLuCmpeqDataArr[i][0], ifLuCmpeqDataArr[i][1]));

        sprintf(resolvedMethodName, "ifLuCmpeqConst1_TestCase%d", i + 1);
        compileOpCodeMethod(luCompareConst, _numberOfBinaryArgs, TR::iflucmpeq, resolvedMethodName, _argTypesBinaryLong,
            TR::Int32, rc, 4, 1, &(ifLuCmpeqDataArr[i][0]), 2, &(ifLuCmpeqDataArr[i][1]));
        OMR_CT_EXPECT_EQ(luCompareConst, compareEQ(ifLuCmpeqDataArr[i][0], ifLuCmpeqDataArr[i][1]),
            luCompareConst(LONG_PLACEHOLDER_1, LONG_PLACEHOLDER_2));

        sprintf(resolvedMethodName, "ifLuCmpeqConst2_TestCase%d", i + 1);
        compileOpCodeMethod(luCompareConst, _numberOfBinaryArgs, TR::iflucmpeq, resolvedMethodName, _argTypesBinaryLong,
            TR::Int32, rc, 2, 1, &(ifLuCmpeqDataArr[i][0]));
        OMR_CT_EXPECT_EQ(luCompareConst, compareEQ(ifLuCmpeqDataArr[i][0], ifLuCmpeqDataArr[i][1]),
            luCompareConst(LONG_PLACEHOLDER_1, ifLuCmpeqDataArr[i][1]));

        sprintf(resolvedMethodName, "ifLuCmpeqConst3_TestCase%d", i + 1);
        compileOpCodeMethod(luCompareConst, _numberOfBinaryArgs, TR::iflucmpeq, resolvedMethodName, _argTypesBinaryLong,
            TR::Int32, rc, 2, 2, &(ifLuCmpeqDataArr[i][1]));
        OMR_CT_EXPECT_EQ(luCompareConst, compareEQ(ifLuCmpeqDataArr[i][0], ifLuCmpeqDataArr[i][1]),
    ...
    for (uint32_t i = 0; i < testCaseNum; ++i) {
        OMR_CT_EXPECT_EQ(_ifLuCmpne, compareNE(ifLuCmpneDataArr[i][0], ifLuCmpneDataArr[i][1]),
            _ifLuCmpne(ifLuCmpneDataArr[i][0], ifLuCmpneDataArr[i][1]));

        sprintf(resolvedMethodName, "ifLuCmpneConst1_TestCase%d", i + 1);
        compileOpCodeMethod(luCompareConst, _numberOfBinaryArgs, TR::iflucmpne, resolvedMethodName, _argTypesBinaryLong,
            TR::Int32, rc, 4, 1, &(ifLuCmpneDataArr[i][0]), 2, &(ifLuCmpneDataArr[i][1]));
        OMR_CT_EXPECT_EQ(luCompareConst, compareNE(ifLuCmpneDataArr[i][0], ifLuCmpneDataArr[i][1]),
            luCompareConst(LONG_PLACEHOLDER_1, LONG_PLACEHOLDER_2));

        sprintf(resolvedMethodName, "ifLuCmpneConst2_TestCase%d", i + 1);
        compileOpCodeMethod(luCompareConst, _numberOfBinaryArgs, TR::iflucmpne, resolvedMethodName, _argTypesBinaryLong,
            TR::Int32, rc, 2, 1, &(ifLuCmpneDataArr[i][0]));
        OMR_CT_EXPECT_EQ(luCompareConst, compareNE(ifLuCmpneDataArr[i][0], ifLuCmpneDataArr[i][1]),
            luCompareConst(LONG_PLACEHOLDER_1, ifLuCmpneDataArr[i][1]));

        sprintf(resolvedMethodName, "ifLuCmpneConst3_TestCase%d", i + 1);
        compileOpCodeMethod(luCompareConst, _numberOfBinaryArgs, TR::iflucmpne, resolvedMethodName, _argTypesBinaryLong,
            TR::Int32, rc, 2, 2, &(ifLuCmpneDataArr[i][1]));
        OMR_CT_EXPECT_EQ(luCompareConst, compareNE(ifLuCmpneDataArr[i][0], ifLuCmpneDataArr[i][1]),
