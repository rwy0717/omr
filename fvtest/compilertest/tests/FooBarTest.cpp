...
// "compiler/codegen/FrontEnd.cpp" TR_FrontEnd::methodTrampolineLookup is "notImplemented("methodTrampolineLookup");"
// and "test/env/FrontEnd.cpp"  TestCompiler::FrontEnd::methodTrampolineLookup is "methodTrampolineLookup not
// implemented yet". This test also failed intermittent (segfault) on PPCLE, temporarily disabled this test on PPCLE,
// under track of Work Item Please remove this #ifdef after those functions are implemented.
