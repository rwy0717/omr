...
TEST_F(LogFileTest, KeywordsLogTest)
{
   ...
   */
    logFileChecks.insert(std::pair<const char*, std::map<const char*, bool> >("traceFull", buildKeywordMap({ "<jitlog", "<ilgen", "<trees", "</trees>", "BBStart", "BBEnd", "<block_" })));
    logFileChecks.insert(std::pair<const char*, std::map<const char*, bool> >("traceCG", buildKeywordMap({ "<codegen" })));
