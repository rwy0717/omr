...
inline bool Object::lookup(Context& cx, const Object* self, Id id, SlotDescriptor& result) {
...
inline Value Object::getValue(const Object* self, SlotIndex index) noexcept {
	Value* pointer = (Value*)(self->fixedSlots_ + index.offset());
	return *pointer;
}

inline void Object::setValue(Context& cx, Object* self, SlotIndex index, Value value) noexcept {
	Value* pointer = (Value*)(self->fixedSlots_ + index.offset());
	*pointer = value;
}
...
inline Shape* Object::takeExistingTransition(Context& cx,
...
inline Shape* Object::takeNewTransition(Context& cx,
...
inline Shape* Object::transition(Context& cx,
                                 Handle<Object> object,
                                 Infra::Span<const SlotAttr> attributes,
                                 std::size_t hash) {
...
inline Object* Object::allocate(Context& cx, Handle<Shape> layout) {
...
inline Object* allocateEmptyObject(Context& cx) { return Object::allocate(cx); }
