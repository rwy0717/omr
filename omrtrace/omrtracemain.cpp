...
static void omrTraceInit(void* env, UtModuleInfo* modInfo) { moduleLoaded(OMR_TRACE_THREAD_FROM_ENV(env), modInfo); }
 ...
 * returns     - Success or error code
 ******************************************************************************/
static omr_error_t trcFlushTraceData(OMR_TraceThread* thr) { return OMR_ERROR_NONE; }
...
static omr_error_t trcSetOptions(OMR_TraceThread* thr, const char* opts[]) { return setOptions(thr, opts, TRUE); }
