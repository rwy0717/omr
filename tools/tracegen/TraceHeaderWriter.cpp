    ...
    unsigned int auxiliary)
{
    ...
    if (auxiliary) {
        ...
        if (0 <= fprintf(fd, TP_TEMPLATE, overhead, testMacro, name, envParam ? "thr" : "",
                     ...
                     envParam ? UT_ENV_PARAM : UT_NOENV_PARAM, module, id, module, id, parameters, parmString, testNop,
                     name, envParam ? "thr" : "", envParam ? parmString : parmStringNoLeadingComma, module, id)) {
            rc = RC_OK;
        } else {
            rc = RC_FAILED;
            goto failed;
