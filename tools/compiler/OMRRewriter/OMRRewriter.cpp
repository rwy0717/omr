...
public:
    ...
    bool VisitCallExpr(CallExpr* call)
    {
        ...
        if ((referencedFunc = dyn_cast<DeclRefExpr>(call->getCallee()->IgnoreImplicit()))
            ...
            /*DiagnosticsEngine &diagEngine = Context->getDiagnostics();
            unsigned diagID = diagEngine.getCustomDiagID(DiagnosticsEngine::Error, "Static member function must be
            called with scope qualifier. Suggested fix:"); DiagnosticBuilder builder =
